    ...
    if ($res != false) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="" style="padding: 10px 0px;">
                                <a href="<?php echo $BaseUrl.'/business-directory-services/details.php?business='.$row['idspProfiles'];?>" class="title"><?php echo $name; ?></a>
        ...
        echo "<h3 style='text-align: center;font-weight: bold;'>There are no Profiles found with your searched words, please search again.</h3>";
    }
    ?>