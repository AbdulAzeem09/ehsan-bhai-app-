...
<button type="submit" name="submit_module"  class="btn btn-primary btn-border-radius">Add</button> 
</div>
</form>
</div>
</div>
...
<input type="text" class="form-control no-radius" id="Title_" name="Title" />  
</div>
<div class="modal-footer" class="uploadupdate">
...
?>
<a href="#" class="btn btn_bus_dircty pull-right" data-toggle="modal" data-target="#addnews" id="addnews" style=" background-color:#e39b0f;"><span class="glyphicon glyphicon-plus"></span> Add Album </a>  
<?php
}
?>
...
<td align="center">
<a href="javascript:void(0)"  onclick="edit_data('<?php echo $row['id']; ?>','<?php echo $row['title']; ?>')" class="editNews"><i class="fa fa-edit"></i></a>
<a href="<?php echo $BaseUrl . '/business-directory/deletegallery.php?id=' . $row['id']; ?>" class="btn "><i class="fa fa-trash"></i></a>
