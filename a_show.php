  ...
  <tbody>
    ...
    <td><?php echo $row ['email']; ?></td>  
      ...
      <td><?php echo $row['password']; ?></td>  
            <td><a href="<?php echo $BaseUrl; ?>aa_delete.php? id=<?php echo $row['id'];?>" class="btn btn-success">Delete</a></td>
            <td><a href="<?php echo $BaseUrl; ?>aa_edit.php? id=<?php echo $row['id'];?>" class="btn btn-danger">Edit</a></td>
