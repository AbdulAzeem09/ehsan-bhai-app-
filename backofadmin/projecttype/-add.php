...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processProfileType.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
