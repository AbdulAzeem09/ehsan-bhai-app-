<?php
	...
	$sql = "SELECT * FROM artsizes WHERE idartsize ='$sizeId'";
...
?>
	...
	<section class="content-header top_heading">
		<h1>Modify Art Size Category</h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processArtSize.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $sizeId;?>"/>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" value="<?php echo $spSizeTitle;?>" class="form-control" maxlength="40">
