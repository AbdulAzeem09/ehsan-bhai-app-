...
?>
	...
	<section class="content-header top_heading">
		<h1>Modify Footer Page Content</h1>
	</section>
	<!-- Main content -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>Under Foot Title</label>
								<select class="form-control" name="txtFootId">
									<option value="0">Select Title</option>
									<?php
									$sql2 = "SELECT * FROM tbl_foot_heading";
									$result2 = dbQuery($dbConn, $sql2);
									if ($result2) {
										while ($row2 = dbFetchAssoc($result2)) {
											?>
											<option value="<?php echo $row2['fh_id']; ?>" <?php echo ($row2['fh_id'] == $fh_id)?'selected':'';?>><?php echo $row2['fh_title'];?></option>
											<?php
										}
									}
									?>
						...
						<div class="col-md-4 col-sm-4 m_btm_30">
