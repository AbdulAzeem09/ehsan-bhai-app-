...
@ini_set('display_errors', 0);
	...
	$rowsPerPage = 25;
  	...
  	$sql		=	"SELECT * FROM milestone AS t inner join payment_milestone as d on t.id = d.post_id where  request_status = 2 order by t.id desc";
...
?>
	...
	<section class="content-header ">
		<h1>Freelancer<small>[Cancel Payment]</small></h1>
	</section>
	<!-- Main content -->
