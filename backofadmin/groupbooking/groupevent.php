...
$sql = "SELECT * FROM spgroupevent_transection";
...
<h1>Group Bookings<small>[Event]</small></h1>
</section>
<!-- Main content -->
...
$sql2 = "SELECT * FROM sp_groupevent where idspPostings = $postid";
...
<!-- </td> -->
<td><?php echo $row2['Default_Currency'].' '.$payment_gross; ?></td>
<td class="text-center"><?php echo $quantity; ?></td>
<td><?php showProfileName($dbConn, $buyer_pid); ?></td>
