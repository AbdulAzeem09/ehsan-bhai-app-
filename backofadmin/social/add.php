...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processSocial.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
			...
			<div class="container-fluid container_block">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
							<label>Icon:</label>
							<input type="text" name="txtIcon" id="txtIcon" class="formField" required="required"/>
						</div>
					</div>
					<div class="col-md-4 col-sm-4">
						<div class="form-group">
					...
					<div class="col-md-12 col-sm-12">
						<div class="form-group">
							<label>Link:</label>
							<input type="text" name="txtLink" id="txtLink" class="formField" required="required"/>
						</div>
					</div>
