...
?>
	...
	<section class="content-header top_heading">
		<h1>Block<small>[Clasified Adds]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processPosting.php?action=block"  enctype="multipart/form-data" onsubmit="return validate(this)">
			...
			<div class="container-fluid container_block">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12" style="margin-bottom:20px;">
						...
						<textarea class="formField" name="txtDesc" rows="6" class="red" id="txtDesc" style="width: 308px;"></textarea>
						<br>
			...
			<div class="row">
				<div class="col-md-offset-5 col-xs-offset-3 col-sm-offset-5" style="margin-left: 21%!important;">
					<input type="submit" name="btnButton" id="add" value="Block" class="butn" /> &nbsp;
