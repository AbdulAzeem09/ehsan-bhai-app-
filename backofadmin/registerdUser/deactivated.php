<?php
	...
	//if (isset($_GET['orderby']) && $_GET['orderby'] != '') {
		...
		//$order = $_GET['orderby'];
		$sql = "SELECT * FROM spuser WHERE deactivate_status=1  ";
...
?>
		...
		<section class="content-header">
			<h1>Deactivated Users<small>[All User List]</small></h1>
		</section>
		<!-- Main content -->
			                	...
			                	<?php
									if ($result){
										...
										while($row = dbFetchAssoc($result)) {
											extract($row);
											$deactivated_date=$row['deactivate_date'];
											...
											$result11 = dbQuery($dbConn, $sql1);
												...
												<td class="text-center"><?php echo $deactivated_date;?></td>
												...
												//	}else{ ?>
<a href="javascript:activateRegUser(<?php echo $idspUser;?>)" data-original-title="Activate" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-green"><i class="fa fa-lock"></i></a>&nbsp; <?php
													//}
													?>
