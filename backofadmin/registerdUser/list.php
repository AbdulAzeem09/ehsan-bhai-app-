...
if ($userby == 'active') {
$order = "0" ;
$sql = "SELECT * FROM spuser WHERE spUserLock = $order";
}else if($userby == 'inactive'){
$order = "1"; 
$sql = "SELECT * FROM spuser WHERE spUserLock = $order";
}else{
...
<h1>Registered User<small>[All User List]</small></h1>
</section>
<!-- Main content -->
...
<option value="AllUser" <?php echo (isset($_GET['useryby']) && $_GET['useryby'] == 'AllUser')?'selected':''; ?> >All User</option>
...
<td><a href="index.php?view=detail&uid=<?php echo $idspUser; ?>"><?php echo $spUserFirstName.' '.$spUserLastName;	?></a></td>
