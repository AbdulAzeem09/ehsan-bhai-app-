					        	...
					        	<div class="col-sm-6">
					          	...
					          	<div class="col-sm-6">
						            <div class="row mgbt-xs-0">
						              	...
						              	<div class="col-xs-7 controls">
						              		<?php //echo $spProfilesState;?>
						              		<?php
	                                        if($spProfilesState > 0 && $spProfilesState != ''){
	                                            StateName($dbConn, $spProfilesState);
	                                        } ?>		
						              	</div>
						              	<!-- col-sm-10 --> 
						            </div>
					          	...
					          	<div class="col-sm-6">
						            <div class="row mgbt-xs-0">
						              	...
						              	<div class="col-xs-7 controls">
						              		<?php
	                                        if($spProfilesCity > 0 && $spProfilesCity != ''){
	                                            CityName($dbConn, $spProfilesCity);
	                                        } ?>
	                                   	</div>
						              	<!-- col-sm-10 --> 
						            </div>
					          	...
					          	<div class="col-sm-6">
						            <div class="row mgbt-xs-0">
						              	...
						              	<div class="col-xs-7 controls"><?php echo formatMySQLDate($spUserDob, "d-M-Y" ); ?></div>
						              	<!-- col-sm-10 --> 
						            </div>
					          	</div>
