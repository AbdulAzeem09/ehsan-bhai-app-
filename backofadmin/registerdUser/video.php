    ...
    <div class="box-body no-padding">
        <?php
            ...
            $rowsPerPage = 25;
            $sql        =   "SELECT * FROM sppostings WHERE spCategories_idspCategory = 10 AND spProfiles_idspProfiles = $pid ORDER BY idspPostings DESC";
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if ($result2) {
                                                ...
                                                echo "<img alt='Posting Pic' src='".WEB_ROOT."img/no-pic.jpg' class='img-responsive'>";
                                            }
