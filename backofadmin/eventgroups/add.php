...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processEventGroup.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
							...
							<input type="text" name="grptxtTitle" id="txtTitle" class="form-control" maxlength="40">
						...
						<div class="col-md-6 col-sm-6" style="margin-bottom:20px;overflow-y: scroll;height:200px;">
							...
							if ($ecresult) {
								...
								while ($ecrow = dbFetchAssoc($ecresult)) {
									...
									?>
									<input type="checkbox" name="catids[]" value="<?php echo $ecrow['idspevent'];?>">&nbsp;&nbsp;<?php echo $ecrow['speventTitle'];?><br>
