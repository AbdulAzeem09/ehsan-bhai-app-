<?php
	...
	$sql = "SELECT * FROM spprofilecontent WHERE idspContent ='$contId'";
...
?>
	...
	<section class="content-header top_heading">
		<h1>Modify Profile Page Content</h1>
	</section>
	<!-- Main content -->
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-5 col-sm-5" style="margin-bottom:20px;">
							...
							<input type="text" name="profilenames" class="form-control" value="<?php echo $profilenames; ?>">
							<!-- <textarea class="formField" rows="6" name="profilenames"><?php echo $profilenames; ?></textarea> -->
						    </div>
						</div>

						<div class="col-md-7 col-sm-7" style="margin-bottom:20px;">
							<div class="col-md-5 col-sm-5" ">
							<div class="form-group">
							<label>upload Image:</label><br>
							<input type="file" name="image" class="form-control" value="<?php echo $profilenames; ?>">
							
							
						    </div>
						    </div>
						    <div class="col-md-6 col-sm-6" style="margin-bottom:20px;">
                              <img src="images/<?php echo $image; ?>"  style="width:50%;height:50%">
						    </div>
						</div> 
						
						<div class="col-md-12 col-sm-12" style="margin-bottom:20px;">
							<label>Description:</label><br>
							<textarea class="formField" rows="6" name="txtDesc"><?php echo $profiletxtDesc; ?></textarea>
						</div>
