...
?>	
	...
	<section class="content-header top_heading">
		<h1>Modify Email Marketing Content</h1>
	</section>
	<!-- Main content -->
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>Title</label>
								<input type="text" class="form-control" name="txtTitle" value="<?php echo $contTitle; ?>" required="" >
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label>Icon</label>
								<input type="file" name="txtImage" id="txtImage" /><?php echo $contIcon?>
							</div>
						</div>
						<div class="col-md-4 col-sm-4">
							<div class="form-group">
								<label>Status :</label></br>
								<input type="radio" name="radStatus" id="radStatus" value="1" <?php if($contStatus == 1){echo "Checked";}?> />
								<span class="txtDarkGray14">Active</span> &nbsp;
								<input type="radio" name="radStatus" id="radStatus" value="0" <?php if($contStatus == 0){echo "Checked";}?> />
						...
						<div class="col-md-12 col-sm-12" style="margin-bottom:20px;">
							...
							<textarea class="form-control detaild" rows="4" name="txtDesc" maxlength="200"><?php echo $contDesc; ?></textarea>
							<span id="chars"><?php echo isset($contDesc)?200-strlen($contDesc):'';?></span> characters remaining
						</div>
