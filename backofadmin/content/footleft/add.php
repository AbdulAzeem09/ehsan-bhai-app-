			...
			<div class="container-fluid container_block">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12" style="margin-bottom:20px;">
						...
						<textarea class="form-control detaild" rows="4" name="txtDesc" maxlength="230" ></textarea>
						<span id="chars">230</span> characters remaining
					</div>
