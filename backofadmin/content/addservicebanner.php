...
$sql_1 =  "SELECT * FROM `service_banner`";
//echo $sql_1;
$result_1  = dbQuery($dbConn,$sql_1);
if($result_1){
$service_ban = mysqli_fetch_array($result_1);
}
...
<div class="col-md-10">
<h1>Upload File For Service Banner</h1>
</div>
<div id="demo" class="col-md-6 float-left">
<input type="file" name="photo" value="" accept="image/*" required ><br>
...
<img src="<?php echo $BaseUrl.'/backofadmin/content/upload/'.$service_ban["banner_img"];?>" alt="" width="200" height="200">
...
$path ="upload/";
$filepath ="upload/". $_FILES["photo"]["name"];
$photoName = $_FILES["photo"]["name"];
$finalname=$path.basename($_FILES["photo"]["name"]);
if(move_uploaded_file($_FILES["photo"]["tmp_name"], $finalname)){

$sqld =  "UPDATE service_banner SET banner_img='$photoName'  WHERE id=2";


if(mysqli_query($dbConn, $sqld)){
