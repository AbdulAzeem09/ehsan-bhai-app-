...
<table id="example" class="display" cellspacing="0" width="100%" >
        ...
        <tbody>
<?php
				$sqlmanagecurrency =  "SELECT * FROM `spbuisness_subscriber`";
...
?>
                                                   <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $i; ?></td>
                                                        <td class="text-center">&nbsp;<?php echo $rowmanagecurrency['email']; ?></td>
                                                        
														
														<!--<td class="text-center"><?php //echo $rowmanagecurrency['duration']; ?></td>
                                                        <td class="text-center"><?php //echo $rowmanagecurrency['status']; ?></td>
                                                        <td class="text-center">
														
														<a href="<?php //echo WEB_ROOT.'buisness_for_sale/edit_business.php?postid='.$rowmanagecurrency['idspbusiness']; ?>"><i class="fa fa-edit"></i></a>
 <a href="<?php //echo WEB_ROOT.'buisness_for_sale/deletepic.php?postid='.$rowmanagecurrency['idspbusiness']; ?>" data-postid="<?php //echo $rowmanagecurrency['idspbusiness']; ?>" class="delpost" ><i class="fa fa-trash"></i></a>
