...
?>
	...
	<section class="content-header top_heading">
		<h1>Add Posting Content</h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="process.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
				...
				<div class="box-body">
					...
					<div class="row">
								...
								<select class="form-control" name="txtModule">
									...
									if ($result) {
										while ($row = dbFetchAssoc($result)) {
											?>
											<option value="<?php echo $row['idspCategory']?>"><?php echo $row['spCategoryName'];?></option>
											<?php
										}
									}
									?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<label>Heading</label>
								<input type="text" name="txtHeading" class="form-control">
							</div>
						</div>
