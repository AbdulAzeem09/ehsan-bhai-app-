...
<?php
	...
	//Add 
	function add($dbConn){
		$isFeature	= mysqli_real_escape_string($dbConn, $_POST['isFeature']);
		...
		$sql2 = "INSERT INTO spcontent(contTitle, contDesc, contIcon, contStatus, contFeature) VALUES ('$txtTitle', '$txtDesc', '$cont_img', $radStatus, $isFeature)";
