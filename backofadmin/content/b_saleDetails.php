...
$sqlu="UPDATE `spbuisnesssale` SET price='$price1',duration='$duration1' WHERE id=$id1" ;
//echo $sqlu;
//die('=');
...
$id1=$_GET['id'];
$sqld="DELETE FROM `spbuisnesssale` WHERE id=$id1";
...
<div class="col-md-2">
<span style="font-size:30px;">B Sales</span>
</div>
...
<form action="formInsert.php" method="post" class="">
<div class="modal-header br_radius_top bg-white">
<h3 class="modal-title" id="changeModalLabel"><b>Create Package</b></h3>
</div>

<div class="modal-body">
<div class="form-group">
<label for="price_number" class="control-label contact">Price </label>
<input type="number" class="form-control" id="price_number" name="price" placeholder="enter a price">
</div>

<div class="form-group">
<label for="duration" class="control-label contact">Duration</label>
<input type="number" class="form-control" id="duration" name="duration" placeholder="enter a duration">
</div>
...
<tbody>
<?php
$sqlmanagecurrency =  "SELECT * FROM `spbuisnesssale`";
...
//die('=======');
$id=$rowmanagecurrency['id'];
$price=$rowmanagecurrency['price'];
$duration=$rowmanagecurrency['duration'];
...
<td><?php echo $i; ?></td>
<td><?php echo $i; ?></td>
<td>USD&nbsp;<?php echo $rowmanagecurrency['price']; ?></td>
<td><?php echo $rowmanagecurrency['duration']; ?></td>
<td><?php echo $rowmanagecurrency['updatedat']; ?></td>
<td>
<a href="" class="" data-postid="<?php echo $row['idspPostings'];?>" data-toggle="modal" data-target="#newForm1_<?php echo $id;   ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<?php
$href = $BaseUrl . '/backofadmin/content/b_sale.php?id=' . $id . '&action=delete';
?>
...
$sqli="SELECT * FROM `spbuisnesssale` WHERE id=$id";
$resi= dbQuery($dbConn, $sqli);
//print_r();
//die('==========');
if($resi){
...
<!-- Modal -->
<div class="modal fade" id="newForm1_<?php echo $id;    ?>" tabindex="-1" role="dialog" aria-labelledby="changeModalLabel">
<div class="modal-dialog" role="document">
<div class="modal-content sharestorepos bradius-15">
...
<div class="form-group">
<label for="price_number" class="control-label contact">Price </label>
<input type="number" class="form-control" id="price_number" name="price" value="<?php echo $rowi['price'];    ?>" placeholder="enter a price">
</div>

<div class="form-group">
<label for="duration" class="control-label contact">Duration</label>
<input type="text" value="<?php echo $rowi['duration'];     ?>" class="form-control"  name="duration" placeholder="enter a duration">
</div>
