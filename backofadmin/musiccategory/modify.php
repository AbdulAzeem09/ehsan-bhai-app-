<?php
	...
	$sql = "SELECT * FROM music_category WHERE music_id ='$musicCatId'";
...
?>
	...
	<section class="content-header top_heading">
		<h1> Music Category<small>[Modify]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processeventcat.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $musicCatId;?>"/>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" value="<?php echo $music_cat_title;?>" class="form-control" maxlength="40"></br>
