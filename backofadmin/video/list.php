<?php
	...
	$rowsPerPage = 25;
  	$sql		=	"SELECT * FROM sppostings WHERE spCategories_idspCategory = 10 ORDER BY idspPostings DESC";
									...
									<tr>
										...
										<td>
											...
											if ($result2 AND dbNumRows($result2) > 0) {
												...
												echo "<img alt='Posting Pic' src='".WEB_ROOT."upload/no-img.png' class='img-responsive' style='width:40px;height: 40px;' >";
											}
                                            ?>
										</td>
										...
										<td class="text-center menu-action">
											...
											<a href="javascript:postDetail(<?php echo $idspPostings; ?>)" data-toggle="tooltip" title="Detail!" class="btn menu-icon vd_bg-blue"><i class="fa fa-info"></i></a>&nbsp; 
