<?php
	...
	$sql = "SELECT * FROM tbl_point_type WHERE pt_id ='$id'";
...
?>
	...
	<section class="content-header">
		<h1>Point Type <small>[Modify]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="process.php?action=modify"  enctype="multipart/form-data" >
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $pt_id;?>"/>
			...
			<div class="box box-success">
					...
					<div class="row">
						<div class="col-md-3 col-sm-6" >
							<div class="form-group">
								...
								<input type="text" name="txtTitle" id="txtTitle" class="form-control" maxlength="40" value="<?php echo $pt_title; ?>" >
				...
				<div class="box-footer"> 
                    <input type="button" name="btnButton" id="update" value="Update" class="btn vd_btn vd_bg-green finish" /> &nbsp;
