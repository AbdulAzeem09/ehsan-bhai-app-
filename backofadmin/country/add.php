...
?>
	...
	<section class="content-header top_heading">
		<h1>Country Name<small>[Add]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processcountry.php?action=add"  enctype="multipart/form-data" >
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" style="margin-bottom:20px;">
							<label>Country Name: <span class="red">*</span></label></br>
...
*/                        
                            ...
                            $("#subcat_error").text("Please Enter Country Name.");
