		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 1, $pid);?><small>Products</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 5, $pid);?> <small>Projects</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		             <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 2, $pid);?> <small>Jobs</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 3, $pid);?> <small>Property</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		             <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 9, $pid);?> <small>Events</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 13, $pid);?> <small>Photos</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		             <div class="col-md-6 col-sm-6 col-xs-12">
		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 10, $pid);?> <small>Videos</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		             <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 8, $pid);?><small>Course</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
		            <div class="col-md-6 col-sm-6 col-xs-12">
		              	<div class="info-box">
			                ...
			                <div class="info-box-content">
			                  	...
			                  	<span class="info-box-number"><?php totalMyStoreProduct($dbConn, 7, $pid);?> <small>Servoces</small></span>
			                </div><!-- /.info-box-content -->
		              	</div><!-- /.info-box -->
		            </div><!-- /.col -->
    		...
    		<div class="col-md-4">
    			...
    			<div class="box-footer no-padding">
                  	<ul class="nav nav-pills nav-stacked">
	                    <li><a href="#">Store <span class="pull-right text-store">			 <?php totalMyStoreProduct($dbConn, 1, $pid);?> Products</span></a></li>
	                    <li><a href="#">Freelance <span class="pull-right text-freelance">		 <?php totalMyStoreProduct($dbConn, 5, $pid);?> Projects</span></a></li>
	                    <li><a href="#">Job Board <span class="pull-right text-jobboard">		 <?php totalMyStoreProduct($dbConn, 2, $pid);?> Jobs</span></a></li>
	                    <li><a href="#">Real Estate <span class="pull-right text-realestate">		 <?php totalMyStoreProduct($dbConn, 3, $pid);?> Property</span></a></li>
	                    <li><a href="#">Events <span class="pull-right text-events">			 <?php totalMyStoreProduct($dbConn, 9, $pid);?> Events</span></a></li>
	                    <li><a href="#">Art Gallery <span class="pull-right text-artgallery">	 <?php totalMyStoreProduct($dbConn, 13, $pid);?> Photos</span></a></li>
	                    <li><a href="#">Music <span class="pull-right text-music">			 <?php totalMyStoreProduct($dbConn, 14, $pid);?> Songs</span></a></li>
	                    <li><a href="#">Videos <span class="pull-right text-video">			 <?php totalMyStoreProduct($dbConn, 10, $pid);?> Videos</span></a></li>
	                    <li><a href="#">Trainings <span class="pull-right text-trainings">		 <?php totalMyStoreProduct($dbConn, 8, $pid);?> Courses</span></a></li>
	                    <li><a href="#">Classified Adds <span class="pull-right text-clasified"><?php totalMyStoreProduct($dbConn, 7, $pid);?> Services</span></a></li>
                  	</ul>
                </div><!-- /.footer -->
    		</div>
    	</div>
