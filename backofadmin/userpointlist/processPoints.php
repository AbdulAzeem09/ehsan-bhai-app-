...
<?php
	...
	function modify($dbConn) {
		$idspPoint 		= mysqli_real_escape_string($dbConn, $_POST['hidId']);
		$totalPoint = mysqli_real_escape_string($dbConn, $_POST['totalPoint']);

		// update content

			$sql = "update spuserpoints SET totalPoints ='$totalPoint' WHERE idspPoint  = $idspPoint";
	...
	function deletee($dbConn){
		...
		$idspPoint		= mysqli_real_escape_string($dbConn, $_GET['idspPoint']);		
		$sql		=	"DELETE FROM spuserpoints WHERE idspPoint = $idspPoint";
