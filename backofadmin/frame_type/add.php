...
?>
	...
	<section class="content-header top_heading">
		<h1>Frame Type<small>[Add]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processFrameType.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
