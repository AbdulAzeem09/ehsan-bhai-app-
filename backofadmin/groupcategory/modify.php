...
$sql = "SELECT * FROM group_category WHERE id ='$eventCatId'";
...
<section class="content-header top_heading">
    <h1> Group Category<small>[Modify]</small></h1>
</section>
<!-- Main content -->
<section class="content" >
    <!-- start any work here. -->
    <form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processgroupcat.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4" style="margin-bottom:20px;">
                        <label>Name</label> <span class="red">*</span></br></br>
                        <input type="text" name="txtTitle" id="txtTitle" value="<?php echo $group_category_name;?>" class="form-control" maxlength="40">
