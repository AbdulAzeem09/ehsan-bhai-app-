...
?>
	...
	<section class="content-header top_heading">
		<h1>Art Sold By<small>[Add]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processArtSoldBy.php?action=add"  enctype="multipart/form-data" >
