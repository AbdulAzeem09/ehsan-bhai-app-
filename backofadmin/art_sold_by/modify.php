<?php
	...
	$sql = "SELECT * FROM art_sold_by WHERE idspArtSold ='$artSold'";
...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processArtSoldBy.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $artSold;?>"/>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" class="form-control" maxlength="40" value="<?php echo $spArtSoldTitle;?>" />
