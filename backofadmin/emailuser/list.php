			...
			<div class="row bord-right-space" >
	              	...
	              	<div class="box box-solid">
		                ...
		                <div class="box-body no-padding">
		                  	<ul class="nav nav-pills nav-stacked">		                    
			                    <li class="active"><a href="index.php?view=list"><i class="fa fa-envelope-o"></i> All Profiles</a></li>
			                    <li><a href="index.php?view=limited"><i class="fa fa-envelope-o"></i> Specific Profiles</a></li>
		                  	</ul>
		                </div><!-- /.box-body -->
	              	</div><!-- /. box -->
				...
				<div class="col-md-9">
					<div class="box box-primary">
						<form action="process.php?action=sendall" method="post" enctype="multipart/form-data" name="frmAddAdmin" id="frmAddAdmin" >
			                <div class="box-header with-border">
			                  	<h3 class="box-title">Compose Email To All Profiles</h3>
			                </div><!-- /.box-header -->
			                <div class="box-body">
