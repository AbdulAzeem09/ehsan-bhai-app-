...
require_once '../../library/config.php';
	...
	$row = selectQ("SELECT * from sptestimonial where id=?", "i", [$Id], "one");
?>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-12 col-sm-12" style="margin-bottom:20px;">
							...
							<textarea class="form-control detaild" rows="4" name="txtDesc" maxlength="5000" required><?php echo $row['description']; ?></textarea>
