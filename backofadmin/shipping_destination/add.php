...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processShipDest.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
			...
			<div class="box box-success">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" >
							<div class="form-group">
								...
								<input type="text" name="txtTitle" id="txtTitle" maxlength="40" class="form-control"  />
				...
				<div class="box-footer"> 
                    <input type="submit" name="btnButton"  id="update" value="Save" class="btn vd_btn vd_bg-green finish" /> &nbsp;
