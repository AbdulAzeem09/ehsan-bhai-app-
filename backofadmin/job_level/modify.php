<?php
	...
	if(isset($_GET['jobLvl']) && ($_GET['jobLvl']) > 0){
		$jobLvl  = $_GET['jobLvl'];
	}else {
		redirect('index.php');
	}
	$sql = "SELECT * FROM job_level WHERE spJobLevel ='$jobLvl'";
...
?>
	...
	<section class="content-header top_heading">
		<h1>Job Level<small>[Modify]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processJobLvl.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $jobLvl;?>"/>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" class="form-control" maxlength="40" value="<?php echo $jobLevelTitle;?>" />
