			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="<?php echo ($activeTab == 2)?'active':'';?> treeview">
		             	<a href="javascript:void(0)">
		              	...
		              	<ul class="treeview-menu">
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "notes" ?>"><i class="fa fa-circle-o"></i> All Sticky Notes</a></li>
			                <li>
		              	...
		              	<ul class="treeview-menu">
			                ...
			                <li>
			                	<a href="<?php echo WEB_ROOT_ADMIN . "mastercategory" ?>">
			                		<i class="fa fa-circle-o"></i> Business Category
			                	</a>
			                </li>
		              	</ul>
		            </li>
					...
					<li class="<?php echo ($activeTab == 5)?'active':'';?> treeview">
		             	<a href="javascript:void(0)">
		                	<i class="fa fa-users"></i> <span>Registered Users</span> <i class="fa fa-angle-left pull-right"></i>
		             	</a>
		              	<ul class="treeview-menu">
		              		<li><a href="<?php echo WEB_ROOT_ADMIN . "registerdUser/index.php?view=today" ?>"><i class="fa fa-circle-o"></i><span>Today Registered Users</span></a></li>
			                <li>
			                ...
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "registerdUser/index.php?view=vemail" ?>"><i class="fa fa-circle-o"></i><span>Valid Email Users</span></a></li>
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "registerdUser/index.php?view=vphone" ?>"><i class="fa fa-circle-o"></i><span>Valid Phone Users</span></a></li>
			                ...
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "registerdUser/index.php?view=block" ?>"><i class="fa fa-ban"></i><span>Blocked Users</span>
			                 ...
			                 <li><a href="<?php echo WEB_ROOT_ADMIN . "registerdUser/index.php?view=vaccount" ?>"><i class="fa fa-circle-o"></i><span>Verify Account</span></a></li>
					...
					<li class="treeview <?php echo ($activeTab == 40)?'active':'';?>">
						<a href="<?php echo WEB_ROOT_ADMIN . "pointtype" ?>"><i class="fa fa-hand-o-right"></i><span>Earning Points Type</span></a>
					</li>
			        <li class="treeview <?php echo ($activeTab == 38)?'active':'';?>">
						<a href="<?php echo WEB_ROOT_ADMIN . "point" ?>"><i class="fa fa-hand-o-right"></i><span>All Points</span></a>
					</li>
					<li class="treeview <?php echo ($activeTab == 39)?'active':'';?>">
						<a href="<?php echo WEB_ROOT_ADMIN . "dollar" ?>"><i class="fa fa-dollar"></i><span>Points to Dollar</span></a>
					</li>
			        <!-- END -->
					...
					<li class="treeview <?php echo ($activeTab == 12)?'active':'';?> treeview">
						<a href="javascript:void(0)"><i class="fa fa-cog"></i> <span>All Active Posts</span> <i class="fa fa-angle-left pull-right"></i></a>
					...
					<li class="treeview <?php echo ($activeTab == 19)?'active':'';?>">
		             	<a href="javascript:void(0)">
			        ...
			        <li class="<?php echo ($activeTab == 20)?'active':'';?> treeview">
		             	<a href="javascript:void(0)">
		                	<i class="fa fa-newspaper-o"></i> <span>Company News</span> <i class="fa fa-angle-left pull-right"></i>
		             	 </a>
		              	<ul class="treeview-menu">
		              		<li><a href="<?php echo WEB_ROOT_ADMIN . "cmpnynews" ?>"><i class="fa fa-circle-o"></i> All News</a></li>
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "cmpnynews/index.php?view=ban" ?>"><i class="fa fa-circle-o"></i> Banned News</a></li>
			            </ul>
			        </li>
			       
					<!-- GROUPS -->
					<li class="header">USER GROUPS</li>
					<li class="<?php echo ($activeTab == 21)?'active':'';?> treeview">
		             	<a href="javascript:void(0)">
		                	<i class="fa fa-users"></i> <span>Groups</span> <i class="fa fa-angle-left pull-right"></i>
		             	 </a>
		              	<ul class="treeview-menu">
		              		<li><a href="<?php echo WEB_ROOT_ADMIN . "groups" ?>"><i class="fa fa-circle-o"></i> All Groups</a></li>
			                <li><a href="<?php echo WEB_ROOT_ADMIN . "groups/index.php?view=ban" ?>"><i class="fa fa-circle-o"></i> Banned Groups</a></li>
			                 <li><a href="<?php echo WEB_ROOT_ADMIN . "groups/index.php?view=groups_c" ?>"><i class="fa fa-circle-o"></i>Groups category</a></li>
			            </ul>
			        </li>
					...
					<li class="treeview <?php echo ($activeTab == 22)?'active':'';?>">
		             	<a href="javascript:void(0)">
		                	<i class="fa fa-flag"></i> <span>Flag Post</span> <i class="fa fa-angle-left pull-right"></i>
		             	 </a>
		              	<ul class="treeview-menu active">
		              		<li><a href="<?php echo WEB_ROOT_ADMIN."flag/index.php?view=flagtimelinepost"?>"><i class="fa fa-circle-o"></i> Timeline</a></li>
			                <li><a href="<?php echo WEB_ROOT_ADMIN."flag/index.php?catId=1"?>"><i class="fa fa-circle-o"></i> Store</a></li>
			                 <li><a href="<?php echo WEB_ROOT_ADMIN."flag/rfqflag"?>"><i class="fa fa-circle-o"></i> RFQ Flag</a></li>
			                ...
			                <li><a href="<?php echo WEB_ROOT_ADMIN."flag/index.php?catId=9"?>"><i class="fa fa-circle-o"></i> Event </a></li>
			                 <li><a href="<?php echo WEB_ROOT_ADMIN."flag/index.php?catId=16"?>"><i class="fa fa-circle-o"></i>Group Event</a></li>
