<?php
	...
	$sql = "SELECT * FROM property_status WHERE idspProStatus ='$proStatus'";
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" class="form-control" maxlength="40" value="<?php echo $spProStatusTitle;?>" />
