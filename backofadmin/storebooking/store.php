...
/*	if (isset($_GET['orderby']) && $_GET['orderby'] != '') {
  	...
  	$sql = "SELECT * FROM sporder_confirm";
...
?>
		...
		<section class="content-header">
			<h1>Store Order History<small>[Store]</small></h1>
		</section>
		<!-- Main content -->
			...
			<div class="box box-success">
				...
				<div class="box-body">
					...
					<div class="table-responsive">
						...
						$sql2 = "SELECT * FROM sporder AS t inner join sp_order_has_ordernew as d on t.idsporder = d.sporeder_idsporeder inner join spproduct as p on d.sppostings_idsppostings = p.idsppostings where txn_id = '$txn_id'";
                                ...
                                //buyerdata
                                $sql3 = "SELECT * FROM spprofiles where idspProfiles = $buyerprofilid";
                                $result3 = dbQuery($dbConn, $sql3);
                                            ...
                                            //sellerdata  
  	                                          $sql4 = "SELECT * FROM spprofiles where idspProfiles = $sellerprofilid";
                                $result4 = dbQuery($dbConn, $sql4);
											...
											<tr class="<?php echo ($spUserLock == 1)?'lockedwind':'';?>">
												...
												<td class="text-center"><?php echo $row2['spOrderQty']; ?></td>
