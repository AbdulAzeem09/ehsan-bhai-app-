<?php
	...
	$sql = "SELECT * FROM industry_type WHERE idspIndustry ='$indType'";
...
?>
	...
	<section class="content-header">
		<h1>Industry Type<small>[Modify]</small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processIndustryType.php?action=modify"  enctype="multipart/form-data" onsubmit="return validate(this)">
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $indType;?>"/>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" >
							<div class="form-group">
								...
								<input type="text" name="txtIndusrtyType" id="txtIndusrtyType" class="form-control" maxlength="40" value="<?php echo $industryTitle;?>" />
		...
		<script type="text/javascript">  /*js start*/
           ...
           $( document ).ready(function() {
                ...
                var txtIndusrtyType = $("#txtIndusrtyType").val();
