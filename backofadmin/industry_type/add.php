...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processIndustryType.php?action=add"  enctype="multipart/form-data" >
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" >
							<div class="form-group">
								...
								<input type="text" name="txtIndusrtyType" id="txtIndusrtyType" class="form-control" maxlength="40" required="required" />
