...
/*	if (isset($_GET['orderby']) && $_GET['orderby'] != '') {
  	...
  	$sql = "SELECT * FROM rfq_transection";
...
?>
		...
		<section class="content-header">
			<h1>Quotation Payment<small>[RFQ]</small></h1>
		</section>
		<!-- Main content -->
		...
		<div class="">
			<div class="box box-success">
				...
				<div class="box-body">
					...
					$sql2 = "SELECT * FROM rfq_comment AS t inner join rfq as d on t.idspRfq = d.idspRfq where t.idspRfqComment = '$post_idspRfqComment'";
  	                                  ...
  	                                  //echo $sql2;   
                                            ...
                                            $sellerprofilid =   $row2['spProfile_idspProfiles'];
  	                     ...
  	                     $sql4 = "SELECT * FROM spprofiles where idspProfiles = $sellerprofilid";
                                $result4 = dbQuery($dbConn, $sql4);
											...
											<tr class="<?php echo ($spUserLock == 1)?'lockedwind':'';?>">
												...
												<td class="text-center"><?php echo $row2['rfqTitle'];?></td>
												...
												<td class="text-center"><?php echo $row2['rfqcMinOrder']; ?></td>
