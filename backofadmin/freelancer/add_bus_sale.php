<?php
	...
	if(isset($_POST["btnButton"])){
		...
		$sql="INSERT INTO `masterdetails`(`masterDetails`, `master_idmaster`) VALUES ('$subCategoryTitle','24')";
		$result = dbQuery($dbConn,$sql);
		redirect('index.php?view=add_bus_sale');
	}
...
?>
	...
	<section class="content-header">
		<h1>Add Sales <small>[Add]</small></h1>
	</section>
	<!-- Main content -->
