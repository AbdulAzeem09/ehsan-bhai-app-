<?php
	...
	if(isset($_POST["btnButton"])){
		...
		$sql="INSERT INTO `subcategory`(`subCategoryTitle`, `spCategories_idspCategory`,`subCategoryStatus`) VALUES ('$subCategoryTitle','1','1')";
...
?>
	...
	<section class="content-header">
		<h1>Store Category <small>[Add]</small></h1>
	</section>
	<!-- Main content -->
