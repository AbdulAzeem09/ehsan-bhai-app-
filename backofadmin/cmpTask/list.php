<?php
	...
	$sql =  "SELECT * FROM tbl_notes WHERE user_id_from = $userId AND spNotesStatus = 2";
...
?>
	...
	<section class="content-header">
		<h1>Completed Task<small>[List]</small></h1>
	</section>
	<!-- Main content -->
								...
								while ($row = dbFetchAssoc($result)) {
									...
									<tr>
										...
										<td class="text-center menu-action">
											<a href="javascript:viewNotes(<?php echo $idspNotes;?>)" data-original-title="Detail" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-red" ><i class="fa fa-eye"></i></a>&nbsp;											
