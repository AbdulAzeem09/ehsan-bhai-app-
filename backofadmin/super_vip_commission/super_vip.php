...
<div class="card text-center" style="width: 300px;margin-left: 393px;"     >
    ...
    <div class="card-body px-5">
        ...
        <button class=" btn btn-warning" type="submit" name="submit_module_1">Verify </button> 
        <span><a href="<?php echo $BaseUrl.'/backofadmin/super_vip_commission/index.php?res1=supresend';?>"class="btn btn-warning" href="">RESEND EMAIL</a> <span>
...
<div class="col-md-4">
    ...
    <div class="box-body"> 
           ...
           <br><br>
            ...
            <button class="pull-right btn btn-warning" type="submit" name="submit_module_commmision" style="margin-top: 8px;">Update </button> 
            </form>
				<!--- End Table ---------------->
		</div>
