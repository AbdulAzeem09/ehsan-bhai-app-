<?php
	...
	if(isset($_POST["btnButtonSub"])){
		...
		$sql33="INSERT INTO `subcategory`(`subCategoryTitle`, `spCategories_idspCategory`) VALUES ('$subCategoryTitle','8')";
		...
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action=""  enctype="multipart/form-data" onsubmit="return validate(this)">
			...
			<div class="box box-success">
				...
				<div class="box-footer"> 
                    ...
                    <input type="button" name="btnButtonSub" value="Back" class="btn vd_btn vd_bg-yellow" onclick="window.location.href='index.php?view=TrainingCategory'" /> &nbsp;
                </div>
			</div>
