...
redirect('index.php?view=TrainingCategory');
}
?>

<!-- Content Header (Page header) -->
<section class="content-header top_heading">
<h1>Tranining Category <small>[Edit]</small></h1>
</section>
<!-- Main content -->
...
<input type="text" name="txtTitle" id="txtTitle" value="<?php echo $subCategoryTitle ;?>" class="form-control" required="required"/>
</div>
...
<input type="button" name="EditButton" value="Back" class="btn vd_btn vd_bg-yellow" onclick="window.location.href='index.php?view=TrainingCategory'" /> &nbsp;
</div>
</div>
