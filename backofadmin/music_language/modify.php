<?php
	...
	$sql = "SELECT * FROM music_language WHERE idspMusicLan ='$musicLan'";
...
?>
	...
	<section class="content-header top_heading">
		<h1>Music Language<small>[Modify] </small></h1>
	</section>
	<!-- Main content -->
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processMusicLang.php?action=modify"  enctype="multipart/form-data" >
			<input type="hidden" name="hidId" id="hidId"  value="<?php echo $musicLan;?>"/>
				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-6" style="margin-bottom:20px;">
							...
							<input type="text" name="txtTitle" id="txtTitle" class="form-control" maxlength="40" value="<?php echo $spMusicTitle;?>" />
