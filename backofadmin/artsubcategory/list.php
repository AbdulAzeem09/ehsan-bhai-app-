...
?>
	...
	$sql1 =  "SELECT * FROM art_subcategory ";
							...
							if ($result1) {
								...
								while ($row = dbFetchAssoc($result1)) {
									...
									<tr>
										...
										$sql2 =  "SELECT * FROM art_category WHERE idspArtgallery = $idspArtcategory";
										...
										<td>
                                            ...
                                            <a href="javascript:modifyCategory(<?php echo $idspArtgallery;?>)" data-original-title="Edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bg-yellow"> <i class="fa fa-pencil"></i> </a>
