<?php
	...
	$sql = "SELECT * FROM art_subcategory WHERE idspArtgallery ='$ArtCat'";
			...
			<div class="box box-success">
				<div class="box-body">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6" style="margin-bottom:20px;">
							...
							if ($result1) {
								...
								while ($row1 = dbFetchAssoc($result1)) {
									//extract($row1);
							?>
								<option <?php if($row1['idspArtgallery']==$idspArtgallery){ echo 'selected'; } ?> value="<?php echo $row1['idspArtgallery'];?>"><?php echo $row1['spArtgalleryTitle']; ?></option>
							<?php }
									}
							?>
							</select>
						...
						<div class="col-md-6 col-sm-6" style="margin-bottom:20px;">
							<label>Name</label></br>
							<input type="text" name="txtTitle" id="txtTitle" value="<?php echo $spArtgalleryTitle;?>" class="form-control" required="required"/>
						</div>
