...
?>
	...
	<section class="content" >
		<!-- start any work here. -->
		<form name="frmAddMainNav" id="frmAddMainNav" method="post" action="processArtCat.php?action=add"  enctype="multipart/form-data" onsubmit="return validate(this)">
						...
						<div class="col-md-6 col-sm-6" style="margin-bottom:20px;">
							...
							if ($result) {
								...
								while ($row = dbFetchAssoc($result)) {
									extract($row);
							?>
								<option value="<?php echo $idspArtgallery;?>"><?php echo $spArtgalleryTitle; ?></option>
							<?php }
									}
							?>
							</select>
