<?php
	...
	if(isset($_GET['idCmpnyNews'])){
	$idCmpnyNews= $_GET['idCmpnyNews'];
	$sql1 =  "UPDATE `company_news` SET `cmpanynewsStatus`='1' WHERE idcmpanynews = $idCmpnyNews";
	...
	$sql =  "SELECT * FROM company_news WHERE cmpanynewsStatus = 1 ";
	$result  = dbQuery($dbConn, $sql);
?>
	
	<!-- Content Header (Page header) -->
	<section class="content-header top_heading">
		<h1>Company <small>[Banned News]</small></h1>
	</section>
	<!-- Main content -->
