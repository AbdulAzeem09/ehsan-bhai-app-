...
<section class="content-header">
	<h1>Withdraw SpPoint<small>[List]</small></h1>
</section>
		...
		<div class="table-responsive tbl-respon">
			<table id="example1" class="table table-bordered table-striped tbl-respon2">
				...
				<tbody>
					...
					$i = 1;
					$sql =  "SELECT * FROM sppoint_withdraw ORDER BY `id` desc";
...
<script>
	function approve(id) {
		swal({
			...
			function(isConfirm) {
				if (isConfirm) {
					window.location.href = '/backofadmin/sppoint_withdraw/index.php?view=approve&id=' + id;
				}
			});
	}
</script>