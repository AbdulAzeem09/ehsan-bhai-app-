...
if (isset($_POST["btnButton"])) {
  ...
  if (strtotime($expiry_date) < strtotime(date("Y-m-d"))) {
    redirect('index.php?view=edit_coupons&id=' . $_GET['id'])->withError('Expiry date is not valid.');
  } else {
    $sql = "UPDATE `discount_coupons` SET `coupon_code`='$coupon_code',`expiry_date`='$expiry_date',`percentage`='$percentage', `updated_at`=NOW() WHERE id= $id ";
...
if (isset($_GET['id'])) {
  ...
  $sql1 = "SELECT * FROM `discount_coupons` WHERE id= $id ";
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <!-- start any work here. -->
      <form action="" method="post" name="frmAddAdmin" id="frmAddAdmin" onsubmit="return validateForm()">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" name="coupon_code" placeholder="Enter coupon code" class="form-control" value="<?php echo $row['coupon_code']; ?>" required>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="inputTitle" class="col-form-label">Expiry date</label>
                  <input type="date" name="expiry_date" id="expiry_date" placeholder="Enter expiry date" class="form-control" value="<?php echo $row['expiry_date']; ?>" required>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="number" name="percentage" id="percentage" placeholder="Enter percentage" class="form-control" value="<?php echo $row['percentage']; ?>" required>
