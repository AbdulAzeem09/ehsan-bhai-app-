...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser'; ?>"><i class="fa fa-circle-o"></i> User Profiles</a></li>
        <li><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=detail&uid='.$uid; ?>"><i class="fa fa-circle-o"></i> User Detail</a></li>
            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'store')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=store'; ?>"><i class="fa fa-circle-o"></i> Stores <span class="label label-store pull-right"><?php totalMyStoreProduct($dbConn, 1, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'freelancer')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=freelancer'; ?>"><i class="fa fa-circle-o"></i> Freelancer <span class="label label-freelance pull-right"><?php totalMyStoreProduct($dbConn, 5, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'job-board')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=job-board'; ?>"><i class="fa fa-circle-o"></i> Job Board <span class="label label-jobboard pull-right"><?php totalMyStoreProduct($dbConn, 2, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'real-estate')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=real-estate'; ?>"><i class="fa fa-circle-o"></i> Real Estate <span class="label label-realestate pull-right"><?php totalMyStoreProduct($dbConn, 3, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'events')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=events'; ?>"><i class="fa fa-circle-o"></i> Events <span class="label label-events pull-right"><?php totalMyStoreProduct($dbConn, 9, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'art-gallery')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=art-gallery'; ?>"><i class="fa fa-circle-o"></i> Art Gallery <span class="label label-artgallery pull-right"><?php totalMyStoreProduct($dbConn, 13, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'music')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=music'; ?>"><i class="fa fa-circle-o"></i> Music <span class="label label-music pull-right"><?php totalMyStoreProduct($dbConn, 14, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'video')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=video'; ?>"><i class="fa fa-circle-o"></i> Video <span class="label label-video pull-right"><?php totalMyStoreProduct($dbConn, 10, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'trainings')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=trainings'; ?>"><i class="fa fa-circle-o"></i> Trainings <span class="label label-trainings pull-right"><?php totalMyStoreProduct($dbConn, 8, $pid);?></span></a></li>
                        <li class="<?php echo (isset($_GET['module']) && $_GET['module'] == 'classifiedAds')?'active':'';?>"><a href="<?php echo WEB_ROOT_ADMIN.'registerdUser/index.php?view=singleprofile&uid='.$_GET['uid'].'&pid='.$_GET['pid'].'&module=classifiedAds'; ?>"><i class="fa fa-circle-o"></i> Classified ads <span class="label label-clasified pull-right"><?php totalMyStoreProduct($dbConn, 7, $pid);?></span></a></li>
