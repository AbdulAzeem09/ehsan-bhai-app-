...
$rowsPerPage = 25;
//$sql		=	"SELECT * FROM sppostings WHERE spCategories_idspCategory = 9 ORDER BY idspPostings DESC";
...
<td>
<?php
$sql2 = "SELECT * FROM speventpics WHERE spPostings_idspPostings = $idspPostings";
...
<td><a href="<?php echo $BaseUrl.'/events/event-detail.php?postid='.$idspPostings;?>"><?php echo substr($spPostingTitle,0,10).'...';	?></a></td>
