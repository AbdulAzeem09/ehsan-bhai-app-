<?php
    ...
    $sql = "SELECT * FROM spevent AS s INNER JOIN spprofiles AS p ON s.spProfiles_idspProfiles = p.idspProfiles WHERE idspPostings = $postid";
...
<section class="content-header top_heading">
    <h1>Post Detail<small>[Event]</small></h1>
</section>
<!-- Main content -->
        ...
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <?php
                        $sql2 = "SELECT * FROM speventpics WHERE spPostings_idspPostings = $postid";
