...
function generate_admin_member_div($row){
    ...
    $div = '<div class="friend">
        ...
        <div class="detail">
            ...
            <div class="mutual">Connects (3)</div>
        </div>
        <div class="icons">
            <div class="three-dot">
...
<div class="friend-list-wrapper">
    <?php        
        if ($getAllAdminMembersCount != '') {
            while ($row = mysqli_fetch_assoc($getAllAdminMembers)) {
                echo generate_admin_member_div($row);
            }
        }
        else { 
            echo "No Admin.";
