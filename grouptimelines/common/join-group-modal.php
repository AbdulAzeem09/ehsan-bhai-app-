    ...
    <div class="modal join-group-modal" id="join-group" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Join Group</h1>
                </div>
                ...
                <div class="modal-body">
                   <div class="text-wrapper-2">                    
                    <div class="text">
                        <p>
                            Welcome to <b><i>"<?php echo $groupname; ?>"</i></b>! Before participating, please read the following terms and conditions carefully. By joining the group, you agree to adhere to these guidelines.
                        </p>
                        <ol>
                    ...
                    <div class="agree_chk">
                        <input type="checkbox" id="group_join_chk"> <label class="text-danger">Yes, I agree to the Terms & Conditions</label>
                    </div>                                       
                </div>                    
                ...
                <div class="modal-footer">
                    ...
                    <button class="joingroup disabled btn btn-primary group_join_chk" <?php gid_pid(); ?> style="background-color: #7649B3; color : white;">
                           Join Group
                    </button>
                </div>
            </div>
