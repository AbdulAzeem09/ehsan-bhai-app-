...
?>
                    ...
                    <div class="row">
                        ...
                        <div class="carousel carousel-showmanymoveone slide" id="itemslider_one">
                                ...
                                $res = $p->myretailgroupproduct(1,$_GET["groupname"]);
...
<?php }else if($_GET['selltype'] == "WholeSale"){ ?>
                          <!-- Retail Close -->      
                     ...
                     <div class="row">
                        ...
                        <div class="carousel carousel-showmanymoveone slide" id="itemslider_four">
                               ...
                               $p = new _productposting;
                                      $resw = $p->mywholesalegroupproduct(1,$_GET["groupname"]);
                   ...
                   <?php  }else if($_GET['selltype'] == "auction"){ ?> 
                     ...
                     <div class="row">
                      ...
                      <div class="carousel carousel-showmanymoveone slide" id="itemslider_five">
                                <div class="carousel-inner">
                                    ...
                                    $p = new _productposting;
                                $resA = $p->myauctiongroupproduct(1,$_GET["groupname"]);
