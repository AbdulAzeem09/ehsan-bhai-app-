                    ...
                    <div class="row">
                        <div class="col-md-2" >
                            <div class="navbarside"> 
                                ...
                                <a data-toggle="collapse"  href="#stores" aria-expanded="false" aria-controls="collapseExample" class="navside <?php echo (isset($_GET["stores"]) ? "selectgrpitem" : "deselectedgrpitem") ?>" data-url="&stores&gid=<?php echo $_GET["groupid"];  ?>&gname=<?php echo $_GET["groupname"];  ?>&groupflag=gflag"> <span class="fa fa-home"></span>&nbsp;Store</a>
									  ...
									  <tr>
                                        ...
                                        if ($result != false) {
                                            while ($rw = mysqli_fetch_assoc($result)) {
                                                ...
                                                $project_name = parse_url($BaseUrl);
