...
<div class="row">
<div class="col-md-6">
<span id="size1">Group  <small>[Booked Event]</small></span>
...
<tr>
  ...
  <td class="text-center"><?php echo ($eventdetail['spPostingPrice'] > 0)? '$'.$eventdetail['spPostingPrice']:'Free';?></td>
...
<!--   <td class="text-center">
  ...
  <td>  <a href="<?php echo $BaseUrl.'/grouptimelines/groupeventticket.pdf' ?>" class="" id="btnPDF"><i class="fa fa-file-pdf-o "></i></a></td>
</tr> <?php
$i++;
...
$mpdf->Output("groupeventticket.pdf", 'F');
