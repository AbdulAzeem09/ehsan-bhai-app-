...
?>
  ...
  if (isset($_POST['send_mail'])) {
    ...
    $messages = $rows1['notification_description'];
      ...
      ?>
        ...
        <section id="contact" class="contact">
          <div class="container">
            ...
            if(isset($_SESSION['invite_friend']) && $_SESSION['invite_friend'] == 'yes'){ 
              
              unset($_SESSION['invite_friend']);
              ?>
...
<script>
  ...
  function top_fav(cid,pid,status){
...
<script>
    ...
    function top_rec(rcid,rpid,rstatus)
    {
