        ...
        <section id="features" class="features">
          <div class="container">
            ...
            <div class="row list-wrapper">
              ...
              $vd = new _video;
              $v = new _videoupload;
              $res = $v->myUploadedVdeos($businessId);
              ...
              if ($res != false) {
                while ($row = mysqli_fetch_assoc($res)) {
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-12 align-items-stretch list-item">
                    <div class="card" data-aos="fade-up">

                      <video src="../upload/video/video_files/<?php echo $row['video_file']; ?>" type="video/mp4" style="height: 200px;" controls autoplay loop></video>
                      <div class="card-body">
                        <h5 class="card-title"><a href="<?php echo $BaseUrl . '/videos/watch.php?video_id=' . $row['video_id']; ?>"><?php echo $row['video_title'] ?></a></h5>
                      </div>
                    </div>
                  </div>
              ...
              <!--<div class="col-lg-3 col-md-4 col-sm-12 mt-5 mt-md-0 d-flex align-items-stretch">
            <div class="card" data-aos="fade-up" data-aos-delay="150">
              <video src="assets/video/video.mp4" controls autoplay loop></video>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Video Title-2</a></h5>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-12 mt-5 mt-lg-0 d-flex align-items-stretch">
            <div class="card" data-aos="fade-up" data-aos-delay="300">
              <video src="assets/video/video.mp4" controls autoplay loop></video>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Video Title-3</a></h5>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 col-sm-12 d-flex align-items-stretch">
            <div class="card" data-aos="fade-up" data-aos-delay="450">
              <video src="assets/video/video.mp4" controls autoplay loop></video>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Video Title 4</a></h5>
              </div>
            </div>
          </div>-->
