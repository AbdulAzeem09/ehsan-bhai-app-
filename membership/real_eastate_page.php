...
$last_id = $cur->update_real_feature($data1,$_GET['postid']);
...
<section class="main_box">            
			...
			<h3 align="left"  >Feature Your Ad (35 USD) </h3>
			...
			<a href='<?php echo $BaseUrl.'/post-ad/real-estate/';?>' style="font-size: 14px;" class="btn btn-success btn-sm  btn-border-radius"  >Return to Form</a>
			</div>
			<br>
			</div>
			</form>
