...
$rowsp=mysqli_fetch_assoc($readsp);
	...
	//die('ppppsfsdfwwwwwwwwwwwww');
	$_SESSION['Erro_msg']= "Erro_msg";
	$post_ad_url = $_SESSION['post_ad_url'];
	
	header("Location: $post_ad_url");
...
<section class="main_box">            
			...
			<div class="alert alert-success" id="span1" style="<?php if($_SESSION['Erro_msg']!=="Erro_msg"){echo "display:none;";} unset($_SESSION['Erro_msg']); ?> margin-top: 8px; " ><span>Payment Successful</span></div>
            <div class="col-md-3">
            </div>
			<div class="col-md-6  btn-border-radius" style="border:1px solid #ddd;">
			<h3>You have dont have any subscription plan please choose any plan from below.</h3>


			<form action="" method="POST" id="paymentForm">	
				<input type="radio" id="radio1" name="total_amount" value="35" checked>
			    <label for="radio1" >$35 USD for 1 Posting</label><br>
				<input type="radio" id="radio2" name="total_amount" value="100" >
				<label for="radio2">$100 USD Monthly Subscription For Unlimited Posting</label><br>
				<input type="radio" id="radio3" name="total_amount" value="1000">
				<label for="radio3">$1000 USD Yearly Subscription For Unlimited Posting</label>
			<div class="form-group">
