...
?>
    ...
    <body class="bg_gray">
        ...
        <a data-toggle="modal" class="pointer" data-target="#inviteFriend" style="font-weight: 600;font-size: 15px;margin-left: 91px;"><span class="fa fa-user"></span> Invite and Earn </a>
            <div class="container">
                <div class="row">
                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            ...
                                            // =========ACTIVE POST
                                            $totalActive = 0;
                                            $result4 = $po->read_active_training($_SESSION['uid'], $_SESSION['pid']);
                                            //echo $p->ta->sql;
                                            if ($result4) {
                                            ...
                                            // =========FAVOURITE POST
                                            $totFav = 0;
                                            $result5 = $f->chekFavourite_training_post($_SESSION['uid'], $_SESSION['pid']);
                                            //echo $p->ta->sql;
                                            if ($result5) {
                                            ...
                                            // ==========FLAGGED
                                            $totFlag = 0;
                                            $result9 = $fl->readflag($_SESSION['pid'], $_GET['categoryID']);
                                            //echo $p->ta->sql;
                                            if ($result9) {
                                            ...
                                            $totpurchase = 0;
                                            $result10 = $po->read_my_purchase_training($_SESSION['pid']);
                                            //echo $p->ta->sql;
                                            if ($result10) {
                                                $totpurchase = $result10->num_rows;
                                            }
                                            ...
                                            <table class="table table-striped no-margin">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="label label-info"><?php echo $totFlag; ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl . $pageLink . 'mypurchase.php'; ?>">My Purchase</a></td>
                                                        <td><span class="label label-danger"><?php echo $totpurchase; ?></span></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            value: <?php echo $totFlag; ?>
                        },
                        {
                            label: "My Purchase",
                            value: <?php echo $totpurchase; ?>
                        }
                    ],
                    hideHover: 'auto'
                });
