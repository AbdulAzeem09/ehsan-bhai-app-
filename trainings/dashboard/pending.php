...
?>
<div class="alert alert-success" id="alert_box">Insert Successfully .</div>

<?php
} else if (isset($_SESSION['msg']) & $_SESSION['msg'] == "update") {
?>

<div class="alert alert-success" id="alert_box">Update Successfully .</div>
<?php
}
unset($_SESSION['msg']);
?>
...
<a href="javascript:void();" class="disable-btn" data-Id="<?php echo $row['id']; ?>" title="Delete"><i title="Delete" class="fa fa-trash" data-disableId="" style="color: red;"></i></a>
