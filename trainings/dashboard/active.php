...
<div class="row">
	<?php
$p = new _postings;
$result = $p->read_active_training($_SESSION['uid'], $_SESSION['pid']);
//echo $p->ta->sql;
if($result != false){
	$table="example";
}
...
<a href="javascript:void();" class="disable-btn" data-Id="<?php echo $row['id'];?>" title="Delete"><i class="fa fa-trash" data-disableId=""></i></a>
