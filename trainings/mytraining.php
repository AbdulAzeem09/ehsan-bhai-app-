                                                                ...
                                                                if($result != false){
                                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                                        ...
                                                                        <tr class="searchable">
                                                                            ...
                                                                            <td class="text-center">
                                                                                <a href="<?php echo $BaseUrl.'/post-ad/trainings/?postid='.$row['idspPostings']; ?>" class="" data-postid="<?php echo $row['idspPostings'];?>"><i class="fa fa-edit"></i></a>
                                                                                <a href="<?php echo $BaseUrl.'/trainings/deletePost.php?postid='.$row['idspPostings'];?>" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>
