...
//echo"hereccxxvxcv";
	...
	if($flag == 0)
	{
		 ...
		 $fe->addfavorites(array("spProfiles_idspProfiles" => $_POST["pid"], "spPostings_idspPostings" => $_POST["postid"], "spUserid" => $_SESSION["uid"]));
	   ...
	   /* print_r($_POST["pid"]);
		...
		// print_r($data);
		 ...
		 $id = $ev->addeventfavoritestimeline($data);
