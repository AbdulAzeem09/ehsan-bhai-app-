						...
						<div class="col-md-9">
							<div class="cartbox bradius-15" style="margin-top: 10px;">
								...
								<div class="cart_body">
						         ...
						         $it= $pi->readtypeitembystore($_SESSION['uid'],$sid);
										//var_dump($it);
										if($it!=false){
										$famount=0;
										...
										$it11= $pi->readtypeitembyartandcraft($_SESSION['uid'],$sid);
										//var_dump($it);
										if($it11!=false){
										$famt=0;
...
<!--<div class='pull-right'><a class='btn btn-info text-right' href='#' data-toggle='modal' data-target='#exampleModal2'  onclick='payOnlyThisSeller('<?php //echo $values; ?>','<?php //echo $totalpricenewnewforss; ?>','<?php //echo $sellerNmae; ?>');'>Pay This Product</a></div><br>-->
                            ...
                            <td class="text-right"><?php echo $curr.' '.$totalpricenewnewforss;?></td>
									
                                    </tr>
									<?php if($disco!=0){?>
                                    <tr>
                                        <td colspan="2">Total:</td>
                                        <td class="text-danger text-right"><?php echo $curr.' '.(($disc_price*$spOrderQty)+$totalpricenewnewforss);?></td>
                                    </tr>
									<?php }else{?>
									 <tr>
                                        <td colspan="2">Total:</td>
                                        <td class="text-danger text-right"><?php echo $curr.' '.($totalspOrderQtyamount);?></td>
                                    </tr>
									<?php } ?>
                                    <tr class="fw-bold">
...
<h4 style='display: none;float: left; font-size: 22px; padding-left: 15px; padding-right: 22px; color:#202548;'>Cart Subtotal (".$totalitem." item): <span id='totalamount' class='pull-right;'>".$curr.' '.$totalspOrderQtyamount+$sippingch."</span></h4>
									...
									<?php $paynow= $totalpricenewnewforss + $totalspOrderQtyamount;
							$paynow1=($disc_price*$spOrderQty)+$totalpricenewnewforss;
...
<a class="btn btn-info text-right" href="#" data-toggle="modal" data-target="#exampleModal1" onclick="payOnlyThisSeller('<?php echo $values; ?>','<?php echo $paynow1; ?>','<?php echo $sellerNmae; ?>','<?php echo $curren; ?>');">Pay This Seller</a></p>
							<?php }else{?>
							<p style="float:right;">
<a class="btn btn-info text-right" href="#" data-toggle="modal" data-target="#exampleModal1" onclick="payOnlyThisSeller('<?php echo $values; ?>','<?php echo $paynow; ?>','<?php echo $sellerNmae; ?>','<?php echo $curren; ?>');">Pay This Seller</a></p>
...
<li><span class="a-list-item"><span id="address-ui-widgets-CityStatePostalCode" class="id-addr-ux-search-text"><?php echo $usercity;?>, <?php echo  $userstate;?> <?php echo $userZipCode;?></span></span></li>
										...
										<!--	<div class="row left_grid left_group_black left_sidebar" style="margin-left:3px;" >
												...
												<span style="font-weight: bold;   font-size: large; text-align: center; margin-left:5px;" >Recently Viewed Products </span>
												<?php 
				...
				<script type="text/javascript">
					...
					function payOnlyThisSeller(sellerid, totalprice,sellerName){
