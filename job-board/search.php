...
$ress = $p->readJobSearch($txtJobTitle,$txtJobLoc);
...
<h2><a href="<?php echo $BaseUrl.'/job-board/job-detail.php?postid='.$row['idspPostings'];?>"><?php echo ucfirst($row['spPostingTitle']);?> </a></h2>
