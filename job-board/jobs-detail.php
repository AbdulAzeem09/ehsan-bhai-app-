                        ...
                        <?php   
                           ...
                           $apply = $cl->alradyapply($_SESSION['pid']);
                               ...
                               <?php
                                ...
                                // User has not applied, show the apply button
                          ?>
                                    <a href="<?php echo $BaseUrl . "/job-board/job-apply.php?postid=".$postId;?>" class="apply-btn" id='applybtn'><button class="apply-btn">APPLY NOW</button></a>
                       <?php
                         }
...
<div class="imp-links">
    ...
    <div class="more-links">
        ...
        $share_url = urlencode($url); // Your share URL
        ?>
        ...
        <div class="icons-wrapper">            
            ...
            <a href="https://twitter.com/intent/tweet?text=<?php echo $share_text; ?>&url=<?php echo $share_url; ?>" target="_blank"><img src="<?php echo $BaseUrl; ?>/job-board/assets/images/tweet.svg" alt=""></a>            
