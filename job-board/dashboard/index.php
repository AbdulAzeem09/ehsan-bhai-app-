...
//check profile is job board or not https://dev.thesharepage.com/post-ad/job-board/?post
if($_SESSION['ptid'] != 1 AND $_SESSION['ptid'] != 5 ){

//  header('location:'.$BaseUrl.'/job-board/?msg=notaccess'); 
}
...
?>
<script>
window.location.replace('<?php echo $BaseUrl?>/my-profile/?mss=message');
</script>
<?php } ?>
...
<div class="alert alert-danger" role="alert">
<h2>It Looks Like Your Buisness Profile Not Verified or You Have Not Submitted Your Profile For Verification . Please Contact Support .</h2>
</div>
<?php   } ?>
...
<li><a href="#" style=" color: #0B241E;">DASHBOARD</a></li>
...
<td><span class="label label-info" style="    background-color: #747c7e!important"><?php echo $totExpPost; ?></span></td>
</tr> -->
<tr>
...
<td><span class="label " style=" background-color: #1e7ccd!important;"><?php echo $totFav ; ?></span></td>
</tr>
<td><a href="<?php echo $BaseUrl.'/'.$pageLink.'/dashboard/flagged_profile.php'; ?>">Flagged Jobs</a></td>
<td><span class="label label-info" style=" background-color: #1abf91!important;"><?php echo $aaa; ?></span></td>
</tr>
<?php
if($_SESSION['ptid'] != 1){ ?>
<!--      <tr>
