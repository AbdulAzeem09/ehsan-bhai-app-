            ...
            <div class="col-xs-12 bg_white no-padding">
                <div class="">
                    <ul class="myjobboaardBread no-margin">
                        ...
                        <li><a class="<?php echo ($activePage == 11)?'active' : '';?>" href="<?php echo $BaseUrl.'/job-board/all-jobs.php';?>">Job Feeds</a></li>
                        <li><span>|</span></li>
                        <li><a class="<?php echo ($activePage == 12)?'active' : '';?>" href="<?php echo $BaseUrl.'/job-board/all-jobseeker.php';?>">Jobseekers</a></li>
                        <li><span>|</span></li>
                        <li><a class="<?php echo ($activePage == 13)?'active' : '';?>" href="<?php echo $BaseUrl.'/job-board/dashboard/cv-manager.php'?>">Cv Manager</a></li>                         
                        <li><span>|</span></li>
