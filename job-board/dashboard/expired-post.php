...
<div class="sidebar col-md-3 no-padding" id="sidebar" style="width: 250px;">
...
<li>Expired Jobs</li>
<?php echo $title;?>
<a href="<?php echo $BaseUrl.'/post-ad/job-board/?post';?>" class="btn btn-border-radius" style="float: right; margin-right:20px; background-color: #31abe3;color: #fff;margin-bottom: 4px;margin-top: -4px;padding-bottom: 4px;">Post a job</a> 
<!--<a href="<?= $BaseUrl; ?>/post-ad/freelancer/?post" class="btn post-project postproject" style="float: right;background-color: orange;color: #fff;margin-bottom: 4px;margin-top: -4px;padding-bottom: 4px;margin-right:20px;" >Post a project</a> -->
</ul>
</div>
</div>
...
$result = $m->myExpireProduct($_GET['categoryid'], $_SESSION['pid']);
...
<tr>
<td><?php echo $i++; ?></td>
<td><?php echo $i; ?></td>        <td><a href="<?php echo $BaseUrl.'/job-board/dashboard/applicant.php?postid='.$row['idspPostings'];?>" ><?php echo ucfirst($row['spPostingTitle']);?></a></td>
...
<a href="<?php echo $BaseUrl.'/post-ad/job-board/?postid='.$row['idspPostings'].'&exp=1';?>" ><i class="fa fa-pencil"></i></a>
<?php $href = $BaseUrl . '/post-ad/dopostjob.php?postid=' . $row['idspPostings'] . '&action=delete'; ?>                                                           
<a onclick="delet('<?php echo $href;?>')"><i class="fa fa-trash"></i></a>
