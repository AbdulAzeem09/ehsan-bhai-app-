            ...
            <div class="modal-content no-radius">
                <form action="<?php echo $BaseUrl.'/job-board/addnews.php';?>" id="add_news_frm" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="spProfiles_idspProfiles" name="spProfiles_idspProfiles"
                            value="<?php echo $_SESSION['pid'];?>">
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">
                                <h4>Title</h4>
                            </label>
                            <input type="text" class="form-control no-radius" id="cmpanynewsTitle"
                                name="cmpanynewsTitle" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control no-radius" id="cmpanynewsDesc" maxlength="200"
                                name="cmpanynewsDesc"></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-9 no-padding">
                    ...
                    <!-- <div class="whiteboardmain m_btm_10" style="padding: 5px;">
							<div class="row"> -->
                    <div class="col-sm-12 nopadding dashboard-section whiteboardmain"
                        style="margin-top: 7px;padding: 16px 0px 0px 0px;">
                        <div class="col-xs-12 dashboardbreadcrum">
                            <ul class="breadcrumb">
                                <li><a href="<?php echo $BaseUrl;?>/job-board/dashboard">Employer Dashboard</a></li>
                                <li><a href="<?php echo $BaseUrl;?>/job-board/forward-jobs.php"></a>Recommend Jobs</li>
                    ...
                    <div class="list-wrapper">
                        ...
                        <table id="task-list-tbl" style="width:100%;">
					       ...
					       $res_skills = mysqli_fetch_assoc($res_skills);
				//print_r($res_skills); die('===-000--');
					
                                    $emp_skills = $res_skills['skill'];
                            ...
                            <tr id="task-<?php echo $row['idspPostings']; ?>" class="task-list-row"
                                data-task-id="<?php echo $row['idspPostings']; ?>"
                                data-user="<?php echo $row['spPostingJoblevel']; ?>"
                                                    ...
                                                    <div class="card-primary">
                                                        <div class="col-md-9 col-sm-12">
                                                            <div class="pri-head">
                                                                <a href="<?php echo $BaseUrl.'/job-board/job-detail.php?postid='.$row['idspPostings'];?>"
                                                                    class="head-link"><?php echo ucfirst($row['spPostingTitle']);?></a>
                                                                                     ...
                                                                                     <?php  
																						...
																						?>
                                                                <span
                                                                    class="head-days"><?php  echo round($diff / 86400); ?>
                                                                    days left</span>
                                                        ...
                                                        <div class="col-md-3 col-sm-12">
                                                            <div class="card-secondary">
                                                                ...
                                                                <div class="avg-btn">
                                                                    <a href="<?php echo $BaseUrl.'/job-board/job-detail.php?postid='.$row['idspPostings'];?>"
                                                                        class="avg-bid btn">Apply now </a>
                                                                </div>
                                                                <div class="location-btn">
                                                                    <a href="#"
                                                                        class="loc-btn"><?php echo ucfirst($row["spPostingLocation"]);?>
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
