...
<div class="row no-margin">
    <!--<div class="col-md-12 text-center no-padding" style="background-color: white;height: 150px;">
    <h1><?php echo $_SESSION['MyProfileName'] ?></h1>
     <div class="col-md-12 right_jobboard no-padding"> -->
   ...
   <!--      <div class="top_head_in">
            <form class="job_search" method="post" action="<?php echo $BaseUrl.'/job-board/search.php';?>" >
                <div class="row">
