...
// =========ACTIVE POST
$totalActive = 0;
$result4 = $p->myAppliedJob($_SESSION['pid']);
//echo $p->ta->sql;
if ($result4) {
...
// =========EXPIRED POST
$totExpPost = 0;
$result7 = $p->mySaveJob($_GET['categoryid'], $_SESSION['pid']);
if ($result7) {
...
<table class="table table-striped no-margin">
    <tbody>
        ...
        <tr>
            <td><a href="<?php echo $BaseUrl.'/'.$pageLink.'/dashboard/applied-job.php'; ?>">Applied Jobs</a></td>
            <td class="test1"><span class="label label-info"><?php echo $totalActive; ?></span></td>
        </tr>
        <tr>
            <td><a href="<?php echo $BaseUrl.'/'.$pageLink.'/dashboard/saved-post.php'; ?>">Saved Jobs</a></td>
            <td class="test1"><span class="label label-info"><?php echo $totExpPost; ?></span></td>
        </tr>
        <!--   <tr>
