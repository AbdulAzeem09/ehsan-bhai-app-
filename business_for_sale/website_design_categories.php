					...
					<div class="row">
						<div class="col-md-12">
							<div class="utf-main-search-container-area">
								...
								<form class="utf-main-search-form-item" action="website_design_categories.php" method="get">
									<div class="row" style="margin-left:12%;">
										...
										<div class="col-sm-2 col-lg-2 custom-pr">
											<select class="category" name="category" style="background: linear-gradient(to bottom, #7dba41 0%, #468e4f 100%);color: white;border-radius: 16px 0px 0px 16px;">
												...
												<option value="0" style="color: black;">All Category <i class="fa fa-down icon"></span></option>
												<option value="1" style="color: black;">Manufacturing</option>
												<option value="2" style="color: black;">Hotel</option>
												<option value="3" style="color: black;">Websites Design </option>
											</select>
										</div>
										<div class="col-sm-8 col-lg-8 custom-pl">
											<div class="category">

												<input type="text" placeholder="Enter Keywords..." id="search" name="search" value="" style="border-radius: 0px 30px 30px 0px;" required />
												<img id="search_btn" style="height: 20px;width: 20px;top:17px;" src="images/web 008.png" alt="">
												<a href="<?php echo $BaseUrl ?>/business_for_sale/website_design_categories.php?page=1" class="reload_btn"><i class="fa fa-refresh" aria-hidden="true"></i></a>
											</div>
										...
										<div class="row">
											<div class="col-md-3">
												<select data-placeholder="Property Status" class="utf-chosen-select-single-item">
													<option value="0" style="color: black;">All Category <i class="fa fa-down icon"></span></option>
													<option value="1" style="color: black;" <?php if ($_GET['category'] == 1) {
																								echo "selected";
																							} ?>>Manufacturing</option>
													<option value="2" style="color: black;" <?php if ($_GET['category'] == 2) {
																								echo "selected";
																							} ?>>Hotel</option>
													<option value="3" style="color: black;" <?php if ($_GET['category'] == 3) {
																								echo "selected";
																							} ?>>Websites Design </option>
		...
		<section class="fullwidth" data-background-color="#f5f5f0">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 ">
						<button class="btn btn-primary " style="border-radius: 30px;background: #eb6f33;height: 50px;width: 200px;border: 0;"><a href="add_business.php" style="color: white;" class="log_in">SELL YOUR BUSINESS</a>
						</button>
					</div>

					<div class="col-md-2">
						<button class="btn btn-primary" style="border-radius: 30px;background: linear-gradient(to bottom, #7dba41 0%, #468e4f 100%);height: 50px;width: 200px;border: 0;"><a href="../business_for_sale/dashboard/index.php" style="color: white;" class="log_in">Dashboard</a></button>
					</div>
					...
					<div class="col-md-12">
						<div class="carousel">
							...
							if ($_GET['search']) {
								if ($_GET['category'] == 0) {
									$de1 = $de->read_search_business($_GET['search']);
								} else {
									$de1 = $de->read_searchCat_business($_GET['search'], $_GET['category']);
								}
							} else {
								$de1 = $de->read_all_business_website_desing($start, $limitaa);
							}
							//print_r($de1);
							...
							?>
										...
										<a href="business_detail.php?postid=<?php echo $row['idspbusiness']; ?>">
											<div class="col-md-4" style="padding: 20px;">
												<div class="row" style="border-radius: 30px;border:  solid 2px;background-color: white;">
														...
														<div class="row" style="padding-top: 10px;padding-left: 20px;">
															<label>
																<p style="line-height:17px;"><b>
																		...
																		<?php echo substr($row['listing_headline'], 0, 25); ?></br>
																		<label style="color: #468E4F;"><?php echo $row['location']; ?></label></br>
																		<?php if ($row['business_category'] == 3) {
																			echo "Website Design";
																		} ?>
																	</b></p>
			...
			<?php if ($account_status != 1) {
				if ($_GET['page'] != "1") { ?>
					...
					<a class="float-left btn btn-primary" href="<?php echo $BaseUrl . '/business_for_sale/website_design_categories.php?page=' . $_GET['page'] - 1; ?>">Previous</a>
				<?php  } ?>


				<?php if ($num_rows == "9") { ?>
					<a class="float-right  btn btn-primary" style="margin-bottom: 10px;" href="<?php echo $BaseUrl . '/business_for_sale/website_design_categories.php?page=' . $_GET['page'] + 1; ?>">Next</a>
			<?php  }
			} ?>
		</section>
	...
	<div id="" style="background-color: #202447;color: white;">
		...
		<script>
			$("#search_btn").click(function() {
				...
				window.location.replace('<?php echo $BaseUrl ?>/business_for_sale/website_design_categories.php?category=' + cat + '&search=' + data + '&page=1');
