...
<li><a href="#">Favorite Business</a></li>
...
$result = $p->read_fav_business_all($_SESSION['uid'],$_SESSION['pid']);
if($result!=false){
$table="example";
}
else{
...
<th class="text-center" >Inventory Amount</th>
...
$ff= $p->read_id_business($row['postid']);
if($ff!=false){
$row1=mysqli_fetch_assoc($ff);


}
$dt = new DateTime($row['created_on']);
...
<!-- <td class="text-center"><?php echo $i; ?></td> -->
<td class="text-center"><a href="<?php echo $BaseUrl.'/business_for_sale/business_detail.php?postid='.$row1['idspbusiness']; ?>"><?php echo $row1['listing_headline']; ?></a></td>
<td class="text-center">&nbsp;<?php echo $row1['inventory_amount']; ?></td>
<td class="text-center"><?php echo $dt->format('d M Y'); ?></td>


<td class="text-center">&nbsp;<?php echo 'USD '.$row1['price']; ?></td>
