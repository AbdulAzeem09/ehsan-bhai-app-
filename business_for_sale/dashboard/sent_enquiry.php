...
<li><a href="#">My Sent Enquiries</a></li>
...
<li><a href="<?php //echo $BaseUrl.'/store/dashboard/sell_dashboard.php'; 
?>" class="<?php //echo ($activePage == 21 || $activePage == 2 || $activePage == 3 || $activePage == 4 || $activePage == 5 || $activePage == 6 || $activePage == 14 || $activePage == 16 || $activePage == 18 || $activePage == 20 || $activePage == 22 || $activePage == 8 || $activePage == 9 || $activePage == 10 || $activePage == 11 || $activePage == 12 || $activePage == 13)?'active':''
?>">Seller Dashboard</a></li>
<li><a href="<?php //echo $BaseUrl.'/store/dashboard/';
?>" class="<?php //echo ($activePage == 1 || $activePage == 15 || $activePage == 7 || $activePage == 23 || $activePage == 24)?'active':''
?>">Buyer Dashboard</a></li>
</ul>
</div>
</div> -->
...
$result = $en->read_business_sent_enquiry($_SESSION['pid']);
if ($result != false) {
$table = "example";
} else {
$table = "";
...
$sellerprofilid  = $row['sellerprofile_id'];
...
<?php echo $row1['listing_headline']; ?>
</td>
...
<p style="padding: 8px;"><?php echo substr($row['comment'], 0, 50); ?></p>
</div>
...
<td class="text-center">
<a href="<?= $BaseUrl; ?>/business_for_sale/dashboard/reply_enquiry.php?id=<?= $id; ?>"><i title="View" class="fa fa-eye" ></i></a>
</td>
...
<button type="button" class="btn btn-primary" onclick="get_replydata(<?php echo $row['id']; ?>)" style="background-color: green; color: #fff;border-radius: 20px; border: none; min-width: 100px;">Submit</button>
</div>
</div>
<!--   </form>  -->
</div>
...
<center> <span class="text-center">No Record Found</span></center>
</td>
</tr>
<?php
}
...
$('#exampe tbody').on('click', 'tr', function() {
