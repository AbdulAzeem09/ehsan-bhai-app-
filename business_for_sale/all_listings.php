					...
					<div class="row">
						<div class="col-md-12">
							<div class="utf-main-search-container-area">
								...
								<form class="utf-main-search-form-item" action="all_listings.php" method="get">
									<div class="row" style="margin-left:12%;">
										...
										<div class="col-sm-8 col-lg-8 custom-pl">
											<div class="category">
												...
												<a href="<?php echo $BaseUrl ?>/business_for_sale/all_listings.php?page=1" class="reload_btn"><i class="fa fa-refresh" aria-hidden="true"></i></a>
											</div>
		...
		<section class="fullwidth" data-background-color="#f5f5f0">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 ">
						<button class="btn btn-primary " style="border-radius: 30px;background: #eb6f33;height: 50px;width: 200px;border: 0;     margin-left: 55px; "><a href="add_business.php" style="color: white;" class="log_in">SELL YOUR BUSINESS</a>
						</button>
					</div>

					<div class="col-md-2">
						<button class="btn btn-primary" style="border-radius: 30px;background: linear-gradient(to bottom, #7dba41 0%, #468e4f 100%);height: 50px;width: 200px;border: 0;    margin-left: ; "><a href="../business_for_sale/dashboard/index.php" style="color: white;" class="log_in">Dashboard</a></button>
					</div>
					...
					<div class="col-md-12">
						<div class="carousel">
							...
							if ($_GET['search']) {
								...
								$de1 = $de->read_all_business($start, $limitaa);
							}
							//print_r($de1);
														...
														<div class="row" style="padding-top: 10px;padding-left: 20px;">
															<label>
																<p style="line-height:17px;"><b>
																		...
																		<?php echo substr($row['listing_headline'], 0, 15) . '....'; ?></br>
				...
				<div class="row">
					<?php if ($account_status != 1) {
						if ($_GET['page'] != "1") { ?>
							...
							<a class="float-left btn btn-primary" href="<?php echo $BaseUrl . '/business_for_sale/all_listings.php?page=' . $_GET['page'] - 1; ?>" style="margin-left: 10px;">Previous</a>
						<?php  } ?>
						<?php if ($num_rows == "9") { ?>
							<a class="float-right  btn btn-primary" style="margin-bottom: 10px; margin-right: 25px;" href="<?php echo $BaseUrl . '/business_for_sale/all_listings.php?page=' . $_GET['page'] + 1; ?>">Next</a>
					<?php  }
					} ?>
				</div>
			</div>
	...
	<div id="" style="background-color: #202447;color: white;">
		...
		<script>
			$("#search_btn").click(function() {
				...
				window.location.replace('<?php echo $BaseUrl ?>/business_for_sale/all_listings.php?category=' + cat + '&search=' + data + '&page=1');
