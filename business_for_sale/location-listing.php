	...
	<!-- Loader end -->
					...
					<div class="row">
						<div class="col-md-12">
							<div class="utf-main-search-container-area">
								...
								<form class="utf-main-search-form-item" action="location-listing.php" method="get">
									<div class="row" style="margin-left:12%;">
										...
										<div class="col-sm-8 col-lg-8 custom-pl">
											<div class="category">
												...
												<a href="<?php echo $BaseUrl ?>/business_for_sale/location-listing.php?page=1" class="reload_btn"><i class="fa fa-refresh" aria-hidden="true"></i></a>
											</div>
		...
		<section class="fullwidth" data-background-color="#f5f5f0">
			<div class="container">
				<div class="row">
					<?php $co = new _country;
					$co1 = $co->readCountryName($countryid);
					if ($co1 != false) {
					...
					?>
					<div class="col-md-7">
						<h1><b>Businesses in <?php echo $country; ?></b></h1>
					...
					<div class="col-md-12">
						<div class="carousel">
							...
							if ($_GET['search']) {
								...
								$de1 = $de->read_location($countryid, $start, $limitaa);
							}
							//print_r($de1);die;
														...
														<div class="row" style="padding-top: 10px;padding-left: 20px;">
															<label>
																<p style="line-height:17px;"><b>
																		...
																		<?php if ($row['business_category'] == 1) {
																			echo "Manufacturing";
																		} ?>
																	</b></p>
															</label>
							...
							<?php }
								...
								echo "<span style='font-size:30px;'>No Business Available</span>";
							} ?>
			...
			<?php if ($_GET['page'] != "1") { ?>
				...
				<a class="float-left btn btn-primary" href="<?php echo $BaseUrl . '/business_for_sale/all_listings.php?page=' . $_GET['page'] - 1; ?>">Previous</a>
			<?php  } ?>


			<?php if ($num_rows == "9") { ?>
				<a class="float-right  btn btn-primary" style="margin-bottom: 10px;" href="<?php echo $BaseUrl . '/business_for_sale/all_listings.php?page=' . $_GET['page'] + 1; ?>">Next</a>
			<?php  } ?>
		</section>
	...
	<div id="" style="background-color: #202447;color: white;">
		...
		<script>
			$("#search_btn").click(function() {
				...
				window.location.replace('<?php echo $BaseUrl ?>/business_for_sale/location-listing.php?category=' + cat + '&search=' + data + '&page=1');
