...
//print_r($row);
																				...
																				$ob=new _spprofiles;
																				$pid2=$_SESSION['pid'];
																				$rr1=$ob->readbucketnnnnewsddd($_SESSION['uid'],$_SESSION['pid']);
																				//	echo $ob->num_rows;
																				//die("-----");
																				if($rr1 != false){
																				$bucket_news=array();
																	   ...
																	   $str1 = substr($str, 8);
																		 $variable = substr($str1, 0, strpos($str1, "/"));?>
																							<?php
																							?><a href="<?php echo $feed_item->link ;?>" target=" ">
																		...
																		$str = substr($str, 0, strpos($str, "/"));
																		 ...
																		 <?php
																				...
																				<p>
																					...
																					<a href="<?php echo $feed_item->link; ?>" >Read more...</a> 
																					| <a href="#"><i class="fa fa-share-alt readshare<?= $randomnum1; ?>" data-link="<?=  $feed_item->link; ?>" title="Share" data-id="<?php echo $row[$pagination][2]; ?>" ></i></a>
													...
													?>	  
																					...
																					| <a href="#"><i class="fa fa-ban" aria-hidden="true" title="Ban"></i></a>
																				</p>
																			</div>
																			<div class="col-md-3">
