...
$ob2 = new _spprofilefeature;

$pid2 = $_SESSION['pid'];



$rr1 = $ob2->ban_world(trim($link), $pid2);
...
<?php   if($_GET['page'] != "1"){ ?>
<a class="float-left btn btn-primary" href="<?php echo $BaseUrl.'/news/Ban_News.php?page='.$_GET['page']-1;?>">Previous</a>
<?php  } ?>
<?php if($num_rows >= $_GET['page']){ ?>
<a class="float-right  btn btn-primary" style="margin-bottom: 10px;" href="<?php echo $BaseUrl.'/news/Ban_News.php?page='.$_GET['page']+1;?>">Next</a>
<?php  } ?>
</div>
