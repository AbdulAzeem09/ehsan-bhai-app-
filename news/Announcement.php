	           ...
	           <?php
							...
							<div class="container-fluid">
								<div class="row">
									...
									<div class="newscontent">
										 <h3 style="margin-bottom:20px">The Sharepage Announcement</h3>
					...
					<div class="col-md-3" style="margin-top:30px">
					 <span><?php echo $rows['create_ondate']; ?></span> 
						 ...
						 <h1 class="load-more1" style="text-align: center;color: #5088ef; cursor:pointer; font-size: 24px;" >Load More</h1>
