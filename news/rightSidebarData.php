...
"> 
            ...
            <button class="btn btn-default btn-collapse btn-xs" type="button" data-toggle="collapse" data-target="#collapseSix<?php echo $id; ?>" aria-expanded="false" aria-controls="collapseExample"><span 111 class="fa fa-minus" aria-hidden="true"></span></button> <span class="label">
			
			
			<?php   
if($pic!=""){
?>
			<a href="<?php echo $BaseUrl; ?>/news/profile.php?id=<?php echo $ppid; ?>"><img  style="margin-top: 10px;width: 50px;height: 50px;" src="<?php echo $pic; ?>" class="img-circle" style="width: 50px; height: 50px;"></span> <?php echo $name;?></a>
			<?php
}else
{
?>
         ...
         <div class="panel-collapse collapse in" id="collapseSix<?php echo $id ;?>">
            <div class="media-left" >
               <div class="vote-wrap">
				  ...
				  ?>
                     ...
                     <a><span style="margin-left:3px"  id="appendbookmark<?php echo $id ?>" onclick="BookmarkComment(<?php echo $id; ?>)" class="commentbookmark"    aria-label="report"> 
					 <i class='fa fa-bookmark' style='color:blue'></i></span></a>
                     <?php
						}else{
                        ?>
            ...
            <div class="media-body">
			   ...
			   ?>
                  ...
                  <span><a class="commentlike" id="appendlike<?php echo $id; ?>" data-like="<?php echo $id; ?>" onclick="myFunction22(<?php echo $id; ?>)"  style="font-size:15px;cursor:pointer">
                  <?php	 //$id=$_POST['comment_id'];
                     ...
                     if($r5!=false){
                     	echo "<i class='fa fa-thumbs-up 11'  style='cursor:pointer; margin-top: 5px;'  title='Unlike' ></i> ";	
                     
                     }
                     else {
                     	echo "<i class='fa fa-thumbs-o-up' style='color: #a07eff; margin-top: 5px;cursor:pointer;' title='Like'></i> ";	
                     }
                     ...
                     ?>																			 
                  </a></span><span style="margin-left: -5px;">|</span>
                  <?php if($_SESSION['pid']==$ppid){?>
                  <span><a class="commentdel" onclick="myFunctionDel(<?php echo $id; ?>)" data-del="<?php echo $id; ?>"  style="font-size:15px;padding-left:5px;cursor:pointer"><i class="fa fa-trash" style="color: red; margin-left: -3px;" title="Delete"></i></a></span>|
                  <?php } 
                     $sppid=$_SESSION['pid'];
                     if($sppid!=$pids)
                     {
                  ...
                  <?php } ?>
                  <span><a  onclick="myFunction(<?php echo $id; ?>)"   id="hideshow<?php echo $id; ?>"  style="font-size:15px;padding-left:5px;"><i title="View" class="fa fa-eye" style=' cursor:pointer;   margin-left: -4px;'></i></a></span>|
                  <span>
				  
                  <a class="" role="button" data-toggle="collapse" id="repcount<?php echo $id; ?>" href="#replyCommentOne<?php echo $id; ?>" aria-expanded="false" aria-controls="collapseExample"  style="font-size:15px; padding-left:5px; color:purpal;"><i class="fa fa-comment" style="color: #a07eff;     margin-left: -4px;" title="Reply"></i>
				...
				<span id="delcnt<?php echo $id; ?>">
				 ...
				 <?php
                  ...
                  <span id="appendshare<?php echo $id ; ?>" >
                  <a class="sharepost" onclick="myFunctionshare(<?php echo $id; ?>)" class="" role="button"  style="font-size:15px; padding-left:5px;"><i class='fa fa-share-alt' title='Share' style='color:#a07eff;margin-left: -4px;'></i>
                  <?php
				   ...
				   if($_SESSION['pid']==$ppid){
					   ...
					   ?>
				  <span style="margin-left: -5px;    margin-right: 3px;">|</span><span><a  href="<?php echo $BaseUrl?>/news/post_edit.php?comment_id=<?php echo $id;?>" class="editpost" style="padding-left:2px;"><i title="Edit" class="fa fa-pencil" title="Edit" style="
  " ></i></a></span>
                  ...
                  <!--reply data 222@@@@@@@@@@@@--->
				  <div style="margin-bottom:15px;" id="appendreply<?php echo $id ;?>"></div>
			   ...
			   <?php
                  ...
                  <div class="form-group" id="rpllybox<?php echo $id2; ?>" >
                     <div class="form-group" style="border:1px solid gray; margin-right:10px; padding:8px 8px" >	
                        ...
                        <span><a class="delreply" onclick="DelreplyReply(<?php echo $id2;?>,<?php echo $id;?>)" data-reply="<?php echo $id2; ?>" style="font-size:15px;padding-left:5px;"><i title="Delete" class="fa fa-trash" title="Delete"></i></a></span>|
