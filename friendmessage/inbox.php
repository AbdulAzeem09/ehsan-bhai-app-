            ...
            <div class="panel messages-panel2">
               <div class="contacts-list">
                  <div class="row" style="margin-left:10px">
                     <span><img src="<?php echo $spall['spProfilePic']; ?>" style="height:50px;width:50px;border-radius:50%">
                     <?php if($spall['chat_status']=='1'){ ?>
                     <span style="margin-left:-4px"><i class="fa fa-circle" aria-hidden="true" style="color:green"></i></span>
                     <?php }
                        else{
                        ?>
                     ...
                     <!--span style="font-weight:500;margin-right:20px" ><?php //echo $spall['spProfileName']; ?></span-->
                     <style>
                        #profileDropDown li {
                     ...
                     <div class="dropdown">
                        <a href="JavaScript:void(0)" class="dropdown-toggle" data-toggle="dropdown" style="color:blue;" >
                           <?php
                              $p = new _spprofiles;
                              ...
                              //print_r($row);
                                      ...
                                      ?>
                           <p style="margin-left: 63px;margin-top: -40px; color:blue;" data-toggle="tooltip" data-placement="bottom" title="<?php echo ucwords(strtolower($_SESSION['MyProfileName']));?>" ><?php echo (isset($_SESSION['MyProfileName'])? substr(ucwords(strtolower($_SESSION['MyProfileName'])), 0, 20) : "Profile "); ?> <span class="caret"></span><br><span style="font-size: 10px;margin-left:-4px;"><?php echo $row['spProfileTypeName']. " Profile";?></span></p>
                           <?php
                              }
                              } 
                              }
                        ...
                        <ul class="dropdown-menu" id="profileDropDown" style="z-index:99">
                           ...
                           <li class="<?php echo ($_SESSION['pid'] == $row['idspProfiles'])?'active':''; ?>" >
                              <a class="sp-user-profile-label headProfile" href="javascript:void(0)" data-profileid='<?php echo $row['idspProfiles'];?>' >
                              <?php
                                 if ($row["spProfilePic"] == '') {
                                     ?>
                              <img src="<?php echo $BaseUrl.'/img/noman.png'?>" alt="" class="img-responsive img-circle" >
                              <?php
                                 }else{
                                     ?>
                              <img src="<?php echo ($row["spProfilePic"]);?>" class="img-responsive img-circle">
                              <?php
                                 }
                     ...
                     <span class="dropdown">
                        ...
                        <i class="fa fa-gear footer_item" style="color:black; float: right;margin-top: -46px;margin-right: 25px;"></i> </span>
                        <ul class="dropdown-menu">
                           <li><a href="<?php echo $Baseurl; ?> /friendmessage/updatestatus.php/?status=1" <?php if($spall['chat_status']=='1'){ echo 'class="actives"'; }?>  >Online</a></li>
                           <li><a href="<?php echo $Baseurl; ?>/friendmessage/updatestatus.php/?status=0"<?php if($spall['chat_status']=='0'){ echo 'class="actives"'; }?>>Offline</a></li>
                        </ul>
                     </span>
                     <span><i class="fa fa-user footer_item"style="padding:12px; float: right;margin-top: -46px;margin-right: 72px;"></i>
                     </span>
                  </div>
                  <div class="inbox-categories">
                     <div data-toggle="tab" data-target="#inbox" class="active">Inbox</div>
                     <div data-toggle="tab" data-target="#groups">Groups</div>
                  </div>
                  <div class="tab-content">
                     <div id="inbox" class="contacts-outter-wrapper tab-pane active">
                              ...
                              <div class="modal-content no-radius sharestorepos">
                                 <form method="post" >
                                    ...
                                    <div class="modal-footer">
                                       ...
                                       <input type="button" class="btn btn-primary composTxtNow" name="" value="Send Message">
                                    </div>
                                 </form>
                              </div>
                           </div>
                        ...
                        <div class="row m_top_10" style="margin:-9px;">
                           <div class="col-md-12">
                              <div class="topstatus" style="border-bottom: 1px solid #CCC;padding: 4px 12px;">
                        ...
                        <form method="GET" action="" class="panel-search-form info form-group has-feedback no-margin-bottom" style="display: inline-flex; padding: 5px 20px;">
                           <input type="text" class="form-control" name="search" placeholder="Search" style="margin-left:-15px;" value="<?php echo $_GET['search'];?>" required="" />    
                              ...
                              <div class="table-responsive myfriend"  >
                                 <ul class="list-unstyled contacts">
                                    <?php  
                                       ...
                                       $result = $p->read9($row1["spprofiles_idspProfilesSender"],$filter);
                                    ...
                                    <?php
                                       echo " <a href='javascript:void(0)' class=' friendchat myfriends " . ($groupid != 0 ? "groupfriend" : "notgroup") . " " . trim($groupname) . "' data-friendname='" . $row["spProfileName"] . "' data-friendid='" . $row["idspProfiles"] . "' data-frndicon='" . $row["spprofiletypeicon"] . "' data-friendname='" . $row["spProfileName"] . "' data-groupid='" . $groupid . "' data-myid='".$receiverPid."'>";								
                                       	?>							
                                    <li data-toggle="tab" data-target="#inbox-message-1" class="active" style="margin-left: -17px;" onclick="countbadge(<?php echo $row["idspProfiles"]; ?>)">
                                       <?php if ($total){?>
									   
									   <div id="readcount<?php echo $row["idspProfiles"]; ?>"> 
                                       <div class="message-count"><?php echo "<span class='badge totalunreadmsg no-radius ".($total > 0 ?"":"hidden")." ' style='color:#fff;background-color:#000;'>" . $total . "</span>"; ?></div></div>
                                       <?php   } ?>
                                       <div class=""></div>
                                       <?php
                                       ...
                                       <div class="vcentered info-combo">
                                          <h3 class="no-margin-bottom name"><span class='frndname'><?php echo ucwords(strtolower($row["spProfileName"])); ?></span></h3>
                                          <h5><?php
                                       ...
                                       <div class="contacts-add">
                                          <span class="message-time " style="font-size:10px"><?php echo $new_time; ?></span>
                                       </div>
                                       <!--i class="fa fa-paperclip"></i--> 
                                    </li>
                                    </a>
                                    <div>  
                                       <span class="delchatmessage pull-right" data-myid2="<?php echo $receiverPid; ?>"  data-friendid2="<?php echo $row["idspProfiles"]; ?>" ><i  class="fa fa-trash-o" style="margin-left: -10px; margin-top: -78px; color:red;" ></i></span>   
                                    </div>
                                    <?php
                                       //echo " <a href='javascript:void(0)' class=' friendchat myfriends " . ($groupid != 0 ? "groupfriend" : "notgroup") . " " . trim($groupname) . "' data-friendname='" . $row["spProfileName"] . "' data-friendid='" . $row["idspProfiles"] . "' data-frndicon='" . $row["spprofiletypeicon"] . "' data-friendname='" . $row["spProfileName"] . "' data-groupid='" . $groupid . "' data-myid='".$receiverPid."'>
                                    ...
                                    <?php 
                                       ...
                                       ?>									
                                    <li onclick="countbadge(<?php echo $row["idspProfiles"]; ?>)" data-toggle="tab" data-target="#inbox-message-1" class="active" style="margin-left: -17px;" class="readmessage">
                                       <?php if ($total){?>
									   
									   
									   
                                       <div class="message-count"  ><?php echo "<span class='badge totalunreadmsg no-radius ".($total > 0 ?"":"hidden")." ' style='color:#fff;background-color:#000;'>" . $total . "</span>"; ?></div>
                                       <?php   } ?>
                                       <div class=""></div>
                                       <?php
                                          echo "<img  alt='profile-Pic' class='img-responsive chat_img' id='".$row['idspProfiles']."' style='display:inline;margin-right: 5px;width:30px; height: 30px;' src='" . (isset($row['spProfilePic']) ? " " . ($row['spProfilePic']) . "" : "../assets/images/blank-img/default-profile.png") . "' > ";
                                          
                                          ?> 
                                       <div class="vcentered info-combo">
                                          <h3 class="no-margin-bottom name"><?php echo ucwords(strtolower($row["spProfileName"])); ?></h3>
                                          <h5><?php
                                             // GET LAST MSG AND DATE OF THAT USER
                                       ...
                                       <div class="contacts-add">
                                          <span class="message-time" style="font-size:10px"> <?php echo $dt->format('d M Y h:i:s'); ?></span>
                                       </div>
                                    </li>
                                    </a>
                                    <div>  
                                       <span class="delchatmessage pull-right" data-myid2="<?php echo $senderPidd; ?>"  data-friendid2="<?php echo $row["idspProfiles"]; ?>" ><i  class="fa fa-trash-o" style="margin-left: -10px; margin-top: -78px; color:red;" ></i></span>   
                                    </div>
                                    <?php
                                       }
                                       }
                     ...
                     <div id="groups" class="contacts-outter-wrapper tab-pane">
                        <form class="panel-search-form info form-group has-feedback no-margin-bottom" style="display: inline-flex; padding: 5px 20px;">
                           <input type="text" class="form-control" name="search" placeholder="Search" />
                           <span class="fa fa-search" style="padding: 11px;"></span>
                        </form>
                        <div class="contacts-outter">
                           <div class="dropdown">
                              <button class="btn dropdown-toggle" type="button" data-toggle="dropdown">Filter <span class="caret"></span></button>
