...
<div class="left_grid left_group_gray" style="height : 270px;"><br>
...
<p style="white-space: nowrap; width: 130px; overflow: hidden; text-overflow: ellipsis;" class="top_margin text_size1"><?php echo ucfirst($admin_Name); ?></p><small><?php if ($admin_ptype == 1) {
...
if ($admin_Id == $_SESSION['pid']) {
?>
<!--<li <?php if (isset($_GET['smsCampaigns'])) {
echo "class='active_group'";
} ?>><a href="<?php echo $BaseUrl ?>/grouptimelines/addSms.php?groupid=<?php echo $_GET['groupid'] ?>&groupname=<?php echo $_GET['groupname']; ?>&smsCampaigns"><img src="<?php echo $BaseUrl; ?>/assets/images/icon/group/smscamp_icon_enable.png" class="img-responsive" alt="" />
<p>SMS Campaigns</p>
</a></li>-->
...
<!-- li <a  data-toggle="modal" data-target="#myModal22" ><img src="<?php echo $BaseUrl; ?>/assets/images/icon/group/videos_icon__enable.png" class="img-responsive" alt=""/><p>Alouncment</p></a></li>-->
...
echo "class='active_group'";
} ?>><a href="<?php echo $BaseUrl ?>/grouptimelines/group-folder.php?groupid=<?php echo $group_id ?>&groupname=<?php echo $_GET['groupname']; ?>&files"><img src="<?php echo $BaseUrl; ?>/assets/images/icon/group/files_icon_enable.png" class="img-responsive" alt="" />
<p>Files</p>
</a></li>
...
<?php } ?>
<!-- <div class="topstatus timeline-topstatus right_sidebar " style="margin-top: 10px;">
<div class="left_grid left_group_gray">

<form class="group_search ">
<div class="form-group ">
<input type="text" class="form-control " id="bg_cl" placeholder="Search this group" / >
</div>

</form>

<span style="text-transform:uppercase; font-size:16px;">Favorites</span>
<ul>
