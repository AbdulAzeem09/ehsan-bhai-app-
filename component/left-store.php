<link rel="stylesheet" type="text/css" href="<?php echo $BaseUrl;?>/assets/css/style.css">  
    ...
    <style>
        .right_sidebar1 {
    margin: 0 10px 0px -70px !important;
}
    #abc{
     white-space: nowrap; 
  width: 200px; 
  ...
  text-overflow: ellipsis; 
    ...
    <div class="w-100" style="margin-left: 15px;">
        ...
        <div class="topstatus timeline-topstatus right_sidebar right_sidebar1" style="padding-top: 0px !important; width: 220px;">
...
a.success.active {
    ...
    <?php if(isset($_GET['userid']) && $_GET['userid'] > 0){ ?>
            ...
            <a href="<?php echo $BaseUrl?>/store/storeindex.php?folder=home">
            <h3 class="active_store" style="color: #787f85;padding: 1px 10px;text-decoration-line: underline;"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Store Home </h3></a>
     ...
     <?php  }else{?>
        <?php if($profileType != '2' && $profileType != '5') { ?>
         <!-- <a href="<?php echo $BaseUrl?>/post-ad/sell/?post" class="btn store_search_btn db_btn db_orangebtn sell" style="margin-right: 5px;padding: 6px;width: auto;background-color:orange!important;padding: 8px 33px!important; margin-top:-45px; height: 35px;">Sell Home</a> -->
        <?php  }?>
      ...
      <!--  <?php echo $profilename; ?>
       ...
       <?php if(isset($_GET['userid']) && $_GET['userid'] > 0){ ?>
           ...
           <!-- <a href="<?php echo $BaseUrl.'/store/user-product.php?userid='.$_GET['userid']; ?>">
            ...
            <?php if($profileType != '2' && $profileType != '5') { ?>
              <a href="<?php echo $BaseUrl?>/post-ad/sell/?post" class="btn store_search_btn db_btn db_orangebtn sell" style="margin-right: 58px!important;padding: 6px;width: auto;background-color:#2ba805!important;padding: 7px 33px!important; margin-top: -5px;"> Sell Product</a>
            <?php }?>
...
<style>
    ...
    color:#00FF00;
            ...
            <h1>Category</h1>
            <div class="condition scroll " style="margin-top:5px;">
                <?php
         ...
         if ($rows["masterDetails"] == "All") {?>
             ...
             <a class="success  <?php if($_GET['id'] == $rows["subCategoryTitle"]){echo "active"; }?>"  id="abc" title="<?php echo $rows["subCategoryTitle"];?>" href="<?php echo $BaseUrl ?>/store/filtercategory.php?id=<?php echo $rows['subCategoryTitle']; ?>"><i class="fa fa-caret-right" aria-hidden="true"></i> <?php echo $rows["subCategoryTitle"];?></a></li>
         ...
         <?php }else{ ?>
             ...
             <a class="success  <?php if($_GET['id'] == $rows["subCategoryTitle"]){echo "active"; }?>" id="abc" title="<?php echo $rows["subCategoryTitle"];?>" href="<?php echo $BaseUrl ?>/store/filtercategory.php?id=<?php echo $rows['subCategoryTitle']; ?>"><i class="fa fa-caret-right" aria-hidden="true"></i> <?php echo $rows["subCategoryTitle"];
             ...
             if($aa1){
             echo "<span style='' class='pull-right'>(" . $aa1 . ")</span>";
             }else{
                echo "<span style='' class='pull-right'>(0)</span>";
             } 
