                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading01 text-center">
                                    <?php
                                    $count = new _spgroup;
                                    $result_count = $count->allmygroup($_SESSION['pid']);
                                    //echo $count->ta->sql;
                                    ...
                                    ?>
                                    <h2>My Groups <span>(<?php echo (isset($private_count) && $private_count >0)?$private_count:'0'; ?> Private | <?php echo (isset($public_count) && $public_count >0)?$public_count:'0'; ?> Public)</span></h2>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                            <div class="cententdatadetail bg_white">
                                                <div class="row no-margin" >
                                                    <?php
                                                    $g = new _spgroup;
                                                    $result = $g->allmygroup($_SESSION['pid']);
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            if($row['spgroupflag'] == 1){
                                                                ...
                                                                <div class="col-md-4 no-padding">
                                                                    <?php
                                                                    if ($link == 1) {
                                                                        $redirct = $BaseUrl."/grouptimelines/addEmail.php?groupid=".$row['idspGroup']."&groupname=".$row['spGroupName']."&emailCampaigns";
                                                                    }else{
                                                                        $redirct = $BaseUrl."/grouptimelines/addSms.php?groupid=".$row['idspGroup']."&groupname=".$row['spGroupName']."&smsCampaigns";
                                                                    }
                                                                    ?>
                                                                    <a href="<?php echo $redirct;?>" >
                                                                        <div class="main_grop_box <?php echo $bg_clr_box; ?>">
                                                                            ...
                                                                            <span class="btn pull-right btn_gray_light"><img src="<?php echo $BaseUrl;?>/assets/images/icon/group_multi_user_btn.png" class="img-responsive" alt="" /><?php echo $content;?></span>
                                                                        </div>
                                                                    </a>
                                                                </div>
                                                                <?php
