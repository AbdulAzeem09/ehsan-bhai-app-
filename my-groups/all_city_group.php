    ...
    ?>
                ...
                <div class="col-md-12" >
                  ...
                  <div class="list-wrapper">
                     <h3 style="color: #0b241e;border-bottom: 1px solid #0b241e;margin-top: 0px;"><b>GROUPS IN MY CITY.</b></h3>
                    <?php
                                // echo $profileCity;
                                
                                $g = new _spgroup;
                               $result = $g->getMyCityallGroup($_SESSION['pid'],$profileCity);
                               // echo $g->ta->sql;
                               if ($result != false) {
                        ...
                        ?>
                         <div class="list-item"> 
                            <div class="col-md-4 no-padding" style=" border-style: groove; ">
                              ...
                              ?>
                              <h6 style="text-align:left; padding:8px ;color:black;"><?php echo $total_member;?> members</h6>
                          </div>
