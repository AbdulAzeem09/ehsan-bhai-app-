...
<div class="row">
	<div class="col-md-8">
			...
			<div class="panel-body">
				<div style="margin-bottom:10px;">
					...
					<div class="row" style="margin-top:5px;">
						...
						<div class="col-md-7">
							<div class="text-right <?php echo ($admin == 0 ?"":"hidden")?>" style="margin-top:10px;">
								<!--<a href="../post-ad/deleteGroup.php/?groupid=<?php echo $_POST["gid"]; ?>" class="btn btn-danger" id="deleteGroup"><span class="glyphicon glyphicon-trash"></span></a>-->
		...
		<!--My All Friend for adding in the group-->
		  <div class="<?php echo ($admin == 0 ?"":"hidden")?>">
			<?php
