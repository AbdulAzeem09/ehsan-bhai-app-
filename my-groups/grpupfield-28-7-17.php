...
<div class="form-group">
	...
	<input type="text" class="form-control" id="spGroupName" name="spGroupName" value="<?php echo $gname;?>">
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		 <div class="form-group">
			...
			<input type="text" class="form-control" id="locationcity" name="spgroupLocation" placeholder="Enter your location..." value="<?php echo $glocation;?>">
		  </div>
	</div>
</div>
...
<div class="form-group">
	...
	<textarea rows="3" class="form-control" id="spGroupTagline" name="spGroupTag" placeholder="Enter text here..." value="<?php echo $gtag;?>"><?php echo $gtag;?></textarea>
</div>
<div class="form-group">
	<label for="spGroupAbout">Long Description  (Max 500 words)</label>
	<textarea class="form-control" rows="5" id="spGroupAbout" name="spGroupAbout" placeholder="Enter text here..." value="<?php echo $gdes;?>"><?php echo $gdes;?></textarea>
</div>
