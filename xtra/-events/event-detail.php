...
<button type="button" class="btn btn-border-radius pull-right"  data-dismiss="modal" style="margin-right: 5px;">Cancel</button>
</div>
</div>
</div>
</form>
...
<button class="btn btn_group_join dropdown-toggle btn-border-radius" type="button" data-toggle="dropdown" aria-expanded="true" style="border: none;"><?php echo $title;?></button>
...
if ($res != false){ ?>
<button type="button" class="btn butn_cancel pull-right disabled btn-border-radius" data-postid="<?php echo $_GET['postid'];?>" data-profileid="<?php echo $_SESSION['pid'];?>" data-categoryid="9"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>  Added to cart</button>
<?php
//echo "<button type='button' class='btn btn_cart disabled' data-profileid='".$_SESSION["pid"]."' data-categoryid='9'>Added to cart</button>";
}else{ ?>
<button type="<?php echo ($visibil == 1 ? "button":"submit");?>" class="btn butn_cancel pull-right btn-border-radius <?php echo ($visibil == 1 ? "disabled":"");?>" id="addtocart" data-postid="<?php echo $_GET['postid'];?>" data-profileid="<?php echo $_SESSION['pid'];?>" data-categoryid="9"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>  <?php echo ($price > 0)?'Buy Ticket':'Free Ticket';?></button>
<?php
...
<div class="space"></div>
<p>
<a href="javascript:void(0)" data-toggle="modal" data-target="#flagPost" class="btn btn-primary text-left btn-border-radius" ><i class="fa fa-flag"></i> Flag This Post</a>
</p>
<!-- Modal -->
