...
if ($p_result == 1) {
?>
<a href="<?php echo $BaseUrl.'/post-ad/events/?post'?>" class="btn butn_save btn-border-radius">Submit an event</a>
<?php
}else{
?>
<a href="javascript:void(0)" data-toggle='modal' data-target='#alertNotEmpProfile' class="btn butn_save btn-border-radius">Submit an event</a> <?php
}
?>
<a href="<?php echo $BaseUrl.'/events/dashboard.php';?>" class="btn butn_cancel btn-border-radius"><i class="fa fa-dashboard"></i> Dashboard</a>
<?php
}else{ ?>
<a href="javascript:void(0)" data-toggle='modal' data-target='#alertNotEmpProfile' class="btn butn_save btn-border-radius">Submit an event</a> <?php
}
...
<button class="btn btn_group_join dropdown-toggle btn-border-radius" type="button" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-star" aria-hidden="true" style="margin: 0px;"></i> <?php echo $title;?></button>
...
<a href="<?php echo $BaseUrl.'/events/all-event.php';?>" class="btn btn_event btn-border-radius">View All</a>
</div>
</div>
</div>
</div>
