                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped " >
                                            ...
                                            <tbody>
                                                ...
                                                //$en = new _favorites;
                                                $p = new _postingview;
                                                $result = $p->myfavourite_music($_SESSION['pid'], $_GET['categoryid']);
                                                //echo $p->ta->sql;
                                                if ($result) {
                                                    $i = 1;
                                                        ...
                                                        if ($row['idspPostings'] != '') {
                                                           ...
                                                           <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="javascript:void(0)" data-pid="<?php echo $row['idspProfiles']; ?>" data-postid="<?php echo $row['idspPostings']; ?>" class="fav_st_del" >Un-Favourite</a>      
                                                                </td>
                                                            </tr>
                                                           <?php
                                                           $i++;
