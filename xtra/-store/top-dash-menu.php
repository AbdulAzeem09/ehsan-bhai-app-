                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="<?php echo ($activePage == 8)?'active' : '';?>">
                                <div class="dropdown" id="storeMenuQuote" style="margin-top: 8px;">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo $BaseUrl.'/store/rfq.php';?>">RFQ Form</a></li>
                                        <li><a href="<?php echo $BaseUrl.'/store/my-send-rfq.php'?>">My Send RFQ's</a></li>
                                        <li><a href="<?php echo $BaseUrl.'/store/my-received-rfq.php';?>">My Received Quotes</a></li>
                                        <li><a href="<?php echo $BaseUrl.'/store/my-responded-rfq.php';?>">My Responded RFQ's</a></li>
