                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo $BaseUrl.'/store/delpro.php?action=delete&postid='.$row['idspPostings']; ?>"><img src="<?php echo $BaseUrl.'/assets/images/icon/delete.png'?>" class="img-responsive" alt="Delete" ></a>
                                                            </td>
                                                        </tr>
                                                       <?php
                                                       $i++;
