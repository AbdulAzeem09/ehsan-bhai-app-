                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table text-center tbl_activebid">
                                    ...
                                    <tbody>
                                        ...
                                        $p = new _postings;
                                        $pv = new _postingview;
                                        $res = $p->myProfileDraftFreelancer(5, $_SESSION['pid']);
                                        //echo $pv->ta->sql;
                                        $i = 1;
                                        if($res){
                                            while($row = mysqli_fetch_assoc($res)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $result2 = $fps->readAceptid($row['idspPostings']);
                                                        if($result2){
                                                            $post = new _postings;
                                                            ...
                                                            ?>
                                                                <a href="<?php echo $BaseUrl.'/freelancer/project-bid.php?postid='.$row['idspPostings'];?>" class="red" >View Detail</a> <?php
