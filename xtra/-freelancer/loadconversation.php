 ...
 */
    ...
    ?>
    <h2 class="chatHeading"><?php echo $Receiver_profileName;?></h2>
    <?php
    ...
    echo '<div class="form-group">
            ...
            <button class="addfreelanceChat btn btn_freelancer pull-right" type="button" data-senderid="' . $ProfileId3 . '" ><i class="fa fa-envelope"></i> Send</button><br>';
    echo '</form>';
