                        ...
                        <div class="row" style="margin-left:10px">
                            ...
                            <div class="dropdown" style="width:180px;">
                                ...
                                ?>
                                            ...
                                            <?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }            ?><br><span style="font-size: 10px;"><?php echo $row['spProfileTypeName'] . " Profile"; ?></span>
                                <?php
                                        }
                                    }
                                }
                                                ...
                                                ?>
                                                        <li class="<?php echo ($_SESSION['pid'] == $row['idspProfiles']) ? 'active' : ''; ?>" style="">
                                                            <a class="sp-user-profile-label headProfile" style="line-height: 15px; padding-top:10px;  padding-bottom:5px;padding-left:5px;" href="javascript:void(0)" data-profileid='<?php echo $row['idspProfiles']; ?>'>
                                                                ...
                                                                echo ucwords($row['spProfileName']); ?> <br><?php echo $row['spProfileTypeName'] . " Profile"; ?></p>
                                                            </a>
                                                        </li>
                                                <?php
                        ...
                        <div class="tab-content">
                            <div id="inbox" class="contacts-outter-wrapper tab-pane active">
                                ...
                                <div class="contacts-outter" style="z-index: 0;">
                                    <div class="dropdown"  margin-left:5px;">
                                        <button class="btn " style=""><a href="<?php echo $BaseUrl ?>/freelancer/dashboard/">Back To Dashboard</a></button>
                                        <button style="margin-left:70px;" class="btn dropdown-toggle" type="button" data-toggle="dropdown">Filter <span class="caret"></span></button>
                                    ...
                                    <div class="panel-body" id="clikk">
                                        <div class="table-responsive myfriend">
                                            <ul class="list-unstyled contacts">
                                                ...
                                                $result1 = $unread->totalUnreadReceiver_freelancer($_SESSION["pid"]);
                                                // print_r($result1);
                                                if ($result1 != false) {
                                                ...
                                                //echo "<br>";
                                                $bb = array();
                                                $result2 = $unread->totalUnreadSender_freelancer($_SESSION["pid"]);
                                                //print_r($result2);
                                                // die('==++');
                                                //echo $unread->ta->sql;
                                                if ($result2 != false) {
                                                    ...
                                                    while ($row2 = mysqli_fetch_assoc($result2)) {
                                                        ...
                                                        $total2 = 0;
                                                        //echo $
                                                        $unres2 = $unread->unreadmessage22_freelancer($receiverPidd, $senderPidd);
                                                        ...
                                                        if ($rr == "") {
                                                            ...
                                                            if (isset($_GET['msg']) == 'inbox_msg') {
                                                                ...
                                                                $obj->updatemessagestatus_freelancer($senderPidd, $receiverPidd);
                                                            }
                                                            //  }
                                                        }
                                                    }
                                                ...
                                                if ($result1 != false) {
                                                    ...
                                                    while ($row1 = mysqli_fetch_assoc($result1)) {
                                                        ...
                                                        $res1 = $unread->read_id_msg_freelancer($row1['spprofiles_idspProfilesSender']);
                                                        //print_r($res1);
                                                        if ($res1 != false) {
                                                            //echo 222;
                                                ...
                                                $result_2new = $unread->totalUnreadSender_freelancer($_SESSION["pid"]);
                                                // print_r($result_2new);
                                                ...
                                                if ($result_2new != false) {
                                                    ...
                                                    while ($row3 = mysqli_fetch_assoc($result_2new)) {
                                                        ...
                                                        $res = $unread->read_id_msg_rec_freelancer($reveiverPidd);
                                                        //print_r($res);
                                                        //	die;
                                                ...
                                                if ($result122 != false) {
                                                    while ($row122 = mysqli_fetch_assoc($result122)) {
                                                        ...
                                                        $total = 0;
                                                        $unres = $unread->unreadmessage_freelancer($senderPid, $receiverPid);
                                                        //	print_r($unres);
                                                ...
                                                ?>
                                                            ...
                                                            ?>
                                                                <script>
                                                                    window.location.href = "<?php echo $BaseUrl; ?>/freelancer_inbox.php";
                                                                </script>
                                                            <?php
                                                            ...
                                                            <li data-toggle="tab" data-target="#inbox-message-1" id="li1<?php echo $row["idspProfiles"]; ?>" class="active" style="margin-left: -17px;  padding-top: 20px;<?php if ($total) {
                                                                ...
                                                                <div class="contacts-add">
                                                                    <span class="message-time " style="font-size:10px;margin-left: -26px;"><?php echo $new_time; ?></span>
                                                                </div>
                    ...
                    <div class="tab-content">
                        <div class="col-md-8" style="width: 73%;">
                            <div class="row m_top_15">
                                <div class="col-sm-12">
                                    <!-- load Chat -->
                                    <div><span class="alert alert-success" id="span1" style="float: right;display:none;">Message send Succesfully!</span> </div>
                                    <div class="chattingsystem " style="position: relative;">
                                        ...
                                        <div class="chat_form" style="display:none;">
                                            <form method="post" id="myform" enctype="multipart/form-data" style="margin-top: 55px;">
                                                <input type="hidden" name="module" id="module" value="freelancer">
