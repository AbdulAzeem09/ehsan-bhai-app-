                            ...
                            <div class="col-md-12">
                                <div class="about_banner">
                                    ...
                                    <div class="event_form">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/job-board/job-detail.php?postid='.$_GET['postid'];?>">
                                                    <div class="postBoxThree">
                                                        <i class="fa fa-info-circle"></i>
                                                        <p>View the job posting</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/post-ad/job-board/?post';?>">
                                                    <div class="postBoxThree">
                                                        <i class="fa fa-plus-square"></i>
                                                        <p>Post another job</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/job-board/dashboard/';?>">
                                                    <div class="postBoxThree">
