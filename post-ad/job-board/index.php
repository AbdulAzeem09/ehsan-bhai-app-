...
$abc=rand(10,100);
?>
<script src="<?php echo $BaseUrl; ?>/assets/js/posting/job-board.js?<?php echo $abc; ?>"></script>
...
<a href="<?php echo $BaseUrl.'/job-board/';?>" style="background-color: #d9534f !important;" class="btn btn-danger  btn-border-radius butn_draf" >Cancel</a>
...
<button id="spSaveDraftJob" type="button"  style=""  class="btn butn_draf  btn-border-radius">Save As Draft</button>
<?php }  //<?php echo $BaseUrl.'/job-board/dashboard/active-post.php';?>
...
<button id="spPostSubmitjobupdate" type="button" class="btn butn_save btn-border-radius">Update
</button>
  <?php  }
?>
