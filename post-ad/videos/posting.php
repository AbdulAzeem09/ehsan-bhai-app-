        ...
        <section class="landing_page" style="min-height: 450px;">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about_banner">
                                    <div class="top_heading_group videohead">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="event_form vdoform">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/videos/music-detail.php?music='.$_GET['postid'];?>">
                                            ...
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/videos';?>">
                                                    <div class="postBoxThree">
                                                        ...
                                                        <p>Post another video</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/videos/dashboard/';?>">
                                                    <div class="postBoxThree">
                    ...
                    <div class="col-md-3">
                        <div class="postJob" id="postvideo">
                            <?php
                            $po = new _spAllStoreForm;
                            $result2 = $po->getformcontent(10);
                            if ($result2) {
