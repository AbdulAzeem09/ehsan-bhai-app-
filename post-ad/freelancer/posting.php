                    ...
                    <div class="col-md-9">
                        <div class="alert alert-success">
                            <?php if($visibility == 0){ ?>
                             ...
                             <h4 >Project have been saved as Draft!</h4>


                           <?php }else{ ?>
                         <h4 >Your Project posted successfully!</h4>

                         <?php } ?>
                        </div>

                      <!-- <h4 style="color:#2ddf2d;">Your ad is posted successfully!</h4> -->
                    </div>
                 </div>
                <div class="row">
                    <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="about_banner about_postbanner">
                                    ...
                                    <div class="event_form">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/freelancer/project-detail.php?project='.$_GET['postid'];?>">
                                                    <div class="postBoxThree about_postbanner" id="freelance_dash" >
                                                        <!-- <i class="fa fa-info-circle"></i> -->
                                                         <i class="fa fa-archive" style="color: orange;" aria-hidden="true"></i>
                                                        <p class="postparagraph"><!-- View Post Detail  -->View Your Posting</p>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/post-ad/freelancer/?post';?>">
                                                    <div class="postBoxThree about_postbanner" id="freelance_dash">
                                                       <!--  <i class="fa fa-plus-square"></i> -->
                                                        <i class="fa fa-plus-square" style="color: orange;"></i>
                                                        <p class="postparagraph">Post Another Project <!-- Add New Post --></p>
                                                    </div>
                                                </a>
                                            </div>

                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/freelancer/dashboard/';?>">
                                                    <div class="postBoxThree about_postbanner" id="freelance_dash">
                    ...
                    <div class="col-md-3">
                        <div class="postJob" id="">
                            ...
                            if ($result2) {
                                ...
                                ?>
                                <div class="col-md-12 nopadding its-free-post-job about_postbanner">
