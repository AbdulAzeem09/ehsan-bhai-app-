                                                    ...
                                                    <tbody>
                                                       ...
                                                       /* print_r($_GET['postid']);*/
                                                        ...
                                                        if($result_po == true){
                                                            ...
                                                            if ($catid == 1 || $catid == 9 || $catid == 15 || $selltype == "Auction" || $selltype == ""  ){
                                                                //echo $available;
                                                                ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="number" class="liveQty" id="liveQty" name="spOrderQty" value="<?php echo $available; ?>" min="0" min="5" onkeyup="this.value = minmax(this.value, 0, <?php echo $available;?>)" style="width: 50px;" maxlength="5" /></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                        }
                                                            ...
                                                            if($catid == 18){
                                                                ...
                                                                if( $catid == 9){
                                                                    ...
                                                                    if($result_po == true){
                                                                        ...
                                                                        $res = $od->checkorder($_GET["postid"] , $buyerid);
                                                                        if ($res != false){
                                                                            echo "<button type='button' class='btn btn_cart disabled btn_add_to_cart' data-profileid='".$_SESSION["pid"]."' data-categoryid='".$catid."'>Added to cart</button>";
                                                                        }else{
