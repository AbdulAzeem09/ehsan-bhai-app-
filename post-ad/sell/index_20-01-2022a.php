                                                                    ...
                                                                    <div class="row no-margin">
                                                                        ...
                                                                        <div class="col-md-12 no-padding">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                ?>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" readonly="" value="<?php echo $_GET['postid']; ?>" class="form-control" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <?php
                                                                                        $dt = new DateTime($ePostDate);
                                                                                        ?>
                                                                                        <input type="date" readonly="" value="<?php echo $dt->format('Y-m-d'); ?>" class="form-control" />
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <div class="form-group">
                                                                                        <label for="">Expiry Date</label>
                                                                                        <input type="date" readonly="" name="" value="<?php echo $eExDt; ?>" class="form-control" />
                                                                                    </div>
                                                                                </div> -->
                                                                                <?php
                                                                                }
                                                                                ...
                                                                                <!--    <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label for="spPostingCountry">Country <span>* <span class="lbl_2"></span></span></label>
                                                                                ...
                                                                                <div class="loadUserState">
                                                                                    <div class="form-group">
                                                                                        <label for="spPostingCity">State <span>*<span class="lbl_3"></span></span></label>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="loadCity">
                                                                                    <div class="form-group">
                                                                                        <label for="spPostingCity">City <span>*</span></label>
