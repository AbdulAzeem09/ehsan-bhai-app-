                            ...
                            <div class="col-md-12">
                                ...
                                <div class="serv_form ">
                                    <h3>
                                        ...
                                        <a href="<?php echo $BaseUrl.'/services';?>" style="color:white; padding-left :16px;" class="pull-right">Back to Home</a>        
										<a href="<?php echo $BaseUrl.'/services/dashboard/index.php';?>" style="color:white ;" class="pull-right">Dashboard</a>  												
                                    </h3>
                                                                ...
                                                                <div class="row">
                                                                  <!--  <div class="col-md-3">
                                                                   ...
                                                                   <!-- <div class="loadCity">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label for="spPostSelection_">Posting Section</label>
                                                ...
                                                <!--    <div class="col-md-3">
                                                 ...
                                                 <!--   </select> -->
                                                                ...
                                                                <div class="row no-margin">
                                                                    <div class="col-md-12 no-padding">
                                                                        <div class="form-group">
                                                                            <label for="spPostingTitle">Title</label>
                                                                            <input type="text" class="form-control" id="spPostingTitle" name="spPostingTitle" maxlength="50"  value=" <?php if($ePostTitle) echo $ePostTitle;else '';?>" placeholder="" required />
                                                                        </div>
																		<label for="skill_" class="control-label">
																			...
																			<div class="form-group">
																				...
																				<input type="text" class="form-control profilefield" name="skill" id="skill" style=" background-color: #032350;" value="<?php echo (isset($Skills))?$Skills: ''; ?>" data-role="tagsinput">
																		...
																		<div class="modal fade" id="myModal" role="dialog">
																			...
																			//                                                    if (isset($_GET["postid"])) {
																				...
																				if (isset($_GET["postid"])) {
	 		                                                                    $usercountry	= $spPostCountry_real ;
																			 $userstate =	  $spUserState_real ;
																				  $usercity =  $spUserCity_real ;
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" id="spPostingNotes" name="spPostingNotes" maxlength="2000" value="<?php if(!empty($ePostNotes)){ echo $ePostNotes; } ?>" ><?php if(!empty($ePostNotes)){ echo $ePostNotes; } ?></textarea>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label for="featurepic">Add Feature Images</label>
                                                                            ...
                                                                            <div id="featurePicPreview">
                                                                                <div class="row">
                                                                                    <div id="fePreview" >
                                                                                        ...
                                                                                        if(isset($_GET['postid'])){
                                                                                            $res = $pic->readFeature($_GET["postid"]);
                                                                                            if ($res != false) {
                                                                ...
                                                                <div class="row <?php echo ($_GET["categoryid"] == 13 || $_GET["categoryid"] == 2 || $_GET["categoryid"] == 5 ? "selected" : ""); ?>">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="file" class="postingpic" id="filesaaa" name="spPostingPic[]" multiple="multiple">
                                                                            <p class="help-block"><small>Browse files from your device</small></p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-9">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label>
                                                                                ...
                                                                                <input type="checkbox" class="form-check-input spPostField" name="spPostingAgree" id="spPostingAgree_" value="1" <?php  if (isset($_GET["postid"])) { echo 'checked'; }?>>
                                                                                <a href="<?php echo $BaseUrl."/page/?page=privacy_policy"; ?>" style="color:#337ab7 !important;" target="_blank">I agree to the terms and conditions</a></label><br>
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-12 text-right">
										...
										<button id="spSaveDraftServ" type="button" class="btn butn_draf <?php echo (isset($_GET['postid']))?'hidden':'';?>">Save As Draft</button>
										 <button  style="background-color:#41b1b9; color:white " id="spPostAds" type="button" class="btn butn_save <?php echo (isset($_GET["postid"]) ? "editing" : ""); ?>"><?php echo (isset($_GET["postid"])? $update : "Publish") ?></button>
                                        <!-- <a href="<?php echo $BaseUrl.'/services';?>" class="btn butn_cancel" >Cancel</a> -->
