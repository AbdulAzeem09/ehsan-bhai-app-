...
<div class="row">
			...
			<input type="text" class="form-control" name="spFSProductDiscount" id="spFSProductDiscount" placeholder="Discount">
			</div>
			</div>
			</div>
			<div class="row">
		...
		<input type="text" class="form-control" name="spFSProductName" id="spFSProductName" placeholder="Product Name" required>			
			...
			</form> <!-- idspFSProduct, spFSProductName, spFSProductCategory, spFSProductDescription, spFSProductImage, spFSProductAmount, spFSProductDiscount, spFSProductQuantity, spFSProductMinQuantity, spFSProductUnit, spFSProductColors, spFSProductSizes, spFriendStore_idspFriendStore, spProfiles_idspProfiles-->	
...
<form method="post" action="../mlayer/postservices.php">
		...
		<div class="row">	
		<div class="col-md-4">	
		<img src="..." alt="..." class="img-responsive img-thumbnail"> 				<div class="form-group">	
		<input type="file">	
		</div>			
		<div class="container-fluid">
		<div class="row">		
