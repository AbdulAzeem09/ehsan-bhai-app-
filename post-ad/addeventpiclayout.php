...
if(isset($_POST['work'])  &&  $_POST['work']=='deletelayout'){
$data=' ';
$p->createPiclayout($_POST["spPostings_idspPostings"], $data);
} 
...
$result = $p->removePostPiclayout($postid);
}
}
...
echo $postid = $_POST['spPostings_idspPostings']; 
}else{
//$p->create($_POST["spPostings_idspPostings"], $data);
//print_r($_POST["spPostings_idspPostings"]);
/*print_r($data);
