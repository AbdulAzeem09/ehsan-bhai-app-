...
if(!isset($_SESSION['pid'])){ 
    ...
    if(isset($_SESSION['sign-up']) && $_SESSION['sign-up'] == 1){
      ...
      $_SESSION['afterMembership']="/post-ad/photos/posting.php".$postId;
        ...
        <section class="landing_page" style="min-height: 450px;">
            <div class="container">
				...
				<div class="col-md-1"></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about_banner">
                                    <div class="top_heading_group artHead">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="text-center">Art & Craft Module</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="top_heading_group artHead">
                                    ...
                                    <div class="event_form artpostform">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/artandcraft/detail.php?postid='.$_GET['postid'];?>">
                                            ...
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/post-ad/photos/?post';?>">
                                                    <div class="postBoxThree">
                                                        <i class="fa fa-plus-square"></i>
                                                        <p>Post Another Item</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
				   ...
				   <!----<div class="col-md-3">
                        <div class="postJob" id="artPostHeading">
                            <?php
                            $po = new _spAllStoreForm;
                            $result2 = $po->getformcontent(13);
                            if ($result2) {
