...
if(!isset($_SESSION['pid'])){ 
    ...
    if(isset($_SESSION['sign-up']) && $_SESSION['sign-up'] == 1){
      ...
      $_SESSION['afterMembership']="/post-ad/events/posting.php".$postId;
...
<?php 
    ...
    ?>
        ...
        <section class="landing_page postingPage" style="margin-bottom: 50px;">
            <div class="container">
<div class="row">
                 <div class="col-md-12 no-padding ">
                         <ul class="breadcrumb">
							<li style="font-weight: 600;font-size: 15px;"><a href="<?php echo $BaseUrl;?>/events/">HOME</a></li>
							<li style="font-weight: 600;font-size: 15px;">EVENTS</li>	
									</ul>
									</div>
									</div>
                 <!-- <div class="row">
                    <div class="col-md-9">
                      <h4 style="color:#a92b2b;">Your Event Added Successfully!</h4>
                    </div>
                 </div> -->
                   <div class="row">
...
$_SESSION['count'] =0;
                                    ...
                                    if(isset($_GET['postid']) && isset($_GET['postid'])){
                                        if($_SESSION['count'] <= 1){
                                            ...
                                            <div class="alert alert-success alert-dismissible">
                                                ...
                                                <strong>Success!</strong> Your Event Added Successfully!
                                            </div> <?php
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about_banner m_top_10 bradius-15">
                                    ...
                                    <div class="top_heading_group eventHead br_radius_top eventheadcolor">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="event_form">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/events/event-detail.php?postid='.$_GET['postid'];?>">
                                                    <div class="postBoxThree eventthrebox bradius-15 br_radius_bottom eventcolor">
                                                        <!-- <i class="fa fa-info-circle"></i> -->
                                                        <i class="fa fa-archive" style="color: orange;" aria-hidden="true"></i>
                                                        <p class="br_radius_bottom">View the event</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/post-ad/events/?post';?>">
                                                    <div class="postBoxThree eventthrebox bradius-15 br_radius_bottom eventcolor">
                                                        <!-- <i class="fa fa-plus-square"></i> -->
                                                        <i class="fa fa-plus-square" style="color: orange;"></i>
                                                        <p class="br_radius_bottom">Post Another Event</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/events/dashboard/';?>">
                                                    <div class="postBoxThree eventthrebox bradius-15 br_radius_bottom eventcolor">
                    ...
                    <div class="col-md-3" style="margin-top: 10px;">
                        <div class="postJob" id="postEventBox">
                            <div class="col-xs-12 nopadding its-free-post-job">
                                <?php
                                    $po = new _spAllStoreForm;
                                    $result2 = $po->getformcontent(9);
                                    if ($result2) {
                                        $row2 = mysqli_fetch_assoc($result2);
                                        ?>
                                        <div class="col-md-12 nopadding its-free-post-job">
                                            <h2 class="heading eventcolor"><?php echo $row2['pc_title']; ?></h2>
