                         ...
                         <input id="spProfiles_idspProfiles" name="spProfiles_idspProfiles" class="business" value="<?php echo $_SESSION['pid']; ?>" type="hidden">
                                          ...
                                          <input type ="hidden" id="albumid" data-filter="0" name="spPostingAlbum_idspPostingAlbum_" class="album_id" value="<?php echo $albumid; ?>">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="spPostingTitle" maxlength="60" name="spPostingTitle"  value="<?php echo $ePostTitle ?>" placeholder="" onkeypress="lettersNumbersCheck('spPostingTitle');"  required />
                                                                </div>
<div class="row">
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
																	...
																	<div class="row">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" id="specification" name="specification" maxlength="100" equired><?php echo $specification ?> </textarea>
                                                                        </div>
																		</div>
																		<div class="col-md-6">
                                                                        <div class="form-group">
																	...
																	<div class="col-md-9">
                                                                                        ...
                                                                                        if(isset($_GET['postid'])){
                                                                                            ...
                                                                                            if ($res != false) {
                                                                                                while ($rows = mysqli_fetch_assoc($res)) {
                                                                                                    ...
                                                                                                    echo "<div class='col-md-2 imagepost'><span class='fa fa-remove dynamicimg closed'  data-work='event' data-aws='6' data-src='" . $rows['spPostingPic'] . "'  data-pic='".$rows['idspPostingPic']."'></span><img class='overlayImage' style='width:100%; height: 80px; margin-right:5px;' data-name='fi_".$i."' src='" .($picture) . "'/><label style='font-size: 10px;' class='updateFeature' data-postid='".$_GET['postid']."' data-picid='".$rows['idspPostingPic']."'></div>";
																	  ...
																	  <div class="col-md-3">
																		   ...
																		   <label for="postingpica">Upload Seating Layout</label>
																			 <input type="file" id="filesaaass" name="spPostingPicaaas[]">
																		   <p class="help-block"><small>Browse files from your device</small></p>  
																		</div>	
																		</div>
																		<div class="col-md-8">
			...
			<div class="col-md-2 imagepost"><span class="fa fa-remove dynamicimg" onclick="deleslayoutpic('<?php echo $_GET['postid']; ?>')" style=" cursor: pointer; "></span>
			<img class="postingimg overlayImage" style="width:100px; height: 100px; margin-right:5px;" src="<?php echo $layoutpic; ?>">
			</div>
																		<?php } ?>
																		</div>
																		</div>
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-8 text-right footer-button-block">
                                       ...
                                       <!--  <button type="submit" id="preview" class="btn butn_preview previewbtn">Preview</button> -->
										...
										<button id="spPostSubmitEvent" type="button" class="btn butn_save savesubmitbtn <?php echo (isset($_GET["postid"]) ? "editing" : ""); ?>"><?php echo (isset($_GET["postid"]) ? "Update" : "Submit") ?></button>
