                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="col-md-8 text-right footer-button-block">
                                       ...
                                       <!--  <button type="submit" id="preview" class="btn butn_preview previewbtn">Preview</button> -->
                                        ...
                                        <button id="spPostSubmitEvent" type="submit" class="btn butn_save savesubmitbtn <?php echo (isset($_GET["postid"]) ? "editing" : ""); ?>"><?php echo (isset($_GET["postid"]) ? "Update" : "Submit") ?></button>
