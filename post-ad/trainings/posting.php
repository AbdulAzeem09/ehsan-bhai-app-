        ...
        <section class="landing_page" style="min-height: 450px;">
            <div class="container">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about_banner">
                                    <div class="top_heading_group trainhead">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="event_form trainform">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/trainings/detail.php?postid='.$_GET['postid'];?>">
                                            ...
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/post-ad/trainings/?post';?>">
                                                    <div class="postBoxThree">
                                                        <i class="fa fa-plus-square"></i>
                                                        <p>Post another training</p>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="<?php echo $BaseUrl.'/trainings/dashboard/';?>">
                                                    <div class="postBoxThree">
                    ...
                    <div class="col-md-3">
                        <div class="postJob" id="postTraing">
                            <?php
                            $po = new _spAllStoreForm;
                            $result2 = $po->getformcontent(8);
                            if ($result2) {
