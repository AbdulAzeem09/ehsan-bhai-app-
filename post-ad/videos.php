	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="videocategory_" class="lbl_2">Category <span>*</span></label>
				<select class="form-control spPostField" id="videocategory_" data-filter="1" name="videocategory_" value="">
					<?php
	                    $m = new _subcategory;
	                    $catid = 10;
	                    $result = $m->read($catid);
		...
		<div class="col-md-6">
			 <div class="form-group">
	            <label for="spPostMusicLyrics_" class="lbl_3">Music Lyricist <span>*</span></label>
		...
		<div class="col-md-6">
			 <div class="form-group">
	            <label for="spPostMusicDirector_" class="lbl_4">Music Director <span>*</span></label>
		...
		<div class="col-md-6">
	        <div class="form-group">
	            <label for="spPostArtistName_" class="lbl_5">Artist name <span>*</span></label>
	    ...
	    <div class="col-md-6">
	        <div class="form-group">
	            ...
	            <label for="spPostingMusicCmpId_" class="lbl_6">Music Composer <span>*</span></label>
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<!--Testing-->
				<div class="dropdown">
					  <button style="width: 100%;text-align: left;" class="btn btn-default dropdown-toggle myalbum" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><?php echo (empty($row["Album"]) ? "Select Album" : $row["Album"]);?><span class="caret"></span></button>
					  <ul class="dropdown-menu albumdroupdown" aria-labelledby="my_album">
							<?php
								$p = new _album;
								$res = $p->video($_SESSION['uid']);
								//echo $p->ta->sql;
								if ($res != false){
	    ...
	    <div class="col-md-12">
			<div class="form-group">
				<label for="tag_" class="lbl_7">Tag <span>*</span></label>
				<textarea name="tag_" id="tag_" class="form-control spPostField"><?php echo (isset($tag) && $tag !='')?$tag:'';?></textarea>
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group">
				...
				<textarea name="lyrics_" id="lyrics_" class="form-control spPostField"><?php echo (isset($lyricup) && $lyricup !='')?$lyricup:'';?></textarea>
			</div>
		</div>
