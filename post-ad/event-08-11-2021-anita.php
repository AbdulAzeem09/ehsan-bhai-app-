                ...
                <?php
                    ...
                    if($result){
                        while($rows = mysqli_fetch_assoc($result)){ 
                            ...
                            ?>
                            <option value='<?php echo $rows["subCategoryTitle"]; ?>' <?php  if( $category == $rows["subCategoryTitle"]){ echo 'selected'; } ?>><?php echo $rows["subCategoryTitle"];?></option>
                            <?php
                        }
                    }
                ?>
    ...
    <div class="col-md-6" style="margin-left:13px;">
        <div class="form-group">
            ...
            ?>
            <label for="spPostingEventOrgId_">Organizer Name <span style="color:red;">*(Type the name of organizer)</span> <span id="org_err" class="label_error"></span></label>
            ...
            <input type="text" class="form-control spPostField" id="spPostingEventOrgName" name="spPostingEventOrgName"  value="<?php echo (isset($row2['spProfileName']))?$row2['spProfileName']:''; ?>" required autocomplete="off" >            
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group multi_select_cohost">
			<label for="spPostingCohost_">Co-Host Name<span style="color:red;">(Do you have a co-host?)</span></label>
            <br>
            <?php
            $pf  = new _postfield;
            $pro = new _spprofiles;
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input style="margin-top:15px;" type="text" class="form-control spPostField" data-filter="0" id="spPostingEventVenue_" name="spPostingEventVenue" value="<?php echo (empty($venu) ? "" : $venu); ?>" autocomplete="off" >
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input style="margin-top:18px;" type="text" class="form-control spPostField" maxlength="4" data-filter="0" id="hallcapacity_" name="hallcapacity" step="5" value="<?php echo (empty($hallcapicty) ? "" : $hallcapicty); ?>"> 
        </div>
    </div>

    <div class="col-md-3">
        <div class="form-group">
            <label for="ticketcapacity_" class="lbl_8">Ticket Capacity <span style="color:red;">*(How many ticket are you selling?)</span> <span id="tic_cap"></span> <span id="lbl_8" class="label_error"></span></label>
            <input type="text" class="form-control spPostField" maxlength="4" data-filter="0" id="ticketcapacity_" name="ticketcapacity" step="5" value="<?php echo (empty($ticketCapty) ? "" : $ticketCapty); ?>">
        </div>
