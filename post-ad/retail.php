...
if (isset($_GET["postid"])) {
    $r = $p->read(isset($_GET["postid"]) ? (int)$_GET["postid"] : 0);
...
<div class="retail">
    <div class="col-md-4" style="">
        <div class="form-group" style="padding-top: 26px;">
            ...
            <input type="radio" class=" " value="Hard" id="hardqty" name="quantitytype"
                <?php if($quantitytype == "Hard" ){ echo "checked";} ?>>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="protype">Product Type <span class=""></span></label>
            <select class="form-control protype" onchange="checkprotype(this.value)" id="protype" name="protype">

                <option value="0" <?php if($producttype==0){ echo "selected"; }?>> Normal </option>
                <option value="1" <?php if($producttype==1){ echo "selected"; }?>> Variants </option>
            </select>
        </div>
    </div>
    <script type="text/javascript">
    ...
    <div class="col-md-4" id="showretailPrice">
        <div class="form-group">
            ...
            <input type="number" class="form-control spPostField" data-filter="0" maxlength="8" id="retailPrice"   name="spPostingPrice" value="<?php echo (empty($price)?'':$price); ?>"  >
        </div>
    </div>
    <!--<div class="col-md-4">
			<div class="form-group">
    ...
    <div class="col-md-4" id="showretailQuantity">
        <div class="form-group">
            <label for="retailQuantity_" class="">Quantity <span class="quantity">*<span class="lbl_6"></span></span></label>
            <input type="number" class="form-control spPostField" data-filter="0" id="retailQuantity_" maxlength="15" name="retailQuantity" placeholder="e.g: 2 pieces, kg etc.." value="<?php echo (empty($retailQuantity) ? "1" : $retailQuantity);?>">
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="retailStatus_">Item Condition <span></span></label>
        ...
        <div class="row">
            <div id="wrapper">
                <div class="col-md-6">
                    <label for="yes_no_radio">Can Cancel</label>
                    <p>
                        <input type="radio" name="yes_no" value="1" <?php if($cancel=='1'){ echo 'checked'; }  ?>>Yes</input>&nbsp;&nbsp;


                        <input type="radio" name="yes_no" value="0" <?php  if($cancel=='0'){ echo 'checked'; }  ?>>No</input>
                    </p>
                </div>
            </div>
            <div id="wrapper1">
                <div class="col-md-6">
                    ...
                    <label for="yes_no_radio">Can Refund</label>
                    <p>
                        <input type="radio" name="yes" onclick="so_input()" value="1" <?php if($refund=='1'){ echo 'checked'; }  ?>>Yes</input>&nbsp;&nbsp;


                        <input type="radio" name="yes" onclick="so_out()"value="0" <?php if($refund=='0'){ echo 'checked'; }  ?>>No</input>



                        
                        <input type="text" name="refund" id="refund" class="form-control" placeholder="Refund Within" style="<?php $displayStyle = ($refund == '0') ? 'display: none;' : ''; echo $displayStyle; ?> width:120px;" value="<?php if($refundwithin){ echo $refundwithin; }  ?>">
