...
<div class="row mb-3">
<div class="col-3">
<button type="button" class="btn btn-primary btn-border-radius" data-toggle="modal" data-target="#userModal" id="addnewbtn">Add New <i class="fa fa-user-circle-o"></i></button>
</div>
<div class="col-9">
