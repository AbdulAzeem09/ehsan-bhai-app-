...
<div class="mb-3"><button class="btn btn-primary btn-border-radius btn-border-radius d-block w-100 mt-3" type="submit" name="submit">Register</button></div>
</form>
...
<div class="col-sm-6"><a class="btn btn-outline-google-plus btn-border-radius btn-sm d-block w-100" href="#"><span class="fab fa-google-plus-g me-2" data-fa-transform="grow-8"></span> google</a></div>
<div class="col-sm-6"><a class="btn btn-outline-facebook btn-border-radius btn-sm d-block w-100" href="#"><span class="fab fa-facebook-square me-2" data-fa-transform="grow-8"></span> facebook</a></div>
</div>
</div>
</div>
</div>
...
<p class="fs--1">Get Falcon now and create beautiful dashboards with hundreds of widgets.</p><a class="mb-3 btn btn-primary btn-border-radius" href="../../product/falcon-admin-dashboard-webapp-template/index.htm" target="_blank">Purchase</a>
</div>
</div>
