...
?> 
                ...
                <div class="business-overview">
                    ...
                    <div class="input-wrapper">
                        ...
                        <!-- <div class="input-group in-2-col">
                           <label for="careerCategory">Career Category<span style="color: #EF1D26;">*</span></label>
                            <input id="careerCategory" name="careerCategory" type="text" placeholder="Enter Career Category" value="<?php if(isset($pro_category)) { echo $pro_category; } ?>" required>
                                  
                            <span id="error-careerCategory" style="color:red;"></span>
                        </div> -->
                        <div class="business-overview">
                          <div class="sub-heading">
                          About Myself
                          ...
                          <div class="input-wrapper">
                            <div class="input-group in-1-col">
                              <textarea id="aboutMyself" name="aboutMyself" placeholder="Type About Myself.." rows="4" cols="50"><?php if(isset($pro_about)) { echo $pro_about; } ?></textarea>
                              <span id="error-aboutMyself" style="color: #EF1D26;"></span>
                            </div>
                          </div>
                        </div>
                        <div class="input-group in-2-col">
                            <label for="careerCategory">Career Category<span style="color: #EF1D26;">*</span></label>
                            <select id="careerCategory" name="careerCategory" required>
                                <!-- You can populate these options dynamically using PHP if needed -->
                                <option value="" disabled selected>Select Career Category</option>
                                <?php 
                                $masterid = 8;
                                ...
                                foreach ($Category['data'] as $row){
                                  $selected = '';
                                ?>
                                    <option value="<?php echo $row['idmasterDetails']; ?>" <?php if(isset($pro_category) && $pro_category == $row['idmasterDetails']) echo 'selected'; ?>>
                        ...
                        <div class="input-group in-2-col" >
                            <label for="hourlyRate">Hourly Rate<span style="color: #EF1D26;"></span></label>
                            <div class="w-100 d-flex" style="align-items: center;">
                                ...
                                <input id="hourlyRate" name="hourlyRate" type="number" placeholder="Enter Hourly Rate (USD)" value="<?php if(isset($pro_hourly_rate)) { echo $pro_hourly_rate; } ?>" required>
                            </div>
                            <span id="error-hourlyRate" style="color:red;"></span>
                        </div>
                        <div class="input-group in-2-col">
                            <label for="languageFluency">Language Fluency<span style="color: #EF1D26;"></span></label>
                            <input name="languageFluency" id="languageFluency" type="text" placeholder="Enter Language Fluency" value="<?php if(isset($pro_language_fluency)) { echo $pro_language_fluency; } ?>" required>
                            <span id="error-languageFluency" style="color:red;"></span>
                        </div>
                        <div class="input-group in-2-col">
                            <label for="availableForm">Available From<span style="color: #EF1D26;"></span></label>
                            <div class="w-100 d-flex" style="align-items: center; position: relative;">
                                <input id="availableForm" name="availableForm" placeholder="Enter Available From" value="<?php if(isset($pro_available_from)) { echo $pro_available_from; } ?>" required>
                            ...
                            <span id="error-availableForm" style="color:red;"></span>
                        </div>
                        <div class="input-group in-1-col">
                            <label for="myWebsite">My Website<span style="color: #EF1D26;"></span></label>
                            <input id="myWebsite" name="myWebsite" maxlength="150" type="text" placeholder="Enter Website" value="<?php if(isset($pro_website)) { echo $pro_website; } ?>" required>
                            <span id="error-myWebsite" style="color:red;"></span>
                        </div>
                        <div class="input-group in-1-col">
                            <label for="careerHighlights">Career Highlights<span style="color: #EF1D26;">*</span></label>
                            <textarea id="careerHighlights" maxlength="150" name="careerHighlights" placeholder="Type Career Highlights.." rows="4" cols="50" required><?php if(isset($pro_highlights)) { echo $pro_highlights; } ?></textarea>
                            <span id="error-careerHighlights" style="color:red;"></span>
                        </div>
                        <div class="input-group in-1-col">
                            <label for="accomplishments">Accomplishments<span style="color: #EF1D26;"></span></label>
                            <textarea id="accomplishments" name="accomplishments"  placeholder="Type Accomplishments.." rows="4" cols="50" required><?php if(isset($pro_accomplishments)) { echo $pro_accomplishments; } ?></textarea>
                            <span id="error-accomplishments" style="color:red;"></span>
                        </div>
                        <div class="input-group in-1-col">
                            <label for="certifications">Certification(s)<span style="color: #EF1D26;"></span></label>
                            <textarea id="certifications" name="certifications" placeholder="Type Certification(s)" rows="4" cols="50" required><?php if(isset($pro_certification)) { echo $pro_certification; } ?></textarea>
                            <span id="error-certifications" style="color:red;"></span>
                        </div>
                        <div class="input-group in-1-col">
                            <label for="hobbies">Hobbies<span style="color: #EF1D26;"></span></label>
                            <textarea id="hobbies" name="hobbies" placeholder="Type Overview.." rows="4" cols="50" required><?php if(isset($pro_hobbies)) { echo $pro_hobbies; } ?></textarea>
                            <span id="error-hobbies" style="color:red;"></span>
                        </div>
                    </div>
            ...
            <div class="experience">
              ...
              <div id="experience-entries"></div>
                <button id="showAllEntries" class="btn btn-primary mt-3 d-none">Show All Entries</button>
              ...
              <div class="status">
                ...
                <div class="list-wrapper">
                  <div class="phone-status-wrapper radio-box">
                    <label class="label">
                    Phone Status<span id="error-phoneStatus" style="color: #EF1D26;">*</span>
                    </label>
                    <div class="phone-status">
                      <input <?php if(!isset($phone_status)){ echo "checked";} ?> type="radio" id="phone-status-private" name="phone_status" <?php if(isset($phone_status) && ($phone_status == 'private')) { echo "checked"; } ?> value="private">
                    ...
                    <div class="phone-status-wrapper radio-box">
                      ...
                      <div class="phone-status">
                        <input type="radio" id="profile-status-private" name="profile_status" <?php if(isset($profile_status) && ($profile_status == 'private')) { echo "checked"; } ?>  value="private">
                        <label for="profile-status-private" class="radio-label">Private</label>
                        <input <?php if(!isset($profile_status)){ echo "checked";} ?> type="radio" id="profile-status-public" name="profile_status" <?php if(isset($profile_status) && ($profile_status == 'public')) { echo "checked"; } ?>  value="public">
                    ...
                    <div class="phone-status">
                      <input <?php if(!isset($email_status)){ echo "checked";} ?> type="radio" id="email-status-private" name="email_status" <?php if(isset($email_status) && ($email_status == 'private')) { echo "checked"; } ?> value="private">
                ...
                if(isset($pro_data['data']) && $pro_data['data']['id'] > 0){
                ?>
                <div class="main-btns" style="margin-top: 30px;">
                  <button id="cancel">CANCEL</button>
                  <button type="button" class="active" id="updateprofile" onclick="validateForm(event,'professional', 'update')" disabled>UPDATE PROFILE</button>
                </div>
                <?php
                } else {
                ?>
                <div class="main-btns" style="margin-top: 30px;">
                  ...
                  <button class="active" type="button" onclick="validateForm(event,'professional', 'create')">CREATE PROFILE</button>
                </div>
                <?php
                }
                ?>
