...
<input type="button" class="btn btn-primary btn-border-radius composTxtNow" id="composTxtNow1" name="" value="Send Message" data-dismiss="modal">
...
<button class="sendmessagetofriend1 btn btn-success btn-border-radius pull-right" type="button" style="height: 76px;width: 7%;"><i class="fa fa-paper-plane"></i></button>
