...
<div class="col-md-12 nopadding dashboard-section bg_white" style="margin-top: 24px;">
<div class="col-xs-12 dashboardbreadcrum">
<ul class="breadcrumb" style="margin-top: 9px;margin-bottom: 9px">
<li><a href="<?php echo $BaseUrl;?>/my-profile/referraluserdetail.php">Referred Friends</a></li>
<li>Referred User Profiles</li>
...
<div class="sp-profile-det bg_white" style="min-height: 380px;margin-top: 90px;padding: 1px 10px 7px 12px;">
...
$reffral =   $pro->alluserprofile($_GET['uid']);
...
$proposted =   $proposting->myallactiveproduct($refuser['idspProfiles']);
...
?>
<tr>
<td><a href="<?php echo $BaseUrl.'/friends/?profileid='.$refuser['idspProfiles'];?>"><?php echo ucfirst($refuser['spProfileName']); ?></a></td>
<!-- <td><?php echo date("Y-m-d",strtotime($refuser['spUserRegDate'])); ?></td> -->
<td><a href="<?php echo $BaseUrl.'/my-store/index.php?pid='.$refuser['idspProfiles'];?>"><?php echo $projectpost; ?></a></td>
