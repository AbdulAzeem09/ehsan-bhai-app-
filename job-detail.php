...
<input type="text" name="txtJobTitle" style="width:350px" id="txtJobTitle" class="form-control" value="<?php echo $_POST['txtJobTitle']; ?>" placeholder="Job Title" />
<span id="title_err" style="color: red;"></span>
</div>
</div>
<!--  <div class="col-md-4">
<div class="form-group no-margin">
<input type="text" id="txtJobLoc"  name="txtJobLoc" class="form-control" list="suggested_address" onkeyup="getaddress();" value="<?php //echo $_POST['txtJobLoc']; 
...
<div class="col-md-4">
<button type="submit" name="btnJobSearch" style="margin-left: 160px;padding: 9px 30px!important;" class="btn btnPosting db_btn btn-border-radius ">Search</button>
</div>
</div>
</div>
...
<div class="form-group no-margin">
<a href="<?php echo $BaseUrl . '/job-board/forwarded-Jobs.php'; ?>" class="btn btn-primary btn-border-radius" style="padding: 9px 12px;">Forwarded Jobs</a>
</div>
</div>
<div class="col-md-2">
<div class="form-group no-margin">
<a href="/job-board/dashboard/" class="btn" style="background-color:purple; color:white;padding: 9px 12px;">Dashboard</a>
</div>
</div>
...
<input type="submit" class="btn btn-danger btn-border-radius" name="Closeresetlocation" value="Reset">
</div>
</form>
</div>
...
<button type="submit" class="btn btnPosting db_btn btn-border-radius" name="searchforstorebtn" style="background-color:#918b8b;">Filter</button>

<a href="/job-board/" class="btn btnPosting db_btn btn-border-radius" style="background-color:#f60;">Reset</a>
</div>

<div class="col-md-2" style="width: 20%;">
<div style="float:right; margin-right:25px; margin-top:4px; font-size: x-small;">
<p>
<?php
...
//print_r($row);die("fsdjhk");
if($row['idspPostings']==$_GET['postid'])
{
continue;
}
?>
...
<p class="p2"><?php echo $overview; ?></p>
</div>
...
<div class="box">Switch Profile/Create Profile</div>
</a>
...
?>
<a href="<?php echo $BaseUrl . '/job-board/savejob.php?unsave=' . $row2['save_id']; ?>">
<p>Unsave</p>
</a> <?php
} else { ?>
<a href="<?php echo $BaseUrl . '/job-board/savejob.php?postid=' . $_GET['postid']; ?>">
<p>Save</p>
</a> <?php
}
} else { ?>
...
if ($_SESSION['ptid'] != 5) {
?>
<a href="" data-toggle="modal" data-target="#fwdjob">
<p>Forward</p>
</a>
...
<a href="" onclick="printContent('printArea')">
<p>Print</p>
</a>
<a href="<?php echo $BaseUrl . '/job-board/company.php?cmpyid=' . $clientId; ?>">
<p>View Company Detail</p>
</a>
<a href="<?php echo $BaseUrl . '/job-board/company.php?cmpyid=' . $clientId . '&job=posted'; ?>">
<p>View all jobs</p>
</a>
<?php
...
$postids = $_GET['postid'];
$sp = new _flagpost;
$spflag = $sp->readflag2($sppids, $postids);
if ($spflag != false) {
...
<a href="javascript:void(0)" data-toggle="modal" data-target="#flagPost">
<p>Flag This Job</p>
</a>
<?php
}
...
<input type="button" name="" id="flag_sub" class="btn btn-submit btn-border-radius" value="Flag Now">
...
<button type="button" class="btn btn-submit btn-border-radius" style='background-color: #31abe3!important;border:0px!important;    color: #fff;background-image: unset;
