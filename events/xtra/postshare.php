					...
					<div class="modal-header">
				 	...
				 	<div class="modal-body sharedimage">
								...
								<div class="row">
									...
									<div class="col-md-3">
	                                    ...
	                                    <div class="dropdown intrestEvent" id="eventDetaildrop" style="display: block;border: 1px solid #CCC">
	                                        <button class="btn btn_group_join dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true" style="border: none;"><i class="fa fa-star" style="margin: 0px;"></i> Interested</button>
				  	...
				  	<div class="modal-footer">
						<button type="" class="btn butn_cancel" data-dismiss="modal">Cancel</button>
						<button type="submit" id="share" class="btn butn_mdl_submit">Share</button>
					</div>
				</form>
			</div>
		</div>
