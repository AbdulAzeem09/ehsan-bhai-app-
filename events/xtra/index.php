                        ...
                        <div class="topBoxEvent text-right">
                            ...
                            if($_SESSION['ptid'] == 3 || $_SESSION['ptid'] == 1 || $_SESSION['ptid'] == 4){ 
                                ...
                                if ($p_result == 1) {
                                    ...
                                    if ($reuslt_vld == false) {
                                        ?>
                                        <a href="<?php echo $BaseUrl.'/post-ad/events/?post'?>" class="btn butn_save">Submit an event</a>
                                        <?php
                                    }
                                }else{
                                    ?>
                                ...
                                ?>
                                <a href="<?php echo $BaseUrl.'/events/dashboard/';?>" class="btn butn_cancel"><i class="fa fa-dashboard"></i> Dashboard</a>
                                 <?php
                            }else{ ?>
                                <a href="javascript:void(0)" data-toggle='modal' data-target='#alertNotEmpProfile' class="btn butn_save">Submit an event</a> <?php
                            }
