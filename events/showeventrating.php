...
<body class="bg_gray">
     ...
     <section class="main_box">            
      ...
      <li><a href="<?php echo $BaseUrl ?>/events"><i class="fa fa-home"></i> Home</a></li>
       <li><a href="<?php echo $BaseUrl ?>/events/event-detail.php?postid=<?php echo $_GET['postid'];?>">Event Detail</a></li>
                           ...
                           <!--        <p id='eventrating' class="rating" style="margin-bottom: 0px;">
                            ...
                            <h4>Reviews</h4>
                             ...
                             <?php $pro = new _spprofiles;
                                  ...
                                  $r = new _speventreview_rating;
                                   $res = $r->readeventrating($_GET["postid"]);
                                   ...
                                   if($res != false){
                                        while ($row = mysqli_fetch_assoc($res)) {
                                             ...
                                             $result = $pro->read($row['spProfile_idspProfile']); 
                                              
                                              //echo $pro->ta->sql; 

                                               $row2 = mysqli_fetch_assoc($result);

                                        $postingDate = $r-> speventPostingDate($row["currentdate"]);
 ...
 -->
                         <input class="stars" type="radio" id="star5" name="rating" value="5" <?php if($row['rating'] == "5") { echo "checked "; }?> 
                              />
                                  ...
                                  <div style="position: absolute;  bottom: -40px;  left: 20px;" ><p ><?php echo $row['review'];?></p></div>
                              </div>
                         </div>
                         <br>
