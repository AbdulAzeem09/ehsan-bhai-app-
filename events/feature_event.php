...
<a href="<?php echo $BaseUrl . '/events'; ?>" class="btn  eventdashboard btn-border-radius">
<i class="fa fa-home "></i> Home</a>
<a href="<?php echo $BaseUrl . '/post-ad/events/?post' ?>" style="color:white" class="btn  submitevent btn-border-radius">Submit an event</a>
<a href="<?php echo $BaseUrl . '/events/dashboard/'; ?>" class="btn  eventdashboard btn-border-radius"><i class="fa fa-dashboard "></i> Dashboard</a>
...
$res    = $p->feature_event($_SESSION['spPostCountry'], $_SESSION['spPostState'], $_SESSION['spPostCity'], $start, $limit);
...
<a style="color:white;" href="/events/feature_event.php?page=<?php echo $_GET['page'] - 1; ?>">Previous</a>
</button>
<?php }  ?>
...
<?php if ($numrowsw == 9) { ?>
<button class="btn btn-primary">
<a style="color: white;" href="/events/feature_event.php?page=<?php echo $_GET['page'] + 1; ?>">Next</a>
</button>
