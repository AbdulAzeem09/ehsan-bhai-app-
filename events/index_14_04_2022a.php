                           ...
                           /* print_r($_SESSION['ptid']);*/
                            if($_SESSION['ptid'] == 3 || $_SESSION['ptid'] == 1 || $_SESSION['ptid'] == 4 || $_SESSION['ptid'] == 6){ 
                                ...
                                if ($p_result == 1) {
                                    ...
                                    if ($reuslt_vld == false) {
                                        ?>
                                        <a href="<?php echo $BaseUrl.'/post-ad/events/?post'?>" class="btn butn_save submitevent">Submit an event33</a>
                                        <?php
                                    }
                                
                                }else{
                                    ?>
                                    <a href="javascript:void(0)" data-toggle='modal' data-target='#alertNotEmpProfile' class="btn butn_save submitevent">Submit an event4444</a> <?php
                                }
                                ?>
                                <a href="<?php echo $BaseUrl.'/events/dashboard/';?>" class="btn eventdashboard"><i class="fa fa-dashboard"></i> Dashboard66</a>
                                 <?php
                            }else{ ?>
                                <a href="javascript:void(0)" data-toggle='modal' data-target='#alertNotEmpProfile' class="btn butn_save submitevent">Submit an event7</a> <?php
                            }
                            ?>
                        </div>
                    </div>
