	...
	<script type="text/javascript">
		...
		$(".intrestArea").on("click", function(){
			...
			$.post(mainUrl+"/events/addEventintrestTwo.php", {postid: postid, pid: pid, area: area}, function (r) {
				//alert(r);
				$("."+classhtml).html(r);
...
?>
	<div class="dropdown intrestEvent " style="display: block;">
		<button class="btn btn_group_join dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-star" aria-hidden="true" style="margin: 0px; color:#ff8400"></i> <?php echo $title;?></button>
