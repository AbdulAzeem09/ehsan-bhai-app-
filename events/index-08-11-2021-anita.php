...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <section class="banner-block">
	...
	$i=0;
        ...
        <img src="https://dev.thesharepage.com/backofadmin/bannerimgs/uploads/<?php echo $row['eventImg']; ?>" alt="">
      </div>
		<?php
							$i++;
						}}
                             ...
                             <?php } ?>
                                       <!--  <a href="<?php echo $BaseUrl.'/events/event-detail.php?postid='.$row['idspPostings'];?>" class="eventcapitalize"> -->
                                        ...
                                        <p class="text-justify eventcapitalize" style="min-height: 18px!important;">
                                            <?php
                                            if(strlen($row['specification']) < 170){
                                                
                                                echo $row['specification'];
                                            
                                            }else{
                                               
                                                echo substr($row['specification'], 0,170)."...";
