...
<!-- <ul class="sidebar-menu" style="padding-top: 20px;"> -->
    ...
    <ul class="sidebar-menu ">
        ...
        <li class="eventview <?php echo ($activePage == 2)?'activepage' : '';?>"><a href="<?php echo $BaseUrl.'/post-ad/events/?post'?>" >Submit an event</a></li> 
       ...
       <!--- <li class="eventview <?php echo ($activePage == 5)?'activepage' : '';?>"><a href="<?php echo $BaseUrl.'/'.$pageLink.'sponsor-list.php'; ?>" >Sponsors</a></li>-->
        <li class="eventview <?php echo ($activePage == 6)?'activepage' : '';?>"><a href="<?php echo $BaseUrl.'/'.$pageLink.'bookmark.php'; ?>" >Bookmarked Events</a></li>
