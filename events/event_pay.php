...
$last_id = $cur->update_feature($_GET['postid'],$data1);
...
<form action="<?php echo $BaseUrl;?>/events/event_pay.php?postid=<?php echo $_GET['postid'];?>" method="POST" id="paymentForm">	
