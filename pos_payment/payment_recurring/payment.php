...
/*if (!isset($_SESSION['pid'])) {
	...
	//print_r($_POST);
	 ...
	 $us2=$us->update_pos_customer_rand_no($data,$rand_no);   
	
     $redirectUrl = $BaseUrl . '/pos_payment/pos_payment_request.php?msg=success';
 			header("Location: " . $redirectUrl);
	//header("Location:https://dev.thesharepage.com/pos_payment/pos_payment_request.php?msg=success");   
...
if($fr1!=false){
	...
	$new_duration=$duration;
                ...
                $redirectUrl = $BaseUrl . '/membership/?msg=success';
                header("Location: " . $redirectUrl);
...
<div class="container">
    ...
    <a href="<?php echo $BaseUrl ?>/membership/member_buy.php?id=<?php echo $_GET['id']?>" class="btn-link">Back to Subscription Page</a>
</div>
