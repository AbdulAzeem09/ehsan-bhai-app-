...
if (isset($_REQUEST['txn_id']) && !empty($_REQUEST['txn_id'])) {
	...
	$orderid = 0;
	 $data1 = array(
						   ...
						   "seller_userid"=>$_REQUEST['sellid'],
						   "buyer_userid"=>$_SESSION['uid'],
						    "amount"=>$_REQUEST['payment_gross'],
							 "orderid"=>$orderid,
							 "balanceTransaction"=>$_REQUEST['txn_id'],
							   "date_txn"=>$_REQUEST['payment_date']
							   );
	
 $ev = new _spevent;
  $result_1 = $ev->create_txn($data1);
...
if ($result != false) {
   ...
   $e->sendgroupeventbooked($postedusername,$posteduseremail,$eventname,$bokkedbyname,$_REQUEST['quantity1'],$_REQUEST['payment_gross']);
...
$pet = new _spgroupevent_transection;
                    ...
                    <div class="col-md-10">
                    	<div class="cartbox">
                    		...
                    		<div class="cart_body text-center successBody">
                    			...
                    			<a href="<?php echo $BaseUrl;?>/my-groups" class="btn create_add no-radius">Go to dashboard</a>
                    		</div>
                    	</div>
                    </div>
                </div>
