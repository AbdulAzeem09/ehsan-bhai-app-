...
<span style="float: left;width: 75px;margin-left: 10px;">Unit Price</span>
...
$raterow = mysqli_fetch_assoc($reviewres);
                    ...
                    <ul class='a-unordered-list a-nostyle a-vertical a-spacing-mini' style="margin-bottom: 5px;">
						...
						<a class='a-link-normal sc-product-link'  href='<?php // echo $BaseUrl.'/store/detail.php?catid=1&postid='.$rowf['productid'];?>'
