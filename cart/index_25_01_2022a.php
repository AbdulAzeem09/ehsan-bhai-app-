...
<div class="col-md-3" style="font-size: 15px;font-weight: 600;float:left;padding-right: 20px;">

<span style="float: left;width: 30px;margin-left: 10px;">Qty</span>
<span style="float: left;width: 75px;margin-left: 10px;">Uint Price</span>
<span style="float: left; margin-left: 10px;"> Total</span>
	...
	<hr style="border: -1px solid Grey;margin-top: 0px;">							
													...
													$totalprice+=$totalqtyprice;
														...
														echo"<div class='row' style='padding-left:190px'>
																...
																?>
				   												...
				   												<img src="<?php echo ($pic2); ?>" alt="Posting Pic" class="img-responsive"  style='height: 100px; width: 130px;'>
																...
																if ($res2 != false) {
																	...
																	echo"</div>
																	<div class='col-md-8' style='padding-left:0%;float:left;padding-right: 0px;'>
																...
																if($resultc != false){
																	...
																	}else
																	{
																		...
																		if ($prodata != false) {
																			$prorow = mysqli_fetch_assoc($prodata);
                                   ...
                                   if($itemType != 'Training'){
                                      ...
                                      <?php 
																		...
																		echo "</div>	
 																		...
 																		if($price != false){
				                               echo"<div class='col-md-3' style='float:left;padding-right:0px;width: 200px;'>
											   <span style='float: left;width: 30px;margin-left: 10px;'>".$spOrderQty."</span>
											<span style='float: left;width: 75px;margin-left: 10px;'>$".$sporderAmountnewnew."</span>
											<span style='float: left; margin-left: 10px;font-size: 20px;color:red'> $".($spOrderQty*$sporderAmountnewnew)."</span></div>";
                ...
                echo"<div class='col-md-12 no-padding' style=' float: right; margin-bottom: 25px; '>
									...
									<h4><b style='float: right; font-size: 22px; padding-left: 28px; padding-right: 22px; color:#202548;'>Cart Subtotal (".$totalitem." item): $<sapn id='totalamount'>".$totalspOrderQtyamount."</span></b></h4>
...
<div class="a-row" style="margin-bottom: 10px;">
 ...
 <a href="<?php echo $BaseUrl.'/store/detail.php?catid=1&postid='.$rowf['productid'];?>" style="background-image: -webkit-linear-gradient(90deg,#202548 0,#202548 100%)!important;border-color: #202548!important;border-radius: 25px!important;color: white;padding: 6px 11px 6px 11px;">View</a>
