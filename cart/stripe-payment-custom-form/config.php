...
class Config
{
    ...
    const APP_ROOT = 'https://dev.thesharepage.com';

    const WORK_ROOT = '/cart/stripe-payment-custom-form/';

    const HOME_URL = Config::APP_ROOT . Config::WORK_ROOT;

    /* Stripe API test keys */
    const STRIPE_PUBLISHIABLE_KEY = "pk_live_51JUeamAbfU8fQGnJGobtqXbWVIohRIMMC8QWGZAeQHYK5eV8KMxGVdBKuhR2tGr7o4hTATYKKamRHH3TzmW3EsUZ00jrLsywhA";

    const STRIPE_SECRET_KEY = "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";
