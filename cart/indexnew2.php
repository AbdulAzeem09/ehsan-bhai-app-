											...
											if ($u_seller != false){
												foreach($u_seller as $values) { 
													...
													
													{
														...
														$pr = new _productposting;
														$pro = $pr->read($rowrpvtforss['idspPostings']);
														...
														if($sippingch==1){
															$left_qty=$rowrpvtforss['spOrderQty']-1;
														...
														$totalpricenewnewforss +=($qty*$rowrpvtforss['sporderAmount']+$sippingch);
													}
												...
												?> 
												   ...
												   <table class="table table-borderless">
                                <th>Seller: <a href="#">  <a href="/artandcraft/seller-store.php?profileid=<?php echo $values; ?>&page=1"><?php echo $sellerNmae; ?></a></a>                                   
									</th>                                                                   
                                    <tr>
                                        <td>
                                            <div class="pull-left" style="padding-right: 10px;">
                                        ...
                                        <td> <button class="btn btn-info text-right" id="" name=""> Pay this Seller</button></td>
												...
												<div class="row">
													...
													<div class="col-md-6 float-right">
														<p style="float:right;">
															<a href="#" data-toggle="modal" data-target="#exampleModal1" onclick="payOnlyThisSeller('<?php echo $values; ?>','<?php echo $totalpricenewnewforss; ?>');">Pay Only This Seller</a>	<!-- |
													...
													if ($rpvt != false){
														...
														<?php		
															...
															if ($itemType == 'Store') {
																...
																if($sippingcharge==1){
																	echo "Shipping Charges: ".$fixedamount." (Fixed)";
																}
																if($sippingcharge==2){
...
echo "<a href='javascript:void(0)' class='a-link-normal delete' onclick=saveproductcart('".$idspOrdedsfdsr."',1)  data-oid='".$idspOrdedsfdsr."' data-savestatus='1' id='saveproduct' >Save For later</a>";
																			...
																			if($price != false){
																				echo"<div class='col-md-6' style='float:right;padding-right:0px;width: 200px;'>
...
<h4><b style='float: right; font-size: 22px; padding-left: 28px; padding-right: 22px; color:#202548;'>Cart Subtotal (".$totalitem." item): <span id='totalamount'>".$curr.' '.$totalspOrderQtyamount+$sippingch."</span></b></h4>
