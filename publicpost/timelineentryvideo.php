                    ...
                    <div class="col-md-12 ">
                        ...
                        if ($result != false) {
							...
							if($sppostingmediaExt == 'mp3'){ ?>
								...
								<div style='margin-left:15px;margin-right:15px;'>
									<video 11111 style='max-height:300px;width: 100%' controls>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    if ($re != false) {
                                        ...
                                        if ($i == 0) {
                                            echo "<span id='' data-toggle='tooltip' data-placement='bottom' title='favourite' class='icon-favorites fa fa-heart-o sp-favorites' data-postid='" . $rows['idspPostings'] . "'><span class='font_regular'> Favourite</span></span>";
                                        }
                                    } else {
