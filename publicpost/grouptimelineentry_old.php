...
<button class="btn dropdown-toggle 4444445555566" type="button" data-toggle="dropdown"><img src="../assets/images/dot-2.svg" /></button>
...
<li><a href="<?php echo $BaseUrl . '/post-ad/savePost.php?save=' . $rows['idspPostings']; ?>"><i class="fa fa-save"></i> Save Post</a></li> <?php
}
} else { ?>
<li><a href="<?php echo $BaseUrl . '/post-ad/savePost.php?save=' . $rows['idspPostings']; ?>"><i class="fa fa-save"></i> Save Post</a></li> <?php
}
...
echo "<li><a href='../post-ad/.php?postid=" . $rows['idspPostings'] . "&flag=1' style='cursor:pointer;' ><i class='fa fa-trash'></i> Delete Post</a></li>";
}
...
<li><a style="cursor:pointer;" onclick="deletePostgroup('../post-ad/deletepost_grouptimeline.php?postid=<?php echo $rows['idspPostings'].'&flag=1&timeline=1&groupid='.$rows['groupid'].'&groupname='.$rows['spGroupName'] ?>')"><i class='fa fa-trash'></i> Delete Post</a></li>
<?php
...
<div id="new_data_<?php echo $rows['idspPostings'];  ?>"> <a onclick="mfunction(this)" id="currentreaction_<?php echo $rows['idspPostings'];  ?>" href="javascript:void(0);" class="reactionbtn 1111" data-pid="<?php echo $_SESSION['pid']; ?>" data-postid="<?= $rows['idspPostings']; ?>" data-reaction="7" style="font-size: 25px;margin-top: -5px;"><?php echo $rection; ?></a> </div>
...
<i class="fa fa-comment" aria-hidden="true" style="font-size:20px; margin-right: 130px;"></i>
<span>
<?php
...
echo "<span id='spFavouritePost' style='font-size:20px;margin-right: -67px;'; data-toggle='tooltip' data-placement='bottom' title='Favourite' class='icon-favorites fa fa-heart-o sp-favorites faa-pulse animated' data-postid='" . $rows['idspPostings'] . "' data-count='" . $count . "' ><span  class='font_regular'></span></span><span class=' show-modal' onclick=\"postfunction(" . $rows['idspPostings'] . ")\" id='delid" . $rows['idspPostings'] . "' style='font-size:14px;margin-left:5px; float:right'>($count)</span> ";
} ?>
</li>
<?php
$pl = new _postshare;
...
<li style="margin-left: 40px;"><a href="javascript:void(0);" data-toggle='modal' data-target='#myshare' 2222><span class='sp-share' data-toggle='tooltip' data-placement='bottom' title='Share' data-postid='<?php echo $rows['idspPostings']; ?>' src='<?php echo ($pict); ?>'><i style='font-size:20px;' class="fa fa-share-alt 1111"></i></span></a><span class="show-modal-share" onclick="openshare(<?php echo $rows['idspPostings'];?>)"style='font-size:14px;margin-left:5px;'><?php echo "($sharecount)"; ?></span></li>
</ul>
</div>
</div>
