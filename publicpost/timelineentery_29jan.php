					...
					<div class="dropdown pull-right right_profile_timeline">
						...
						<ul class="dropdown-menu">
							...
							<?php
								...
								<?php
									echo "<li><a href='../post-ad/deletePost.php?postid=".$rows['idspPostings']."&flag=1&timeline=1' ><i class='fa fa-trash'></i> Delete Post</a></li>";
								}
							?>
							...
							<li>
								...
								<nav class="nav">
									<ul class="navigation">
										...
										<div id="new_data_<?php echo $rows['idspPostings'];  ?>">	<a id="currentreaction_<?php echo $rows['idspPostings'];  ?>" href="javascript:void(0);"  class="reactionbtn" data-postid="<?= $rows['idspPostings']; ?>" data-reaction="7" style="font-size: 25px;" ><?php  echo $rection; ?></a>	</div>	
										...
										<?php if($r->num_rows=='1'){ ?>
												<div id="new_data_<?php echo $rows['idspPostings'];  ?>">		<a id="currentreaction_<?php echo $rows['idspPostings'];  ?>" href="javascript:void(0);"  class="reactionbtn_remove" data-postid="<?= $rows['idspPostings']; ?>" style="font-size: 25px;" ><?php  echo $rection; ?></a>	</div>	
										<?php  } ?>
										
										
										
											<ul class="" style="display:flex;margin-top: -65px;margin-left: -20px;">
