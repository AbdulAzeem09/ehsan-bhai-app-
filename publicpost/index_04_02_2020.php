                ...
                <div class="modal-content no-radius sharestorepos">
                    <form class="no-margin" method="post" action="<?php echo $BaseUrl;?>/album/savemod.php">
                    	...
                    	<div class="modal-header">
                            <h4 class="modal-title" id="userModalLabel">MENU SELECTION</h4>
                        </div>
                        <div class="modal-body nobusinessProfile text-center" id="jobseakrAlert">
	                        <h1><img src="<?php echo $BaseUrl.'/assets/images/logo/logo-black.png'?>" alt="" class="" /></h1>
	                        <h2>Sharepage gives you the option to customize your menu</h2>
	                        
	                        <p>Please unchek the modules you want to hide from your menu</p>
	                        ...
	                        <div class="row text-left">
	                        	...
	                        	<div class="col-md-4">
	                        		<div class="checkbox">
	                        			<label><input type="checkbox" value="0" checked="" name="artgallery">Art Gallery</label>
	                        		</div>
	                        		<div class="checkbox">
	                        			<label><input type="checkbox" value="0" checked="" name="music">Music</label>
	                        		</div>
	                        		<div class="checkbox">
	                        	...
	                        	<div class="col-md-4">
	                        		...
	                        		<div class="checkbox">
	                        			<label><input type="checkbox" value="0" checked="" name="service">Directory Servies</label>
	                        		</div>
	                        		<div class="checkbox">
	                        			<label><input type="checkbox" value="0" checked="" name="group">Groups</label>
	                        		</div>
	                        	</div>
	                        </div>
	                    ...
	                    <div class="modal-footer">
                            <button type="submit" class="btn btn-default" name="btnshowall" >Show All Modules</button>
