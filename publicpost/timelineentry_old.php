...
<h5  id="posttimeago<?php echo $rows["idspPostings"]; ?> 55"><?php echo $postingDate; ?> <i class="fa fa-globe"></i></h5>
</div> <?php
}
}
...
<li style="cursor: pointer;" id="savefun<?php echo $rows['idspPostings'];  ?>"><a onclick="myUnsave('<?php echo $rows['idspPostings']; ?>')"><i class="fa fa-save"></i> Unsave Post</a></li>

<li style="cursor: pointer;" id="savefun<?php echo $rows['idspPostings'];  ?>"></li>
 <?php
					} else { ?>
<li><a href="<?php echo $BaseUrl . '/post-ad/savePost.php?postid=' . $rows['idspPostings']; ?>"><i class="fa fa-save"></i> Save Post33</a></li> <?php
					}
				} else { ?>


<li style="cursor: pointer;" id="savefun<?php echo $rows['idspPostings'];  ?>"><a class="profile_section" onclick="myFun('<?php echo $rows['idspPostings']; ?>')"

><i class="fa fa-save"></i> Save Post22</a></li>
...
><i class="fa fa-save"></i> Save Post</a></li> <?php
			}
...
<?php
//echo "<li><a href='../post-ad/.php?postid=".$rows['idspPostings']."&flag=1' ><i class='fa fa-trash'></i> Delete Post</a></li>";
...
echo "<li><a onclick=\"deletePost(".$rows['idspPostings'].",".$groupId.",'".$groupName."')\"'" . $rows['idspPostings'] . "&flag=1' style='cursor:pointer;' ><i class='fa fa-trash'></i> Delete Post</a></li>";
echo "<li><a href='javascript:void(0)' data-toggle='modal' data-target='#myPostEdit' data-postid='". $rows['idspPostings']."' class='sendPostidEdit'><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Edit Post</a></li>";
}
...
<li><a style="cursor:pointer;" onclick="deletePost(<?php echo $rows['idspPostings'] ?>);"><i class='fa fa-trash'></i> Delete Post55</a></li>
<!-- <li><a href='../post-ad/.php?postid="<?php echo $rows['idspPostings'] ?>"&flag=1&timeline=1' onclick="return confirm('Are you sure?');"><i class='fa fa-trash'></i> Delete Post</a></li> -->
<?php
...
<div id="new_data_<?php echo $rows['idspPostings'];  ?>"> <a onclick="mfunction(this)" id="currentreaction_<?php echo $rows['idspPostings'];  ?>" href="javascript:void(0);" class="reactionbtn 1111" data-pid="<?php echo $_SESSION['pid']; ?>" data-postid="<?= $rows['idspPostings']; ?>" data-reaction="7" ><?php echo $rection; ?></a> </div>
...
<i class="fa fa-comment 11" aria-hidden="true" style="font-size:20px; margin-right: 15px;"></i> <span class='font_regular'>(0)</span>
</a>
...
echo "<span style='font-size:20px';    id='spFavouri
tePost' data-toggle='tooltip' data-placement='bottom' title='Unfavourite' class='icon-favorites fa fa-heart removefavorites faa-pulse animated' data-postid='" . $rows['idspPostings'] . "'><span class='font_regular'> </span></span><span  onclick=\"postfunction(" . $rows['idspPostings'] . ")\" class='show-modal' id='delid".$rows['idspPostings']."' style='font-size:14px;'>($count)</span>";
...
echo "<span id='spFavouritePost' style='font-size:20px'; data-toggle='tooltip' data-placement='bottom' title='Favourite' class='icon-favorites fa fa-heart-o sp-favorites faa-pulse animated 75' data-postid='" . $rows['idspPostings'] . "'><span class='font_regular'></span></span><span  onclick=\"postfunction(" . $rows['idspPostings'] . ")\" class='show-modal' id='delid".$rows['idspPostings']."' style='font-size:14px;'>($count)</span>";
} ?>
</li>
<li><a href="javascript:void(0);" data-toggle='modal' data-target='#myshare' 2222><span class='sp-share' data-toggle='tooltip' data-placement='bottom' title='Share' data-postid='<?php echo $rows['idspPostings']; ?>' src='<?php echo ($pict); ?>'><i style='font-size:16px;' class="fa fa-share-alt"></i> <!--<span class='font_regular'>Share</span>--></span></a></li>
</ul>
</div>
</div>
...
<div class="col-md-12">
<?php
echo "<a href='../publicpost/post_comment_details.php?postid=" . $rows['idspPostings'] . "' ><span class='morecomment' data-postid='" . $rows['idspPostings'] . "' >View all comments <span class='tltcmt'>(" . $totalcmt . ")</span></span></a>";
?>
</div>
</div>
</div>
