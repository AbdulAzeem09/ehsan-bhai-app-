                ...
                <div class="store_box">
                    ...
                    if(!empty($rows['spPostingtitle'])){
                        if(strlen($rows['spPostingtitle']) < 15){
                            ?><h3><a href="<?php echo $BaseUrl.'/post-details/?postid='. $rows['idspPostings'].'&groupid='.$_GET['groupid'].'&groupname='.$_GET['groupname'].'&store'; ?>" data-toggle="tooltip" title="<?php echo $rows['spPostingtitle']; ?>"><?php echo $rows['spPostingtitle']; ?></a></h3><?php
                            
                        }else{
                            ?><h3><a href="<?php echo $BaseUrl.'/post-details/?postid='. $rows['idspPostings'].'&groupid='.$_GET['groupid'].'&groupname='.$_GET['groupname'].'&store'; ?>"><?php echo substr($rows['spPostingtitle'], 0,15).'...'; ?></a><h3><?php
                        }
                    }else{
                        echo "<h3>&nbsp;</h3>";
                    }
                        ...
                        if (isset($_GET["categoryName"]) == "Freelancers") {
                            ...
                            if (isset($_GET["spPostingsFlag"]) == 1){
                                ...
                                if ($rows['idspCategory'] != 5) {
                                    echo "<a href='../post-details/?postid=" . $rows['idspPostings'] . "&groupid=".$_GET['groupid']."&groupname=".$_GET['groupname']."&store' role='button' class='btn buybutton'>" . $rows['spCategoriesButton'] . "</a>";
                                } else{
