...
<div class="card">
  <ul class="nav nav-tabs" role="tablist">
	...
	<li role="presentation"><a href="#vehicaltype" aria-controls="profile" role="tab" data-toggle="tab">Vehical Type</a></li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="vehicaltype">
	<?php
		$masterid = 5;
		$result = $m->read($masterid);
		if($result != false)
