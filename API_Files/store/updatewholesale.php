...
$wholesaledata = array(
     ...
     "spPostingEmail"=>$_POST["spPostingEmail"]
		 ...
		 $postid = $p->update($wholesaledata, " WHERE t.idspPostings=" . $_POST["idspPostings"]);
    // echo $p->ta->sql;
    /*echo $mysqli->info;
    echo $postid;*/
/*
...
/*print_r($profimgdata);*/
        $FeatureImg = 1;
       $pi->createPic($_POST["idspPostings"], $profimgdata, $FeatureImg);
		/*print_r($ext);*/
		# code...
	/*}*/
...
$file_tmp_name1 =$postpic;
	...
	$proimgdata = base64_decode($img);
        ...
        $FeatureImg = 0;
        $pi->createPic($_POST["idspPostings"], $proimgdata, $FeatureImg);
		/*print_r($ext);*/
		# code...
	}
...
$s->update($sizedata, " WHERE productid =" . $_POST["idspPostings"]);
}
...
$s->update($sizedata, " WHERE productid =" . $_POST["idspPostings"]);
     ...
     "spPostingEmail"=>$_POST["spPostingEmail"]
      ...
      $data = array("status" => 200, "message" => "success","data"=>$postwholesaledata);
