                                ...
                                <div class="pad_top_55">
                                    ...
                                    <div class="row logo_signup">
                                        <div class="col-md-12 text-center">
                                            <a href="<?php echo $BaseUrl;?>" style="left: 39%;"><img src="<?php echo $BaseUrl;?>/assets/images/logo/tsp_trans.png" alt="The SharePage" class="img-responsive" style="width: 108px;height: 108px;" /></a>
                                        </div>
                                    </div>
                                    <div class="forgotForm">
                                        <div class="space-lg"></div>
                                        <form action="backreset.php" method="post">
