...
$e = new _email;
$au_email = $_GET['email'];
$au_username = $_GET['username'];
$au_me = $_GET['me'];
$e->send_welcome_email($au_email,$au_username,$au_me,'');
//echo "<h3>Your account has Activated. Go to <a href='".$BaseUrl."/my-profile/'> The SharePage.</a></h3>";

}else if($row["email_verify_code"] == 0){
...
<a href='<?php echo $BaseUrl.'/login.php'?>' class="btn">Login now</a>
</td>
</tr>
