...
//echo"hereccxxvxcv";
	...
	if($result != false)
	{
		...
		{
			if($row["spPostings_idspPostings"] == $postid && $row["spProfiles_idspProfiles"] == $_POST["pid"])
			{
	...
	{
//die('==');
		 $fe->addfavorites_realstate(array("spProfiles_idspProfiles" => $_POST["pid"], "spPostings_idspPostings" => $postid, "spUserid" => $_SESSION["uid"]));
