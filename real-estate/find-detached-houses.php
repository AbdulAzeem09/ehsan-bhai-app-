		...
		<body class="bg_gray">
								...
								<div class="col-md-6">
									<div class="text-left agentbreadCrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active">Detached Type Property</li>
										</ol>
									</div>
								</div>
								<div class="col-md-6">
			...
			<section class="" style="padding: 30px;">
				<div class="container">
					...
					<div class="row">
						<form class="searchReal" action="find-detached-houses.php">
					...
					<div class="row">
						...
						<div class="list-wrapper">
							...
							<?php
								...
								//echo $p->ta->sql;
								if($res != false){
									echo "<h1 class='text-center'>Detached Type Property</h1>";
								...
								echo "<h3 class='text-center'>There is no property found of DETACHED TYPE  in "  .$defcity. ','.$defstate.','.$defcountry."</h3>";
										?>
								<style>
