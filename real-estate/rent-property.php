                        ...
                        <div class="table-responsive" style="min-height: 400px;">
                            <table class="table tabe-striped realTable">
                                ...
                                <tbody>
                                    ...
                                    $result2 = $rsp->myAllRentEntire($_GET['categoryID'], $_SESSION['pid'], $type);
                                    // print_r($result2);
                                    // exit;
                                    //echo $p->ta->sql;
                                    if($result2 != false){
                                        while ($row2 = mysqli_fetch_assoc($result2)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row2['spPostingPropertyType'];?></td>
                                                <td><?php echo $row2['spPostingPropStatus'];?></td>
                                                <td><a href="<?php echo $BaseUrl.'/post-ad/real-estate/?type=1&postid='.$row2['idspPostings'];?>">Edit</a></td>
                                            </tr>                                            
                                            <?php
                                        }
                                    }
