		...
		<body class="bg_gray">
								...
								<div class="col-md-6">
									<div class="text-left agentbreadCrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active">Town Type Property</li>
										</ol>
									</div>
								</div>
								<div class="col-md-6">
			...
			<section class="" style="padding: 30px;">
				<div class="container">
					...
					<div class="row">
						<form class="searchReal" action="find-town-houses.php">
					...
					<div class="row">
						...
						<?php
							...
							if(isset($_GET['dream']) && $_GET['dream'] != ''){
								...
								$proptype = "Town House";
								$ps      = new _realstateposting;
																															

								$res = $ps->showAllPropertybytype($proptype,$defcountry,$defstate,$defcity);
								if($res){
						...
						<div class="list-wrapper">
							...
							<?php
								...
								//echo $p->ta->sql;
								if($res != false){
									echo "<h1 class='text-center'>Town Type Property</h1>";
