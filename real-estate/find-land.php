    ...
    <body class="bg_gray">
								...
								<div class="col-md-6">
									<div class="text-left agentbreadCrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active">Land Type Property</li>
										</ol>
									</div>
								</div>
								<div class="col-md-6">
        ...
        <section class="" style="padding: 30px;">
            <div class="container">
											...
											<div class="row">
		<form class="searchReal" action="find-land.php">
...
//unset($_SESSION['realstate_default_address']);
	...
	$defcity = $default_address['default_city'];
                    ...
                    //echo $p->ta->sql;
                    if($res != false){
						  							echo "<h1 class='text-center'>Land Type Property</h1>";
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            ...
                            <div class="col-md-3">
								...
								echo "<h3 class='text-center'>There is no property found of LAND TYPE  in "  .$defcity. ','.$defstate.','.$defcountry."</h3>";
										?>
								<style>
