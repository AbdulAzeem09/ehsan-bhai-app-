...
<li style="font-size: 14px;" class="breadcrumb-item active">Received Booking For Room </li>
</ol>
...
<!--<h4>Booking Recieved Related to Rent A Room</h4>
...
<td style="text-align:center;"><?php echo $row2['spDays']; ?></td>
<td style="text-align:center;"><?php echo $row2['spAdult']; ?></td>
<td style="text-align:center;"><?php echo $row2['spChildren']; ?></td>
<?php	
