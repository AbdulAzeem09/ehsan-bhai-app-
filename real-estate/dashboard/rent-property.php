...
<li style="font-size: 14px;" class="breadcrumb-item active">Rent Entire Place</li>
</ol>
...
$i = 1;
$result2 = $p->myPropertyWithTyperent_entire($_GET['categoryID'], $_SESSION['pid'], $type, $defaultType);
...
<a href="<?php echo $BaseUrl . '/post-ad/real-estate/?type=1&postid=' . $row2['idspPostings']; ?>"><i style="color: #428bca" title="Edit" class="fa fa-pencil"></i></a>

<!-- <a href="javascript:void(0);" class="disable-btn" data-work="deactive" data-Id="<?php echo $row2['idspPostings']; ?>"><i style="color: red;" class="fa fa-user disable-btn" data-disableId=""></i></a> -->

<!-- <a href="javascript:void(0);" class="disable-btn" data-work="delete" data-Id="<?php echo $row2['idspPostings']; ?>"><i style="color: red;" class="fa fa-trash disable-btn" data-disableId=""></i></a> -->


<a href="javascript:void(0);" onclick="doyouwant1('deactivate',<?php echo $row2['idspPostings']; ?>)" class="disable-btn" data-work="deactive" data-Id="<?php echo $row2['idspPostings']; ?>"><i style="color: red;" title="Deactivate" class="fa fa-ban disable-btn" ></i></a>

<a href="javascript:void(0);" onclick="doyouwant1('delete',<?php echo $row2['idspPostings']; ?>)" class="disable-btn" data-work="delete" data-Id="<?php echo $row2['idspPostings']; ?>"><i style="color: red;" title="Delete" class="fa fa-trash disable-btn" ></i></a>
...
function doyouwant1(work,dataId){
...
function(isConfirm) {
if (isConfirm) {
window.location.href = '/real-estate/dashboard/delete_rent_property.php?postid=' + dataId + '&work=' + work;
}
});
