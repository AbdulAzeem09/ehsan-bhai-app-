...
<div class="text-left agentbreadCrumb" style="margin-top: 20px;margin-bottom: -15px;">
<ol class="breadcrumb">
...
<li style="font-size: 14px;" class="breadcrumb-item active">Draft Property</li>
</ol>
...
$pssstid = isset($_GET['postid']) ? (int) $_GET['postid'] : 0;
...
if($_GET['work']=='active'){
//$pssstid = $_GET['postid'];
$p->activeTodraft($pssstid, $_SESSION['pid']);
}
...
<td><a class="btn btn-primary" title="Edit" href="/post-ad/real-estate/?postid=<?php echo $row2['idspPostings']; ?>&repost=3<?php if($row2['spPostListing'] == 'Rent'){ echo '&type=1'; }?>"><i class="fa fa-pencil-square" aria-hidden="true"></i>

</a>
<?php 
$href='/real-estate/dashboard/draft-property.php?postid=' . $row2['idspPostings'] 
    . '&work=active';
?>

<a class="btn btn-success" title="Active" onclick="permanentDelete('<?php echo $href; ?>')" ><i class="fa fa-check-circle" aria-hidden="true"></i>
</a></td>
</tr>                                            
<?php
}
...
<script src="<?php echo $baseurl?>/assets/js/sweetalert.js"></script> 
    <script>
        ...
        Swal.fire({
        title: 'Are you sure you want to active this list ?',
        icon: 'warning',
