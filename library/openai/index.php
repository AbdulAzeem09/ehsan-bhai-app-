...
<body>
 ...
 <h1>Chat with Assistant</h1>
     ...
     <form id="chatForm" style="text-align: center;">
        <label for="user_query">Your Query:</label><br>
        <input type="text" style="width:400px;height:50px;border-radius: 10px;" id="user_query" name="user_query" required>
        <button type="button" onclick="submitQuery()" style="height:50px;border-radius: 10px;">search</button>
    </form>
       <div id="conversation">
    ...
    <script>
        function submitQuery() {
            ...
            if (userQuery.trim() !== '') {
                ...
                xhr.open('POST', 'indexbackend.php', true);
                xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                xhr.send('user_query=' + encodeURIComponent(userQuery));
            }
