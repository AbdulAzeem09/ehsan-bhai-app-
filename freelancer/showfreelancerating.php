...
*/
  ...
  if($result){
                         ...
                         <div class="row">
                            ...
                            <div class="">
							<!--<img src="../assets/images/blank-img/default-profile.png" class="img-responsive" style="height: 70px; border-radius: 100%;">-->
							<img  src="<?php  echo $row2['spProfilePic']; ?>" class="img-responsive" style="width: 60px; border-radius: 100%;">

                               <div class="" style="position: absolute; top: 10px; right: 80px;">
                               
                                <a href="<?php echo $BaseUrl.'/freelancer/profile_detail.php?prof_id='.$row2['idspProfiles'];?>"><p class="eventcapitalize"><b><?php echo $row2['spProfileName'];?></b></p></a>
 ...
 -->
                         <input class="stars" type="radio" id="star5" name="rating" value="5" <?php if($row['recomnd_rating'] == "5") { echo "checked "; }?> 
                              />
                                  ...
                                  <div style="position: absolute;  bottom: -25px;  left: 20px;" ><p ><?php echo $row['desc_recomndation'];?></p></div>
                              </div>
                         </div>
                         <br>
