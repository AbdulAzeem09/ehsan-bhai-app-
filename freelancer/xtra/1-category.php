...
if($result2){ ?>
<a href="<?php echo $BaseUrl.'/post-ad/freelancer/?post';?>" class="btn get-started">Get Started</a> <?php
}else{ ?>
<!-- Modal -->
...
<a href="javascript(0)" class="btn get-started"  data-toggle="modal" data-target="#Notabussiness" >Get Started</a> <?php
} ?>
