...
<?php if($_SESSION["ptname"] == "Freelancer"){ ?> 
                        ...
                        <li><a href="<?php echo $BaseUrl.'/freelancer/projects.php';?>" 
                            class="<?php echo ($activePage == 2)?'red' : '';?>">Find Project</a></li>
...
<?php }?>
 ...
 <?php if($_SESSION["ptname"] == "Bussiness"){ ?>
                       ...
                       <li><a href="<?php echo $BaseUrl.'/freelancer/freelancer.php?cat=ALL';?>" 
                         class="<?php echo ($activePage == 7)?'red' : '';?>">All Freelancer</a></li>
<?php }?>

                        
                         <li class="hidden-xs"><a href="#" class="seprator">|</a></li>
                        <li><a href="<?php echo $BaseUrl.'/freelancer_inbox.php'?>" class="<?php echo ($activePage == 6)?'red' : '';?>">Inbox <span><strong> <?php if(isset($totalchat)){ if($totalchat > 0){echo '( '.$totalchat.' )'; }}?> </strong></span></a></li>
...
<!--     <div class="col-xs-12 search-for-project projectsearch" style="margin-top: 5px;">
        <form class="col-xs-12" method="post" action="search.php" >
            <div class="form-group">
                ...
                <input class="btn search-btn searchbutton" value="Search" name="btnSearchProject" type="submit">
            </div>
        </form>
