   ...
   .ratings:before {
    ...
    <body class="bg_gray">
        ...
        <section class="main_box" id="freelancers-page">
          ...
          $m = new _subcategory;
          $catid = 5;
          $result = $m->new_read($catid , $_GET['cat']);
           if($result){
                $row = mysqli_fetch_assoc($result);
							  ...
							  <li>All</li>
							  <?php }else{?>
                              <li><?php echo ucfirst(strtolower($row['subCategoryTitle']));?></li>
							  <?php } ?>
							  <div class="pull-right">
							  <form action="search_profile.php?cat=<?php echo $_GET['cat']?>">
...
*/
                    ...
                    <span class="red pull-right" style="font-size:13px;"><?php if($currancys) { echo $currancys.' '.$perhour; } else { echo 'USD'.' '.$perhour;  }?>/hr</span></div>
                                                                  <?php } ?>
...
*/
                        ...
                        </p> <a href="<?php echo $BaseUrl.'/freelancer/user-newprofile.php



?profile='.$row['idspProfiles'];?>" class="btn engineer-view-profile viewprofile">View Profile</a>
                                                            </div>
                                                        </div>
                                                    </div>
