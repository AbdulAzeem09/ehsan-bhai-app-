...
<th class="text-center">My Bid</th>
...
<td class=""></td>
<td class=""><a href="<?php echo $BaseUrl . '/freelancer/project-detail.php?project=' . $row['idspPostings']; ?>" class="red freelancer_capitalize">
<?php echo $row['spPostingTitle']; ?></a></td>

<td class=""><?php echo $row['Default_Currency'] . ' ' . $row['bidPrice'] . $bidPrice; ?></td>
<td class=""><?php echo $row['Default_Currency'] . ' ' . $row['spPostingPrice']; ?></td>
...
<?php if ($row['status'] != 1) { ?> 
<td class=""> 
<a href="<?php echo $BaseUrl . '/freelancer/project-detail.php?project=' . $row['idspPostings']; ?>" class="red" ><i style="color: orange;" class="fa fa-eye" ></i></a>

<a href="" data-toggle='modal' data-categoryid='5' data-postid='".$_GET["project"]."' data-target='#bid-system<?php echo $row["idspPostings"]; ?>' data-profileid='".$_SESSION["pid"]."'> <i class="fa fa-pencil"></i> </a>
<a href="<?php echo $BaseUrl . '/freelancer/dashboard/delete_bid.php?bidid=' . $row["id"]; ?>" data-original-title="Retract" data-toggle="tooltip" data-placement="top"> <i style="color:red" class="fa fa-undo"></i> </a>
</td>
<?php } else { ?>
<td> N/A </td>
<?php  } ?>
