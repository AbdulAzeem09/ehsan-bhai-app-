...
<a href="javascript:void(0)" class="red freelancer_capitalize"><?php //echo $row['spPostingTitle'];
?></a>
...
<th class="action" style="color:#fff;text-align:center;">Action</th>
</tr>
</thead>
<tbody>
<?php
// $p = new _postings;
//$pv = new _postingview;
// $res = $p->myProfileDraftFreelancer1(5, $_SESSION['pid']);
$st = new _spuser;
...
<!-- <a href="javascript:void(0);" class="red"  ><?php //echo ucfirst($row['spPostingTitle']);
    ?></a>                                                       
-->
...
<!--  <a href="<?php echo $BaseUrl . '/freelancer/dashboard/detail.php?postid=' . $row['idspPostings']; ?>" class="red freelancer_capitalize" ><i class="fa fa-eye"></i></a> -->

<a href="<?php echo $BaseUrl . '/post-ad/freelancer/?postid=' . $row['idspPostings']; ?>"><i style="color: #428bca" title="Edit" class="fa fa-pencil" style="color: black;"></i></a>

<a href="javascript:void(0);" onclick="deletedraft(<?php echo $row['idspPostings']; ?>);" class="red freelancer_capitalize"><i title="Delete" class="fa fa-trash" style="color:black;"></i></a>
<!-- <a href="<?php echo $BaseUrl . '/freelancer/dashboard/delete_project.php?post_id=' . $row['idspPostings']; ?>" class="red freelancer_capitalize" ><i class="fa fa-trash"></i></a> -->
</td>
</tr> <?php
$i++;
}
...
echo "<td colspan='5'><center>No Draft Available</center></td>";
}
?>
