...
if(!isset($_SESSION['otpconfirm'])){
    $BaseUrl2=$BaseUrl."/dashboard/vault/pin.php"; 
...
<!-- /.box-header -->
<div class="box-body">
<form role="form" method="post" action="createpin.php" class="stckyForm" id="frmpin">
...
<div class="col-md-4">
<div class="form-group">
<label>Enter your new key (4 Digits)</label>  
<input type="password" class="form-control" id="txtPin" name="txtPin" maxlength="4" /> 
<span  class="error74 red" id="error74"><span>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<span class="error red " id="error"><span>
</div>
</div>
<div class="col-md-4">
<div class="form-group">
...
<!-- <div class="col-md-12">
<div class="form-group">
<a href="javascript:void(0)" class="btn btn-primary getnrateOtp" style="">Generate Code</a>
</div>
</div> -->
...
<span class="red" id="email_msg" style="display:none;font-size:15px;"> Code is sent to your Email.</span>
...
<div class="col-md-2 ">
<div class="form-group">
<input type="hidden" class="form-control" name="txtOtp" id="codematch" value="<?php echo $_SESSION['spstickyOtp'];  ?>" placeholder="Input code here" />
...
<input type="hidden" id="action" value="<?php echo $_GET['action']; ?>">
 <?php 
         $pid = $_SESSION['pid'];
        $result = $pin->chekOtp($pid);
        if($result){
        $row = mysqli_fetch_assoc($result);
        }
			$codeSend = $row['spstickyOtp'];
            ?>
<input type="hidden" id="codetst" value="<?php echo $codeSend; ?>">
<?php
if ($pn != false) {
?>
<input type="button" name="btnCreatePin" onclick='UpdateOtp()' value="Update PIN" class="btn btn-success">
<?php
} else {
?>
