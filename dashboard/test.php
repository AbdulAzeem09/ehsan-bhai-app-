...
<table class="table table-striped table-bordered table-hover" border="1" cellspacing="0" cellpadding="">
    <tr>
        <th>id</th>
        <th>First name</th>
        <th>last name</th>
...
while($row=mysqli_fetch_assoc($result)){
    ...
    echo "<td><a href='/dashboard/edit.php?id=$id'>Edit </a> </td>";
    echo "<td><a href='/dashboard/delete.php?id=$id'>Delete</a></td>";  
