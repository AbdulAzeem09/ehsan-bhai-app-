...
*/
                      ...
                      $sds =$sn->readannounceallcount();
					 $totalAnnouncement= $sds->num_rows;
					 if($totalAnnouncement==""){
						 $totalAnnouncement=0;
					 }
					// echo $totalAnnouncement;
					 //die('==');
						 ...
						 $totalblock=0;
									 ...
									 ////////////==== Comments
									 $obj=new _spprofiles;
									 $result1=$obj->read_comments($_SESSION['pid']);
									 
									 $totalcomments= $result1->num_rows;
									  if($totalcomments==""){
						 $totalcomments=0;
					 }
					// echo $totalcomments;
							//die('==');
                                           ...
                                           ////////////==== Channel Created
										  $n = new _news;
									 $r=$n->read_channel($_SESSION['pid']);
									 
									 $totalChannel= $r->num_rows;
									  if($totalChannel==""){
						 $totalChannel=0;
					 }
									//echo $totalChannel;
							//die('==');	   
										   ...
										   ?>
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                                       <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/news/Announcement.php'; ?>">Announcement </a></td>
                                                        <td><span class="label label-info"><?php echo $totalAnnouncement; ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/news/block_users.php'; ?>">Block Users</a></td>
                                                        <td><span class="label label-info"><?php echo $totalblock; ?></span></td>
                                                    </tr>
                                                    <!-- <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="label label-danger"><?php echo $totalcomments; ?></span></td>
                                                    </tr>

                                                    <tr>
                                                        <td><a href="#">Channel Created</a></td>
                                                        <td><span class="label label-warning"><?php echo $totalChannel; ?></span></td>
                                                    </tr>
                                            ...
                                            <div class="box-footer clearfix">
                                              <!--  <a href="<?php echo $BaseUrl.'/news/index.php?page=1';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a> -->
                                                <a href="<?php echo $BaseUrl.'/news/index.php?page=1';?>" class="btn btn-sm btn-primary btn-flat pull-right btn-border-radius">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
