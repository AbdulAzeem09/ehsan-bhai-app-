                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                ...
                                                if($result){
													$totInActive = $result->num_rows;
															...
															$m = new  _jobpostings;
														//$result = $m->myDeactiveProfilejob($_SESSION['pid']);
														$result = $m->mySaveJob($_GET['categoryid'], $_SESSION['pid']);
														//echo $m->ta->sql;
														if($result){
															$totalDraft = $result->num_rows;
														}
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/job-board/dashboard/';?>" class="btn btn-sm btn-info btn-flat pull-left  btn-border-radius">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/job-board/';?>" class="btn btn-sm btn-primary btn-flat pull-right  btn-border-radius">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="nav-tabs-custom">
                                            ...
                                            <div class="tab-content no-padding">
                                                <!-- Morris chart - Sales -->
                                                <div class="chart tab-pane active" id="bar-chart" style="position: relative; height: 329px;">
                                                    <div id="jobBoardChart" style="width: 100%; height: 100%; margin: 0 auto"></div>
                                                </div>
                                                <!-- this is xxtra chart for dummy -->
                                                <div class="chart tab-pane " id="revenue-chart" style="position: relative; height: 329px;">
                                                    
                                                    
                                                </div>
                                                <div class="chart tab-pane" id="chart-two" style="position: relative; height: 329px;">
                                                    
                                                    
                                                </div>
                                                <div class="chart tab-pane" id="pie-chart" style="position: relative; height: 329px;">
