        ...
        <section class="">
            <div class="container-fluid no-padding">
                ...
                $result2 = $p->myAllSellActiveProperty($_GET['categoryID'], $_SESSION['pid'], $type);
                                        ...
                                        if($result2 != false){
											$totalDraft = $result2->num_rows;
															...
															?>
                                                                ...
                                                                <td><span class="label label-info"><?php echo $totalDraft; ?></span></td>
                                                            </tr>
                                        ...
                                        //echo $p->ta->sql; die;
                                        if($result2 != false){
											$totFav = $result2->num_rows;
										}
															
															?>
															
															
                                                                <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/my-enquiry.php';?>">Sent Enquiries</a></td>
                                        ...
                                        $type = "Sell";
                                        //$result2 = $p->myAllSellReal($_GET['categoryID'], $_SESSION['pid'], $type);
                                        $result2 = $p->myEnqueryrecive($_GET['categoryID']);
                                        //echo $p->ta->sql; die;
                                        if($result2 != false){
												$rent_entire_place = $result2->num_rows;
										}
											?>
                                                                <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/received-enquiry.php';?>">Received Enquiries</a></td>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/real-estate/dashboard/';?>" class="btn btn-sm btn-info btn-flat pull-left btn-border-radius">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/real-estate/';?>" class="btn btn-sm btn-primary btn-flat pull-right btn-border-radius">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
