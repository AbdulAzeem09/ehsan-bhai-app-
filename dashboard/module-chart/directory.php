...
if(!isset($_SESSION['pid'])){ 
    ...
    $_GET["categoryid"] = "19";
    $moduleTitle = "Directory Services";
    $pageactive = 15;
    // background color
?>
<!DOCTYPE html>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><a href="javascript:void(0)">In-Active Post</a></td>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/business-directory/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left  btn-border-radius">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/business-directory/';?>" class="btn btn-sm btn-primary btn-flat pull-right  btn-border-radius">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
            ...
            $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        ...
                        {label: "In-Active Post", value: <?php echo $totInActive; ?>},
