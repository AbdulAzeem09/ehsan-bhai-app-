                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Total Music</a></td>
                                                                <td><span class="label label-success"><?php echo $totalProducts; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">My Upload Music</a></td>
                                                                <td><span class="label label-info"><?php echo $totalActive; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Favourite Music</a></td>
                                                            ...
                                                            <tr>
                                                                <td><a href="javascript:void(0)">My Private Music</a></td>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/music/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/music/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        {label: "Total Music", value: <?php echo $totalProducts;?>},
                        {label: "My Upload Music", value: <?php echo $totalActive;?>},
                        {label: "Favourite Music", value: <?php echo $totFav;?>},
                        {label: "Playlist", value: <?php echo $playList; ?>},
                        {label: "Album", value: <?php echo $album; ?>},
                        {label: "My Private Music", value: <?php echo $private;?>}
                    ],
                    hideHover: 'auto'
                });
            });
