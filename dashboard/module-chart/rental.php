...
<html lang="en">
	...
	$draft=$result7->num_rows;
					 ...
					 $result3 = $p->myReceivedBooking($_SESSION['pid'],$type);
					 $totalBookingplace= $result3->num_rows;
////echo $totalBookingplace;
							//die();
										if($totalBookingplace==""){
						 $totalBookingplace=0;
					 }
                                        ...
                                        $r1 = $p->readMyBooking($_SESSION['pid'],$type);
										$totalBooking1= $r1->num_rows;
					 //echo $totalBooking1;
							//die();
										if($totalBooking1==""){
						 $totalBooking1=0;
					 ...
					 $type ="Rent Entire Place";
										...
										$totalBooking2= $result3->num_rows;
					 //echo $totalBooking1;
							//die();
										if($totalBooking2==""){
						 $totalBooking2=0;
...
?>						
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                                       <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/booking.php'; ?>">Received Booking For Room </a></td>
                                                        <td><span class="label label-info"><?php echo $totalBooking; ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/booking2.php'; ?>">Received Booking For Place </a></td>
                                                        <td><span class="label label-info"><?php echo $totalBookingplace; ?></span></td>
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/my_send_booking.php'; ?>">My Send Booking(1)</a></td>
                                                        <td><span class="label label-info"><?php echo $totalBooking1; ?></span></td>
                                                    </tr>

                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/real-estate/dashboard/my_send_booking2.php'; ?>">My Send Booking(2)</a></td>
                                                        <td><span class="label label-info"><?php echo $totalBooking2; ?></span></td>
                                                    </tr>
        ...
        <script src="<?php echo $BaseUrl?>/assets/admin/plugins/slimScroll/jquery.slimscroll.min.js" type="text/javascript"></script>
            ...
            Highcharts.chart('jobBoardChart', {
                ...
                series: [{
                    ...
                    colorByPoint: true,
                    data: [{
                        name: "Received Booking For Room ",
                        y: <?php echo $totalBooking;?>
                    },{
                        name: "Received Booking For Place ",
                        y: <?php echo $totalBookingplace; ?>
                    },{
                        name: "My Send Booking(1)",
                        y: <?php echo $totalBooking1;?>
                    },/*{
                        name: "Flagged Ads",
                        y: <?php echo $totFlgPst;?>
                    },*/{
                        name: "My Send Booking(2)",
                        y: <?php echo $totalBooking2; ?>
                    }]
                }],
