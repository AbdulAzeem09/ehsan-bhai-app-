...
// ========PLAYLIST
$playList = 0; 
$result6 = $cl->readList($_SESSION['pid'], $_GET['categoryid']);
if ($result6) {
$playList = $result6->num_rows;
}
// =======ALBUM
$album = 0; 
$result7 = $al->readMyalbum($_SESSION['pid'], $_GET['categoryid']);
//echo $al->ta->sql;
if ($result7) {
$album = $result7->num_rows;
}
// MY PRIVATE SONG
$private = 0; 
$result8 = $p->myAllPrivateSongs($_SESSION['pid'], $_GET['categoryid'], 0);
if ($result8) {
$private = $result8->num_rows;
}
...
$start = 0;
$v = new _videoupload;
$res = $v->myUploadedVid($_SESSION['pid'],$start,$limitaa);

//var_dump($res);
$totalProducts += $res->num_rows;




?>
<td><a href="<?php echo $BaseUrl.'/videos/myvideos.php?page=1';?>">My Videos </a></td>
...
$playlist_obj = new _createplaylist;
$res2 = $playlist_obj->readList11($_SESSION['pid'],10,$start,$limitaa); 
$num_rows= $res2->num_rows;

if (!empty($res2)) {
while ($row2 = mysqli_fetch_assoc($res2)) {
$v = new _video;
$res = $v->get_my_playlist_video($_SESSION['pid'],$row2['list_id']);
...
<td><a href="<?php echo $BaseUrl.'/videos/myplaylist.php?page=1';?>"> My Playlist </a></td>
...
<?php 
$v = new _video;
$res = $v->getMyFavouriteVideo($_SESSION['pid'], $_SESSION['uid']);
$totFav += $res->num_rows;
?>
<td><a href="<?php echo $BaseUrl.'/videos/myfavourite.php?page=1';?>">My Favourites</a></td> 
...
//$v = new _video;
$_GET["categoryID"] = "10";
//$res = $v->myflagVideo($_GET["categoryID"],$_SESSION['pid'],'Duplicate post');
$v = new _video;
$res1 = $v->myflagVideo($_GET["categoryID"],$_SESSION['pid'],'Duplicate post');
$playList = 0;
if($res1){
 $playList += $res1->num_rows; 
}
?>
<td><a href="<?php echo $BaseUrl.'/videos/flaggedVideo.php?page=1';?>">Flagged Videos</a></td>
<td><span class="label label-warning"><?php echo $playList; ?></span></td>
</tr>
...
<a href="<?php echo $BaseUrl.'/videos/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left btn-border-radius">View Module Dashboard</a>
<a href="<?php echo $BaseUrl.'/videos/index.php?page=1';?>" class="btn btn-sm btn-primary btn-flat pull-right btn-border-radius">View Module</a>
</div><!-- /.box-footer -->
</div><!-- /.box -->
</div>
...
data: [
{label: "Total Videos", value: <?php echo $totalProducts;?>},
{label: "My Uploaded Videos", value: <?php echo $totalActive;?>},
{label: "Favourite Videos", value: <?php echo $totFav;?>},
{label: "Playlist", value: <?php echo $playList; ?>},
{label: "Album", value: <?php echo $album; ?>},
{label: "My Private Videos", value: <?php echo $private;?>}
],
hideHover: 'auto'
});
});
