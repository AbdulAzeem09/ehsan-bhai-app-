							...
							//die('==');	   
										   ...
										   ?>
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                                       <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/services/dashboard/active.php'; ?>">
															Active Ads </a></td>
                                                    ...
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/services/dashboard/enquiry.php'; ?>">Enquiries </a></td>
                                                        <td><span class="label label-danger"><?php echo $totFav; ?></span></td>
                                                    </tr>

                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.'/services/dashboard/draft.php'; ?>">Draft</a></td>
                                                        <td><span class="label label-warning"><?php echo $totalDraft; ?></span></td>
                                                    </tr>
