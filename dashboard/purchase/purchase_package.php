...
$paymentMessage = '';
		if(!empty($_POST['stripeToken'])){
            //echo $_POST['stripeToken']; die('====66');
                          ...
                          //print_r($paymenyResponse);die('=====444444');
...
$new_duration=$duration;
						 ...
						 //$cardDetails
								//die('======');
                                //echo $_POST['stripeToken']; die('====777');
		$tansation = "123456789";
			$uid = $_SESSION['uid'];
			$pid = $_SESSION['pid'];
		//echo $_POST['price'];
...
Payment Successful
				...
				header('location:'.$BaseUrl.'/dashboard/purchase/index.php?type=purchase&id='.$id);
...
<div class="col-md-12"> 
	<div class="col-md-6" style="border-right:1px solid #ddd;">
		...
		<form action="<?php echo $BaseUrl;?>/dashboard/purchase/purchase_package.php?id=<?php echo $id;?>" method="POST" id="paymentForm">	
		...
		<?php 
                            ...
                            $mb = new _spmembership;
                            $result = $mb->read_package_1($id);
				if ($result != false) {
						while ($row = mysqli_fetch_assoc($result)) { 
						$untinprice =	$row['pack_amount'];
					$ProTitle=$row['pack_name'];
                    $duration=$row['pack_duration'];
							//print_r($row); 
				}}	?>
			...
			<table class="table table-bordered table-striped">
				...
				if ($result != false) {
						...
						//	print_r($row); 
							?>
								<tr>
								<td class="text-center"><?php echo $row['pack_name'];?></td>
								<td class="text-center"><?php echo $row['pack_duration'];?></td>
								<td class="text-center"><?php echo $row['pack_amount'];?></td>
								</tr>
