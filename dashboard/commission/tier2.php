...
<a href="<?php echo $BaseUrl.'/dashboard/commission/tier2.php?id='.$_GET['id']; ?>" class="btn btn-danger btn-border-radius" style="margin-top:20px; margin-left:4px;">Reset</a>
...
<h4 class="text-center"><b>TIER 2 USERS</b></h4>
<div class="num_rows">
...
$enddate=$_POST['date2'];
$getAllTierCommission = $u->getAllTier2CommissionsFilter(implode(',',$tierIds),$startdate,$enddate);
}
else{
$getAllTierCommission = $u->getAllTier2Commissions(implode(',',$tierIds));
}
$total=0;
$totalSales=0;
