...
<a href="<?php echo $BaseUrl.'/dashboard/commission/'; ?>" class="btn btn-danger btn-border-radius" style="margin-top:20px; margin-left:4px;">Reset</a>
...
<h4 class="text-center"><b>TIER 1 USERS</b></h4>
...
$enddate=$_POST['date2'];
$getAllTierCommission = $u->getAllTier1CommissionsFilter(implode(',',$tierIds),$startdate,$enddate);
}
else{
$getAllTierCommission = $u->getAllTier1Commissions(implode(',',$tierIds));

}
$total=0;
$totalSales=0;
if($getAllTierCommission){
...
?>
<tr>
<td><a href="tier2.php?id=<?php echo $row1['idspUser'];?>"><?php echo $row1['spUserName']; ?></a></td>
