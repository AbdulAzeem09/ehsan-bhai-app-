...
.f1
{
    ...
    font-size:25px!important;
            ...
            <div class="content">
                <div class="col-md-12 ">
                    ...
                    <form action="minsert.php" method="POST" enctype="multipart/form-data" class="f1">
                        <label for="Student_name">student name
                            <span id="nameerror" style="color:red;">*</span>
                        </label>
                        <input type="text" id="name" name="sname" placeholder="enter the student name" maxlength="25" class="form-control">
                        ...
                        <input type="email" id="email" name="semail" placeholder="enter the student email id" maxlength="25" class="form-control">
                        <label for="Student_name">student email password
                            <span id="passerror" style="color:red;">*</span>
                        </label>
                        <input type="password" id="password" name="spassword" placeholder="enter the student email password" maxlength="50" class="form-control">
                        <label for="Student_name">student mobile number
                            <span id="moberror" style="color:red;">*</span>
                        </label>
                        <input type="number" id="mob" name="smob" placeholder="enter the student mobile number" maxlength="50" class="form-control">
                        ...
                        <input type="text" name="saddress" maxlength="80" class="form-control"/>
                        <label for="Student_name">student state name
                            <span id="imagerror" style="color:red;">*</span>
                        </label>
                        <select name="sstate" id="" class="form-control"/>
                        ...
                        <input type="date" name="sbirth" id="" class="form-control"/>
                        <label for="">student monthly salary
                            <span style="color:red">*</span>
                        </label>

                        
                        <input type="money" name="ssalary" class="form-control" id=""/>
                        ...
                        <button type="sumbit" id="msumbit" class="btn btn-success form-control" style="margin-top:23px!important;">sumbit</button>
                    </form>
                </div>
                </div>
            </div>
    ...
    <table class="table mt-10">
        <thead class="t2 text-success bg-light fs-4 fw-bold mt-4">
            <tr>
                <th>Id</th>
                <th>Name</th>
                <th>lName</th>
        ...
        <tbody class="t1 text-success fs-0.5 fw-bold bg-light">
            <?php
            $kk = new _timelineflag;
            $display = $kk->mjkhg();
            ...
            // $show_p = $p->read11();
            // //print_r($show_p);
            // while($result = mysqli_fetch_assoc($show_p))
            ...
            // {
                ...
                <td ><a href="deletemukesh.php?sid=<?php echo $result['eid']; ?>" class="btn btn-danger">Delete</a></td>
                <td ><a href="updatemukesh.php?mid=<?php echo $result['eid']; ?>" class="btn btn-success">Update</a></td>
             </tr>
