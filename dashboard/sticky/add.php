...
<label>Title</label>
<input type="text" class="form-control" name="spStickyTitle" placeholder="Enter Title" required="" />
</div>
<div class="form-group">
...
<textarea name="spStickyDes" id="spPostingNotes" style="height: 135px; width:100%; display:none;" required><?php echo $ePostNotes ?></textarea>
...
<input type="submit" name="btnAdd" value="Save Note" class="btn btn-success btn-border-radius">
</form>
</div>
</div>
