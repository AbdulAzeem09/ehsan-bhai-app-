...
<html lang="en">
    <head>
        ...
        <script src="<?php echo $BaseUrl; ?>/home.js"></script>
...
$wt = new _spwithdraw;
           ...
           <div id="withdraw_eventfield" class="row" style="margin-top: 90px;" >
            ...
            <form action="add_withdraw.php" method="post" id="Withdarwform">
                ...
                <input type="number" class="form-control" name="withdraw_amount" min="0" min="5"
                 onkeyup="this.value = minmaxnew(this.value)" id="Withdarw_ammount">
