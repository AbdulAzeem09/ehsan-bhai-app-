                    ...
                    <div class="col-md-10 no_pad_left">
                        <div class="rightContent">
                            <div class="row text-center">
                                <h2>My Earnings - Videos Module</h2>
                            </div>
                            <?php
                            $u = new _spuser;
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped " class="table table-striped table-bordered dashServ display" id="example">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $result = $pw->read_videos($_SESSION['uid']);
                                                            //print_r($result);
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="" method="post">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="hidden" name="store" value="Video">
                                                                    <label for="spBankusername" class="control-label">Amout<span class="red">*</span></label>
                                                                    <input type="number" class="form-control" min="50" max="<?php if ($amount3) {
                                                                                                                                echo $amount3;
                                                                                                                            } else {
                                                                                                                                echo $amount1;
