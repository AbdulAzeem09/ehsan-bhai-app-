					...
					<div class="col-md-10 ">
						<div class="rightContent">
							...
							<div class="row text-center">
								<h2>My Earnings - Store Module</h2>
							</div>
							<?php 
							$u = new _spuser;
...
<div class="content">
	<div class="row">
		...
		<?php $sp= new _spuser;
		$sp1= $sp->readdatabybuyerid($_SESSION['uid']);
		if($sp1!=false){
			$id=mysqli_fetch_array($sp1);
			$idspuser=$id['is_phone_verify'];
		}
		if($idspuser==1){
...
$sp= new _spuser;
$result_1 = $sp->readcurrency($_SESSION['uid']);

if($result_1!=false){ 

	while($row_n=mysqli_fetch_assoc($result_1)){
