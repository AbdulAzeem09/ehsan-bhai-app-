...
<h2>My Earnings - Training Module</h2>
</div>
<?php 
$u = new _spuser;
...
<div class="inner">
<h3><?php  if($amount10 > 0 ){ echo $currency.' '.$amount10; }else{ echo $currency.' '.'0' ; } ?></h3>
</div>
...
<div class="small-box bg_events">
<div class="inner">
<h3><?php $amut=0;  if($amount20){  echo $currency.' '.$amount20; } else { echo $currency.' '.$amut;} ?></h3>
</div>
...
<div class="small-box bg_events">
<div class="inner">
<h3><?php  if($amount30) {echo $currency.' '.$amount30; } else {  echo $currency.' '.'0'; }
...
<h4 style="font-weight:bolder; color:black;">TOTAL AMOUNT LEFT</a>
</div>
</div>
</div>
...
<td class="text-center "><span class="smalldot"><?php echo $curr.' '.$r1['amount']; ?></span></td>
<td   class="text-center "><span class="smalldot"><?php echo $r1['balanceTransaction']; ?></span></td>
<td class="text-center "><span class="smalldot"><?php echo $r1['date_txn']; ?></span></td>
<!-- <td class="tchext-center">
<?php echo "<img src='/dashboard/portfolio/image/".$r1['spImg']."' alt='image' width='40' height='40' />";?>
...
<input class="form-control" type="number" min="50" max="<?php if($amount30) {echo $amount30; } else {  echo $amount10; }?>" placeholder="Minimum 50 - Maximum <?php if($amount30) {echo $amount30; } else {  echo $amount10; }?>" name="amount" required>
</div></div><br>	   
<?php
$uid = $_SESSION['uid'];
$b = new _spbankdetail;
