...
<h2>My Earnings - Group Event Module</h2>
</div>
<?php 
$u = new _spuser;
...
// die("------------");
$result = $pw->read_group_event_wallet($_SESSION['uid']);
...
<input type="hidden" name="groupevent" value="groupevent"> 
