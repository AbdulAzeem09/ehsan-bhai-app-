...
<h2>My Earnings - Real Estate Module</h2>
</div>
...
<!-- <a href="https://dev.thesharepage.com/dashboard/finance/realEstate_wallet.php">Lifetime Sale </a-->
...
<div class="col-md-8">
<input type="hidden" name="store" value="realEstate">
<label for="spBankusername" class="control-label">Amount<span class="red">*</span></label>
<input type="number" class="form-control" min="50" max="<?php if($amount3) {echo $amount3; } else {  echo  $amount1; } ?>" placeholder="Minimum 50 - Maximum <?php if($amount3) {echo $amount3; } else {  echo  $amount1; } ?>" name="amount" required></div></div><br>												
<?php
$uid = $_SESSION['uid'];
$b = new _spbankdetail;
$data = $b->read($uid);
