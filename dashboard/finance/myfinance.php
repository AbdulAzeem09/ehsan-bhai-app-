...
$oid= $oi->readid($_SESSION['uid']);
	...
	?>
                                            ...
                                            <!-- ./col -->
                                             ...
                                             <div class="col-md-2">
                                                ...
                                                <div class="small-box" style="background-color: #90EE90;border-radius: 20px;">
                                                    <div class="inner">
    <h3>$<?php echo $amount1;// if($total_storebalance > 0 ){ echo $total_storebalance; }else{ echo "0" ; //}
		...
		?></h3>
                                                    ...
                                                    <a href="<?php echo $BaseUrl.'/dashboard/finance/store_wallet.php';?>" class="small-box-footer" style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;" >Store </a>
                                                </div>
                                            </div><!-- ./col -->
  ...
  // die("+++++++++");
                                                ...
                                                <div class="small-box" style="background-color: #90EE90;border-radius: 20px;">
                                                    <div class="inner">
												<h3>$<?php  if($amountart > 0 ){ echo $amountart; }else{ echo "0" ; } ?></h3>
                                                    ...
                                                    <a href="/dashboard/finance/artandcraft.php" class="small-box-footer" style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;" >ArtAndCraft </a>
                                                </div>
                                            </div>
...
$oid= $pw->readid($_SESSION['uid']);
	...
	?>
                                            ...
                                            <!-- ./col -->
                                             ...
                                             <div class="col-md-2">
                                                ...
                                                <div class="small-box" style="background-color: #90EE90;border-radius: 20px;">
                                                    <div class="inner">
    <h3>$<?php echo $amount2;// if($total_storebalance > 0 ){ echo $total_storebalance; }else{ echo "0" ; //}
		
		?></h3>
                                                     
													   <p style="font-size: 10px;">RealEstate Total Earning </p>
                                                    </div>
                                                    <div class="icon">
                                                      <i class="fa fa-dollar"></i>
                                                    </div>
                                                    <a href="<?php echo $BaseUrl.'/dashboard/finance/realEstate_wallet.php';?>" class="small-box-footer" style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;" >Real Estate</a>
                                                </div>
                                            </div>
    ...
    <h3>$<?php echo $amount2;// if($total_storebalance > 0 ){ echo $total_storebalance; }else{ echo "0" ; //}
		...
		?></h3>
													   ...
													   <p style="font-size: 10px;">Videos Total Earning </p>
                                                    </div>
                                                    <div class="icon">
                                                      <i class="fa fa-dollar"></i>
                                                    </div>
                                                    <a href="<?php echo $BaseUrl.'/dashboard/finance/videos_wallet.php';?>" class="small-box-footer" style="border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;" >Videos</a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="box box-info">
                                                        <div class="box-header with-border">
                                                            <h3 class="box-title">MY FINANCES</h3>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="table-responsive">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td><a href="<?php echo $BaseUrl.'/dashboard/finance/finance.php'; ?>">My Finance</a></td>
                                                                            <td><span class="label label-info"><?php echo $job_totalActive; ?></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><a href="<?php echo $BaseUrl.'/dashboard/BankDetails'; ?>">My Bank Details</a></td>
                                                                            <td><span class="label label-info"><?php echo $job_totExpPost; ?></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><a href="<?php echo $BaseUrl.'/dashboard/currency'; ?>">Currency</a></td>
                                                                            <td><span class="label label-danger"><?php echo $job_totalDraft; ?></span></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><a href="<?php echo $BaseUrl.'/dashboard/WithdrawRequest'; ?>">My Withdraw</a></td>
