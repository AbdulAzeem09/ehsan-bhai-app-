...
if($_POST['phoneotp'] == $_SESSION['loginphotp'])
{
    
    $res = $u->checkuseiotp($_SESSION['loginphotpuser']);
...
unset($_SESSION['loginphotp']);
unset($_SESSION['solidphotp']);
unset($_SESSION['phonesend']);
unset($_SESSION['loginphotpuser']);
