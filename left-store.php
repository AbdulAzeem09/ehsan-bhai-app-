    ...
    <?php if(isset($_GET['userid']) && $_GET['userid'] > 0){ ?>
     ...
     <?php  }else{?>
        <?php if($profileType != '2' && $profileType != '5') { ?>
         <a href="<?php echo $BaseUrl?>/post-ad/sell/?post" class="btn store_search_btn db_btn db_orangebtn sell" style="margin-right: 5px;padding: 6px;width: auto;background-color:#2ba805!important;padding: 8px 33px!important; margin-top:-45px; height: 35px;">Sell Product</a>
        <?php  }?>
...
<style>
    ...
    color:#00FF00;
      ...
      <a class="success  <?php if($_GET['condition'] == "All"){echo "active"; }?>" href="<?php echo $BaseUrl.'/'.$folder.'/view-all.php?condition='.$rows["masterDetails"]."&folder=".$storeFolder.'&page=1';?>"><i class="fa fa-caret-right" aria-hidden="true"></i> <?php echo $rows["masterDetails"];?></a></li>
      ...
      <a class="success <?php if($_GET['condition'] == $rows['masterDetails']){echo "active"; }?>" href="<?php echo $BaseUrl.'/'.$folder.'/view-all.php?condition='.$rows["masterDetails"]."&folder=".$storeFolder.'&page=1';?> "><i  class="fa fa-caret-right "  aria-hidden="true"></i>  <?php echo $rows["masterDetails"];?> </a></li><?php
