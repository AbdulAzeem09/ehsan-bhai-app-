...
?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="panel messages-panel2 m_top_15">
                ...
                <div class="contacts-list">
                    ...
                    <div class="row" style="margin-left:10px">
                        ...
                        <span><img src="<?php echo $spall['spProfilePic']; ?>"
                                style="height:50px;width:50px;border-radius:50%" 111>
                        ...
                        <span><img src="<?php echo $BaseUrl . '/assets/images/icon/blank-img.png'; ?>"
                                style="height:50px;width:50px;border-radius:50%" 111>
...
?>
                            ...
                            <p href="JavaScript:void(0)" class="dropdown-toggle" data-toggle="dropdown"
                                style=" white-space: nowrap; width: 140px; overflow: hidden; text-overflow: ellipsis; width:145px;margin-left: 55px;margin-top: -40px; color:blue;"
                                data-toggle="tooltip" data-placement="bottom"
                                title="<?php echo ucwords(strtolower($_SESSION['MyProfileName'])); ?>">
                                <?php echo (isset($_SESSION['MyProfileName']) ? substr(ucwords(strtolower($_SESSION['MyProfileName'])), 0, 20) : "Profile "); ?>&nbsp;<?php if ($spall['chat_status'] == '1') { ?>

                                <span style="margin-left:-4px"><i class="fa fa-circle" aria-hidden="true"
...
?>
                                ...
                                <span style="margin-left:-4px"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#f60; font-size:12px;"></i></span>
...
?>
                                ...
                                <li class="<?php echo ($_SESSION['pid'] == $row['idspProfiles']) ? 'active' : ''; ?>"
                                    ...
                                    <a class="sp-user-profile-label headProfile"
                                        style="line-height: 15px; padding-top:10px;  padding-bottom:5px;padding-left:5px;"
                                        href="javascript:void(0)" data-profileid='<?php echo $row['idspProfiles']; ?>'>
...
?>
                                        ...
                                        <img src="<?php echo $BaseUrl . '/img/noman.png' ?>"
                                            style="height:30px; width:30px;float:left" alt=""
...
?>
                        ...
                        <span class="dropdown">
                            ...
                            <span class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                ...
                                <i class="fa fa-gear footer_item" id="settin" onclick="chngecolor()"
                                    style="color:black; float: right;margin-top: -46px;margin-right: 25px; padding-left:12px"></i></span>
...
echo 'class="actives"';
                        ...
                        <a href="#" data-toggle="modal" data-target="#composeNewTxt"> <span><i
                                    class="fa fa-envelope footer_item"
                                    style="padding-right:12px; float: right;margin-top: -46px;margin-right: 72px; padding-top:13px;"></i></a>

                        </span>

                    </div>

                    <div class="inbox-categories" hidden>
                                    ...
                                    <div class="modal-content no-radius sharestorepos">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"><i style="color: #428bca"
                                                        class="fa fa-pencil"></i> Compose Message</h4>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>Select User<span class="red">* <span
                                                                class="error_user"></span></span></label>
                                                    <select class="form-control form-select data_selsect"
                                                        name="txtReceiver" id="txtReceiver">
...
?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="spfriendChattingMessage"
                                                        id="friendMessage" required=""></textarea>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary composTxtNow"
                                                    style="border-radius: 2 !important" id="composTxtNow1"
                                                    data-dismiss="modal">Send Message <i class='fa fa-paper-plane'
                                                        aria-hidden='true'></i></button>

                                                <!-- <input type="button" class="btn btn-primary composTxtNow" id="composTxtNow1" name="" value="Send Message <i class='fa fa-paper-plane' aria-hidden='true'></i>" data-dismiss="modal"> -->
                            ...
                            * {
                            ...
                            <div class="row m_top_10" style="margin:-9px;">
                                <!--div>   
<select name="message" id="select1">
...
<option value="4">Trash</option>
                                ...
                                <div class="col-sm-12 zoom d-none" data-toggle="modal" data-target="#composeNewTxt"
...
if ((($res) || ($res1)) != false) {  ?>
                                    ...
                                    <div class="topstatus"
                                        style="border-bottom: 1px solid #CCC;padding: 4px 12px;background: navy;color: white;">

                                        <?php if ($_SESSION['guet_yes'] != 'yes') { ?>

                                        <div class="createbox composeTxt">

                                            <span><label style=" margin-bottom: 1px;"><i class="fa fa-envelope"></i>
                            ...
                            <form method="GET" action=""
                                class="panel-search-form info form-group has-feedback no-margin-bottom"
                                style="display: inline-flex; padding: 5px 20px;">

                                <input type="text" class="form-control" name="search" placeholder="Search" id="myInput"
                                    style="margin-left:-15px;" value="<?php echo $_GET['search']; ?>" />

                                <button type="submit" name="filter" style="border: none;"><span class="fa fa-search"
                                        style="padding: 4px;"></span></button>

                            </form>

                            <div class="contacts-outter" style="z-index: 0;">
...
$filter = $_GET['search'];
if ($filter) {
$result3 = $p->read9($row2["spprofiles_idspProfilesReciver"], $filter);                                                                  //print_r($result);                                                               //die();
}
...
?>
                                                ...
                                                <input type="hidden" value="<?php echo $row["spProfilePic"]; ?>"
                                                    id="profile_img<?php echo $row["idspProfiles"]; ?>">

                                                <?php
//  echo $row["idspProfiles"];
//  $idsProfiles = $row["idspProfiles"];

$idsProfile = $row["idspProfiles"];
// if($idsProfiles != $row["idspProfiles"]){
if (!in_array($idsProfile, $idsProfiles)) {
//  echo $receiverPid;
...
?>
                                                ...
                                                <li data-toggle="tab" class="contact-li" data-target="#inbox-message-1"
                                                    id="li1<?php echo $row["idspProfiles"]; ?>" class="active" style="margin-left: -17px;  padding-top: 20px;<?php if ($total) {
...
if ($total) { ?>
                                                    ...
                                                    <div id="readcount<?php echo $row["idspProfiles"]; ?>">
                                                        ...
                                                        <div class="message-count">
                                                            <?php echo "<span id='span1' class='badge totalunreadmsg no-radius " . ($total > 0 ? "" : "hidden") . " ' style='color:#fff;background-color:#e21313;'>" . $total . "</span>"; ?>
                                                        </div>
                                                    </div>
...
?>
                                                    ...
                                                    <div class="vcentered info-combo">
                                                        ...
                                                        <h3 class="no-margin-bottom name"><span class='frndname'>
...
echo ucwords(strtolower(substr($row['spProfileName'], 0, 10) . '...'));
}
?>
                                                            ...
                                                            <span style=""><i class="fa fa-circle" aria-hidden="true"
                                                                    style="color:green; font-size:12px;"></i></span>
...
$p2 = new _postings;
$postingDate = $p2->spPostingDate($row4['spMessageDate']);
...
?>
                                                    ...
                                                    <div class="contacts-add">
                                                        ...
                                                        <span class="message-time "
                                                            style="font-size:11px;margin-left: -16px;"><?php echo $postingDate; ?></span>
                                                ...
                                                <div>
                                                    ...
                                                    <span class="delchatmessage pull-right"
                                                        data-myid2="<?php echo $receiverPid; ?>"
                                                        data-friendid2="<?php echo $row["idspProfiles"]; ?>"><i
                                                            class="fa fa-trash-o zoom" id=""
                                                            style=" margin-top:-68px; font-size: 15px; color:red; position: absolute;"></i></span>

                                                </div>
                                                <?php
//   $idsProfiles = $row["idspProfiles"];

$idsProfiles[] = $idsProfile;
}
?>
...
?>
                        ...
                        <div id="groups" class="contacts-outter-wrapper tab-pane">
                            ...
                            <form class="panel-search-form info form-group has-feedback no-margin-bottom"
                                style="    margin-top: 11px;display: inline-flex; padding: 5px 20px;">

                                <input type="text" class="form-control" name="search" placeholder="Search"
                                    style="margin-left:-15px;" value="" />
                    ...
                    <div class="col-md-8" style="width: 73%;">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-12 " style="padding-left:0px">
                                ...
                                <div><span class="alert alert-success" id="span2"
                                        style="float: right; display: none;">Message Sent!</span> </div>
...
<form method="post" id="myform" enctype="multipart/form-data" style="display:flex;">
...
?>">
<textarea class="form-control" id="freindmessage1" name="spfriendChattingMessage" placeholder="Type your message here..." style="height: 45px;width:85%; "><?php  ?></textarea>
<span style="margin-left:10px">



<label for="upload1"><i style="font-size:24px; margin-top:7px;" class="fa">&#xf093;</i></label></span>
...
<button class="sendmessagetofriend1 btn btn-success pull-right" type="button" style="height: 37px;width: 7%; margin-left:10px"><i class="fa fa-paper-plane"></i></button>
                                    ...
                                    <div class="chat-footer " style="display:none;">
                                        ...
                                        <form method="post" id="myform" enctype="multipart/form-data"
                                            ...
                                            <input type="hidden" name="module" id="module" value="inbox">
                                            <input type="hidden" id="sender1" name="spprofiles_idspProfilesSender"
                                                value="<?php echo $_SESSION['pid']; ?>" />
                                            <input type="hidden" id="mypic" value="<?php //echo ($sender_msg_img); 
?>">
                                            <input type="hidden" id="mypic"
                                                value="../assets/images/blank-img/default-profile.png">
                                            <input type="hidden" id="mydate" value="<?php date_default_timezone_set('Asia/Kolkata');
echo date("Y-m-d H:i:s"); ?>" />
                                            <input type="hidden" id="myname" value="<?php echo 'ooooooooo'; ?>" />
                                            <input type="hidden" id="receiver1" name="spprofiles_idspProfilesReciver"
                                                value="<?php //echo $_POST["friendid"]; 
?>">
                                            <textarea class="send-message-text" id="freindmessage1"></textarea>



                                            <label class="upload-file" style="margin-bottom:8px;">
                                                <input type="file" name="file" id="upload1">
                                                <i class="fa fa-paperclip"></i>
                                            </label>
                                            <button type="button"
                                                class="send-message-button btn-info sendmessagetofriend1"><i
                                    ...
                                    <div class="col-md-1 " id="image1" style="height: 77px;padding-left: 0px;">
                                        <!--<a type="button" target="blank" id="preview_btn" class="btn_preview" href="" style="display: none;">Preview </a>-->
                                        <span id="smalldiv" style="display: none; cursor: pointer;">
                                            <span style="background: red;color: white;margin-left: 40px;"
                                                onclick="delete_play()"><b>X</b></span>
                                            <img src="" alt="" id="preview_img" width="50" height="50">
                                        </span>
                                    </div>
...
?>
    ...
    function countbadge(friend) {
        ...
        // $('.contact-li').css('background-color','#fbfcff');
        // $('.contact-li').css('color','#337ab7');

        //   $('#li1'+frid).css('background-color','rgb(45 169 233)');
        //   $('#li1'+frid).css('color','#fff');
    ...
    $(document).ready(function() {
        ...
        $("#composTxtNow1").click(function() {
            var cc = $("#txtReceiver").val();
            var aa = $("#friendMessage").val();
            if (aa == 0 || cc == 0) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["file"])) {
    ...
    $image->validateFileImageExtensions($fileArray);
    if ($validationMessage) {
        echo '<script>alert("please upload image files");</script>';
        exit;
    } else {
        $targetDirectory = "uploads/";
        $targetFile = $targetDirectory . basename($fileArray["name"]);
        move_uploaded_file($fileArray["tmp_name"], $targetFile);
...
?>
    <script>
    upload1.onchange = evt => {
        const [file] = upload1.files;
        if (file) {
    ...
    <script type="text/javascript">
    $('.data_selsect').select2({
        selectOnClose: true
    });
    </script>


    <script src="https://cdnjs.cloudflare.com/ajax/libs/emojionearea/3.4.2/emojionearea.min.js" crossorigin="anonymous"
        referrerpolicy="no-referrer"></script>

    <script>
    $('#freindmessage1').emojioneArea({
        pickerPosition: 'left'
    })
    ...
    //// message filter
    $(document).on('keyup', "#message-search", function() {
