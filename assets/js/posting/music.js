	...
	$(document).ready(function () {
		...
		$("#spPostMusic").on("click", function () {
			...
			if(idspprofile != ""){
				...
				var category = $('#musiccategory_ option:selected').val();
										...
										if(tag == ""){
											...
											$(".lbl_7").removeClass("label_error");
												...
												$.post(url, term, function (data, status) {
													...
													$.post(sendUrl+"/post-ad/music/updatelyric.php", {postid: postid, lyrics: lyrics}, function (nte) {
														//alert(nte);
													});
													...
													if(musicId > 0){
														$.post(sendUrl+"/music/updatemusic.php", {spPostings_idspPostings: postid, musicId: musicId}, function (r) {
															//alert(r);
														});
													}
													//Testing
