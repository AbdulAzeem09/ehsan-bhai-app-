...
$(function () {
            ...
            $($(this)[0].files).each(function () {
				...
				if(file[0].size <= 2097152){
					if (regex.test(file[0].name.toLowerCase())) {
						var reader = new FileReader();
						reader.onload = function (e) {
							var img = $("<div class='col-md-2 sponsorpost'><span class='fa fa-remove dynamicspimg closed'></span><img class='sponsorimg overlayImage' style='width:100%; height: 80px; margin-right:5px;' src='" + e.target.result + "'/></div>");
	...
	$(".my-group-dd").click(function () {
		var gname = "Share with: " + $(this).attr("data-gname");
		if(gname != ''){
			$("#groupTitle").html(gname);
		}
    });
...
$(document).ready(function () {
    ...
    $("#commentUploading").on("click", ".deletecmt", function () {
		...
		function(isConfirm) {
			if (isConfirm) {
				$.post(MAINURL+"/social/commentdelete.php", {commentid: cmntid}, function (data) {
					//console.log(data);
    ...
    $("#emailwith").on("click", function () {
        $.post("/publicpost/mailto.php", {profilename: $("#shareprofile").val(), postid: $("#sharedpost").val(), recipientemail: $("#recipientemail").val()}, function (data) {
            $("#mailto").modal("hide");
        });
    });
    ...
    $(".emailto").on("click", function () {
        $("#recipientemail").val("");
        $(".emaildetails").load("/publicpost/postdetails.php", {idspPostings: $(this).data("postid")}, function () {
    ...
    $(".postenquiry").on("click", function () {
        $.post("../enquiry/addenquire.php", {buyerProfileid: $("#buyerProfileid").val(), sellerProfileid: $("#sellerProfileid").val(), spPostings_idspPostings: $("#spPostings_idspPostings").val(), message: $("#message-text").val(),spmessaging_date:$("#spmessaging_date").val()}, function (data) {
        });
        $("#enqueryModal").modal('hide');
		$(".modal").modal('hide');
		//show notification on the page
		var title = '<strong>Your enquiry send successfully</strong>';
    ...
    $(".sndnotification").on("click", function () {
        var btn = this;
        $.post("/enquiry/updateconversation.php", {mid: $("#messageid").val(), receiver: $("#receiverid").val()}, function (r) {
            $.post("/enquiry/conversation.php", {spMessaging_idspMessage: $("#messageid").val(), spConversationFlag: 1, spConversation: $("#message").val(), spconversationReceiver: $("#receiverid").val()}, function (data) {
                $.post("/enquiry/updatenotification.php", {spMessaging_idspMessage: $("#messageid").val()}, function (data) {
                });
    ...
    $(".eventcalender").on("click", ".eventdate", function () {
        $(".eventcalender").load("../grouptimelines/event.php", {month: $(this).data("month"), year: $(this).data("year"), groupid: $(this).data("groupid"), flag: 1}, function () {
	...
	$(".eventDetail").on("click", function () {
        ...
        $(".addeventdetail").load("addeventdetail.php", {postid: postid, pid: pid, intrest: intrest}, function (data) {
    ...
    $(".joinevent").on("click", function () {
        var btn = this;
        $.post("/cart/addorder.php", {spByuerProfileId: $(this).data("profileid"), spSellerProfileId: $(this).data("seller"), spOrderStatus: 0, spOrderQty: 1, sporderAmount: 0, spOrderAdid_: $(this).data("postid")}, function (r) {
        });
    ...
    $(".sp-group-details").on("click", "#editgrp", function () {
        ...
        $(".groupfield").load("../my-groups/grpupfield.php", {gid: $(this).data("groupid")}, function () {
    ...
    $(".commentstatus").on("click", ".hidecomment", function () {
        var btn = this;
        $.post("hidecomment.php", {postid: $(this).data("postid")}, function (r) {
    ...
    $(".commentstatus").on("click", ".allowcomment", function () {
        var btn = this;
        $.post("allowcomment.php", {postid: $(this).data("postid")}, function (r) {
    ...
    $(".sp-profile-det").on("blur", "#storeName", function () {
        $.post("/my-profile/checkstore.php", {storename: $("#storeName").val()}, function (r) {
            if (r == " Try")
            {
    ...
    $("#saveplylist").on("click", function () {
        ...
        $.post("editplaylist.php", {idspPostingAlbum: $("#palylistalbumid").val(), spPostingAlbumName: $("#spAlbumName").val(), spPostingAlbumDescription: $("#spAlbumDescription").val()}, function (r) {
        });
        //Testing 
    ...
    $(".editalbm").on("click", function () {
        ...
        $(".albumdet").load("albumdetails.php", {albumid: $(this).data("albumid")}, function (r) {
        });
    });
    ...
    $(".deletealbm").on("click", function () {
        ...
        {
            $.post("deletealbum.php", {albumid: $(this).data("albumid")}, function (r) {
    ...
    $(".sp-profile-det").on("click", ".publish", function () {
        $.post("/my-profile/published.php", {profileid: $(this).data("profileid")}, function (r) {
    ...
    $(".sp-profile-det").on("click", ".conceal", function () {
        $.post("/my-profile/conceal.php", {profileid: $(this).data("profileid")}, function (r) {
    ...
    $(".social").on("click", ".deleteitem", function (event) {
        ...
        $.post("/myjobboard/deleteresume.php", {mediaid: $(this).data("mid")}, function (r) {
            //alert(r);
        });
    });
    ...
    $(".loadmyplayer").on("click", ".playlistitem", function () {
        $(".video").html("loading...");
        $(".video").load("media.php", {postid: $(this).data("postid")}, function () {
        });
    });
    ...
    $(".myplaylist").on("click", ".playlistdd", function () {
        ...
        $(".playlistitm").load("albumplayer.php", {albumid: $(this).data("albumid")}, function () {
        });
    });
    ...
    $(".social").on("click", ".playlist", function (event) {
        ...
        $.post("../../post-ad/addmedia.php", {spPostings_idspPostings: $(this).data("postid"), spPostingMedia: base64image, ext: ext, spPostingAlbum_idspPostingAlbum: $(this).data("albumid")}, function (r) {
            //alert(r);
        });
    });
            ...
            $(".media-file-data").each(function (i, e)
            {
                ...
                $.post("../myjobboard/addgroupfile.php", {txtFolerName: txtFolerName, txtFoldTitle:txtFoldTitle, spPostingMedia: base64image, ext: ext, mediatitle: $("#mediatitle").val(), profileid: $(".dynamic-pid").val(), filename: $("#adddocument").val(), groupid: $("#grpid").val()}, function (r) {
                    ...
                    $.post('../grouptimelines/priviewfile.php', {mediaid: mediaid}, function (response) {
                        ...
                        $('.table > tbody:last').append("<tr class='resumeoperation'><td width='72%' data-toggle='modal' data-target='#previewfile' data-src='https://dev.thesharepage.com/resume/" + previewfile.trim() + "' class='preview'><a href='#'>" + $("#mediatitle").val() + "</a></td><td width='10%'><b>" + $(".dynamic-profilename").val() + "</b></td><td width='10%'>" + d + " " + time.getHours() + ":" + time.getMinutes() + "</td><td width='2%'><a href='https://dev.thesharepage.com/resume/" + previewfile.trim() + "'  ata-toggle='tooltip' data-placement='left' title='Download'><span class='glyphicon glyphicon-download'  ></span></a></td><td width='6%'><button type='button' class='btn btn-link deleteresume' data-mediaid='" + mediaid + "'><span class='glyphicon glyphicon-trash'></span> Delete</td></tr>");
    ...
    $("#adminlogin").on("click", function () {
        $.post('../authentication/adminlogin.php', {spUserName: $("#usrname").val(), spUserPassword: $("#usrpassword").val()}, function (data) {
            $("#usrpassword").val("")
            $("#usrname").val("")
            if (data == " /admin/buy/")
	...
	$(".composTxtNow").on("click", function (){
		...
		if(isvalid == true){
			...
			$.post(MAINURL+'/friendmessage/sendmessage.php', {spfriendChattingMessage: $("#friendMessage").val(), spprofiles_idspProfilesReciver: $("#txtReceiver").val(), spprofiles_idspProfilesSender: $("#txtSender").val()}, function (data) {
    ...
    {
        var btn = this;
        $.post('../friendmessage/sendmessage.php', {spfriendChattingMessage: $("#sndmsg").val(), spprofiles_idspProfilesReciver: $(btn).attr("data-reciver"), spprofiles_idspProfilesSender: $(btn).attr("data-sender")}, function (data) {
    ...
    $(".myfriend").on("click", ".readmessage", function () {
        var btn = this;
        $.post("/friendmessage/read.php", {messageid: $(this).data("mid")}, function (r) {
    ...
    $(".loadmyplayer").on("click", ".delitemlist", function () {
        var btn = this;
        if (confirm("Are you sure you want to Delete ?")) {
            $.post("/myjobboard/deleteresume.php", {mediaid: $(this).data("mediaid")}, function (r) {
    ...
    $(".loadmyplayer").on("click", ".autoplay", function () {
        ...
        {
            $(".video").load("music.php", {postid: $(this).data("postid")}, function () {
    ...
    $(".rselection").on("click", ".resumeselect", function () {
        var btn = this;
        $.post("/my-activity/selectedprofile.php", {resumeid: $(this).data("resumeid"), postid: $(this).data("postid"), profileid: $(this).data("profileid")}, function (r) {
            $(btn).css({"color": "#ea7831"});
    ...
    $(".rselection").on("click", ".deselect", function () {
        var btn = this;
        $.post("/my-activity/cancelselect.php", {resumeid: $(this).data("resumeid"), postid: $(this).data("postid"), profileid: $(this).data("profileid")}, function (r) {
            $(btn).css({"color": "gray"});
    ...
    $(".savemembership").on("click", function () {
        $(".membershipdetail").each(function (i, e)
        {
            ...
            $.post("/membership/updatedetails.php", {mid: membershipid, mname: mname, mlimit: mlimit, mduration: mduration, mamount: mamount}, function (r) {
                swal({
    ...
    $(".previewdoc").on("click", ".preview", function () {
        ...
        $('.resumeid.embed').gdocsViewer({height: $(window).height() * 0.9, width: '100%'});
    });
    ...
    $(".table").on("click", ".deleteresume", function () {
        ...
        if (confirm("Are you sure you want to Delete?")) {
            ...
            $.post(MAINURL+"/job-board/dashboard/deleteresume.php", {mediaid: $(this).data("mediaid")}, function (r) {
    ...
    $(".jobseeker").on("click", ".addresume", function () {
        if ($("#adddocument").val() != "" && $("#mediatitle").val() != ""){
            $(".media-file-data").each(function (i, e){
                ...
                var arr = base64image.match(/data:[a-zA-Z0-9 -/]+;/);
                var ext = arr[0].replace("data:", "");
                $.post(MAINURL+"/job-board/dashboard/addresume.php", {spPostingMedia: base64image, ext: ext, mediatitle: $("#mediatitle").val(), profileid: $("#jobseekerpr").val(), filename: $("#adddocument").val()}, function (data) {
                    var mediaid = data;
                    $("#nwresume").modal('hide');
					window.location.reload();
                });
    ...
    $(".information").on("click", ".uploadresume", function () {
        ...
        if ($("#adddocument").val() != "" && $("#mediatitle").val() != "")
        {
            $(".media-file-data").each(function (i, e)
            {
                ...
                var arr = base64image.match(/data:[a-zA-Z0-9 -/]+;/);
                var ext = arr[0].replace("data:", "");
                $.post("../myjobboard/addresume.php", {spPostingMedia: base64image, ext: ext, mediatitle: $("#mediatitle").val(), profileid: $("#jobseekerpr").val(), filename: $("#adddocument").val()}, function (data) {
                    var mediaid = data;
    ...
    $(".information").one("click", ".updateresume", function () {
        $(".media-file-data").each(function (i, e)
        {
            ...
            var arr = base64image.match(/data:[a-zA-Z0-9 -/]+;/);
            var ext = arr[0].replace("data:", "");
            $.post("../myjobboard/addresume.php", {spPostingMedia: base64image, ext: ext, mediatitle: $("#mediatitle").val(), mediaid: $("#mediaid").val()}, function (r) {
                $("#nwresume").modal('hide');
            });
            //location.reload();
        });
    ...
    $(".years").on("click", function () {
        $.get("/authentication/updateprofile.php", {year: $(this).text(), monthtext: $("#monthdet").text(), monthvalue: $("#monthdet").data("monthval")}, function (r) {
        });
    });


    $(".mnth").on("click", function () {
        $.get("/authentication/updateprofile.php", {monthtext: $(this).text(), monthvalue: $(this).data("month"), year: $("#currentyear").text()}, function (r) {
        });
    });
    ...
    $(".sp-profile-det").on("click", ".deactivate", function () {
        ...
        {
            $.post("../my-profile/deactivate.php", {profileid: $(this).data("profileid")}, function () {
    ...
    $(".sp-profile-det").on("click", ".activate", function () { //Activate account
        ...
        {
            $.post("../my-profile/activateaccount.php", {profileid: $(this).data("profileid")}, function () {
    ...
    $(".friendchatsystem").on("click", ".sendas", function () {
        ...
        $(".chattingsystem").load("../friendmessage/messaging.php", {friendid: $(this).data("friendid"), myid: $(this).data("myid"), myname: $(this).text()}, function () {
    ...
    $("#submitpost").on("click", function () {
        $.post("../post-ad/updatevisibility.php", {postid: $(this).data("postid"), visibility: $(this).data("visibility")}, function () {
    ...
    //Save in Draft
    var postedit = false;
    $("#spSaveDraft").one("click", function () {
            ...
            if (idspprofile != "")
            {
                ...
                $.post(url, term, function (data, status) {
                    ...
                    $.each(inputs, function (i, val) {
                        $.post("https://dev.thesharepage.com/post-ad/addpostcustomfields.php", val, function (response) {
                            //alert(response);
                        });
                    });
					...
					if(pageEvent == 1){
						...
						//add feature profile
						$.post("https://dev.thesharepage.com/post-ad/addpostcustomfieldsfeature.php",{Accessids:Accessids,postid:postid,postedit:postedit}, function (re) {
						...
						//console.log(spon);
						$.post("https://dev.thesharepage.com/post-ad/addsponsor.php",{spon:spon,postid:postid,postedit:postedit}, function (re) {
							//alert(re);
						});
						//======add co-host========
						var cohost = "";
						...
						//console.log(cohost);
						$.post("https://dev.thesharepage.com/post-ad/addcohost.php",{cohost:cohost,postid:postid,postedit:postedit}, function (cohost) {
					...
					$(".postingimg").each(function (i, e){
						...
						ext = ext.replace(";", "");
						$.post("https://dev.thesharepage.com/post-ad/addpostingpic.php", {spPostings_idspPostings: postid, spPostingPic: base64image, ext: ext, spFeatureimg:spFeatureimg, postedit:postedit}, function (r) {
							//alert(r);
							//Timeline prepending
							if (i == imgCount - 1) {
								$.get("https://dev.thesharepage.com/publicpost/timelineentry.php", {js: "1", timelineid: postid, grouptimeline: $(btn).data("grouptimeline")}, function (r) {
                    ...
                    $.notify({
                        ...
                        icon: 'fa fa-info',
                        message: "<a href='../../my-posts/?flag&viewdraft=check'>View your draft </a>"
                    },{
                        type: 'success',
                        animate: {
                            enter: 'animated fadeInUp',
    ...
    $(".join_timeline_main").on("click", "#addmemontimeline", function () {
        $("#addmemontimeline").each(function (i, e) {
            ...
            $.post("../my-groups/addmember.php", {spProfiles_idspProfiles: pid, spGroup_idspGroup: gid, spProfileIsAdmin: 1, spApproveRegect: 1, spGroup_newMember_Date: today}, function (r) {
                location.reload();
    ...
    $(".sp-group-details").on("click", "#addcheckeditem", function () {
        $(".chekedfriend").each(function (i, e) {
            ...
            $.post("addmember.php", {spProfiles_idspProfiles: $(e).data("pid"), spGroup_idspGroup: $(e).data("gid"), spProfileIsAdmin: 1, spApproveRegect: 1, spGroup_newMember_Date: today}, function (r) {
    ...
    $(".sp-group-details").on("click", ".unblockMember", function () {
        ...
        {
            $.post("/public-group/unblockmember.php", {pid: $(btn).data("profileid"), gid: $(btn).data("gid")}, function (r)
            {
                $(btn).text("Block");
        ...
        {
            $.post("../friends/unblockmember.php", {profileid: $(btn).data("profileid")}, function (response) {
                $(btn).text("Block");
                $(btn).removeClass("unblockMember").addClass("blockMember");
            });
        }
    ...
    $(".sp-group-details").on("click", ".blockMember", function () {
        ...
        if ($(btn).data("flag") == 1)//For Group
        {
            $.post("/public-group/blockMember.php", {pid: $(btn).data("profileid"), gid: $(btn).data("gid")}, function (r)
            {
                $(btn).text("Unblock");
        ...
        {
            $.post("../friends/blockmember.php", {profileid: $(btn).data("profileid")}, function (response) {
                $(btn).text("Unblock");
                $(btn).removeClass("blockMember").addClass("unblockMember");
            });
        }
    ...
    $(".friendchatsystem").on("click", ".unread", function () {//unreadMessage
        $(".myfriends").removeClass("active");
        var btn = this;
        $.post("/friendmessage/unread.php", {messageid: $(this).data("mid")}, function (r) {
    ...
    $(".friendchatsystem").on("click", ".archive", function () {//Archive friend Message
        var btn = this;
        $.post("../friendmessage/archive.php", {messageid: $(this).data("messageid"), profileid: $(this).data("profileid")}, function (r) {
    ...
    $(".friendchatsystem").on("click", ".unarchive", function () {//unrchive friend Message
        var btn = this;
        $.post("../friendmessage/unsetarchive.php", {messageid: $(this).data("messageid"), profileid: $(this).data("profileid")}, function (r) {
            $(btn).css("color", "green");
    ...
    $(".friendchatsystem").on("click", ".deletemessage", function () {//Delete friend Message
        ...
        {
            var btn = this;
            $.post("../friendmessage/deletemessage.php", {messageid: $(this).data("messageid"), profileid: $(this).data("profileid")}, function (r) {
                $(btn).closest(".message").html("");
            });
        }
    });
    ...
    $(".friendchatsystem").on("click", ".starred", function () { //Starred friend Message
        var btn = this;
        $.post("../friendmessage/starred.php", {messageid: $(this).data("messageid"), profileid: $(this).data("profileid")}, function (r) {
            $(btn).css("color", "yellow");
            $(btn).removeClass('starred').addClass('unstarred');
        });
    });
    ...
    $(".friendchatsystem").on("click", ".unstarred", function () { //Unstarred
        var btn = this;
        $.post("../friendmessage/unsetstarred.php", {messageid: $(this).data("messageid"), profileid: $(this).data("profileid")}, function (r) {
            $(btn).css("color", "green");
            $(btn).removeClass('unstarred').addClass('starred');
        });
    });
    ...
    $(".sp-group-details").on("click", ".gruoprej", function () {
        if (confirm("Are you sure you want to reject request ?")) {
            var btn = this;
            $.post("/public-group/rejectrequest.php", {gid: $(this).data("gid"), pid: $(this).data("pid")}, function (r) {
    ...
    $(".sp-group-details").on("click", ".gruopap", function () {
        var btn = this;
        $.post("/public-group/acceptrequest.php", {gid: $(this).data("gid"), pid: $(this).data("pid")}, function (r) {
            alert(r);
    ...
    $(".joingroup").on("click", function () {
        var btn = this;
        $.post("/public-group/sendrequest.php", {gid: $(this).data("gid"), pid: $(this).data("pid")}, function (r) {
    ...
    $(".closed").on("click", function () {
        var btn = this;
        $.post("https://dev.thesharepage.com/post-ad/deletepic.php", {postingpic: $(this).data("pic")}, function (r) {
    ...
    $(".deletereview").on("click", function () {
        if (confirm("Are you sure you want to Delete your Review ?")) {
            $.post("/customer_reviews/deletereview.php", {profieid: $(this).data("profileid"), postid: $(this).data("postid"), reiviewid: $(this).data("reviewid")}, function (r) {
                location.reload();
            });
        }
    });
    ...
    $(".sp-profile-det").on("click", ".editprofile", function () {
        var btn = this;
        $(".sp-profile-det").load("profilefield.php", {ptid: $(btn).data("ptid"), pid: $(btn).data("pid"), ptype: $(btn).data("profiletype")}, function (response) {
            ...
            if ($(btn).data("ptid") == 1){
                ...
                $("#profilefield").load("bussiness.php", {pid: $(btn).data("pid")}, function (respone) {
            ...
            if ($(btn).data("ptid") == 2)
            {
                $("#profilefield").load("freelancer.php", {pid: $(btn).data("pid")}, function (respone) {
            ...
            if ($(btn).data("ptid") == 3)
            {
                $("#profilefield").load("entertainment.php", {pid: $(btn).data("pid")}, function (respone) {
            ...
            if ($(btn).data("ptid") == 5)
            {
                $("#profilefield").load("jobseeker.php", {pid: $(btn).data("pid")}, function (respone) {

                });
            }
            if ($(btn).data("ptid") == 6)
            {
                $("#profilefield").load("dating.php", {pid: $(btn).data("pid")}, function (respone) {
    ...
    function isvalidprofilefield(){
		var protitle = $("#spProfileName").val();
		var proemail = $("#spProfileEmail").val();
		var prophone = $("#spProfilePhone").val();
		var protype = $("#ptypeid").val();
		var country = $('#spProfilesCountry option:selected').val();
		var state = $('#spProfilesState option:selected').val();
		var spProfilePostalCode = $("#spProfilePostalCode").val();
		...
		if(proemail.trim() == ""){
			...
			var isvalidemail = IsEmail(proemail);
			if(isvalidemail == false){
				$(".lbl_3").html("Enter correct email");
				isvalid = false;
			}else{
				$(".lbl_3").html("");
			}
		...
		// ===CHEK WHICH PROFILE TYPE
		var type = 0;
		var isallfield = true;

		if(protype == 1){
			var cmpName = $("#companyname_").val();
			var skill = $("#skill_").val();
			var companyEmail = $("#companyEmail_").val();
			var companyPhoneNo = $("#companyPhoneNo_").val();
			var businesscategory = $("#businesscategory_").val();
			var companytagline = $("#companytagline_").val();
			var companyProductService = $("#companyProductService_").val();
			var spProfileAbout = $("#spProfileAbout").val();
			var companyaddress = $("#companyaddress_").val();
			...
			if(companyEmail.trim() == ""){
				$(".lbl_10").html("Required");
				isallfield = false;
			}else{
				$(".lbl_10").html("");
			}
			if(companyPhoneNo.trim() == ""){
				$(".lbl_11").html("Required");
				isallfield = false;
			}else{
				$(".lbl_11").html("");
			}
			if(businesscategory.trim() == 0){
				$(".lbl_12").html("Required");
				isallfield = false;
			}else{
				$(".lbl_12").html("");
			}
			if(companytagline.trim() == ""){
				$(".lbl_13").html("Required");
				isallfield = false;
			}else{
				$(".lbl_13").html("");
			}
			if(companyProductService.trim() == ""){
				$(".lbl_14").html("Required");
				isallfield = false;
			}else{
				$(".lbl_14").html("");
			}
			if(spProfileAbout.trim() == ""){
			...
			//===FRELANCER
			var profiletype = $("#profiletype_").val();
			var hourlyrate = $("#hourlyrate_").val();
			var skill = $("#skill_").val();
			
			if(profiletype.trim() == 0){
				$(".lbl_8").html("Required");
				isallfield = false;
			}else{
				$(".lbl_8").html("");
			...
			var highlights = $("#highlights_").val();
			//var availablefor = $("#availablefor_").val();
			var details = $("#details_").val();
			//var spProfileAbout = $("#spProfileAbout").val();
			if(category.trim() == 0){
				$(".lbl_8").html("Required");
				isallfield = false;
			...
			var college = $("#college_").val();
			var university = $("#university_").val();
			var experience = $("#experience_").val();
			var degree = $("#degree_").val();
    ...
    $(".sp-profile-det").on("click", ".addprofile", function (e) {
		var chekvalid = isvalidprofilefield();
		if(chekvalid == true){
            ...
            $.post(url, term, function (data, status) {
				...
				if(base64image === undefined){
					...
					var ext = arr[0].replace("data:image/", "");
					ext = ext.replace(";", "");
					$.post("../my-profile/uploadimage.php", {profileid: pid, spprofilePic: base64image, mediaid: $("#profilepic").data("media"), ext: ext}, function (r) {
						//alert(r);
					});
				}
                ...
                $(".profilefield").each(function (i, e) {
                    ...
                    var v = $(e).val();
					//alert(l+' - '+n+' - '+v);
                    $.post("../my-profile/addprofilefield.php", {spProfileFieldLabel: l, spProfileFieldName: n, spProfileFieldValue: v, spprofiles_idspProfiles: pid, editing_: profileedit}, function (r) {
                        //alert(r);
                    });
                });
                //if ($("#idspProfiles").val() == "")
                    //$("#sp-list-profile").append("<a href='profileDetails.php' class='list-group-item sp-user-profile-label active' data-pid='" + data.trim() + "' data-ptid='" + $("#ptypeid").val() + "'><span style='font-weight: bold;'>" + $("#spProfileName").val() + "</span><span style='font-weight: lighter; color:#330099;'>(" + $("#spProfileTypename").val() + ")</span></a>");
    ...
    $(".friendchatsystem").on("click", ".sendmessagetofriend", function () {
        ...
        $(".btnfriend").each(function (i, e) {
            $.post('../friendmessage/sendmessage.php', {spfriendChattingMessage: $("#freindmessage").val(), spprofiles_idspProfilesReciver: $(e).data("friendid"), spprofiles_idspProfilesSender: $("#sender").val()}, function (data) {
                mid = data;
            });
        });
		...
		$('<li class="sent"><img src="'+$("#mypic").val()+'" alt="" /><p>' + $("#freindmessage").val() + '</p></li>').appendTo($('.messages ul'));
        $("#freindmessage").val("");
        $(".messages").scrollTop($(".messages").prop("scrollHeight"));
    });
    ...
    $(".rejectrequest").on("click", function () {
        if (confirm("Are you sure you want to  Reject ?")) {
            $.post('../friends/reject.php', {sender: $(this).data("sender"), receiver: $(this).data("receiver")}, function (d) {
                location.reload();
            });
        }
    });
    ...
    //Complete
	//friend request send
    $("#sendrequest").on("click", function (i, e) {
        var btn = this;
    ...
    $("#sp-auto-friends").autocomplete({
        minLength: 1,
        source: "https://dev.thesharepage.com/mlayer/profilelist.php",
        focus: function (event, ui) {
            $(this).val(ui.item.label);
            return false;
        },
        select: function (event, ui) {
            $("#sp-auto-friends").val(ui.item.label);
            // $("#sp-auto-friends").val(ui.item.value);
            window.open("https://dev.thesharepage.com/friends/?profileid=" + ui.item.value + "", "_self");
            return false;
        }
    });
    ...
    $("#sp-auto-post").autocomplete({
        ...
        minLength: 1,
        source: "https://dev.thesharepage.com/mlayer/productlist.php",
        focus: function (event, ui) {
            $(this).val(ui.item.label);
            return false;
        }
    ...
    $(".quantity").change(function () {//Calculating price of quantity
        ...
        $.post("/cart/updateorder.php", {orderid: $(this).data("oid"), quantity: quantity, subtotal: $subtotal}, function (r) {});
    ...
    $(".eventregister").on("click", function () {
        $.post('../events/eventregister.php', {postid: $(this).data("postid"), profileid: $(this).data("profileid"), startdate: $(this).data("startdate"), enddate: $(this).data("enddate"), categoryid: $(this).data("categoryid")}, function (d) {
            //alert(d);
        });
    });
    ...
    $.getJSON("https://dev.thesharepage.com/finance/revanuecategorywise.php", function (json) {
    ...
    $.getJSON("https://dev.thesharepage.com/finance/revanue.php", function (json) {
    ...
    $.getJSON("https://dev.thesharepage.com/my-posts/executed.php", function (json) {
    ...
    $.getJSON("https://dev.thesharepage.com/my-store/mypost.php", function (json) {
    ...
    $.getJSON("https://dev.thesharepage.com/favorite/favorite.php", function (json) {
    ...
    $(".chattingsystem").on("click", ".addfreelanceChat", function () {
        ...
        $.post(url, term, function (data, status) {
            ...
            $("#loadtxtmsg").load("loadnewconversation.php", {txtSendrProId: $(btn).data("senderid")}, function () {
                //Testing Complete
				$(".messages").scrollTop($(".messages").prop("scrollHeight"));
            });
    ...
    $(".chattingsystem").on("click", ".addconversation", function () {
        ...
        $.post(url, term, function (data, status) {
            ...
            //alert("Done !");
            $("#loadtxtmsg").load("loadnewconversation.php", {idspGroupMessage: $(btn).data("gmesgid")}, function () {
                //Testing
    ...
    $(".freelanceconversation").on("click", ".displayconversation", function () {
        ...
        $.post('updatechat.php', {txtSendrProId: txtSendrProId }, function (d) {
            //alert(d);
        })
        $.post("loadconversation.php", {txtSendrProId:txtSendrProId}, function (r) {
            $('#message_box').html(r);
            //$(btn).closest(".acptrjt").html("");
			$(".messages").scrollTop($(".messages").prop("scrollHeight"));
    ...
    $(".grpconversation").on("click", ".displayconversation", function () {
        ...
        $.post("loadconversation.php", {txtSendrProId:txtSendrProId, txtGroupMsg:txtGroupMsg,  pid: $(this).data("gid")}, function (r) {
            $('#message_box').html(r);
            //$(btn).closest(".acptrjt").html("");
        });
//		var btn = this;
...
//		$(this).closest(".conversationmessage").find(".conversation").toggleClass("hidden");
    ...
    $(".deleteMasterDetails").on("click", function () {
        var btn = this;
        if (confirm("Are you sure you want to Delete ?")) {
            $.post('../deleteDetails.php', {masterdetailsid: $(btn).data("masterdetailsid")}, function (d) {
    ...
    $("#postrating .stars").click(function () {
        ...
        $.post('../post-details/rating.php', {rate: $(this).val(), profileid: $(".dynamic-pid").val(), postid: $("#spPostings_idspPostings").val()}, function (d) {
            $("#rate").text(d);
            $("#review").text(d + " ");
            $("#totalrating").text(d + " ");
        });
        $.post('../customer_reviews/updatereviewrating.php', {rate: $(this).val(), profileid: $(".dynamic-pid").val(), postid: $("#spPostings_idspPostings").val()}, function (d) {
    ...
    $(".postratingMusic").on("click", function () {
        ...
        $.post('../post-details/rating.php', {rate: $(this).val(), profileid:pid, postid: postid}, function (d) {
            
        });
        $.post('../customer_reviews/updatereviewrating.php', {rate: $(this).val(), profileid: pid, postid: postid}, function (d) {
    ...
    $(".navside").on("click", function () {
        ...
        window.history.pushState('page2', 'Title', 'https://dev.thesharepage.com/grouptimelines/?groupid=' + $("#grpid").val() + '&groupname='+ $("#grpName").val() + $(this).data("url"));

        $(".navside").css({"background-color": "#f1f1f1", "color": "black"});
    ...
    $(".reject").on("click", function () {
        ...
        $.post("../grouptimelines/reject.php", {messageid: $(this).data("messageid")}, function (r) {
        });
    });
    ...
    $(".approve").on("click", function () {
        ...
        $.post("../grouptimelines/approve.php", {messageid: $(this).data("messageid")}, function (r) {
        });
    });
    ...
    $(".dashboard").on("click", function () {
        ...
        $.get("/authentication/updateprofile.php", {dashboardtext: $(this).text(), pid: $(".dynamic-pid").val(), myprofile: $("#myprofile").text()}, function (r) {
        });
    });

    $(".post-share").on("click", function () {
        $.get("/authentication/updateprofile.php", {store: "Public Store", pid: $(this).data("profileid"), myprofile: $("#myprofile").text()}, function (r) {
        });
    });
    //Group Filter
    ...
    $(".stores").on("click", function (e) {
        $.get("/authentication/updateprofile.php", {store: $(this).text(), pid: $(this).data("profileid"), myprofile: $("#myprofile").text()}, function (r) {
        });
    });
    ...
    $("#lockcode").on("click", function () {
        $.post("codecheck.php", {code: $("#code").val()}, function (r) {
            alert(r);
    ...
    $(".jobapply").on("click", function () {
        var btn = this;
        $.post(MAINURL+"/my-activity/jobapply.php", {postid: $(this).data("postid"), categoryid: $(this).data("categoryid"), activitydate: $(this).data("activitydate"), closingdate: $(this).data("closingdate"), resumeid: $(this).data("resumeid"), coverletter: $("#letter").val()}, function (r) {
            if (r.trim() == '') {
    ...
    $(".dashboard-container").on("click", ".freelancers", function () {
        var btn = this;
        $.post("/my-activity/addfreelancer.php", {profileid: $(this).data("freelancerid")}, function (r) {
            //alert(r);
    ...
    $(".dashboard-container").on("click", ".deletefreelancer", function () {
        var btn = this;
        $.post("/my-activity/removefreelancer.php", {profileid: $(this).data("freelancerid"), groupid: $(this).data("groupid")}, function (r) {
    ...
    $(".dashboard-container").on("click", ".acceptbid", function () {
        if (confirm("Are you sure you want to accept this Bid?")) {
            ...
            $.post("/my-activity/acceptedbid.php", {postid: $(this).data("postid"), profileid: $(this).data("profileid")}, function (r) {
            }).fail(function (e) {
    ...
    $(".dashboard-container").on("click", ".rejectbid", function () {
        ...
        {
            $(btn).closest(".bidproject").fadeOut();
            $.post('../freelancer/rejectedbid.php', {postid: $(this).data("postid"), profileid: $(this).data("profileid")}, function (d) {
            }).fail(function (e) {
                $(btn).closest(".bidproject").fadeIn();
            });
        }
    ...
    $(".placebidAuction").on("click", function () {
       var lastBid = document.getElementById("lastBid").value;
		...
		if(currentBid > lastBid){
			var btn = this;
			$.post('../store/auction-bid/placebid.php', {postid: $("#bidpost").val(), profileid: $(".dynamic-pid").val(), categoryid: $(".auctioncat").val()}, function (d) {
				//alert(d);
			})
			$(".activity").each(function (i, e) {
				$.post("../store/auction-bid/addactivity.php", {spPostFieldName: $(e).attr("name"), spPostFieldValue: $(e).val(), spPostings_idspPostings: $("#bidpost").val(), spCategories_idspCategory: $(".auctioncat").val(), spPostFieldIsFilter: $(e).data("filter"), spProfiles_idspProfiles: $(".dynamic-pid").val(), spPostFieldBidFlag: $("#spPostFieldBidFlag").val()}, function (r) {
					//alert(r);
				});
			});
			$("#bid-auction").modal("hide");
			location.reload();
		}else{
			$("#invalidBid").html("<div class='alert alert-danger error_show' role='alert'>Your bid must be greater $"+lastBid+".</div>");
		}
    });
    ...
    $(".placebid").on("click", function () {
        ...
        $.post('../freelancer/placebid.php', {postid: $("#bidpost").val(), profileid: $(".dynamic-pid").val(), enddate: $(".closingdate").val(), categoryid: $(".freelancercat").val()}, function (d) {
            //alert(d);
        })


        $(".activity").each(function (i, e) {
            $.post("../my-activity/addactivity.php", {spPostFieldName: $(e).attr("name"), spPostFieldValue: $(e).val(), spPostings_idspPostings: $("#bidpost").val(), spCategories_idspCategory: $(".freelancercat").val(), spPostFieldIsFilter: $(e).data("filter"), spProfiles_idspProfiles: $(".dynamic-pid").val(), spPostFieldBidFlag: $("#spPostFieldBidFlag").val()}, function (r) {
                //alert(r);
            });
        });
    ...
    $("#checkout").on("click", function () {
        ...
        $(".sp-order").each(function (i, e) {
            if ($(e).data("remainingquant") == 0) {
                $.post("/cart/checkout.php", {postid: $(e).data("postid"), profileid: $("#checkout").data("buyerid")}, function (r) {
            ...
            if ($(e).data("categoryid") == 9 || $(e).data("categoryid") == 15) {//Update event upcomming event in spPost_has_spProfile table
                $.post('../events/eventregister.php', {postid: $(e).data("postid"), profileid: $(e).data("profileid"), startdate: $(e).data("startdate"), enddate: $(e).data("enddate"), categoryid: $(e).data("categoryid")}, function (d) {
                    //alert(d);
                });
            }
        });
        ...
        if (($btn).data("categoryid") == 15)//my deadline
            $.post('../coupons/buycoupons.php', {postid: $(btn).data("postid"), profileid: $(btn).data("buyerid"), enddate: $(btn).data("expirydate"), categoryid: $(btn).data("categoryid")}, function (d) {
                alert(d);
            })
    });
    ...
    $('.searchtimelines').hover(function (e) {
        $("#aboutprofile").load("../publicpost/aboutprofile.php", {profileid: $(this).data("profileid")}, function (response) {
        });
        var moveLeft = -100;
        var moveDown = -200;
        $('.pop-up').show();
        $(".pop-up").css({'top': e.pageY + moveDown})
        $(".pop-up").css({'left': e.pageX + moveLeft})
    }, function () {
        $('.pop-up').hide();
    });
    ...
    $(".acceptquote").on("click", function () {
        if (confirm("Are you sure you want to accept this quote?")) {
            ...
            $.post("../RFQ/accepted.php", {buyeremail: $(this).data("buyeremail"), selleremail: $(this).data("selleremailid"), quotationid: $(this).data("quoteid"), sellername: $(this).data("sellername"), buyername: $(this).data("buyername"), buyerphone: $(this).data("buyerphone")}, function (r) {
    ...
    $(".rejectedquote").on("click", function () {
        if (confirm("Are you sure you want to add in the Archieved?")) {
            var btn = this;
            $(btn).closest(".quote").fadeOut();
            $.post("../RFQ/rejected.php", {buyeremail: $(this).data("buyeremail"), selleremail: $(this).data("selleremailid"), quotationid: $(this).data("quoteid"), sellername: $(this).data("sellername"), buyername: $(this).data("buyername"), buyerphone: $(this).data("buyerphone")}, function (r) {
            }).fail(function (e) {
                $(btn).closest(".quote").fadeIn();
            });
        }
    ...
    $(".deletequote").on("click", function () {
        if (confirm("Are you sure you want to delete?")) {
            var btn = this;
            $(btn).closest(".quote").fadeOut();
            $.post("../RFQ/deletequote.php", {buyeremail: $(this).data("buyeremail"), selleremail: $(this).data("selleremailid"), quotationid: $(this).data("quoteid"), sellername: $(this).data("sellername"), buyername: $(this).data("buyername"), buyerphone: $(this).data("buyerphone")}, function (r) {
            }).fail(function (e) {
                $(btn).closest(".quote").fadeIn();
            });
        }
    ...
    $(".addindraft").on("click", function () {
        var btn = this;
        $(btn).closest(".quote").fadeOut();
        $.post("../RFQ/adddraft.php", {buyeremail: $(this).data("buyeremail"), selleremail: $(this).data("selleremailid"), quotationid: $(this).data("quoteid"), sellername: $(this).data("sellername"), buyername: $(this).data("buyername"), buyerphone: $(this).data("buyerphone")}, function (r) {
        }).fail(function (e) {
            $(btn).closest(".quote").fadeIn();
        });
    });
    ...
    $(".my-group-dd").on("click", function () {
        ...
        $.get("/authentication/updateprofile.php", {gid: $(this).data("gid"), groupname: $(this).text(), pid: $(this).data("profileid"), myprofile: $("#myprofile").text()}, function (r) {
        });
    });
    ...
    $(".profiledd").on("click", function () {
		...
		$(".profilepicture").load("../../my-profile/profilepicture.php", {profileid: $(this).data("pid")}, function (r) {
				...
				if(new_pass !=""){
					if(cnf_pass != ''){
						if(new_pass == cnf_pass){
							...
							var title = "New password does not match";
							notify_msg(title);
						}
					}else{
						var title = "Please type confirm new password";
						notify_msg(title);
					}
				}else{
					var title = "Please type new password";
					notify_msg(title);
				}
			}else{
				var title = "Please type old password";
				notify_msg(title);
			}
    ...
    $(".sp-profile-det").on("click", "#makedefaultprofile", function (e) {
        var btn = this;
        $.post("../my-profile/makeprofiledefault.php", {profileid: $(this).data("profileid")}, function (r) {
	...
	$(".headProfile").on("click", function(){
		var btn = this;
		$.post("https://dev.thesharepage.com/my-profile/makeprofiledefault.php", {profileid: $(this).data("profileid")}, function (r) {
            $(".default").addClass("hidden");
            $("#pfadmin-pid" + $("#idspProfiles_").val()).html("<span style='font-weight: bold;'>" + $("#spProfileName_").val() + "</span><span style='font-weight: lighter; color:#330099;'>(Default/" + $(btn).data("profiletype") + ")</span>");
            //alert("Done!");
            location.reload();
    ...
    $(".searchcategory").on("click", function (e) {
        ...
        if ($(b).attr("data-action") == "default")
        {
            ...
            if (!$(".dashboard-container").hasClass("category-loaded"))
            {
                ...
                $(".dashboard-container").load("categorydashboard.php", {categoryID: $(b).data("categoryid")}, function (r) {
        ...
        {
            $(".dashboard-container").html("<div class='loader'></div>");
            $(".dashboard-container").load($(b).attr("data-action"), {categoryID: $(b).data("categoryid")}, function (r) {
    ...
    $("#timeline-container").on("keypress", ".enterkey", function (e) {
		...
		if (keyCode === 13) { 
			...
			if($(this).val().trim() == ""){
				//notification message from send box
				$.notify({
					title: '<strong>Please write any content</strong>',
					icon: '',
					message: ""
				},{
					type: 'danger',
				...
				$form.submit(function (e) {
					...
					$.post(url, term, function (data, status)
					{
						$(".timlinecmnt").load("../publicpost/loadcomment.php", {idspPostings: $("#timlinepost").val()}, function () {});
    ...
    $('#timeline-container').on('click', ".morecomment", function (e) {
        ...
        $("#commentUploading").load("../social/comment.php", {postid: $(this).data("postid")}, function (r) {
            //alert(r);
        });

        $("#profilepictures").load("../social/profilepic.php", {profileid: $(".dynamic-pid").val()}, function (r) {
            // alert(r);
        });
    });
	...
	$(".artCategory").on("change", function () {
		...
		//alert(category);
		$.post("loadMedium.php", {category: category}, function (r) {
			//alert(r);
			$(".loadMedium").html(r);
		});
    ...
    $(".replay").on("click", function () {
        ...
        $("#senderdet").load("/enquiry/senderdet.php", {mid: $(this).data("messageid")}, function () {
    ...
    $('#conversatation').on('show.bs.modal', function (e) {
        $.post("../enquiry/message.php", {mid: $("#spMessaging_idspMessage").val()}, function (r) {
            $("#buyerEnquiry").text(r);
        });
    });
    //header complete
	...
	$(".social").on("click", ".addtofavourite", function () {
        $.post("../social/addfavorites.php", {postid: $(this).data("postid"), pid: $("#spByuerProfileId").val()}, function (response) {
        });
		$(".showfav").html('<a href="javascript:void(0)" data-postid="'+$(this).data("postid")+'" class="remtofavorites"><i class="fa fa-heart"></i> Unfavourite</a>');
		//show notification on the page
    ...
    $(".wholesocial").on("click", ".wholsalefav", function () {
		var postid = $(this).data("postid"); 
        $.post("../social/addfavorites.php", {postid: $(this).data("postid"), pid: $(this).data("pid")}, function (response) {
        });
		$(".showfav_"+postid).html('<a href="javascript:void(0)" class="wholsaleunfav btn btn-default x" data-pid="'+$(this).data("pid")+'" data-postid="'+$(this).data("postid")+'" ><i class="fa fa-heart"></i></a>');
		//show notification on the page
		var title = '<strong>Product added in favourite</strong>';
		var icon = 'fa fa-heart';
		showNofification(title, icon);
    ...
    $(".wholesocial").on("click",".wholsaleunfav", function () {
		var postid = $(this).data("postid"); 
        $.post("../social/deletefavorites.php", {postid: $(this).data("postid")}, function (response) {
        });
		$(".showfav_"+postid).html('<a href="javascript:void(0)" class="wholsalefav btn btn-default " data-pid="'+$(this).data("pid")+'" data-postid="'+$(this).data("postid")+'" ><i class="fa fa-heart-o"></i></a>');
		//show notification on the page
		var title = '<strong>Product removed from favourite</strong>';
		var icon = 'fa fa-heart-o';
		showNofification(title, icon);
    ...
    $(".social").on("click", ".sp-like", function () {
        ...
        $.post("../social/addlike.php", {postid: $(this).data("postid"), pid: $(".dynamic-pid").val()}, function (response) {
            $(btnLike).attr({class: 'icon-socialise fa fa-thumbs-up spunlike'});
            if (liked != false){
                liked++;
                $(btnLike).text(" (" + liked + ")");
    ...
    $(".social").on("click", ".spunlike", function () {
        ...
        $.post("../social/unlike.php", {postid: $(this).data("postid"), pid: $(".dynamic-pid").val()}, function (response) {
            $(btnunlike).attr({class: 'icon-socialise sp-like fa fa-thumbs-o-up'});
            if (liked != false)
            {
                if (liked == 1 || liked == 0)
                {
    ...
    $(".social").on("click", ".sp-favorites", function () {
        ...
        $.post(MAINURL+"/social/addfavorites.php", {postid: $(this).data("postid"), pid: $(".dynamic-pid").val()}, function (response) {
            $(btnfavorites).attr({class: 'icon-favorites fa fa-heart removefavorites'});
    ...
    $(".social").on("click", ".removefavorites", function () {
        ...
        $.post(MAINURL+"/social/deletefavorites.php", {postid: $(this).data("postid")}, function (response) {
            //alert(response);
            $(btnremovefavorites).attr({class: 'icon-favorites fa fa-heart-o sp-favorites'});
	...
	$(".bokmarktab").on("click","#addtofavouriteevent", function () {
        ...
        $.post(MAINURL+"/social/addfavorites.php", {postid: postid, pid: pid}, function (response) {
			...
			$(".bokmarktab").html('<a href="javascript:void(0)" id="remtofavoritesevent" data-postid="'+postid+'" data-pid="'+pid+'"><span id="removetofavouriteeve"><i class="fa fa-heart"></i></span>Un Bookmark</a>');
			//window.location.reload();
        });
    });
    ...
    $(".bokmarktab").on("click","#remtofavoritesevent", function () {
        ...
        $.post(MAINURL+"/social/deletefavorites.php", {postid: postid}, function (response) {
			...
			//window.location.reload();
			$(".bokmarktab").html('<a href="javascript:void(0)" id="addtofavouriteevent" data-postid="'+postid+'" data-pid="'+pid+'"><span id="addtofavouriteeve"><i class="fa fa-heart-o"></i></span>Bookmark</a>');
        });
    });
	...
	$(".listing_fvrt_art").on("click","#addtofavouriteart", function () {
        ...
        $.post(MAINURL+"/social/addfavorites.php", {postid: postid, pid: pid}, function (response) {
			$(".listing_fvrt_art").html('<a href="javascript:void(0)" id="remtofavoriteart" class="btn btn_morePhoto" data-postid="'+postid+'" data-pid="'+pid+'"><span id="removetofavouriteeve"><i class="fa fa-heart"></i></span> this listing</a>');
        });
    });
    ...
    $(".listing_fvrt_art").on("click","#remtofavoriteart", function () {
        ...
        $.post(MAINURL+"/social/deletefavorites.php", {postid: postid}, function (response) {
			$(".listing_fvrt_art").html('<a href="javascript:void(0)" id="addtofavouriteart" class="btn btn_morePhoto" data-postid="'+postid+'" data-pid="'+pid+'"><span id="addtofavouriteeve"><i class="fa fa-heart-o"></i></span> this listing</a>');
        });
    });
    ...
    $(".sp-album").on("click", ".sp-album-label", function (e) {
        ...
        $(this).addClass("active")
        $(".sp-album-details").load("../album/albumdetails.php", {albumid: $(this).data("albumid"), albumname: $(this).text()}, function (response) {
            // alert(response);
        })
        return false;
    });
    ...
    var cartcount = 0;
    $.get("https://dev.thesharepage.com/authentication/getcartcount.php", function (r) {
        cartcount = r;
    });
    ...
    $("#addtocart").one("click", function () {
        ...
        $form.submit(function (e) {
            ...
            $.post(url, term, function (data, status) {
                ...
                {
                    $("#addtocart").html("<span class='glyphicon glyphicon-shopping-cart' aria-hidden='true'></span> ADDED TO CART");
                    $("#addtocart").attr("disabled", true);
                    cartcount++;
                    $.get("../authentication/cartcountupdate.php", {cartcount: cartcount}, function (d) {
                        //alert(d);
                    });
    ...
    //BUY NOW VALUE START
    $("#buytocart").one("click", function () {
		var sendUrl = "https://dev.thesharepage.com";
        var btn = this;
        var $form = $(btn).closest("form");
        $form.submit(function (e) {
            e.preventDefault();
    ...
    $(".remove_order").one("click", function () {
		var orderId = $(this).attr("data-oid");
		$.post("removefromcart.php", {orderId:orderId}, function (data) {
			window.location.reload();
		});
    });
	//===========END========
    ...
    $(".sp-profile-det").on("click", ".profiletypes-dd", function (e) {
		...
		if($(this).data("ptid") == 6){
			$("#shwocountry").addClass("hidden");
			$("#showstate").addClass("hidden");
			$("#showcity").addClass("hidden");
		}else{
			$("#shwocountry").removeClass("hidden");
			$("#showstate").removeClass("hidden");
    ...
    $(".sell").on("click", function (r) {
        ...
        $("#buyid").val("");
        $(".addcustomfields").removeClass("hidden");
        $(".addcustomfields").load("/post-ad/sell.php", {profileid: $("#spProfiles_idspProfiles").val(), flag: 1}, function (response) {
    ...
    $(".buy").on("click", function (r) {
        ...
        $(".addcustomfields").removeClass("hidden");
        $("#buyid").val(1);
        $(".addcustomfields").load("/post-ad/buy.php", {flag: 1, postid: $("#postid").val()}, function (response) {
            //slider
            $("#slider-range").slider({
                range: true,
                min: 1,
    ...
    $(".my-profile-dd").on("click", function (e) {
        ...
        $.post("/publicpost/updatealbumid.php", {pid: $(this).attr("data-pid")}, function (r) {
            //alert(r);
            $("#albumid").val(r);
        });
        ...
        $(".sp-album").load("../album/albums.php", {albumid: $(this).data("albumid")}, function (response) {
        ...
        $.get("/authentication/updateprofile.php", {pid: $(this).data("pid"), ptname: $(this).data("ptname"), myprofile: $(this).text(), ptid: $(this).data("ptid"), ptypeicon: $(this).data("ptypeicon")}, function (r) {
            // alert(r);
            var cartcount = 0;
            cartcount = r;
            $("#cartbadge").text(cartcount);
    ...
    $(".sp-profile-Group").on("click", ".sp-group-label", function (e) {
        ...
        $(".sp-group-details").load("members.php", {gid: $(this).data("gid"), gname: $(this).text(), ptid: $(this).data("createrptid")}, function (response) {
            // alert(response);
        })
        return false;
    });
    ...
    $(".sp-group-details").on("keydown.autocomplete", "#sp-auto-profile", function () {
        $(this).autocomplete({
            ...
            select: function (event, ui) {
                ...
                $(".sp-profile-details").load("../my-groups/profiles.php", {pid: ui.item.value, gid: $("#idspGroup").val()}, function (response) {
                    // alert(response);
    ...
    $(".groupfield").on("click", "#submitRename", function () {
        ...
        $form.submit(function (e) {
            ...
            $.post(url, term, function (data, status) {
                ...
                var ext = arr[0].replace("data:image/", "");
                ext = ext.replace(";", "");
                $.post("/my-groups/uploadimage.php", {groupid: $("#idspGroup").val(), groupPic: base64image, ext: ext}, function (r) {
                });
                //Testing complete

                if ($(".spgroupflag").val() == 0)
                    $(".gradmin-gid" + $("#idspGroup").val()).html("<span class='fa fa-globe'></span> " + $("#spGroupName").val());
                else
                    $(".gradmin-gid" + $("#idspGroup").val()).html("<span class='glyphicon glyphicon-lock'></span> " + $("#spGroupName").val());
    ...
    $(".sp-group-details").on("click", ".deleteMember", function () {
        if (confirm("Are you sure you want to unfriend....?")) {
            ...
            $.post(href, function (data, status) {
                ...
                $.post("../friends/unfriend.php", {profileid: $(btn).data("profileid")}, function (response) {
    ...
    $("#sp-list-profile").on("click", ".sp-user-profile-label", function (e) {
        ...
        $(".sp-profile-det").load("profileDetails.php", {pid: $(this).data("pid"), pname: $(this).data("profilename"), ptid: $(this).data("ptid")}, function (response) {
            // alert(response);
        })
        return false;
    });
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
                ...
                $(".postingimg").each(function (i, e){
                    ...
                    var ext = arr[0].replace("data:image/", "");
                    ext = ext.replace(";", "");
                    $.post("https://dev.thesharepage.com/post-ad/addpostingpic.php", {spPostings_idspPostings: postid, spPostingPic: base64image, ext: ext}, function (r) {
                        //Timeline prepending
                        if (i == imgCount - 1) {
                            $.get("https://dev.thesharepage.com/publicpost/timelineentry.php", {js: "1", timelineid: postid, grouptimeline: $(btn).data("grouptimeline")}, function (r) {
                                $("#timeline-container").prepend(r);
                ...
                if (imgCount == 0)
                {
                    $.get("https://dev.thesharepage.com/publicpost/timelineentry.php", {js: "1", timelineid: postid, grouptimeline: $(btn).data("grouptimeline"),idspprofile:idspprofile}, function (r) {
                        $("#timeline-container").prepend(r);
                        //$(btn).button('reset');
                        //alert(r);
                    });
        ...
        if (idspPostings != ""){
            ...
            $.post(url, term, function (data, status) {
                ...
                $(".postingimg").each(function (i, e){
                    ...
                    var ext = arr[0].replace("data:image/", "");
                    ext = ext.replace(";", "");
                    $.post("https://dev.thesharepage.com/post-ad/addpostingpic.php", {spPostings_idspPostings: postid, spPostingPic: base64image, ext: ext,postedit:'1', del:del}, function (r) {
						//alert(r);
                    });
					del++;
					//alert(del);
	...
	$('#sponsorTab').on('click', ".sendSponsorEdit", function (e) {
		...
		$(".sp-sponsor-edit").load("sponsorField.php", {sponsorId: sponsorId}, function (response) {
            //alert(response);
        })
    });
	//=====sponsor edit end
	...
	$("#spPostSubmitMusic").on("click", function () {
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
				...
				$.post("https://dev.thesharepage.com/post-ad/music/updatelyric.php", {postid: postid, lyrics: lyrics}, function (nte) {
					//alert(nte);
				});
				...
				if(musicId > 0){
					$.post("https://dev.thesharepage.com/music/updatemusic.php", {spPostings_idspPostings: postid, musicId: musicId}, function (r) {
                        //alert(r);
                    });
				}
                //Testing
                ...
                $(".media-file-data").each(function (i, e){
					...
					setInterval(function () {
						seconds--;
						if (seconds == 0) {
							window.location.href = 'https://dev.thesharepage.com/music/dashboard.php';
						//window.location.reload();
						}
					}, 1000);
					//====end=====
	...
	$("#spPostSubmitReal").on("click", function () {
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
				...
				//console.log(Accessids);
				$.post("https://dev.thesharepage.com/post-ad/addpostHightlight.php",{Highlights:Highlights,postid:postid,postedit:postedit}, function (re) {
					//alert(re);
				});
                ...
                $.post(url, term, function (data, status) {
					...
					if(pageEvent == 1){
						...
						if(multi == 'None selected' || multi == ''){
							...
							$.post("https://dev.thesharepage.com/post-ad/addpostcustomfieldssize.php",{multi:multi,postid:postid}, function (re) {
								//alert(re);
							});
						}
					}
					...
					if(chkVideo != ''){
						...
						form_data.append('spPostingAlbum_idspPostingAlbum', albumid);
						$.ajax({
							url: "https://dev.thesharepage.com/post-ad/addpostmedia.php",
							type: "POST",
							data:  form_data ,
							contentType: false,
							cache: false,
	...
	$(".updateFeature").click(function(){
		if($(this).attr("data-picid")){
			...
			var postid = $(this).attr("data-postid");
			$.post("https://dev.thesharepage.com/post-ad/updatepostfeat.php", {picid: picid, postid: postid}, function (r) {
				//alert(r);
			});
		}
	});
	...
	$('#leftmenu').on('change',function() {
		var proId = $(this).val();
		$.post("https://dev.thesharepage.com/post-ad/events/loadfeatur.php", {proId: proId}, function (r) {
			$(".showName").html(r);
		});
	});
	//onclick get feature name======
	...
	$(".intrestArea").on("click", function(){
		...
		$.post("https://dev.thesharepage.com/events/addEventintrest.php", {postid: postid, pid: pid, area: area}, function (r) {
			//alert(r);
			$("."+classhtml).html(r);
			//window.location.reload();
		});
	...
	$(".intestDetail").on("click", function(){
		...
		var area = $(this).attr("data-area");
		var classhtml = "ie_"+postid;
		$.post("https://dev.thesharepage.com/events/addEventintrestTwo.php", {postid: postid, pid: pid, area: area}, function (r) {
			//alert(r);
			$("."+classhtml).html(r);
			//window.location.reload();
		});
    ...
    // FORGET PASSWORD LINK
     $("#forreset").one("click", function () {
        ...
        $form.submit(function (e) {
			...
			if(spfregemail.trim() == ""){
				$(".spfregemail").html("This field is required");
			}else{
				...
				if(isemailvalid == true){
					...
					var posting = $.post(url, term, function (data, status) {
						if (data == 0) {
							$('.help-block').html("An Email has been sent with Reset link, please check your email.");
							$(".emailNotValid").html("");
						} else {
							$('.help-block').html('');
							$(".emailNotValid").html("This email is not exist in our database.");
						}
						$("#forreset").button('reset');
					});
				}else{
					$(".spfregemail").html("Enter correct email");
					$('.help-block').html('');
					$('.emailNotValid').html('');
				}
			}
    ...
    $("#spUserEmail").on("change", function () {
        $ip = $("#spUserEmail");
        $("#checkemail").text("");
        if ($ip.val().length > 4) {
            $.get("authentication/availableemail.php?uemail=" + $ip.val(), function (echeck) {
                if (echeck == 0)
                {
                    $ip.closest(".has-feedback").addClass("has-error").removeClass("has-success");
                    $ip.parent().siblings(".form-control-feedback").removeClass("hidden").removeClass("glyphicon-ok").addClass("glyphicon-remove");
                    $("#checkemail").text($ip.val() + " is already registered!");
                    $("#spUserEmail").val("");
                } else
                {
                    $("#checkemail").text("");
	...
	$(".artType").on("change", function () {
		...
		if(type == -3){
			...
			$("#eventDiv").load("eventload.php", {type: type}, function (response) {
				//alert(response);
			})
		}else if(type == -2){
			document.getElementById('leftArtFrm').style.height = "1140px";
			...
			$("#eventDiv").load("exhibitionload.php", {type: type}, function (response) {
				//alert(response);
			})
		}else{
				...
				if(file[0].size <= 2097152){
					if (regex.test(file[0].name.toLowerCase())) {
						...
						reader.onload = function (e) {
							...
							var img = $("<div class='col-md-2 imagepost'><span class='fa fa-remove dynamicimg closed'></span><img class='postingimg overlayImage' style='width:100%; height: 80px; margin-right:5px;' src='" + e.target.result + "'/></div>");
							//img.attr("style", "width:72px; height: 80px; margin-right:5px;");
							//img.attr("src", e.target.result);
							dvPreview.append(img);
							document.getElementById("dvPreview").classList.remove('hidden');
	...
	$(".addtoboard").on("click", function () {
		...
		var pid = $(this).attr("data-pid");
		var postid = $(this).attr("data-postid");
		$.post("../photos/addtoboard.php", {spPosting_idspPosting: postid, spProfile_idspProfile: pid}, function (r) {
			//alert(r);
			//notification message from send box
			$.notify({
				title: '<strong>Add to board</strong>',
				icon: '',
				message: ""
			},{
				type: 'info',
			...
			location.href="https://dev.thesharepage.com/photos/board.php";
		});
	});
	...
	$(".removetoboard").on("click", function () {
		...
		$.post("../photos/addtoboard.php", {remove: 1, spPosting_idspPosting: postid, spProfile_idspProfile: pid}, function (r) {
			//alert(r);
			//notification message from send box
			$.notify({
				title: '<strong>Remove to board</strong>',
				icon: '',
				message: ""
			},{
				type: 'info',
	...
	$(".addtoplaylist").on("click", function () {
		var pid = $(this).attr("data-pid");
		var postid = $(this).attr("data-postid");
		$.post("../music/addtoplaylist.php", {spPosting_idspPosting: postid, spProfile_idspProfile: pid, spCategory_idspCategory: 14}, function (r) {
			//alert(r);
			//notification message from send box
			$.notify({
				title: '<strong>Add to board</strong>',
			...
			location.href="https://dev.thesharepage.com/music/category.php";
		});
	});
	//Remove to PLAYLIST MUSIC
	$(".removetoplaylist").on("click", function () {
		var baseurl = "https://dev.thesharepage.com/music/dashboard";

		var pid = $(this).attr("data-pid");
		var songid = $(this).attr("data-songid");
		$("."+songid).addClass("hidden");
		
		$.post(baseurl+"/addtoplaylist.php", {remove: 1, idaddtomusic: songid, spProfile_idspProfile: pid}, function (r) {
        ...
        $form.submit(function (e) {
            ...
            $.post(url, term, function (data, status) {
				...
				if(imgCount != 0){
					...
					var ext = arr[0].replace("data:image/", "");
					ext = ext.replace(";", "");
					$.post("https://dev.thesharepage.com/post-ad/addsponsorpic.php", {spPostingPic: base64image, ext:ext, SponorId: SponorId}, function (t) {
						//alert("pass");
						if(reload == true){
							window.location.reload();
						}
	...
	$("#addSponser").on("click", function () {
		var BaseUrl = "https://dev.thesharepage.com";
        var btn = this;
        var $form = $(btn).closest("form");
        $form.submit(function (e) {
            e.preventDefault();
	...
	$(".deleteevent").on("click", function () {
        if (confirm("Are you sure you want to delete?")) {
            var btn = this;
			var postid = $(this).data("postid")
            $.post("../events/deleteevent.php", {postid: postid}, function (r) {
				//alert(r);
				window.location.reload();
            }).fail(function (e) {
	...
	$(".uploadlogo").change(function() {
		...
		if(filename == "wrong"){
			...
			if(chkAudio != ''){
				...
				$.ajax({
					url: "https://dev.thesharepage.com/music/addmusic.php",
					type: "POST",
					data:  form_data ,
					contentType: false,
					cache: false,
					...
					success: function(vi){
						...
						setInterval(function () {
							seconds--;
							if (seconds == 0) {
								window.location.href = 'https://dev.thesharepage.com/post-ad/music/?post='+$.trim(vi);
							}
						}, 1000);
					},
					error: function(error){
	...
	$('#AlbumChange').on('change', function() {
		...
		if(albumName == ''){
			...
			console.log('testing');
			$.post("../dashboard/loadAlbum.php", {albumName: albumName, pid:pid}, function (r) {
				//alert(r);
				$('#showAlbum').html(r);
	...
	$('#AlbumChangevdo').on('change', function() {
		...
		if(albumName == ''){
			...
			console.log('testing');
			$.post("../videos/loadAlbum.php", {albumName: albumName, pid:pid}, function (r) {
				//alert(r);
				$('#showMysong').html(r);
	...
	$('#MyUploadSong').on('change', function() {
		...
		if(albumName == ''){
			...
			console.log('testing');
			$.post("../music/loadMysong.php", {albumName: albumName, pid:pid}, function (r) {
				//console.log(r);
				$('#showMysong').html(r);
	...
	$(".uploadlogovideo").change(function() {
		...
		if(filename == "wrong"){
			...
			if(chkAudio != ''){
				var form_data = new FormData($("#sp-music-form-post")[0]);
				$.ajax({
					url: "https://dev.thesharepage.com/videos/addmusic.php",
					type: "POST",
					data:  form_data ,
					contentType: false,
					cache: false,
					...
					success: function(vi){
						...
						setInterval(function () {
							seconds--;
							if (seconds == 0) {
								window.location.href = 'https://dev.thesharepage.com/post-ad/videos/?post='+$.trim(vi);
							}
						}, 1000);
					},
					error: function(error){
	...
	$("#spPostSubmitVideo").on("click", function () {
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
				...
				//LYRICS UPDATE TEXT EDITOR START
				var lyrics = $("#lyrics_").Editor("getText");
				$.post("https://dev.thesharepage.com/post-ad/videos/updatelyric.php", {postid: postid, lyrics: lyrics}, function (nte) {
					//alert(nte);
				});
				//LYRICS UPDATE TEXT EDITOR END
				// IMAGE
				...
				var musicId = document.getElementById("spMusicmediaId_").value;
				if(musicId > 0){
					$.post("https://dev.thesharepage.com/videos/updatevideo.php", {spPostings_idspPostings: postid, musicId: musicId}, function (r) {
                        //alert(r);
                    });
				}
                //Testing
				...
				setInterval(function () {
					seconds--;
					if (seconds == 0) {
						window.location.href = 'https://dev.thesharepage.com/videos/links.php?postid='+$.trim(postid);
						//window.location.reload();
					}
				}, 1000);
				//====end=====
	...
	$(".followVide").on("click", function () {
		...
		$.post("https://dev.thesharepage.com/videos/addtofolow.php", {pid: pid, follower: follower, catid: catid}, function (r) {
			//alert(r);
			window.location.reload();
		});
	});
	...
	$(".UnfollowVidemdl").on("click", function () {
		...
		var unfollow = 1;
		$.post("https://dev.thesharepage.com/videos/addtofolow.php", {unfollow:unfollow, pid: pid, follower: follower, catid: catid}, function (r) {
			//alert(r);
			window.location.reload();
		});
	});
	...
	$('#MyPlayList').on('change', function() {
		...
		if(playlist == ''){
			...
			$.post("../videos/loadMyplaylist.php", {playlist: playlist, pid:pid, catid:catid}, function (r) {
				//console.log(r);
				$('#showMysong').html(r);
	...
	$("#spPostSubmitTrain").on("click", function () {
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
				...
				$.post("https://dev.thesharepage.com/post-ad/trainings/updatenote.php", {postid: postid, postingNotes: postingNotes, postOutline:postOutline}, function (nte) {
					//alert(nte);
				});
				...
				$.post("https://dev.thesharepage.com/post-ad/trainings/updatevdo.php", {postid: postid, pid: pid , featvdo:featvdo}, function (vdo) {
					//alert(vdo);
				});
				...
				setInterval(function () {
					seconds--;
					if (seconds == 0) {
						window.location.href = 'https://dev.thesharepage.com/trainings';
						//window.location.reload();
					}
				}, 1000);
				//====end=====
	...
	$(".spmediaTrain").change(function() {
		...
		if(filename == "wrong"){
			...
			if(addvideo != ''){
				...
				$.ajax({
					url: "https://dev.thesharepage.com/post-ad/trainings/addvideo.php",
					type: "POST",
					data:  form_data,
					contentType: false,
					cache: false,
    ...
    $("#remtofavoritesvdo").on("click", function () {
        var btnremovefavorites = this;
        $.post("../social/deletefavorites.php", {postid: $(this).data("postid")}, function (response) {
			$("#removetofavouriteeve").html("<i class='fa fa-heart-o' aria-hidden='true'></span>");
			window.location.reload();
	...
	$(".spmediAttach").change(function() {
		...
		if(filename == "wrong"){
			...
			if(addattachment != ''){
				...
				//var form_data = new FormData($("#sp-create-album")[0]);
				$.ajax({
					url: "https://dev.thesharepage.com/post-ad/trainings/addattach.php",
					type: "POST",
					data:  form_data,
					contentType: false,
					cache: false,
	...
	$(".spmediaTrainPrev").change(function() {
		...
		if(filename == "wrong"){
			...
			if(prevideo != ''){
				...
				//var form_data = new FormData($("#sp-create-album")[0]);
				$.ajax({
					url: "https://dev.thesharepage.com/post-ad/trainings/prevideo.php",
					type: "POST",
					data:  form_data,
					contentType: false,
					cache: false,
	...
	$("#spPostSubmitServ").on("click", function () {
        ...
        if (idspprofile != ""){
            ...
            $.post(url, term, function (data, status) {
				...
				//DESCRIPTION UPDATE OF THE TEXT BOX
				var postingNotes = $("#spPostingNotes").Editor("getText");
				$.post("https://dev.thesharepage.com/post-ad/services/updatenote.php", {postid: postid, postingNotes: postingNotes}, function (nte) {
					//alert(nte);
				});
				//DESCRIPTION UPDATE TEXT EDITOR END
				...
				setInterval(function () {
					seconds--;
					if (seconds == 0) {
						window.location.href = 'https://dev.thesharepage.com/services';
						//window.location.reload();
					}
				}, 1000);
				//====end=====
	...
	$("#spPostCountry_").on("change", function () {
		...
		$.post("loadstate.php", {countryId: countryId}, function (r) {
			//alert(r);
			$(".loadState").html(r);
		});
	...
	$("#spPostSelection_").on("change", function () {
        //alert(this.value);
		var serv = this.value;
		$.post("loadService.php", {serv: serv}, function (r) {
			//alert(r);
			$(".loadserv").html(r);
		});
    });
    ...
    var postedit = false;
    $("#spSaveDraftServ").one("click", function () {
		$(".loadbox").css({ display: "block" });
            ...
            if (idspprofile != "")
            {
                ...
                $.post(url, term, function (data, status) {
					...
					setInterval(function () {
						seconds--;
						if (seconds == 0) {
							window.location.href = 'https://dev.thesharepage.com/services/draft.php';
							//window.location.reload();
						}
					}, 1000);
					//====end=====
    ...
    $(".addToProfileFav").click(function () {
		...
		//alert(isfavourite);
        $.post("../social/addfavdir.php", {idspProfiles_spProfileCompany: idspProfiles_spProfileCompany, spProfiles_idspProfiles: spProfiles_idspProfiles, isfavourite: isfavourite}, function (response) {
			window.location.reload();
        });
    });
    ...
    $(".removeToProfileFav").click(function () {
		...
		var isfavourite = $(this).data("favourite");
		//alert(isfavourite);
        $.post("../social/remfavdir.php", {idspProfiles_spProfileCompany: idspProfiles_spProfileCompany, spProfiles_idspProfiles: spProfiles_idspProfiles, isfavourite: isfavourite}, function (response) {
			//alert(response);
			window.location.reload();
        });
    });
	...
	$(".addnotesresource").click(function(){
		...
		$.post("readNotes.php", {resourceid: resourceid}, function (response) {
			//alert(response);
	...
	$('#businesscategory').on('change', function() {
		...
		if(category == ''){
			...
			$.post("../business-directory/loadFav.php", {category: category}, function (r) {
				$('#showMyFav').html(r);
            }).fail(function (e) {
				//alert(e);
            });	
	...
	$('#busCatResouce').on('change', function() {
		...
		if(category == ''){
			...
			$.post("../business-directory/loadResource.php", {category: category}, function (r) {
				$('#showMyRes').html(r);
            }).fail(function (e) {
				//alert(e);
            });	
	...
	$(".readCmpnyNews").click(function(){
		...
		$.post("readNews.php", {newsId: newsId}, function (response) {
			//alert(response);
			//document.getElementById("#txtResourceNotes").value = resourceid.trim();
	...
	$(".editNews").click(function(){
		//alert($(this).data("resourceid"));
		var newsId = $(this).data("newsid");
		$.post("loadNews.php", {newsId: newsId}, function (response) {
			//alert(response);
			//document.getElementById("#txtResourceNotes").value = resourceid.trim();
	...
	$(".en_st_del").on("click", function () {
        if (confirm("Are you sure you want to Delete this Message?")) {
			...
			$.post("delEnquiry.php", {msgid: msgid}, function (response) {
				window.location.reload();
			});
        }
        return false;
	...
	$(".fav_st_del").on("click", function () {
        if (confirm("Are you sure you want to Delete this?")) {
			var postid = $(this).data("postid");
			var pid = $(this).data("pid");
			$.post("delFavourite.php", {postid: postid, pid:pid}, function (response) {
				window.location.reload();
			});
        }
        return false;
	...
	$(".quote_stor_del").on("click", function () {
        if (confirm("Are you sure you want to Delete this?")) {
			...
			$.post("delQuote.php", {strid: strid}, function (response) {
				window.location.reload();
			});
        }
        return false;
	...
	$('#spPostingCategory_').change(function(){
		if(this.value != 0){
			...
			$.post("loadInSubCat.php", {categoryId: categoryId}, function (r) {
	...
	$("#rfqCategory").on("change", function () {
		...
		if(catid == 0){
			...
			$.post("loadUsers.php", {catid: catid}, function (re) {
				//alert(re);
	...
	$("#txtPercntage").keyup(function (e) {
		...
		$.post("loan.php", {principal: newPrinc,down: down, interest_rate: interest_rate, years: years}, function (response) {
	...
	$("#txtIntrstRate").keyup(function (e) {
		...
		$.post("loan.php", {principal: newPrinc,down: down, interest_rate: interst, years: years}, function (response) {
			$("#calMorggae").html(response);
		});
	});
	...
	$(".removePlayList").on("click", function () {
		...
		$.post(baseurl+"/removePlaylist.php", {remove: 1, idspPlayList: listId, spProfile_idspProfile: pid}, function (r) {
	...
	$(".playSong").on("click", function (){
		...
		//load music 
		$.post("loadPlaylist.php", {listid: listid}, function (data) {
			$("#loadsong").html(data);
		});
	});
	//=========PLAYLIST END PLAYER=================
    ...
    $(".remtofavalbm").on("click", function () {
		var baseurl = "https://dev.thesharepage.com";
        var btnremovefavorites = this;
        $.post(baseurl+"/social/deletefavorites.php", {postid: $(this).data("postid")}, function (response) {
            window.location.reload();
        });
    });
	...
	$('#txtPhonePublic').change(function() {
        ...
        if($(this).is(":checked")) {
            $.post("loadgeneral.php", {pid:pid, uid:uid,phone:"1", mod:"sms"}, function (data) {
				//console.log(data);
			});
        }else{
			$.post("loadgeneral.php", {pid:pid, uid:uid,phone:"0", mod:"sms"}, function (data) {
				//console.log(data);
			});
		}	
    });
	$('#txtEmailPublic').change(function() {
		...
		var uid = $("#spUser_idspUser").val();
        if($(this).is(":checked")) {
            $.post("loadgeneral.php", {pid:pid, uid:uid,email:"1", mod:"email"}, function (data) {
				//console.log(data);
			});
        }else{
			$.post("loadgeneral.php", {pid:pid, uid:uid,email:"0", mod:"email"}, function (data) {
				//console.log(data);
			});
		}	
    });
	...
	$(".moduleshow").change(function(){
		...
		//console.log(mod);
		if($(this).is(":checked")) {
            $.post("loadmodule.php", {pid:pid, uid:uid, mod: mod, show:'0'}, function (data) {
				//console.log(data);
			});
        }else{
			$.post("loadmodule.php", {pid:pid, uid:uid, mod: mod, show:'1'}, function (data) {
				//console.log(data);
			});
		}
	});
	...
	$(".reStorepost").click(function(){
		...
		if (confirm("Are you sure you want to Re-Store?")){
			if(postid > 0){
				$.post("restorepro.php", {postid:postid}, function (data) {
					//console.log(data);
					window.location.reload();
				});
			}else{
						...
						if(state < 1){
							...
							if(city < 1){
								...
								if(address == ""){
									...
									//===START FORM SUBMIT
									$.post("addship.php", {name:name,mobile:mobile, email:email, country:country,state:state,city:city,address:address, txtUser:txtUser }, function (data) {
	...
	$(".postdel").on("click", function(){
		...
		function(isConfirm) {
			if (isConfirm) {
				$.post(MAINURL+"/post-ad/deltimelinepost.php", {postid:postid}, function (data) {
				});
				$(".deldiv_"+postid).html("");
	...
	$(".savepostdel").on("click", function(){
		...
		function(isConfirm) {
			if (isConfirm) {
				$.post(MAINURL+"/post-ad/deletePost.php", {postid:postid, flag:flag}, function (data) {
					console.log(data);
				});
				$(".deldiv_"+postid).html("");
				$(".deldiv_"+postid).removeClass('searchable');
