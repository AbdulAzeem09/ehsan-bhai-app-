...
<div class="container-fluid">
	<div class="row">
					...
					<div class="panel-body ">
						...
						<div class="tab-content <?php echo ($_GET["category"] == 2 ? "" : "hidden");?> ">
							...
							<div role="tabpanel" class="tab-pane" id="myresumes">
								<a  href="#" class="rsm pull-right" style="margin-bottom:20px;" data-toggle="modal" data-target="#nwresume" id="resumenew"><span class="glyphicon glyphicon-plus"></span><b> Add New Resume</b></a></li>
										...
										{	
											...
											$title = $rw['sppostingmediaTitle']; 
											 ...
											 echo "<tr class='resumeoperation'>
												...
												<td width='7%'><button type='button' class='btn btn-link preview' data-toggle='modal' data-target='#previewresume' data-src='".$BaseUrl."/resume/".$previewfile."'><span class='glyphicon glyphicon-search'></span> Preview</button></td>
												
												<td width='7%'><button type='button' class='btn btn-link editresume' data-toggle='modal' data-target='#nwresume' data-mediaid='".$rw['idspPostingMedia']."' data-mediatitle='".$title."'><span class='glyphicon glyphicon-edit'></span> Update</button></td>
		...
		<!--Adding new Resume modal-->
			<div class="modal fade" id="nwresume" tabindex="-1" role="dialog" aria-labelledby="resumeModalLabel">
