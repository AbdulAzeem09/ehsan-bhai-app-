...
<html lang="en-US">
  ...
  -->
                                                          ...
                                                          <?php
                                                           ...
                                                           <td class="text-center">  <a href="javascript:void(0)" data-postid="<?php echo $row['id']; ?>" class="delsortlist" ><i class="fa fa-trash"></i></a></td>
                                                        </tr>
                                                   ...
                                                   echo "<tr style='text-align:center;'><td colspan='6'><h4>No Favourite Ads  Found</h4></td></tr>";
