                                                ...
                                                while ($row = mysqli_fetch_assoc($res)) { 
                                                    ...
                                                    <tr>
                                                      <td class="text-center"><?php echo $i; ?></td>
                                                        ...
                                                        <td class="text-center"><a href="javascript:void(0)" data-postid="<?php echo $row['enquiry_id'];?>" class="delenq"><i class="fa fa-trash"></i></a>
															<a href="<?php echo $BaseUrl.'/services/dashboard/Sent_EnquiryReply.php?id='.$row['enquiry_id'];?>"><i class="fa fa-edit"></i></a>
															</td>
