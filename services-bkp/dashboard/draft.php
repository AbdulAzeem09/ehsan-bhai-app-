						...
						<link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive bg_white">
                                    <table class="table table-striped table-bordered display dashServ" id="example">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Service Name</th>
                                                  ...
                                                  /*  if($result_pf){
                                                     ...
                                                     /*   }*/
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo date("Y-m-d",strtotime($row['spPostingDate'])); ?></td>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo $BaseUrl.'/post-ad/services/?postid='.$row['idspPostings']; ?>" class="" data-postid="<?php echo $row['idspPostings'];?>"><i class="fa fa-edit"></i></a>
