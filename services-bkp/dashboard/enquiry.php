                                            ...
                                            if($res != false){
                                                while ($row = mysqli_fetch_assoc($res)) { 
                                                    ...
                                                    <!--    <td class="text-center"> <a href="javascript:void(0)"  onclick="javascript:chatWith(<?php echo $row['sender_id'];?>)"  class="red"><i class='fas fa-comment-dots' style="color: #ff7208;"></i></a></td>  -->
														...
														<a href="javascript:void(0)" data-postid="<?php echo $row['enquiry_id'];?>" class="delenq"><i class="fa fa-trash"></i></a>
														
																		<a href="<?php echo $baseurl ;?>/services/dashboard/reply-enquiry.php?id=<?php echo $row['enquiry_id'];?>" class=""><i class="fa fa-edit"></i></a>
