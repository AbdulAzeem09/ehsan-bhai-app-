                                            ...
                                            if($res != false){
                                                ...
                                                /* if($result_pf){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <button type="button" class="btn bcolor btn-success  btn-sm"  data-toggle="modal" data-target="#myModal<?php echo $row['id']; ?>"><i class="fa fa-edit"></i></button>
                                                   ...
                                                   echo "<tr style='text-align:center;'><td colspan='5'><h4>No Favourite Ads  Found</h4></td></tr>";
