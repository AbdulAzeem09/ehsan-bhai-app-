						...
						<link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
                            <div class="col-xs-12">
                                <div class="table-responsive bg_white">
                                    <table class="table table-striped table-bordered dashServ display" id="example">
                                        <thead>
                                            <tr>
                                                <th>Service Name</th>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <!--  <td class="text-center">0 Person</td> -->
                                                            <td class="text-center">
                                                                <!-- <a href="<?php echo $BaseUrl.'/post-ad/services/?active=2&postid='.$row['idspPostings']; ?>" class="" data-postid="<?php echo $row['idspPostings'];?>"><i class="fa fa-edit"></i></a> -->
                                                                <a href="<?php echo $BaseUrl.'/services/delete.php?action=renew&postid='.$row['idspPostings'];?>">
                                                                    <i class="fa fa-recycle" 
                                                                        title="Activate">
                                                                    </i></a>
                                                                <a href="<?php echo $BaseUrl.'/services/delete.php?action=delete&postid='.$row['idspPostings'];?>"><i class="fa fa-trash" title="Delete"></i></a>
                                                            </td>
                                                        </tr>
