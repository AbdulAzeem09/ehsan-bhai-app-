                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            ...
                                            // =========ACTIVE POST
                                            $totalActive = 0;
                                            $result4 = $p->event_favorite($_GET['categoryid'], $_SESSION['pid']);
                                            //echo $p->ta->sql;
                                            if ($result4) {
                                            ...
                                            // =========EXPIRE POST
                                            $totExp = 0;
                                            $result6 = $p->myEnq(7, $_SESSION['pid']);
                                            if ($result6) {
...
*/
                                            ...
                                            <table class="table table-striped no-margin">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.$pageLink.'myenquiry.php'; ?>">Enquiry Ads</a></td>
            ...
            $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        ...
                        {label: "Favourite Ads", value: <?php echo $totFav;?>},
