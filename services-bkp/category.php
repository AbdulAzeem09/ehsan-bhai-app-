										...
										<div role="tabpanel" class="tab-pane active" id="video1">
											<div class="row">
												<div class="col-md-12 topServBread">
													<nav aria-label="breadcrumb">
														...
														<!--<form  action="<?php// echo $BaseUrl.''.$_SERVER['REQUEST_URI']; ?>"   method ="GET" style="text-align:center;" >
															<input type="text" value="" name="keyword">
															<input class="btn" id="mytab" type = "submit"  name="Submit">
															</form>-->
															...
															?>
															                 ...
															                 <small style=" float:right;">Current Location:<?php //echo $currentcountry.', '.$currentstate.', '.$currentcity ; ?><br>
											...
											<div class="" style="">
												...
												//echo $condition1 ; die("------------------");
														 ...
														 $res = $p->sameServCategory1($where1, $_GET["categoryID"],$keyword);
															}
														//  else{
