					...
					<div class="modal-header">
				 	...
				 	<div class="modal-body sharedimage">
						...
						<div class="row">
							...
							<div class="col-md-12 group-select-block hidden" id="groupshow">
							<div class="form-group">
								...
								<select class="select3 form-control" name="spShareToGroup[]" id="groupSelect" multiple >
								 ...
								 <div class="col-md-12 friend-select-block hidden" id="profileshow">
							<div class="form-group">
...
<table class="table table-borderless" style="">
  ...
  <tbody>
    <tr>
      <td style="border: 0px;width: 43%;"><label>Add Name:</label></td>
