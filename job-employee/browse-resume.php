...
<?php $job_seeker_nav = 'browse-resume'; ?>
                    ...
                    <div class="main-body">
                        ...
                        <div class="resume-wrapper">
                            ...
                            <div class="resume-list">
                                <?php 
                                    $cl = new _resumeget;
                                    $dsf = $cl->browseAllResume($records_per_page, $offset, $keyword, $category);
                                    $totalPages = $cl->browseAllResumeCount($keyword, $category);
                                    if ($dsf && $dsf->num_rows > 0) {
                                        while ($row = $dsf->fetch_assoc()) {
                                            // echo "<pre>";print_r($_SESSION);die();
                                            $save = $cl->get_job_save_fav($row['pid'], $_SESSION['uid']);
                                            if($save){
                                                $save = $save->fetch_assoc();
                                            }
                                            $sfill = (!empty($save['save'])) ? '-fill' : '';
                                            $ffill = (!empty($save['fav'])) ? 'fav-fill' : 'fav-2';
                                            $sStatus = (!empty($save['save'])) ? $save['save'] : 0;
                                            $fStatus = (!empty($save['fav'])) ? $save['fav'] : 0;
                                        ...
                                        <div class="resume">
                                            ...
                                            <div class="detail">
                                                <div class="fav-icon" style="top:10px;">
