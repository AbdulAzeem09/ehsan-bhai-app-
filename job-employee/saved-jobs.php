...
if (!isset($_SESSION['uid'])) {
    ...
    border-radius: 4px;' class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                   <img src='../assets/images/menu-icon-2.svg'>
                    ...
                    <div class="main-heading">Saved Jobs</div>
                        <div class="active-job draft-jobs">
                            <div class="table-wrapper list-wrapper">
    ...
    <script> 
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "../ssp/job-seeker/saved-jobs.php?type=employee", 
                    "type": "POST"
                },
                "columns": [
                    { "data": "0" }
