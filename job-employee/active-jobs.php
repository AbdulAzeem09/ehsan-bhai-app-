...
if (!isset($_SESSION['uid'])) {
    ...
    if(isset($_REQUEST['active_id'])){
        ...
        updateQuery('spjobboard', array('spPostingVisibility' => -1), array('idspPostings' => $_REQUEST['active_id']));
    }

    if(isset($_REQUEST['pause_id'])){
        include '../ssp/custom-mysql.php';
        updateQuery('spjobboard', array('spPostingVisibility' => 1), array('idspPostings' => $_REQUEST['pause_id']));
    }
    ...
    <?php $job_seeker_nav = 'active-jobs'; ?>
        ...
        $(document).ready(function() {
            $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": { 
                    "url": "../ssp/data.php",  // Ensure this points to your PHP file
                    "type": "POST"
                },
                "columns": [
                    { "data": "0" }, // ID
        ...
        function activateJob(id) {
            ...
            Swal.fire({
                title: "Are you sure you want to mark this job Active?",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?php echo $BaseUrl; ?>/job-employee/active-jobs.php?active_id='+id;
                }
            });
        }
        ...
        function pauseJob(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = '<?php echo $BaseUrl; ?>/job-employee/active-jobs.php?pause_id='+id;
                }
            });
        }
