...
<title>Expense Category List | TheSharepage-POS </title>
...
<?php if($_SESSION['msgme']=="1"){ 
// unset($_SESSION['msgme']); ?>
...
<h3>Expense Category <small>[List]</small></h3>
<button type="button" class="btn btn-main mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><span class="d-none d-sm-inline"><i class="fas fa-plus"></i> Add Category</span></button>
...
<a href="<?php echo $BaseUrl.'/store/pos-dashboard/category-edit.php?id='.$row['id'];?>" class="btn btn-main"><i class="fas fa-edit"></i></a>
...
<form action="ExpenseCategory.php" method="post">
<input type="hidden" name="Department" value="Department">
<div class="mb-3">
<label for="recipient-name" class="col-form-label">Code:</label><br>
<div class="input-group">
<input type="text" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2" name="code" id="code_" required>
...
window.location.href = "delete_categoryto.php?id=" + id;
