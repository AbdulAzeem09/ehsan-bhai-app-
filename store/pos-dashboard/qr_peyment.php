...
<body class="bg_gray">
    ...
    ?>
            <script>
                window.location.replace('<?php echo $BaseUrl ?>/store/pos-dashboard/thankyou.php?action=all&msg=message');
            </script>
        <?php
        }
    }
                                    ...
                                    ?>
                                        <div class="col-md-12">
                                            <div class="col-md-6" style="border-right:1px solid #ddd;">
                                                ...
                                                <form action="<?php echo $BaseUrl; ?>/store/pos-dashboard/qr_peyment.php?id=<?php echo $_GET['id']; ?>" method="POST" id="paymentForm">
                                                    ...
                                                    <div align="left">
                                                        ...
                                                        <input type="hidden" name="total_amount" value="<?php echo $data['sub_total']; ?>">
