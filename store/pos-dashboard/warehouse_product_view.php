...
$id = isset($_GET['warehouse_id']) ? (int) $_GET['warehouse_id'] : 0;
...
<h3><?php echo $row2['warehouse']; ?> Product List</h3>
...
$result = $p->read_post_product_pos1($_SESSION['uid'],$_SESSION['pid'],$id);  
