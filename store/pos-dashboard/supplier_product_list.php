...
$id= isset($_GET['vendor_in']) ? (int) $_GET['vendor_in'] : 0;
...
<title>Product List | TheSharepage-POS </title>
...
<h3><?php echo $row2['customer_name'] ?> Product List</h3>
<!--<a href="add-product.php" class="nav-link pull-right" style="text-align: end;margin-bottom: -47px;"><button class="btn btn-main text-light" type="submit"style="margin-top: 1px;">Add Product</button>  </a>
...
<button style="margin-left: -60px;" type="submit" class="btn btn-main text-light" data-bs-toggle="modal" data-bs-target="#filter"> <i class="fas fa-filter"></i> Filter </button>
...
//$id=$_GET['vendor_in'];
$result = $ps->read_post_product_pos2($_SESSION['uid'],$_SESSION['pid'],$id);  
...
window.location.href = "product-list.php?key=all";    
