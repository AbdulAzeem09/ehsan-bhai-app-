...
if(isset($_POST['update'])){
	...
	$res = $pf->update_trans_inv($data,$id);      
	$_SESSION['msg'] = 2;	
}
...
<body>
  ...
  Successfully Submitted.
     ...
     Successfully updated .
               ...
               <h4 class="float-start">Transfer Inventory</h4>               
            </div>
            <div class="col-lg-12">
                     ...
                     <form method="post" action="">
                        <div class="d-flex justify-content-center input-group">
                           ...
                           <div class="col-2 me-1 d-flex">
                              <input type="text" class="form-control me-1" placeholder="Qty" id="qty_1" name="qty" aria-label="qty_in" aria-describedby="addon-wrapping" required >                                                              
                           </div>
                           <div class="col-1 me-1"> 
                              <input type="text" class="form-control" name="unit_price_in" placeholder="Unit Price" aria-label="Unit Price" aria-describedby="addon-wrapping" required >
                           </div>
                           <div class="col-1 me-1">
            ...
            <div class="col-lg-12 top-product">
			   ...
			   $p = new _pos;
							...
							$result = $p->read_trans_inv($_SESSION['uid']);  
					...
					if ($result) {
                     ...
                     <tr>
                       ...
                       <!-- <td><?php echo $row['Location']; ?></td>-->
                        ...
                        <td><?php echo $row['currency']; ?>&nbsp;<?php echo $row['unit_price_in']; ?></td>
					  ...
					  <a onclick="delete_attributes('<?php echo $BaseUrl?>/store/pos-dashboard/delete_transfer_inv.php?id=<?php echo $row['id'];?>&action=delete')" class="text-danger"> <i class="fas fa-trash"></i></a>
						</td>
                     </tr> 
                   <?php }} ?>	     				 
                  </tbody>
