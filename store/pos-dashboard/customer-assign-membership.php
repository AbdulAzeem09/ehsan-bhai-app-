...
<div class="row p-3">
<div class="col-md-5 border border-sucess bg-light p-3">
<?php
$p = new _pos;					
...
<span><b>Address :</b> <?php echo $row['spUserAddress']; ?></span><br>
...
<div class="col-md-7 border border-sucess bg-light p-3">
...
<?php
$data11 = $p->read_barcode11($_GET['postid'],$_SESSION['uid']);
if($data11){
$total_quntity=0;
$row_b11 = mysqli_fetch_assoc($data11);
$bar_mem = (explode(",",$row_b11['barcode']));
foreach($bar_mem as $value){

    $data7 = $p->read_cust($_GET['postid'], $value);
    if($data7){
    $row7 = mysqli_fetch_assoc($data7);
    }
//select pos_membership_customer where barcode =$valve and custemer_id= $_GET['postid'];

$d = $p->read_name_qty($value,$_SESSION['uid']);
if($d){
$r = mysqli_fetch_assoc($d);
echo $r['name_qty']." = ";	echo $row7['quantity']."<br>";
$total_quntity+=$row7['quantity'];						
}
}
}
?>	
<div><span>Total Quantity : <?php echo $total_quntity; ?></span></div>
</div>

<hr>
<div class="row">
<div class="col-6">
<div class="broder bg-info px-3 py-3">
<span class="text-white"><b>Deduct Quantity</b></span>
...
<select class="form-control" name="current_barcode">
<option> Select Plan</option>
<?php
$data11 = $p->read_barcode11($_GET['postid']);
if($data11){
$row_b11 = mysqli_fetch_assoc($data11);
...
?>
<option value="<?php echo $r['barcode'] ?>"><?php echo $r['name_qty'] ?></option>
<?php							
...
<div class="d-flex">
<input type="number" name="second" class="form-control me-1 mt-1">
<input type="submit" value="Deduct" class="btn btn-danger mt-1">
...
<div class="col-6">
<!-- <button class="form-control btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addcustomer"style="margin-bottom:10px;"><i class="fa fa-minus"></i></button> -->
<div class="broder bg-success px-3 py-3">
<span class="text-white"><b>Refill Quantitiy</b></span>
...
<div class="d-flex">
<input type="number" name="second" class="form-control me-1 mt-1">
<input type="submit" value="Refill" class="btn btn-primary mt-1">
