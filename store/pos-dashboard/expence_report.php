...
?>
   ...
   <head>
      ...
      <title>Expense List | TheSharepage-POS </title>
   ...
   <body>
      <div class="container-fluid">
         <div class="row flex-nowrap">
            ...
            <div class="col py-3">
               <div class="row mb-4">
                  <div class="d-flex justify-content-between border-bottom mb-3">
                     ...
                     <a href="add_expense.php" class="btn btn-main mb-3"><span class="d-none d-sm-inline"><i class="fas fa-plus"></i> Add Expense</span></a>
                     </div>

                     <form action="expence_report.php?action=filter" method="post"> 
            <div class="row">
               <div class="col-2">
            ...
            <div class="col-1">
                  <a href="expence_report.php"  class="btn btn-secondary">Reset</a> 
               </div>
                  ...
                  <div class="col-12">
                     ...
                     <table id="table_id" class="display" data-order='[[ 0, "desc" ]]' data-page-length='25'>
                       ...
                       $result = $p->read_expence2($start_date, $end_date, $biller_id);
                           }else{
                            $result = $p->read_expense($pid, $uid);
                           }
                           ...
                           ?>
                                 <tr>
                                    ...
                                    $result5 = $p->readexpenseto($row['ExpenseCategory']);
                                    if ($result5) {
                                    ...
                                    ?></td>
                                    <td><?php
                                    $result7 = $p->readewarehouseto($row['warehouse']);
                                    if ($result7) {
                                    ...
                                    <td><?php
                                    $result4 = $p->read_account_to($row['account']);
                                    if ($result4) {
                                   ...
                                   echo $row4['account_name'];
                                    ...
                                    <!--<td style="padding: 8px 6px;">
                                       <a href="<?php echo $BaseUrl . '/store/pos-dashboard/edit_Expense.php?id=' . $row['id']; ?>" class="btn btn-main"><i class="fas fa-edit"></i></a>
