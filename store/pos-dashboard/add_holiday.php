                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-mb-3" style="width: 50% !important;">
                                            <label for="From" class="col-form-label">From<span style="color:red">*</span></label>
                                            <input type="date" class="form-control" name="from" id="from" required>
                                        </div>

                                        <div class="col-mb-3" style="width: 50% !important;">
                                            <label for="To" class="col-form-label">To<span style="color:red">*</span></label>
