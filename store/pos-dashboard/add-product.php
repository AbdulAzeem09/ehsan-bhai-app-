...
<form action="<?php echo $BaseUrl; ?>/store/pos-dashboard/add-product-detail.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data" class="" id="addProduct">
<div class="row">
<input type="hidden" name="currency" value="<?php echo $curr; ?>">
<div class="col-md-8 col-sm-12 mb-3">
<div class="d-flex mobile-view">
<input type="text" class="form-control shadowBox mb-3 me-2" id="itemNo" name="itemNo_in" placeholder="Item No(Required)*" value="" required>
<input type="date" class="form-control shadowBox mb-3 me-2" name="date_in" id="Date" placeholder="Date(Required)*" value="" required><!--
...
<input type="text" class="form-control shadowBox mb-3" id="productname" name="productname_in" placeholder="Product Name(Required)*" value="" required>
...
<input type="text" class="form-control shadowBox mb-3 me-2" id="atValue" name="atValue_in" placeholder="Set Att Value(Required)*" value="" required>
...
<span class="red" id="productimage_error" style="color:red"></span>
</div>
</div>
<div class="col-12">
...
<input type="number" class="form-control mb-3 me-2" id="pirce" name="pirce_in" placeholder="Price(Required)*" required>
</div>
<div class="col-auto mb-3">
<label class="form-check-label" for="invalidCheck2">Selling Cost</label>
<input type="number" class="form-control mb-3" id="cost" name="purchase_cost_in" placeholder="Cost(Required)*" required>
</div>

<div class="col-md-3 col-sm-12 mb-3">
<label class="form-control-label" for="invalidCheck2">Choose Supplier</label>
...
<div class="col-md-3 col-sm-12 mb-3">
<label class="form-check-label" for="invalidCheck2">Quantity</label>
<input type="number" class="form-control mb-3 disabled" id="lastReceiveDate" name="retailQuantity" placeholder=" Add Quantity(Required)*" required>
</div>
<!---<div class="col-auto mb-3">
...
<input type="number" class="form-control mb-3" id="sellingPrice" name="sellingPrice_in" placeholder="Selling Price" required>
</div>
<div class="col-auto mb-3">
<label class="form-check-label" for="invalidCheck2">Gross Profit</label>
<input type="number" class="form-control mb-3" id="grossprofit" name="grossprofit_in" placeholder="Gross Profit" required>
</div>---->

<div class="col-auto d-flex flex-column mb-3 mt-3">
<!--<div class="form-check mx-2">
<input class="form-check-input" type="checkbox" value="1" id="discountable" name="discountable_in">
<label class="form-check-label" for="discountable">Discountable</label>
</div>
<div class="form-check mx-2">
<input class="form-check-input" type="checkbox" value="1" name="funcationQty_in" id="funcationQty">
<label class="form-check-label" for="funcationQty">Fucntional Qty</label>
</div>--->
</div>
</div>
</div>
<div class="tab-pane active" id="vendors" role="tabpanel" aria-labelledby="vendors-tab">
<div class="row mobile-view">
...
<input type="number" class="form-control mb-3 me-2" id="cost" name="cost_in" placeholder="Cost" required>
</div>
<div class="col-md-3col-sm-12 mb-3">
...
<input type="number" class="form-control mb-3 me-2 disabled" id="lastReceiveCost" name="lastReceiveCost_in" placeholder="Last Receive Cost" required>
</div>--->
...
<div class="tab-pane active" id="barcode" role="tabpanel" aria-labelledby="barcode-tab">
<div class="row mobile-view">
<div class="col-md-6 col-sm-12 mb-3">
<label class="form-check-label" for="invalidCheck2">Barcode</label>
<input type="text" class="form-control shadowBox mb-3 me-2" id="barcode" name="barcode_in" onkeyup="checkbarcode(this.value)" placeholder="Barcode(Required)*" required>
<span id="barcode_error" style="color: red;"></span>
</div>

<div class="col-md-6 col-sm-12 mb-3">
<label for="recipient-name" class="form-check-label">Warehouse</label>
<select name="warehouse" id="warehouse" class="form-control shadowBox" required>
...
if (response != "") {
$("#barcode_error").text('Barcode already Used');
...
if (aa == 2) {
  ...
  Swal.fire("Please Enter Valid Barcode");
...
document.getElementById("image_file").addEventListener("change", function() {
  validateImageFile("image_file", "productimage_error");
});
