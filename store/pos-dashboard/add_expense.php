...
?>
  ...
  <head>
    ...
    <title> Add Expense  | TheSharepage-POS </title>
      ...
      <div class="row flex-nowrap">
        ...
        <div class="col py-3">
              ...
              <form action="add_expense.php" method="post" enctype="multipart/form-data">
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-mb-3" style="width: 33% !important;">
                      <label for="recipient-name" class="col-form-label">Expense Category<span class="text-danger">*</span></label>
                    ...
                    <div class="col-mb-3" style="width: 33% !important;">
                      <label for="recipient-name" class="col-form-label">Account<span class="text-danger">*</span></label>
                      <select name="account" id="account" class="form-control" required>
                        ...
                        ?>
                            <option value="<?php echo $row1['id']; ?>"><?php echo $row1['account_name']; ?></option>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" name="submit">Submit</a>
            </form>
