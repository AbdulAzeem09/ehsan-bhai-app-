...
<input type="text" class="form-control shadowBox mb-3 me-2" id="atValue" name="atValue_in" placeholder="Set Att Value(Required)*" value="<?php echo $row['atValue_in'];?>" required>
...
<option value="1" <?php if($row['product_type'] == "1"){ echo "selected" ;} ?> >Old</option>
<option value="2" <?php if($row['product_type'] == "2"){ echo "selected" ;} ?> >New</option>
...
<input type="number" class="form-control mb-3 me-2" id="pirce" name="pirce_in" placeholder="Price" value="<?php echo $row['pirce_in']; ?>">
</div>

<div class="col-auto mb-3">
<label class="form-check-label" for="invalidCheck2">Selling Cost</label>
<input type="number" class="form-control mb-3" id="cost" name="purchase_cost_in" placeholder="Cost" value="<?php echo $row['spPostingPrice']; ?>">
</div>
...
<input type="number" class="form-control mb-3 disabled"  id="lastReceiveDate" name="retailQuantity" placeholder=" " value="<?php echo $row['retailQuantity']; ?>">
</div>
...
<input type="number" class="form-control mb-3" id="sellingPrice" name="sellingPrice_in" placeholder="Selling Price" value="<?php echo $row['sellingPrice_in']; ?>">
</div>
<div class="col-auto mb-3">   
<label class="form-check-label" for="invalidCheck2">Gross Profit</label>
<input type="number" class="form-control mb-3" id="grossprofit" name="grossprofit_in" placeholder="Gross Profit" value="<?php echo $row['grossprofit_in']; ?>">
</div>--->
...
<input type="number" class="form-control mb-3 me-2" id="cost" name="cost_in" placeholder="Cost" value="<?php echo $row['cost_in']; ?>" >
</div>
<div class="col-md-3 col-sm-12 mb-3">
...
<input type="number" class="form-control mb-3 me-2 disabled"  id="lastReceiveCost" name="lastReceiveCost_in" placeholder="Last Receive Cost" value="<?php echo $row['lastReceiveCost_in']; ?>">
</div>  --->
...
?>
<option value="<?php echo $row6['id']; ?>" <?php if($row['warehouse_id'] == $row6['id']){ echo "selected";} ?>><?php echo $row6['warehouse']; ?></option>
