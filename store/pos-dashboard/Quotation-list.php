...
?>
   ...
   <head>
      ...
      <title>Quotation List | TheSharepage-POS </title>
...
$result = $p->read_pos($_SESSION['uid'],$_SESSION['pid']);  
...
?>
                           ...
                           $result_warehouse = $p->read_pos_warehouse($warehouse_id); 

                           if($result_warehouse){

                           $row1 = mysqli_fetch_assoc($result_warehouse);
                           }
                           echo $row1['warehouse'];
                           ...
                           $result_customer = $p->read_pos_customer($customer_id); 
                           if($result_customer){
                           ...
                           <td><a href="Quotation-view.php?id=<?php echo $row['id']; ?>">View</a></td>
                           </tr>  
                           <?php }} ?>                        
                        </tbody>
                     </table>
