    ...
    fclose($handle); 
                    ...
                    <div class="col-md-10" style="margin-top: 15px;">          
                      ...
                      <ul class="breadcrumb" style="background: white !important; ">
							...
							<form enctype="multipart/form-data" action="<?php echo $BaseUrl;?>/store/pos_dashboard1/add_bulk_vendor.php" method="post" id="sp-form-post" name="postform">
								...
								<div class="col-md-2">
									<div class="form-group">
										<button type="submit" class="btn butn_draf" style="border-radius: 20px;background-color: #1c6121;background-image: -webkit-linear-gradient(90deg,#1c6121 0,#1c6121 99%);" name="submit_retail" value="Upload">Upload</button>
												...
												<td>
												<a  href= "<?php echo $BaseUrl.'/store/pos_dashboard1/pos_csv/customer_cs1.csv'; ?>" >Sample CSV</a><br>
