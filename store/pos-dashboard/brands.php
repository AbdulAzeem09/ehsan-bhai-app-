...
<head>
   ...
   <title>Brand List | TheSharepage-POS </title>
    ...
    Delete Successfully  .
			   ...
			   <?php } ?> 
                  ...
                  <div class="row d-flex">                    
					...
					<div class="col-auto">
                         <button type="submit" name="submit"  onclick=" return fun_brand()" class="btn btn-main"><i class="fas fa-plus"></i> Add</button> 
                     </div>                      
                  </div> 
				  </form>
...
<div class="modal fade" id="editBrand" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
    <form action ="" method="post">
      <div class="modal-content" style="width: 65%; margin-left: 176px;
      ">
         ...
         <div class="modal-body">
            <div class="row d-flex">
               <div class="col-sm-12 mobile-view mb-3">
			    <input type="hidden" name="id" class="form-control" id="post_id">
        ...
        <div class="modal-footer">  
         ...
         <button type="submit" name="update" class="btn btn-main mb-3 me-2">Update</button>                
