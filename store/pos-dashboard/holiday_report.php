...
?>
    ...
    <head>
        ...
        <title>Holiday List | TheSharepage-POS </title>
                ...
                <div class="col py-3">
                    <div class="row mb-4">
                        <div class="d-flex justify-content-between border-bottom mb-3">
                            ...
                            <a href="add_holiday.php" class="btn btn-main mb-3"><span class="d-none d-sm-inline"><i class="fas fa-plus"></i> Holiday</span></a>

                        </div>
        <form action="holiday.php?action=filter" method="post"> 
            <div class="row">
               <div class="col-2">
            ...
            <div class="col-1">
                  <a href="holiday.php"  class="btn btn-secondary">Reset</a> 
               </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <table id="table_id" class="display" data-order='[[ 0, "desc" ]]' data-page-length='25'>
                                ...
                                <tbody>
                                   ...
                                   $result = $p->read_filterahol($start_date, $end_date);
                                    }else{
                                    $result = $p->read_holiday($_SESSION['pid'],$_SESSION['uid']);
                                    }
                                    if ($result) {
                                        $i = 1;
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <!--<td style="padding: 8px 6px;">
                                                    <a href="<?php echo $BaseUrl . '/store/pos-dashboard/edit_holiday.php?id=' . $row['id']; ?>" class="btn btn-main"><i class="fas fa-edit"></i></a>
