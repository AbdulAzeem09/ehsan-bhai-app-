                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-mb-3" style="width: 33% !important;">
                      ...
                      <select id="cars" name="department" id="department" class="form-control form-select">
                        ...
                        ?>
                            <option value="<?php echo $row['id']; ?>"><?php echo $row['department_in']; ?></option>
...
<select name="countryCode" class="form-select" id="countryCode">
  ...
  <input type="text" class="form-control" name="phone" id="phone" style="/* width: 40% !important; */">
</div>
</div>
                    <div class="col-mb-3" style="width: 33% !important;">
                  ...
                  <option value='<?php echo $row3['city_id']; ?>' <?php echo (isset($_SESSION['spPostCity']) && $_SESSION['spPostCity'] == $row3['city_id'])?'selected':''; ?>><?php echo $row3['city_title'];?></option> <?php
                    ...
                    <div class="col-mb-3" style="width: 33% !important;">
                      ...
                      <span class="red" id="image_error" style="color:red"></span>
                    </div>
