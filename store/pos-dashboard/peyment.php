                                 ...
                                 <div class="col-md-12">
                                    <div class="col-md-6" style="border-right:1px solid #ddd;">
                                       ...
                                       <form action="<?php echo $BaseUrl; ?>/store/pos-dashboard/peyment.php?id=<?php echo $_GET['id']; ?>" method="POST" id="paymentForm">
                                          ...
                                          <div class="form-group">
                                             <div class="row">
                                                <div class="col-md-3">
                                                   ...
                                                   <input type="text" name="cardExpMonth" style="width:110px;margin-left: -12px;" id="cardExpMonth" class="form-control" placeholder="MM" maxlength="2" onkeypress="return validateNumber(event);">
                                          ...
                                          <br>
                                          <div align="left">
                                             <input type="hidden" name="price" value="<?php echo $data['Gross_net']; ?>">
                                             <input type="hidden" name="total_amount" value="<?php echo $data['Gross_net']; ?>">
                                       ...
                                       <div class="table-responsive" id="order_table">
                                          <table class="table table-bordered table-striped">
                                             ...
                                             <td align="right"><button type="submit" class="btn butn_submit_real" style="border-radius: 25px;margin-left:5px;min-width:50px;" >UPDATE</button></td>-->
                                                   ...
                                                   ?>
                                                      <tr>
                                                         <td colspan="" align="right">Tax111</td>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td align="right"><strong><?php echo $data['currency']; ?> <?php echo $data['sub_total']; ?></strong></td>
                                                   </tr> -->
                                             </form>
                                             </tbody>
         ...
         <?php
            ...
            <body>
               ...
               <header class="site-header" id="header">
                  <h1 class="site-header__title" data-lead-id="site-header-title" style="font-size: 3.25rem;">Payment Done!</h1>
               </header>
