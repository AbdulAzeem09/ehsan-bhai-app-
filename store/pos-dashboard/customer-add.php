...
<button type="submit" id="addcust" onclick="form_submit()" class="btn btn-main me-3"><i class="fas fa-plus"></i> Add Customer</button>
</span>
</div>
...
<select class="form-control form-select shadowBox" id="submembership" name="submembership[]" multiple>
...
<div class="col-6 mb-3">
<input type="number" class="form-control shadowBox" id="form_qty" placeholder="Membership Quantity" name="form_quantity" value="" >
</div>
...
<span class="red" id="profile_img_error" style="color: red;"></span>
</div>
</div>
</div>
<div class="row">
...
<select class="form-control form-select shadowBox" id="select-payment" name="paymentterm">
<?php  
$p = new _pos;
$uid=$_SESSION['uid'];
//echo $uid;
//die('======');
$result5 = $p->read_data_payment1($uid);
//print_r($result5);
//die('=====');
if ($result5) {
$i = 1;
...
?>		 
<option value="<?php echo $row6['id'];  ?>"><?php echo $row6['payment_type'];  ?></option>
...
<div class="col-4">
<div class="d-flex me-1">
<select class="form-control form-select shadowBox" id="select-credit" name="creditterm">
...
<div class="col-4">
<select class="form-control form-select shadowBox" id="select-payment" name="paymentterm_type">
...
document.getElementById("image_file").addEventListener("change", function() {
  validateImageFile("image_file", "profile_img_error");
});
</script>
