...
<body>
  ...
  Successfully Submitted.
     ...
     Successfully updated .
               ...
               <h4 class="float-start"> Return Inventory</h4>               
            </div>
			 <form method="post" action="add_detail_return_inventory.php">
                  ...
                  <div class="mb-1">
                     <div class="input-group d-flex mobile-view">                        
                        <div class="col-md-6 col-sm-12 pe-2">
                           ...
                           <div class="d-flex">
                              <input type="text" class="form-control mb-3 mt-3 me-2" name="vender_id_in" placeholder="Vendor ID" aria-label="vendorID" aria-describedby="addon-wrapping" required >                                                   
                              <input type="text" class="form-control mb-3 mt-3 me-2" name="email_in" placeholder="Email" aria-label="Email" aria-describedby="addon-wrapping" required >                                                   
                              <input type="number" class="form-control mb-3 mt-3" name="phone_in" placeholder="Phone" aria-label="phone" aria-describedby="addon-wrapping" required >      
                           </div>                                             
                        </div>
                  ...
                  <div class="">
                        ...
                        <div class="d-flex justify-content-center input-group">
                           ...
                           <div class="col-auto float-end">
                              <button type="submit" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#productdata"> Add</button>
                           </div>                            
                        </div>
                     </form>
                  </div>
               ...
               <table id="example" class="table bg-light table-striped shadowBox">
				  ...
				  <?php
					$p = new _pos;
							...
							$result = $p->read_data_ret_inventory($_SESSION['uid']);    
					...
					if ($result) {
                     ...
                     <tr>
                        ...
                        <td> $<?php echo $row['t_cast']; ?> </td>
                        <td> <?php echo $row['markup_in']; ?> </td>
                        <td> <?php echo $row['gp_in']; ?> </td>
                        <td>$<?php echo $row['price_in']; ?>.00</td>
                        <td>
						...
						<a onclick="delete_inventory('<?php echo $BaseUrl?>/store/pos-dashboard/delete_ret_inventory.php?id=<?php echo $row['id'];?>&action=delete')" class="text-danger"> <i class="fas fa-trash"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <div class="modal-body">
        <form action="update_detail_return_inventory.php" method="post">
