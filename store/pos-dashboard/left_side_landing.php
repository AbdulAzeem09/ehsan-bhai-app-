...
<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-side">
	<div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 mainnav">
		...
		<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
			...
			<li>
				<a href="#product" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class="fab fa-product-hunt"></i> <span class="ms-1 d-none d-sm-inline">Products</span>  <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 1) ? "show" : ""; ?>" id="product" data-bs-parent="#menu">
					<li class="w-100">
...
<a href="add-product.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Add Product</span></a>
			...
			<li>
				<a href="#HRM" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class="fas fa-address-card"></i> <span class="ms-1 d-none d-sm-inline">HRM</span> <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 2) ? "show" : ""; ?>" id="HRM" data-bs-parent="#menu">
					<li class="w-100">
						<a href="department.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Department</span></a>
					</li>
					<li>
						<a href="employee.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Employee</span></a>
					</li>
					<li>
						<a href="attendance.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Attendance</span></a>
					</li>
					<li>
						<a href="pay_roll.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Payroll</span></a>
					</li>
					<li>
						<a href="holiday.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Holiday</span></a>
					</li>
					<li>
						<a href="accounts.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Accounts</span></a>
					</li>
				</ul>
			</li>

			<li>
				<a href="#expense" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class=" fas fa-laptop"></i> <span class="ms-1 d-none d-sm-inline">Expense</span> <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 3) ? "show" : ""; ?>" id="expense" data-bs-parent="#menu">
					<li class="w-100">
						<a href="ExpenseCategory.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Expense Category</span></a>
					</li>
					<li>
						<a href="ExpenseList.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Expense List</span></a>
					</li>
					<li>
						<a href="add_expense.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Add Expense</span></a>
					</li>
					<li>
						<a href="warehouse.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Warehouse</span></a>
					</li>
				</ul>
			</li>
...
-->
			<!--<li>
<a href="customer-add.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Customers</span></a>
</li>-->
			<!--<li class="w-100">
...
<a href="customer-sale-history.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Sales History</span></a>
			...
			<li>
				<a href="#suppliers" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class="fas fa-list-alt"></i> <span class="ms-1 d-none d-sm-inline">Suppliers</span> <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 4) ? "show" : ""; ?>" id="suppliers" data-bs-parent="#menu">
					<li class="w-100">
...
<a href="suppliers-sale-history.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Sales History</span></a>
			...
			<!--<li>
				...
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 5) ? "show" : ""; ?>" id="inventory" data-bs-parent="#menu">
					<li class="w-100">
					...
					<li>
						<a href="inventory-list.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Inventory's List</span></a>
					</li>
				</ul>
			</li>-->
			<!--<li>
				...
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 6) ? "show" : ""; ?>" id="purchase" data-bs-parent="#menu">
					<li class="w-100">
...
<a href="store.php" class="nav-link px-0 align-middle"><i class="fas fa-store"></i> <span class="ms-1 d-none d-sm-inline">Store</span></a>
			...
			<!-- <li>
				<a href="pos_payment_record.php?action=all" class="nav-link px-0 align-middle"><i class="fas fa-money-bill-wave"></i> <span class="ms-1 d-none d-sm-inline">Payment Details</span></a>
			</li> -->
			<li>
				<a href="payment.php" class="nav-link px-0 align-middle"><i class="fas fa-dollar-sign"></i> <span class="ms-1 d-none d-sm-inline">Payment</span></a>
			</li>
			<li>
				<a href="settingsto.php?record=tax_typee" class="nav-link px-0 align-middle"><i class="fas fa-cogs"></i> <span class="ms-1 d-none d-sm-inline"><table>Tax</table></span></a>
			</li>
			<li>
				<a href="settingsto.php?record=support_typee" class="nav-link px-0 align-middle"><i class="fas fa-cogs"></i> <span class="ms-1 d-none d-sm-inline">Support</span></a>
			</li>
			<li>
				<a href="#quotation" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class="fas fa-list-alt"></i> <span class="ms-1 d-none d-sm-inline">Quotation</span> <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 5) ? "show" : ""; ?>" id="quotation" data-bs-parent="#menu">
					<li class="w-100">
						<a href="Quotation-add.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Add Quotation</span></a>
					</li>
					<li>
						<a href="Quotation-list.php" class="nav-link px-0"> <span class="d-none d-sm-inline">List Quotation</span></a>
					</li>
				</ul>
			</li>
			...
			<li>
				<a href="#report" data-bs-toggle="collapse" class="nav-link px-0 align-middle" style="width: 180px;"><i class="fas fa-list-alt"></i> <span class="ms-1 d-none d-sm-inline">Report </span> <i class="fas fa-angle-down float-end"></i></a>
				<ul class="collapse nav flex-column ms-1 <?php echo ($active == 7) ? "show" : ""; ?>" id="report" data-bs-parent="#menu">
					<!--<li class="w-100">
						<a href="report1_list.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Top Product</span></a>
					</li>-->
					<li>
						<a href="top_product.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Top Product </span></a>
					</li>
					<li>
						<a href="warehouse_product.php" class="nav-link px-0"> <span class="d-none d-sm-inline">Warehouse Report </span></a>
					</li>

					<li>
				<a href="holiday_report.php" class="nav-link px-0 "> <span class="ms-1 d-none d-sm-inline">Holiday Report </span></a>
			</li>


			        <li>
						<a href="expence_report.php" class="nav-link px-0"> <span class="d-none d-sm-inline"> Expense Report  </span></a>
					</li>

					<li>
						<a href="supplier_report.php" class="nav-link px-0"> <span class="d-none d-sm-inline"> Supplier Report  </span></a>
					</li>
			...
			<!-- <li>
				<a href="membership_history.php" class="nav-link px-0 align-middle"><i class="fas fa-users"></i> <span class="ms-1 d-none d-sm-inline">Membership History</span></a>
			</li> -->
		...
		<div class="dropdown pb-4 profile">
			<a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" style="background-color: #3e2048;height: 54px;"  aria-expanded="false">
