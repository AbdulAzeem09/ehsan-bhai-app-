...
$res = $p->create_warehouse_($data);  
header("Location: warehouse.php");
}
if(isset($_GET['delid'])){

 $delid = $_GET['delid'];
 $p->remove_warehouse($delid);
 header("Location: warehouse.php");
}
?>
...
<title>Warehouse List | TheSharepage-POS </title>
...
<h3>Warehouse<small>[List]</small></h3>
<button type="button" class="btn btn-main mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><span class="d-none d-sm-inline"><i class="fas fa-plus"></i> Add House</span></button>
...
Swal.fire({
      ...
      if (result.isConfirmed) {
         window.location.href = "warehouse.php?delid=" + id;
