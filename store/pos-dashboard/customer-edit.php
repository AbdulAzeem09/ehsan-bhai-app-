...
<button type="submit" form="addcustomer" class="btn btn-main me-3"><i class="fas fa-save"></i> Update Customer</button>
</span>
</div>
<?php 
$p = new _pos;

$result = $p->read_data_id($postid);
...
<form action="<?php echo $BaseUrl; ?>/store/pos-dashboard/update_detail.php" method="post" enctype="multipart/form-data" class="" id="addcustomer">
...
<div class="col-6 mb-3">
<input type="text" class="form-control shadowBox" id="customername" placeholder="Customer Name" value="<?php echo $row['customer_name']; ?>" name="customername" required>
</div>
<div class="col-6 mb-3">
...
<option value="3" <?php if($row['customer_type'] == 3 ){ echo "selected";} ?> >Domestic</option>
</select>
</div>
</div>
<div class="row">
<div class="col-6 mb-3">
<input type="number" class="form-control shadowBox" id="customerphone" placeholder="Customer Phone" value="<?php echo $row['phone']; ?>" name="customerphone" required>
</div>
<div class="col-6 mb-3">
<input type="email" class="form-control shadowBox" id="customeremail" placeholder="Customer Email" value="<?php echo $row['email']; ?>"  name="customeremail"  required>
</div>
</div>
<div class="row">
...
<option value="<?php echo $row1['idspProfileType']; ?>" <?php if($row['profiletype'] == $row1['idspProfileType'] ){ echo "selected";} ?> ><?php echo $row1['spProfileTypeName']; ?></option>   
<?php   }
}
...
<br> 
<input onclick="fun_Membership_qty()" <?php if($row['membership'] == 1){ echo 'checked';} ?> class="form-radio-input" type="radio" value="1" id="Membership_qty"  name="membership">
<label class="form-radio-label" for="Membership_qty">Membership By Quantity</label>

<input onclick="fun_Membership_dur()" <?php if($row['membership'] == 2){ echo 'checked';} ?>  value="2" class="form-radio-input" type="radio" id="Membership_dur" name="membership" >
...
<input class="form-radio-input" type="radio" value="1" id="Membership_qty" name="membership" <?php if($row['membership']== 1){ echo "checked";}?>>
<label class="form-radio-label" for="Membership_qty">Membership By Quantity</label><br>
<input value="2" class="form-radio-input" type="radio" id="Membership_dur" name="membership" <?php if($row['membership']== 2){ echo "checked";}?>>
<label class="form-radio-label" for="Membership_dur">Membership By Duration</label>
...
<?php } ?>									
<input type="file" class="form-control shadowBox" id="image_file" name="profile_img" style="width:333px; text-align: center;">
...
<div class="row">
<div class="col-6 mb-3">   
<label for="spPostadeee_" class="lbl_2">Address</label>                           
...
<option value="7" <?php if($row['paymentterm_type'] == "7" ){ echo "selected";} ?> > Employee Discount t </option>                                                 
</select>
</div>
</div>
</div>
