...
<title>Department List | TheSharepage-POS </title>
...
<button type="button" class="btn btn-main mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><span class="d-none d-sm-inline"><i class="fas fa-plus"></i> Department</span></button>
...
<tr>
<td><?php echo $i++ ; ?></td>
<td><?php echo $row['department_in']; ?></td>                    
<td style="padding: 8px 6px;">
<a href="<?php echo $BaseUrl.'/store/pos-dashboard/department-edit.php?id='.$row['id'];?>" class="btn btn-main"><i class="fas fa-edit"></i></a>
      ...
      <div class="modal-body">
        <form action="add_department.php" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="department_in" id="department_in" required>
          </div>
          <!-- <div class="mb-3">
