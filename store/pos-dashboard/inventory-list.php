  ...
  Successfully .
     ...
     Successfully  .
               ...
               <div class="col-12">
                  ...
                  <table id="table_id" class="display"  data-order='[[ 1, "asc" ]]' data-page-length='10'>
                    <thead>
                      <tr>
                        <th>Supplier Name</th>
                        <th>Date</th>
				  ...
				  <?php
					$p = new _pos;
							...
							$result = $p->read_invt_receive($_SESSION['uid'],$_SESSION['pid']);
...
$result_1 = $p->read_supplier_id($row['supplier_in']); 
...
$customer_name = $row_1['customer_name']; 
                   ...
                   <tr>
                     ...
                     <td><?php echo $row['invDate_in']; ?></td>
                     <td><?php echo $row['vender_id_in']; ?></td>
                     <td><?php echo $row['phone_in']; ?></td>
                    
                     <td><?php echo $row['email_in']; ?></td>
