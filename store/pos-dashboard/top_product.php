     ...
     Delete Successfully .
			   ...
			   ?>
                  <tr>
                       ...
                       $result_customer = $catlist->re2_customer($customer_id); 
                       ...
                       <?php
                         ...
                         $cat2 = $catlist->rep1_list();
                         $rep2 = mysqli_fetch_assoc($cat2);

                       ?>
                       <td><?php echo $row['product_name']; ?></td>
                       <td><?php echo $row['quantity']; ?></td>
                       <td><?php echo $rep2['currency']." ".$row['unit_price']; ?></td>
                       <td><?php echo $rep2['currency']." ".$row['total_price']; ?></td>
