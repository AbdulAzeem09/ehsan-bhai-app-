...
<body>
   <div class="container-fluid">
      <div class="row flex-nowrap">
         ...
         <div class="col py-3">
            <div class="row mb-4">
			<?php if($_GET['msg']=='support'){?>
			<div class="alert alert-success" role="alert">
  Successfully Added !
</div>
			<?php }?>
			<?php if($_GET['msg']=='send'){?>
			<div class="alert alert-success" role="alert" id="alert_email">
                     ...
                     <div class="col-12">
                        <div class="row">
                           <div class="col-auto">
                              ...
                              <!-- <li class="nav-item <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>" href="#import_customer" role="tab" aria-controls="tax" data-bs-toggle="tab">Import Customer</a>
                                 </li>
								 
								  <li class="nav-item <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>" href="#import_products" role="tab" aria-controls="tax" data-bs-toggle="tab">Import Supplier</a>
                                 </li>
								 <li class="nav-item <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>" href="#customer_list" role="tab" aria-controls="tax" data-bs-toggle="tab">Balance Email</a>
                                 </li> -->
								 <li class="nav-item <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "tax_type"){echo 'active';} ?>" href="#welcome_customer_list" role="tab" aria-controls="tax" data-bs-toggle="tab">Welcome Email</a>
                                 </li>
								 
								<!-- <li class="nav-item <?php if($_GET['record'] == "email_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "email_type"){echo 'active';} ?>" href="#email_content" role="tab" aria-controls="tax" data-bs-toggle="tab">Email Content</a>
                                 </li>
								 
								  <li class="nav-item <?php if($_GET['record'] == "email_type"){echo 'active';} ?>">
                                    <a class="nav-link <?php if($_GET['record'] == "email_type"){echo 'active';} ?>" href="#welcome_email_content" role="tab" aria-controls="tax" data-bs-toggle="tab">Welcome Email Content</a>
                                 </li>-->
