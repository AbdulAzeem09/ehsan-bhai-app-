...
if($row_1['status'] == "1"){
$status = "<span class='font-li btn btn-success'>Success</span>";
}else{
$status = "<span class='font-li btn btn-danger'>Pending</span>";
}

if($row_1['biller_id']){
   
   $resultEmp = $p->read_employesData($row_1['biller_id']);
   if($resultEmp){						 
      $Empdata = mysqli_fetch_assoc($resultEmp);
   }
}
?>		
<div class="col-6 card shadow-sm">
<div class="card-header"><h4 class="card-title">Billing Details</h4></div>	
<div class="card-body">
<p class="card-text"><b>Name:</b> <?= $customername; ?></p>
...
<div class="col-6 card shadow-sm"> 
  ...
  <div class="card-header"><h4 class="card-title">Biller Details </h4></div>
  <div class="card-body">
   
  <p class="card-text"><b>Biller Name:</b> <?= $Empdata['name']; ?></p>
  <p class="card-text"><b>Billing Date:</b> <?= $date; ?></p>
...
<table class="table table-borderless" >
    <tbody>
<?php
    $tax=($Gross_net-$payment_amount);
    ?>
      <tr><th>Sub Total:</th><td><?php  echo $currency ;?>&nbsp;<?= $sub_total; ?></td></tr>
      <tr><th>Discount:</th><td><?php  echo $currency ;?>&nbsp;<?= $discount_by_net; ?></td></tr>
      <tr>
    <th>tax:</th>
    <td>
        <?php
     echo $currency . "&nbsp;" . $tax . " (" . ($tax * 100 / $payment_amount) . "%)";
      ...
      <tr><th>Total Amount:</th><td><?php  echo $currency ;?>&nbsp;<?= $Gross_net; ?></td></tr>
      <!-- <tr><th>Payment Amount:</th><td><?php  echo $currency ;?>&nbsp;<?= $payment_amount; ?></td></tr> -->
      <tr><th>Payment Type:</th><td><?= $type_payment; ?></td></tr>
    </tbody>
  </table>
  </div>
  </div>
