...
<style>
 ...
 <section class="main_box">
            <div class="container">
			<a href="<?php echo $BaseUrl.'/store/pos_dashboard/add_sales.php'; ?>" class="btn btn-primary pull-right">Add Sales</a>
			&nbsp;&nbsp;&nbsp;<a style="margin-right: 12px" href="<?php echo $BaseUrl.'/store/pos_dashboard/add_bulk_sales.php'; ?>" class="btn btn-primary pull-right">Import Sales</a>
                <div class="row">
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($result)) {
																	...
																	<td></td>
																	  ...
																	  <td class="text-center "><span class="smalldot"><?php echo $row['iteam']; ?></span></td>
																	   <td class="text-center "><span class="smalldot"><?php echo $row['size']; ?></span></td>
                                                           
                                                           
															<td class="text-center"> <?php echo $row['date']; ?> </td>
															<td class="text-center">
										<a href="<?php echo $BaseUrl.'/store/pos_dashboard1/update_sales.php/?postid='.$row['id']; ?>" class="" data-postid="<?php echo $row['id'];?>"><i style="font-size: 18px;" class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
