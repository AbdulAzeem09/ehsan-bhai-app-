...
<form action="add_current_detail.php" method="post" enctype="multipart/form-data" class="" >  
...
<select id="qty" class="form-control" name="membership_name">
...
<div class="form-group">        
<div class="">
<button type="submit" name="btn1" class="btn btn-default Add_adderess">Add Membership</button>  
</div>
</div>
  </div>
