...
<html lang="en-US">
                ...
                <div class="row">
                  <!--   <div class="sidebar col-md-2 no-padding left_store_menu" id="sidebar" >
                    ...
                    <div class="col-md-10">                        
                        ...
                        <?php 
                        $storeTitle = "Buyer Dashboard / Prepare to shipment";
                            ...
                            <!--   <div class="col-md-12 no-padding">
                                  <ul class="breadcrumb" style="background-color: #fff;">
                                      <li><a href="<?php echo $BaseUrl.'/store/dashboard/sell_dashboard.php';?>">Seller Dashboard</a></li>
                                       <li><a href="#">Prepare to shipment</a></li>
    ...
    border-color: #BACCE8;">
                        <ul class="nav nav-tabs">
                            ...
                            <li  class="active"><a href="#tab2warning" data-toggle="tab">Prepare to Shipment</a></li>
                ...
                <div class="panel-body">
                    <div class="tab-content">
                     ...
                     <div class="col-md-12 no-padding">
                        ...
                        <div class="tab-pane fade in active" id="tab2warning">  <div class="col-md-12 no-padding">
                                <div class="">
                                    <div class="table-responsive">
                                        <table class="table tbl_store_setting" >
                                            <thead>
                        ...
                        <div class="tab-pane fade" id="tab4warning">  <div class="col-md-12 no-padding">
                                <div class="">
                                    <div class="table-responsive">
                                        <table class="table tbl_store_setting" >
                                            <thead>
