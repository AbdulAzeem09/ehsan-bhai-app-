...
<!-- <td></?php echo $i; ?></td> -->
<td></td>
  <td class="eventcapitalize" style="width: 150px;">
      <a href="<?php echo $BaseUrl.'/friends/?profileid='.$row['buyerProfileid']; ?>" target="_blank">
          <?php 
          $p = new _spprofiles;
          $result2 = $p->read($row['buyerProfileid']);
          if ($result2) {
  ...
  <td class="eventcapitalize" style="text-align: left;">
...
<a href="<?= $BaseUrl; ?>/store/dashboard/reply_enquiry_seller.php?id=<?= $id; ?>" ><i style="color:#428bca" title="View" class="fa fa-eye" ></i></a>
  </td>
