...
<div class="col-md-12 pro_detail_box" style=" margin: 20px; ">
		<div class="row ticket-reply markdown-content staff">
           ...
           <div class="message1">
					...
					<a href="/store/detail.php?catid=1&postid=<?php echo $row1['spPostings_idspPostings']; ?>"><?php echo 'Product Tittle : '.$prtitle; ?></a><br>
...
<form action="" method="post">
		...
		<input type="hidden" value="<?php echo $buyer_id; ?>" name="receiver_id">
		<input type="hidden" value="<?php echo $id; ?>" name="enquiry_id">
		<input type="hidden" value="<?php echo $_SESSION['pid']; ?>" name="sender_id">
		<input type="hidden" value="<?php echo $row1['spPostings_idspPostings']; ?>" name="product_id">
