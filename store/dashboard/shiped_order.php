                ...
                <div class="row">
                   <!--  <div class="sidebar col-md-2 no-padding left_store_menu" id="sidebar" >
                    ...
                    <div class="col-md-10">                        
                        ...
                        <?php 
                        $storeTitle = "Buyer Dashboard / Shipped Order";
   ...
   <div class="col-md-12">
    ...
    border-color: #BACCE8;">
                        <ul class="nav nav-tabs">
                            ...
                            <li  class="active"><a href="#tab3warning" data-toggle="tab">Shipped Order</a></li>
                          <!--   <li class="dropdown">
                ...
                <div class="panel-body">
                    <div class="tab-content">
                     ...
                     <div class="col-md-12 no-padding">
                        ...
                        <div class="tab-pane fade in active" id="tab3warning"><div class="col-md-12 no-padding">
                                <div class="">
                                    <div class="table-responsive">
                                        <table class="table tbl_store_setting" >
                                            <thead>
