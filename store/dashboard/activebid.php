...
<li><a href="<?php echo $BaseUrl.'/store/dashboard/';?>" class="<?php echo ($activePage == 1 || $activePage == 15 || $activePage == 7 || $activePage == 23 || $activePage == 24 ||  $activePage = 50)?'active':''?>">Buyer Dashboard</a></li>
</ul>
</div>
...
<li class="active"><a href="#tab1warning" data-toggle="tab">Active Bid</a></li>
<li><a href="#tab2warning" data-toggle="tab">Awarded Bid</a></li>
...
$result = $p->active_auction_bid($_SESSION['pid']);
if($result!=false){
$table="example1";
}
else {
...
<link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
<table class="table table-striped table-class" id= "example1" style="width :100%;">
...
$result2 = $p->read($row['spPostings_idspPostings']);
if($result2!=false){
...
//print_r($row);die;
$id=$row['id'];
$sellerid=$row['spProfiles_idspProfiles'];
$curr=$row2['default_currency'];
$dt = new DateTime($row['bid_timestamp']);
//$edt = new DateTime($row['spPostingExpDt']);
$mybid=$row['auctionPrice'];


?>
<td></td>
<td class="text-center"><?php echo $i; ?></td>
<td><a href="<?php echo $BaseUrl.'/store/detail.php?catid=1&postid='.$row2['idspPostings']; ?>"><?php echo $row2['spPostingTitle']; ?></a></td>

<td>&nbsp;<?php echo $curr.' '.$row['auctionPrice']; ?></td>
<td>&nbsp;<?php echo $curr.' '.$row['lastBid']; ?></td>
...
$result = $p->awarded_auction_bid($_SESSION['pid']);
//var_dump($result);
...
<!-- <table class="table tbl_store_setting display " id="<?php echo $tableid2;?>" cellspacing="0" width="100%" > -->
...
<td><?php if($row['status']==1){
echo "<span style='color:green;'>Awarded</span>
<a href=$BaseUrl/store/dashboard/bid_payment.php?id=$id&curr=$curr&mybid=$mybid&sellerid=$sellerid class='btn btn-primary'>Pay</a>
";
...
/*$result = $p->mydeactiveauctionbid($_SESSION['pid']);*/
$result = $p->paid_auction_bid($_SESSION['pid']);
...
$result3=$p->read_bid_wallet($row['id']);
if($result3!=false){
...
<td></td>
<td class="text-center"></?php echo $i; ?></td>
<td><a href="<?php echo $BaseUrl.'/store/detail.php?catid=1&postid='.$row['idspPostings']; ?>"><?php echo ucwords($row2['spPostingTitle']); ?></a></td>
<td><?php echo $curr.' '.$row['auctionPrice']; ?></td>
<!-- <td><?php //echo $row3['balanceTransaction']; ?></td>
