...
$last_id = $cur->update_feature_bid($data1,$id_bid);


 
 $re = new _redirect;
    $re->redirect($BaseUrl."store/dashboard/activebid.php");
...
<form action="<?php echo $BaseUrl;?>/store/dashboard/bid_payment.php?postid=<?php echo $_GET['id'];?>" method="POST" id="paymentForm">	
...
<input type="hidden" name="price" value="<?php echo $_GET['mybid']; ?>">
<input type="hidden" name="total_amount" value="<?php echo $_GET['mybid']; ?>">
<input type="hidden" name="currency_code" value="<?php echo $_GET['curr']; ?>">
