        ...
        <section class="main_box">
            <div class="container">
                <div class="row">
				  ...
				  $image->validateCsvExtension($_FILES['file']);
...
echo $data[14];
		...
		$alldata = array( "skucode" => $data[0],
								   ...
								   "quantitytype " => $data[3],
									 ...
									 "retailDiscount" => $data[6],
									  "retailSpecDiscount" => $data[7],
							    	  "retailQuantity" => $data[8],
		                             "retailStatus" => $data[9],
									  "is_cancel" => $data[10],
									   "is_refund" => $data[11],
									    "specification" => $data[12],
										 "spPostingNotes" => $data[13],
										  "sippingcharge" => $data[14],
										   "spProfiles_idspProfiles" => $pid,
									  ...
									  "is_cancel" => $data[10],
									   "is_refund" => $data[11],
									    "specification" => $data[12],
										 "spPostingNotes" => $data[13],
										  "sippingcharge" => $data[14],
										   "weight_shipping" => $data[15],
										     "width_shipping" => $data[16],
											   "height_shipping" => $data[17],
											     "depth_shipping" => $data[18],
										   "spProfiles_idspProfiles" => $pid,
										    "spPostingsFlag" => $spflag, 
											 "spCategories_idspCategory" => $idspCategory,
											  "spPostingVisibility" => $spPostingVisibility,
                      ...
                      <ul class="breadcrumb" style="background: white !important; ">
								...
								<div class="col-md-2">
								  ...
								  <div class="col-md-4">
									...
									<input type="file" name="file"  id="file" accept=".csv" style="display: block;">
										...
										<span class="red"></span><span class="red" id="error_title"></span>
								</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										<button type="submit" class="btn butn_draf" style="border-radius: 20px;background-color: #1c6121;background-image: -webkit-linear-gradient(90deg,#1c6121 0,#1c6121 99%);" name="submit_retail" value="Upload">Upload</button>
												...
												<td>
												<a  href= "<?php echo $BaseUrl.'/store/bulkimport/retail_1.csv'; ?>" >Free Template</a><br>
							...
							<div class="col-md-12 ">
								...
								<div class="col-md-2">
								  ...
								  <div class="col-md-4">
									<div class="form-group">
									<input type="file" name="file"  id="file1" accept=".csv" style="display: block;">
										</div>
									    <span class="red"></span><span class="red" id="error_title1"></span>
								</div>
                          ...
                          <tr>
                           <td>
								...
								<div class="col-md-2">
								  ...
								  <div class="col-md-4">
									<div class="form-group">
									<input type="file" name="file"  id="file3" accept=".csv" style="display: block;">
										</div>
										  <span class="red"></span><span class="red" id="error_title3"></span>
								</div>
								<div class="col-md-2">
									<div class="form-group">
...
document.getElementById("file").addEventListener("change", function() {
  validatecsvFile("file", "error_title");
});

document.getElementById("file1").addEventListener("change", function() {
  validatecsvFile("file1", "error_title1");
});
document.getElementById("file3").addEventListener("change", function() {
  validatecsvFile("file3", "error_title3");
});
</script>
