...
<td><?php echo $curr.' '.$row['retailSpecDiscount']; ?></td>
...
<a href="<?php echo $BaseUrl.'/store/detail.php?catid=1&postid='.$row['idspPostings']; ?>" target="_blank"><i title="View" style="color:#428bca" class="fa fa-eye"></i></a>
