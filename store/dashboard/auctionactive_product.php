...
<input type="text" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="Search.." class="form-control">
                             ...
                             <div class="col-md-12">
                                <div class="">
                                    ...
                                    <link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
                                    <table class="table table-striped table-class tbl_store_setting" id= "example">
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?php echo $BaseUrl.'/store/dashboard/bid_detail.php?catid=1&postid='.$row['idspPostings']; ?>" target="_blank"><i style="color:#428bca" title="View" class="fa fa-eye"></i></a>
...
<input type="text" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="Search.." class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="">
                                    <div class="table-responsive1">
                                    <link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
                                    <table class="table table-striped tbl_store_setting table-class" id= "example1">
                                                ...
                                                if ($result!=false) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td class="text-center">
                                                                 <a href="<?php echo $BaseUrl.'/store/dashboard/bid_detail.php?catid=1&postid='.$row['idspPostings']; ?>"><i style="color:#428bca"  title="View" class="fa fa-eye"></i></a> 
																 <!--<a href="<?php //echo $BaseUrl.'/store/detail.php?catid=1&postid='.$row['idspPostings']; ?>" target="_blank"><i class="fa fa-eye"></i></a>-->
																     <a href="<?php echo $BaseUrl.'/post-ad/sell/?postid='.$row['idspPostings']; ?>"><i  style="color:#428bca" title="Edit"  class="fa fa-pencil" ></i></a>
