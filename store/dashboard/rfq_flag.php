...
<h1 style="font-size:35px;"><b>RFQ FLAGS</b></h1>
</div> -->
<div class="row">
...
<link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
<table class="table table-striped table-class" id= "example2" style="width: 100%;">
<!-- <table id="example" class="display" cellspacing="0" width="100%" >
<thead style="background-color: #56966f;color:white;"> -->
<thead>
<tr>
<th> </th>
<th>Name</th>
...
?>
<a href="<?php echo $BaseUrl ?>/friends/?profileid=<?php echo $result;?>"><?php echo $row88['spProfileName'];?></a>



</td>
<td>
<a href="<?php echo $BaseUrl;?>/store/detail.php?catid=1&postid=<?php echo $pr_id; ?>"><?php echo $prname;?></a>
