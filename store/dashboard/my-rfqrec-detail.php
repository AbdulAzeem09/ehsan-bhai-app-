            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        $storeTitle = " (<small>My RFQ Detail Conversation</small>)";
                        ...
                        $q = new _rfq;
                        $p = new _spprofiles;
                        $result2 = $q->readRfqConvRec($_GET['rfq'], $_SESSION['pid']);
                        //echo $q->rfc->sql;
                        if ($result2) {
                                ...
                                <div class="widget-area no-padding blank">
                                    <div class="status-upload">
                                        <form action="addrfqConv.php" method="post" >
                                            ...
                                            <input type="hidden" name="idspProfile_receiver" value="<?php echo $row['spProfile_idspProfiles']; ?>">
