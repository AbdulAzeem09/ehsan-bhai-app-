...
<div class="col-md-12 ">
<!--<h4 style="color: #0B241E!important;">EXPIRED PRODUCTS: </h4>-->
<div class="">
...
&nbsp;<?php echo $curr.' '.$row['retailSpecDiscount']; ?></td>
<td><?php echo $dt->format('d M Y'); ?></td>
<td><?php echo $edt->format('d M Y'); ?></td>

<td class="text-center">
<a href="<?php echo $BaseUrl.'/post-ad/sell/?postid='.$row['idspPostings'].'&exp=1'; ?>"><i title="Edit" style="color:#428bca" class="fa fa-pencil" ></i></a>
