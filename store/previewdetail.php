    ...
    window.location.href = "detail.php?postid=<?php echo $postId; ?>&colorid="+id;
    }*/
    ...
    ?>
    <input style="border-radius: 19px;background-color: #e6eeff;padding:18px 10px;width: <?php echo $priceWidth ?>;" type="text" class="form-control" name="txtStoreSearch" placeholder="Search For Products in <?php echo $selltype; ?>" required>
    <button type="submit" class=" btnd_store btn btn-info" name="btnSearchStore" style="padding: 10px 36px;border-radius: 20px;background-color: #035049;">Search</button>
    <?php if ($profileType != '2' && $profileType != '5') { ?>
    <a href="<?php echo $BaseUrl ?>/post-ad/sell/?post" class="btn sell" style="width: auto;background-color:#FFA500; color:white; font-size:13px; padding: 9px 30px!important;  border-radius: 19px!important;">Sell Product</a>
    <?php } ?>
    </div>
    </form>
    ...
    ?>
    <input type="number" class="form-control input-number text-center " style="width: 35% !important; "  id="quantity" name="spOrderQty" value="<?php echo $minorderqty; ?>" min="<?php echo $minorderqty; ?>" onkeyup="this.value = minmax(this.value, <?php echo $minorderqty; ?>, <?php echo $available; ?>)"  maxlength="5" />
    ...
    <div style="display: none;" class="btn_box <?php echo ($Sell_uid == $_SESSION['uid']) ? 'hidden' : ''; ?>">
    ...
    echo "<button type='submit' name='buy_now' style='width:94px;float:right;margin-top:-3px' class='btn btn_cart_buy btn_buy_now ' id='" . ($available == 0 ? "" : "buytocart") . "'  data-postid='" . $postId . "'  data-profileid='" . $_SESSION["pid"] . "' data-categoryid='" . $catid . "' name='' " . ($available == 0 || $exda < $today ? "" : "") . "style='background-color:#ff901d!important;'>Buy Now</button>";
    }
    } else {
    ...
    if ($_SESSION['guet_yes'] != 'yes') {
    echo "<button type='submit'  style='width:90px;float:right;margin-left: 10px;'  name='addtocart' class='btn btn_cart btn_add_to_cart " . ($available == 0 ? "disabled" : "") . "' id='" . ($available == 0 ? "" : "addtocart") . "'  data-postid='" . $postId . "'  data-profileid='" . $_SESSION["pid"] . "' data-categoryid='" . $catid . "'>Add to cart</button>";
    }
    }
    }
    } else {
    ...
    <button type="button" class="btn btn-close db_btn db_orangebtn" data-dismiss="modal" 
    style="margin-bottom: 0px; !important" >Close</button>
    ...
    <button style="height:40px; width:150px; border-radius:20px;  background-color:#ff7676; float:right;background-color: #ffffff; margin-top: -25px;"> Request For Quote</button></a>
    ...
    <span id="wholsaleunfavt"><a onclick="wholsaleunfavte('<?php echo $postId ?>','<?php echo $_SESSION['pid']; ?>') " class="wholsaleunfav" data-pid="<?php echo $_SESSION['pid']; ?>" data-postid="<?php echo $postId ?>"><i class="fa fa-heart" style="font-size:25px;padding:5px 9px 0px;float:right;"></i> </a></span>&nbsp;&nbsp;&nbsp;&nbsp;

    <?php
    } else {
    ?>
    <span id="wholsalefavt">
    <a onclick="wholsalefavte('<?php echo $postId ?>','<?php echo $_SESSION['pid']; ?>')" class="wholsalefav" data-pid="<?php echo $_SESSION['pid']; ?>" data-postid="<?php echo $postId ?>"><i class="fa fa-heart-o" style="font-size:25px;padding:7px 9px;float:right;"></i></a></span>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <!--<a  class="wholsalefav" id="add_heart" data-postid2="<?php echo $postId; ?>"><i class="fa fa-heart-o alert2" style="font-size:25px;padding:7px 0px"></i></a>


    <a  class="wholsalefav" id="del_heart" data-postid3="<?php echo $postId; ?>"><i class="fa fa-heart-o alert2" style="font-size:25px;padding:7px 0px"></i></a>   -->
    <br>
...
<!--     <div class="card mt-2"> <span>Similiar items:</span>
 -->    <div style="display: none;" class="similar-products mt-2 d-flex flex-row">
...
<div class="col-md-6 pull-right " style="padding-bottom: 10px;padding-right: 0px;margin-top: -80px;">

<form action="prevpublish.php" method="post" style="
    margin-top: 15px;
">

<input type="hidden" value="<?php echo $postId;?>" name="postid">
<button type='submit' class='btn  btn_add_to_cart btnpublishpre ' style="width: 25%!important; float: right;background-color:#50ad50!important;margin-right: 5px;" >Publish</button>

</form>
<?php if (isset($_SESSION['sign-up']) && $_SESSION['sign-up'] == 1) { ?>
  <a href="<?php echo $BaseUrl . '/registration-steps.php?pageid=7'; ?>"   class="btn btn_add_to_cart btnpublishpre" style="width: 25%!important; float: right;margin-right: 5px;background-color: red!important;">Cancel</a><?php } ?>

<?php if (!isset($_SESSION['sign-up']) && $_SESSION['sign-up'] != 1) { ?>
<a href="<?php echo $BaseUrl;?>/post-ad/sell/?postid=<?php echo $postId;?>" title="" id="btnpublishpre" class='btn btn_add_to_cart btnpublishpre' style="width: 24%!important; float:right;margin-right: 5px;background-color: #d39c00!important; ">Edit</a>

<button type='button' id="delpreviewdraft" data-postid="<?php echo $postId;?>" class='btn btn_add_to_cart btnpublishpre delpreviewdraft' style="width: 25%!important; float: right;margin-right: 5px;background-color: red!important;" >Delete</button>
<?php } ?>
</div>
    ...
    var auctionPrice_co = "<?php echo $auctionPrice_co; ?>";
    ...
    $("#wholsaleunfavt").html('<span id="wholsalefavt"><a onclick="wholsalefavte(' + postid + ',' + pid + ')" class="wholsalefav" data-pid="' + pid + '" data-postid="' + postid + '"><i class="fa fa-heart-o" style="font-size:25px;padding:7px 9px;float:right;"></i></a></span>');
