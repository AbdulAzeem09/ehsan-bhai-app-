        ...
        <section class="main_box">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div id="demo">
                            <a href="../img/no.png" title="medal sygnowany S.D. (Sebastian Dadler) wybity w 1636 roku" data-spzoom data-spzoom-width="200" data-spzoom-height="200">
                                <img src="../img/no.png" alt="Image"/>
                            </a>
                        </div>
                                    ...
                                    <div class="row no-margin">
                                        ...
                                        <div class="col-md-6">
                                            <div class="product_detail_right">
                                                <ul class="pro_add">
                                                    <li><?php echo $City.', '.$Country.' | Added on '.$dt->format('d M');?>,<br>
                                                        Ad ID: AEF-<?php echo $_GET['postid'];?></li>
                                                </ul>
                                                <?php
