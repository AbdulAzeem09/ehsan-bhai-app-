 ...
 <section class="main_box">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php 
                        if($_SERVER['REQUEST_URI'] == "/my-store/") {
...
/*print_r($_SERVER['PHP_SELF']);*/
  if($_SERVER['REQUEST_URI'] == "/my-store/" || $_SERVER['PHP_SELF'] == "/my-store/index.php") {?>
                <div class="row no-margin">
                            ...
                            <div class="col-md-12 no-padding">
                                <div class="top_banner">
                                    ...
                                    <?php } else {?>
                                        <img src="<?php echo $BaseUrl;?>/assets/images/bg/top_banner.jpg" class="img-responsive" alt="" style="border-radius:12px;" />
                                        <div style="position: absolute!important;
                                            bottom: 14px!important;
                                            font-size: 26px;
                                            background-color: white;
     ...
     <?php }?>
                    ...
                    <!--     <div class="carousel carousel-showmanymovetwo slide" id="itemslider_three">
                        <div class="carousel-inner">
                         ...
                         <div class="item">
                            <div class="top_banner">
                                    <img src="<?php echo $BaseUrl;?>/assets/images/bg/LUX-WEB-BANNER.jpg" class="img-responsive" alt="" />
                                </div>  
                            </div>   
                             <div class="item">
                            <div class="top_banner">
                                    <img src="<?php echo $BaseUrl;?>/assets/images/bg/cure.jpg" class="img-responsive" alt="" />
                                </div>  
                            </div> 
        ...
        <div class="breadcrumb_box m_btm_10" style="border-radius: 23px;padding: 3px 3px;  ">
                    ...
                    <form method="POST" action="<?php echo $BaseUrl.'/my-store/'; ?>" style="margin-block-end: 2px!important;">
                     ...
                     <div class="" style="padding-top: 3px;padding-left: 3px;">
                        ...
                        <input style="border-radius: 20px;background-color: #e6eeff;width:80%!important;display:inline-block;  height: 40px;" type="text" class="form-control" name="txtStoreSearch" value="<?php if(isset($_POST['txtStoreSearch'])){ echo $_POST['txtStoreSearch'];  }?>" placeholder="Search For Products" />
                        <button type="submit" class="btn btnd_store" name="btnSearchStore" style=" width: 145px!important;">Search <!-- store --></button>          
                     </div>                                
                  </form>
    ...
    <form id="price_form" method="POST" action="<?php echo $BaseUrl.'/my-store/'; ?>" style="margin-block-end: 2px!important;">
    <?php if($spProfileType != '2' && $spProfileType != '5') { 
        $priceWidth = "170px";
    } else {
        $priceWidth = "100%";
    }
    ?> 
    <select class="form-control pull-right no-radius" id="dynamic_price"style="width: <?php echo $priceWidth ?>;display: inline;margin-left: 5px;border-radius: 20px; height: 40px;margin-right: 4px;" name="pricedropdown">
                            ...
                            <option value="Desc"  <?php if($_POST["pricedropdown"] == 'Desc') echo "selected"; ?>>Desc</option>
                                   ...
                                   <!--  <div class="listingview pull-right" style="display: inline">
                                    ...
                                    <?php if($spProfileType != '2' && $spProfileType != '5') { ?>
                                     <a href="<?php echo $BaseUrl ?>/post-ad/sell/?post" class="btn store_search_btn db_btn db_orangebtn sell" style="width: auto;background-color:#2ba805!important;padding: 10px  33px!important;     margin-right: 18px!important;">Sell Product</a>
                                     <?php } ?>
                                </div>
                            </div>
                                    ...
                                    while ($rows = mysqli_fetch_assoc($res)) {?>
                                        ...
                                        <div class="col-xs-5ths">
                                          <!-- <div class="featured_box text-center"> -->
                                            <div class="featured_box " style="height:274px;">
                        ...
                        <div class="carousel carousel-showmanymoveone c_four slide" id="itemslider_four">
                                ...
                                if($resw != false){
                                    ...
                                    <div class="item <?php echo ($active == 0)?'active':'';?>">
                                        <div class="col-xs-5ths">
                                          <!-- <div class="featured_box text-center"> -->
                                            <div class="featured_box" style="height:273px;">
                                            <div class="img_fe_box" style="border: 0px solid #ccc;">
...
<!-- Auction open -->
                ...
                //$p = new _postingview;
                                  /*$p = new _productposting;*/
                                    ...
                                    //public store
                                    $res = $p->search_mystore("Auction", 1, $txtStoreSearch,$_SESSION['pid']);
                              

                              }else if(isset($_POST["pricedropdown"]) && $_POST["pricedropdown"] == 'Desc'){

                               $res = $p->myAuctionDESCproduct(1,$_SESSION['pid']);      

                            // echo $p->ta->sql;

                               }else if(isset($_POST["pricedropdown"]) && $_POST["pricedropdown"] == 'Asc'){

                                 $res = $p->myAuctionASCproduct(1,$_SESSION['pid']);

                               //  echo $p->ta->sql;

                               }else{

                                $res = $p->myauctionproduct(1,$_SESSION['pid']);
                              }
...
*/
                                  ...
                                  if($res != false){
                                    $auctionRecordCount = mysqli_num_rows($res);
                                    while ($rows = mysqli_fetch_assoc($res)) {
                                     /* echo "<pre>";
                                    print_r($rows) ; */
    ...
    <div class="item <?php echo ($active == 0)?'active':'';?>">
                                        <div class="col-xs-5ths">
                                         <!--  <div class="featured_box text-center"> -->
                                           <div class="featured_box " style="height:248px;">
                                            <div class="img_fe_box" style="border: 0px solid #ccc;">
                                 <a href="<?php echo $BaseUrl.'/'.$folder.'/detail.php?catid=1&postid='.$rows['idspPostings'];?>">
                                              <?php
                                                $pic = new _productpic;
    ...
    <div class="modal-dialog">
        <div class="modal-content sharestorepos bradius-15" style="width: 800px;">
            ...
            <div class="modal-footer bg-white br_radius_bottom">
                <button type="button" class="btn btn-primary" id="btnbannerimg">Upload</button>
                &nbsp;
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content sharestorepos bradius-15">
            <form action="<?php echo $BaseUrl ?>/my-store/updatestorename.php" method="post" class="">
                ...
                <div class="modal-footer bg-white br_radius_bottom">
                    <button type="submit" id="change_store_name" name="change_store_name" class="btn btn-submit db_btn db_primarybtn">Change</button>
...
//alert(auction_exp);
 ...
 <script type="text/javascript">
          ...
          $(document).ready(function(){
            $('#itemslider_one').carousel({ interval: 5000 });
            ...
            $('#itemslider_four').carousel({ interval: 5000 });
            ...
            $('#itemslider_five').carousel({ interval: 5000 });
