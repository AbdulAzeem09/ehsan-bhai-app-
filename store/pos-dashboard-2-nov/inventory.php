...
<style>
 ...
 <section class="main_box">
            <div class="container">
			<a href="<?php echo $BaseUrl.'/store/pos_dashboard/add_inventory.php'; ?>" class="btn btn-primary pull-right">Add Inventory</a>
			&nbsp;&nbsp;&nbsp;<a style="margin-right: 12px" href="<?php echo $BaseUrl.'/store/pos_dashboard/add_bulk_inventory.php'; ?>" class="btn btn-primary pull-right">Import Inventory</a>
                <div class="row">
                                                            ...
                                                            if ($result) {
                                                                ...
                                                                while ($row = mysqli_fetch_assoc($result)) {
																	...
																	<td></td>
																	  ...
																	  <td class="text-center "><span class="smalldot"><?php echo $row['pro_name']; ?></span></td>
																	   <td class="text-center "><span class="smalldot"><?php echo $row['sell_pr']; ?></span></td>
                                                           
                                                           
															<td class="text-center"> <?php echo $row['date']; ?> </td>
															<td class="text-center">
										<a href="<?php echo $BaseUrl.'/store/pos_dashboard1/update_inventory.php/?postid='.$row['id']; ?>" class="" data-postid="<?php echo $row['id'];?>"><i style="font-size: 18px;" class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
