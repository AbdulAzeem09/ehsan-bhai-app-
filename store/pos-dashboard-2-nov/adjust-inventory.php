            ...
            <div class="col-lg-12">
               <div class="border-3 border-success border-top p-3 bg-orange shadowBox">
                  <div class="">
                        ...
                        <div class="col-md-1 col-sm-12">
                           <input type="number" class="form-control me-2" name="sqty" placeholder="Stock Qty" aria-label="sqty" aria-describedby="addon-wrapping" required >
                        </div>                         
                        <div class="col-md-1 col-sm-12">
                        ...
                        <div class="col-1 float-end">
                           <button type="submit" class="btn btn-success" name="submit" data-bs-toggle="modal" data-bs-target="#productdata"> Add</button>
                        </div>                            
                     </div>
