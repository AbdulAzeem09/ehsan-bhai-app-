...
<style>
 ...
 <section class="main_box">
            <div class="container">
			<a href="<?php echo $BaseUrl.'/store/pos_dashboard/add_po.php'; ?>" class="btn btn-primary pull-right">Add PO</a>
			&nbsp;&nbsp;&nbsp;<a style="margin-right: 12px" href="<?php echo $BaseUrl.'/store/pos_dashboard/add_bulk_po.php'; ?>" class="btn btn-primary pull-right">Import PO</a>
                <div class="row">
				 ...
				 <div id="sidebar" class="col-md-2 hidden-xs no-padding">
					 ...
					 <div class="col-md-10 " style="padding-bottom: 15px; margin-top: 10px;">
					        <div class="box box-success">
										...
										<a href="<?php echo $BaseUrl.'/store/pos_dashboard1/update_po.php/?postid='.$row['id']; ?>" class="" data-postid="<?php echo $row['id'];?>"><i style="font-size: 18px;" class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
