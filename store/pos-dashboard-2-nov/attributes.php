     ...
     Successfully updated .
			   ...
			   <?php } ?> 
                  ...
                  <div class="row d-flex">
                     ...
                     <div class="col-auto mobile-view mb-3">
                       <input type="text" class="form-control mb-3 me-2" id="attributeValue_in_id" name="attributeValue_in" required placeholder="Attribute Value" aria-label="attributeValue" aria-describedby="addon-wrapping">  <span id="error_2" class="text-danger"></span>                           
                    </div>         
                    <div class="col-auto mobile-view mb-3">
