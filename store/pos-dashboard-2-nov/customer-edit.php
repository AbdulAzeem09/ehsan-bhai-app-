    ...
    <input type="hidden" name="id" value="<?php echo $_GET['postid']; ?>">  
                     ...
                     <div class="row">
                              ...
                              <div class="col-6 mb-3" id="add_membership" >
                                ...
                                <!-- <select class="form-control form-select shadowBox" id="submembership" name="submembership">
								 ...
								 <?php if($row['membership']== 1){
                                     $p = new _pos;  
                                      $res1 = $p->read_data_membership_qty($_SESSION['uid']);
									  if($res1){?>
										  
										  <select class="form-control form-select shadowBox" id="submembership" name="submembership">
										  <option selected> Select Sub Membership</option>
										  <?php while($row_1 = mysqli_fetch_assoc($res1)){ ?>
										  <option value="<?php echo $row_1['id']; ?>" <?php if($row['submembership'] == $row_1['id'] ){ echo "selected";} ?> ><?php echo $row_1['name_qty']; ?></option>
										  <?php } ?>
									...
									<?php   }
                                     ...
                                     $p = new _pos;  
                                      $res1 = $p->read_data_membership_dur($_SESSION['uid']);
									  if($res1){?>
										  
										  <select class="form-control form-select shadowBox" id="submembership" name="submembership">
										  <option selected> Select Sub Membership</option>
										  <?php while($row_1 = mysqli_fetch_assoc($res1)){ ?> 
										  <option value="<?php echo $row_1['id']; ?>" <?php if($row['submembership'] == $row_1['id'] ){ echo "selected";} ?> ><?php echo $row_1['Name']; ?></option> 
										  <?php } ?>
                        ...
                        <div class="col-4">
						   ...
						   <?php } ?>									
                              <input type="file" class="form-control shadowBox" id="image_file" name="profile_img" style="width:370px; text-align: center;">
