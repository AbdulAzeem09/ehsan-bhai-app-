               ...
               <div class="col-12 p-3">
                  <div class="d-flex justify-content-between border-bottom pb-2 mb-3">
                     ...
                     <span class="float-end">
                         <a href="customer-list.php" class="btn btn-outline-secondary me-3">Supplier List</a>
                        <button type="submit" form="addcustomer" class="btn btn-main me-3"><i class="fas fa-plus"></i> Add Supplier</button>
                     </span>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-8">
                           <div class="row">
                              ...
                              <div class="col-6 mb-3">
                                 <input type="text" class="form-control shadowBox" id="customername" placeholder="Customer Name" name="customername" value="" required>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-6 mb-3">
                                 <input type="text" class="form-control shadowBox" id="customerphone" placeholder="Customer Phone" name="customerphone" value="" required>
                              </div>
                              <div class="col-6 mb-3">
                                 <input type="text" class="form-control shadowBox" id="customeremail" placeholder="Customer Email" name="customeremail" value="" required>
                              </div>
                           </div>
                           <div class="row">
                              <!--<div class="col-6 mb-3">
                        ...
                        <div class="col-4">
                           <div class="profile-img mb-4 border border-3 text-center p-2">
                              ...
                              <input type="file" class="form-control shadowBox" name="profile_img" id="image_file" style="width:370px; text-align: center;">
                           </div>
                        </div>
                     </div>
                     <div class="row">
