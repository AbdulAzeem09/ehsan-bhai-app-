...
<body>
   <div class="container-fluid">
	  ...
	  <?php include('left_side_landing.php');?>  
	    ...
	    $result = $p->read_supplier_id($_GET['postid']); 
    ...
    <input type="hidden" name="id" value="<?php echo $_GET['postid']; ?>">  
                     ...
                     <div class="row">
                        <div class="col-8">
                           ...
                           <div class="row">
                              <div class="col-6 mb-3">
                                 <input type="text" class="form-control shadowBox" id="customerphone" placeholder="Customer Phone" value="<?php echo $row['phone']; ?>" name="customerphone" required>
                              </div>
                              <div class="col-6 mb-3">
                                 <input type="text" class="form-control shadowBox" id="customeremail" placeholder="Customer Email" value="<?php echo $row['email']; ?>"  name="customeremail"  required>
                              </div>
                           </div>
                           <div class="row">
                              <!--<div class="col-6 mb-3">
