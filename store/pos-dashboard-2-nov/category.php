...
<body>
  ...
  Successfully Submitted.
     ...
     Successfully updated .
			   ...
			   <?php } ?> 
                  ...
                  <div class="row d-flex">
                    ...
                    <!-- <div class="col-auto">
                     ...
                     <div class="col-auto">
                        <button type="button" class="btn btn-main" onclick="checkadd()"> Add Category</button> 
                     </div>
			   ...
			   <?php 
			   $catlist = new _pos;
			   $cat = $catlist->get_all_cat();
				if($cat->num_rows > 0){
					$i=1;
					while($catl = mysqli_fetch_assoc($cat)){
						$cid = $catl['idsubCategory'];
			   ?>
                  <tr>
                     <td><?= $i;  ?></td>
                     <!--<td><?= $catl['idsubCategory '];  ?></td>-->
                     <td><?= $catl['subCategoryTitle'];  ?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" id="subcat" name="subcat" value="" >
...
function checkadd(){   
	...
	if(sub_cat == false){
		$("#error_1").text("Enter sub category name.");
