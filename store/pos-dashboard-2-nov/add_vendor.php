                ...
                <div class="row">
				 ...
				 <div id="sidebar" class="col-md-2 hidden-xs no-padding" >
					...
					<div class="col-md-1"></div>
					 ...
					 <h1>Create New Vendor</h2>
					 
					 <form action="add_detail_vendor.php" method="post" enctype="multipart/form-data" class="" >   
...
<input type="hidden" name="u_id" value="<?php echo $_SESSION['uid']; ?>">
    ...
    <input type="text" class="form-control"  onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"  id="shipp_username" placeholder="Enter Your Name" name="fullname" required> 
 ...
 <div class="loadCity">
    ...
    <input type="text" class="form-control"   id="shipp_username" placeholder="Enter Your Street name" name="street_name"> 
       <!--<span id="shippname_error" style="color:red;"></span>-->
    </div>
 <div class="form-group">
      <label class="add_shippinglabel" for="shipp_username">Street number:<span class="red"></span></label>
              
    <input type="text" class="form-control"    id="shipp_username" placeholder="Enter Your Street number" name="street_no"> 
       <span id="shippname_error" style="color:red;"></span>
    </div>
...
<div class="form-group">
  ...
  Enter phone number" name="phone" required>
...
<div class="form-group">
  ...
  <input type="text" class="form-control"  id="respUserEphone" placeholder="
  Enter phone number" name="phone_1">
  <span id="shippphone_error" style="color:red;"></span>
