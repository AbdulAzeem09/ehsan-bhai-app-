   ...
   <div class="container-fluid">
      <div class="row flex-nowrap">
		 ...
		 <?php  if($_GET['list']== 'all'){ ?>
            <div class="row mb-4">
               <div class="col-12">
                  <h3>Receive Inventory By PO List</h3>
			   ...
			   $reult = $ps->get_all_by_po();
				if($reult->num_rows > 0){
                  ...
                  <tr>
                     ...
                     <td><?php echo $row1['posted_date'];?></td>
                     <td><?php echo $row1['posted_by'];?></td>
                     <td><i class="fas fa-check text-success"></i> <?php echo $row1['status'];?> Received</td>
                     <!--<td>N/A</td>
                     <td>N/A</td> -->
