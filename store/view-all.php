                     ...
                     <div class="col-md-12">
                              ...
                              <div class="col-md-8 mt-3">
                                 <form method="POST" action="">
                                    <div class="input-group">
                                       ...
                                       <input type="text" class="form-control" name="txtStoreSearch" value="<?php echo isset($_POST['txtStoreSearch'])?$_POST['txtStoreSearch']:'';?>" placeholder="Search For Products" required/>
                                 ...
                                 <div class="d-flex justify-content-between mx-3">
                                    ...
                                    <form id="price_form" method="POST" action="">
                                       <div class="" style="display: inline;">
                                          <select class="form-select" id="dynamic_price" name="pricedropdown" style="width: 122% !important;">
                        ...
                        <div class="row no-margin ">
                           <?php
                              ...
                              $result3 = $au->readDESCretailsort(1,$_SESSION['pid']);      
                              
                                 //echo $au->ta->sql;
                              
                              }else if(isset($_POST["pricedropdown"]) && $_POST["pricedropdown"] == 'Asc'){
                              
                              $result3 = $au->readASCretailsort(1,$_SESSION['pid']);
                              ...
                              $num_rows=$result3->num_rows;
                                          ...
                                          // echo 2;
                              $result3 = $au->myretail_store_prange($condition, $txtStartPrice, $txtEndPrice,$exp);
                              if($result3!=''){
                              $num_rows=$result3->num_rows;
                              }
                              }
                                 ...
                                 $limitaa = 24; 
                                 // echo $start.'----'.$limitaa; die('---');
                                 // $r3=$au->allretailproductnumrows(1,$_SESSION['pid'],$start,$limitaa);
                                 //  if($r3!=false){
                                 
                                 //  }
                                 //echo $nm_rows;
                                 $result3 = $au->allretailproduct_retails(1, $_SESSION['pid'], $start, $limitaa);
                                 ...
                                 //die('33');
                                 $result3 = $au->readitemcondtion_product($_GET['folder'], $condition,$_SESSION['pid']);
                                 if($result3!=''){
                                    $num_rows=$result3->num_rows;
                                 }
                                 
                                 //echo $au->ta->sql;
                              }else if($condition == 'Has Defect'){
                                      //die('22');
                              ...
                              $result3 = $au->myauctionall_store_prange($txtStartPrice, $txtEndPrice,$exp);
                                               ...
                                               //die('==');
                                           // echo 1;
                              $result3 = $au->myauction_store_prange($condition, $txtStartPrice, $txtEndPrice,$exp);
                              }
                              ...
                              $result3 = $au->readitemcondtion_storeproduct($condition);
                              ...
                              $result3 = $p->myall_store_condition($_SESSION['uid'], $condition);
                              ...
                              $result3 = $p->store_friends_Posting_condition($_SESSION['uid'], $condition);
                              }else if(isset($_POST['btnPriceRange'])){
                              $txtStartPrice = $_POST['txtStartPrice'];
                              $txtEndPrice = $_POST['txtEndPrice'];
                              ...
                              $result3 = $p->all_group_store_condition($_SESSION['pid'],$condition);
                              }else if(isset($_POST['btnPriceRange'])){
                              $txtStartPrice = $_POST['txtStartPrice'];
                              $txtEndPrice = $_POST['txtEndPrice'];
                              ...
                              $result3 = $p->retailpost_order_by($_GET['orderby']);
                                          ...
                                          //die('cc');
                              $result3 = $p->retailpost_condition($condition);
                              ...
                              $result3 = $p->publicpost_price($_GET['orderby']);
                                          ...
                                          //die('==');
                              $result3 = $p->publicpost_condition($condition);
                              }else if(isset($_POST['btnPriceRange'])){
                              $txtStartPrice = $_POST['txtStartPrice'];
                              $txtEndPrice = $_POST['txtEndPrice'];
                           ...
                           <div class="item list-wrapper">
                              <?php
                                 ...
                                 while ($row3 = mysqli_fetch_assoc($result3)) {
                                    ...
                                    <div class="col-xs-5ths list-item12">
                                       <div class="featured_box text-center zoom2 subcategory_box">
                                          ...
                                          <ul style="padding-left: 7px;display: grid;">
                                             <li>
                                                <?php
                                                   ...
                                                   if(strlen($row3['spPostingTitle']) < 10){
                                                      ?>
                                                <h4 style="background-color: unset;float: left;padding:0px;"><a href="<?php echo $BaseUrl.'/'.$folder.'/detail.php?catid=1&postid='.$row3['idspPostings'];?>"  style="color: #0b241e;font-weight: 600; font-size:14px; " data-toggle="tooltip" title="<?php echo $row3['spPostingTitle']; ?>"><?php echo ucfirst($row3['spPostingTitle']); ?></a></h4>
                                                <?php
                                                   }else{
                                                      ?>
                                                <h4 style="background-color: unset;float: left;padding: 0px;"><a href="<?php echo $BaseUrl.'/'.$folder.'/detail.php?catid=1&postid='.$row3['idspPostings'];?>"  style="color: #0b241e;font-weight: 600; font-size:14px;" data-toggle="tooltip" title="<?php echo $row3['spPostingTitle']; ?>"><?php echo ucfirst(substr($row3['spPostingTitle'], 0,15).'...') ; ?></a></h4>
                                                <?php
                                                   }
                                                   }else{
                                             ...
                                             <li>
                                                <h5 style="float: left; margin-bottom: -6px; font-size:14px;">
                                                   <?php
                                                      if($_GET['folder']=="retail"){
                                             ...
                                             <span style="color:green; margin-left: -237px; margin-top: 1px;"><b>In Stock</b></span>
                                             <?php } else {  ?>
                                             <span style="color:red; margin-left: -126px;float:left;"><b style="margin-right:40px;">Out Of Stock</b></span>
                                             <?php } }?>
                                          </ul>
                                       </div>
                                    </div>
                        ...
                        <div class="row" style="height:60px;">
                           <div class="col-md-6" style="height:50px;">
                              <div class="ps-4">
                                 <?php 
                                    if($_GET['page'] != "1"){ ?>
                                 <a class="btn btn-success btn-lg sell btn-border-radius"  href="<?php echo $BaseUrl.'/retail/view-all.php?condition=All&folder=retail&page='.$_GET['page']-1;?>">Previous</a>
                                 <?php  } ?>
                              </div>
                           </div>
                           <?php
                           ...
                           <div class="col-md-6">
                              <div class="pe-4">
                                 <a class="float-right btn btn-success btn-lg sell btn-border-radius" href="<?php echo $BaseUrl.'/retail/view-all.php?condition=All&folder=retail&page='.$_GET['page']+1;?>">Next</a>
                              </div>
                           </div>
                           <?php  } ?>
                           <?php 
