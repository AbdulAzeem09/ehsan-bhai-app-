            ...
            <div class="row">
                    ...
                    <div class="col-md-8 mt-3">
                      <form method="POST" action="">
                        <div class="input-group">
                          ...
                          <a type="button" class="btn" href="<?php echo $BaseUrl ?>/store/view-all-auction.php?type=auction&folder=store&page=1" style="font-size: 17px;" >Reset</a>         
                        </div>                                
                      </form>
                    </div>
              ...
              <div class="row">
                ...
                if(isset($_GET['friend']) && $_GET['friend'] >0){
                  ...
                  $result3 = $au->search_store("Auction", 1, $txtStoreSearch);
                      ...
                      if($account_status!=1){                                   
                        ...
                        <!-- <div class="item <?php echo ($active >= 15)?'seeproduct':'';?>"> -->
                          <div class="col-xs-5ths list-item">
                            <div class="featured_box text-center subcategory_box zoom3">
                                  ...
                                  if ($row3['spCategories_idspCategory'] != 5 && $row3['spCategories_idspCategory'] != 2) {
                                    if ($result4 != false) {
                                      if(mysqli_num_rows($result4) > 0){
                                        ...
                                        border-top-right-radius: 17px;height: 100% !important; width: 100%;' alt='Posting Pic' class='img-responsive' src=' " . ($picture) . "' >";
                                      }
                                    } else{
                                      echo "<img style='height: 100% !important; width: 100%;' alt='Posting Pic' src='../assets/images/blank-img/no-store.png' class='img-responsive'>";
                                    }
                                  }else{
                                    echo "<img style='height: 100% !important; width: 100%;' alt='Posting Pic' src='../assets/images/blank-img/no-store.png' class='img-responsive'>";
                                  }
                              ...
                              <ul style="padding-left: 10px;display: grid;">
                                ...
                                <li>
                                  <h5 style="float: left;">
                                    ...
                                    if ($row3['spPostingPrice'] != false) {
                                      echo "<div class='postprice' style='display: inline-block;font-size:14px;' data-price='" . $row3['spPostingPrice'] . "'>" .'starts at'.' '.$row3['default_currency'].' '.$row3['spPostingPrice'] . "</div><span class='" . ($row3['idspCategory'] == 5 || $row3['idspCategory'] == 18 || $row3['idspCategory'] == 9 || $row3['idspCategory'] == 3 ? "hidden" : "") . "'></span>";
                                    }else{
                                    }
                                    ?>
                                  </h5>
                                ...
                                <li>
                                  <?php  $date1 =  $row3['spPostingExpDt']; 
                                  $date2 = date("Y-m-d h:i:sa");
                                  if(strtotime($date1) >  strtotime($date2)){ ?>
                                    <span  style="float: left;color: green;font-size:14px!important;" id="auction_enddate<?php echo $row3['idspPostings']?>"></span>     
                                  <?php } else{
