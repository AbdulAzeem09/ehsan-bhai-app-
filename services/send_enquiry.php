                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-bordered dashServ">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $res = $p->myServEnq($_GET["categoryID"], $_SESSION['pid']);
                                                                ...
                                                                if($res != false){
                                                                    while ($row = mysqli_fetch_assoc($res)) { 
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center"><?php echo $row['spProfileName']?></td>
                                                                            <td class="text-center"><?php echo $row['enquiry_msg']; ?></td>
                                                                            <td class="text-center"><a href="<?php echo $BaseUrl.'/services/delenq.php?enqid='.$row['enquiry_id'];?>"><i class="fa fa-trash"></i></a></td>
