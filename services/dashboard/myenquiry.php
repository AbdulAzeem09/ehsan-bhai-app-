                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive" style="overflow:hidden;">
								   ...
								   <?php
                                    ...
                                    <table class="table table-striped table-bordered dashServ display" id="<?php echo $mnque; ?>">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Service Name</th>
                                                ...
                                                while ($row = mysqli_fetch_assoc($res)) { 
                                                    ...
                                                    <tr>
                                                      <td class="text-center"><?php echo $i; ?></td>
                                                        ...
                                                        <td class="text-center"><a href="javascript:void(0)" data-postid="<?php echo $row['enquiry_id'];?>" class="delenq"><i title="Delete" class="fa fa-trash"></i></a>
															<a href="<?php echo $BaseUrl.'/services/dashboard/Sent_EnquiryReply.php?id='.$row['enquiry_id'];?>"><i style="color: #428bca" title="Edit" class="fa fa-pencil"></i></a>
															</td>
