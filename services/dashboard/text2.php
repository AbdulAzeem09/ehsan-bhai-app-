                                ...
                                <div class="table-responsive bg_white">
                                    <table class="" id="">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">shipName</th>
                                                 ...
                                                 <th class="text-center">shipEmail</th>
                                                <th class="text-center">shipPhone</th>
												 <th class="text-center">country_id</th>
                                                 
												 <th class ="text-center">state_id</th>
												 <th class ="text-center">city_id</th>
                                        ...
                                        <tbody>
											...
											$res = $pq->readclassified($_SESSION['uid']); 
                                            ...
                                            if($res != false){ 
                                                while ($row = mysqli_fetch_assoc($res)) { 
												  ...
												  <td>  <?php  echo $row['shipName']?></td>
												   <td>  <?php  echo $row['shipEmail']?></td>
												    <td>  <?php  echo $row['shipPhone']?></td>
													<td>  
													<?php 
													
													    $d1 = new _state;
														$pro= $d1->read_country($row['country_id']);
														$title = mysqli_fetch_assoc($pro);
														echo $title['country_title'];
														...
														<?php  
														$f1 = new _state;
														$res2 = $f1->read_state($row['state_id']);
														$title = mysqli_fetch_assoc($res2);
														echo $title['state_title'];
