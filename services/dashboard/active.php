...
if(isset($_SESSION['sign-up']) && $_SESSION['sign-up'] == 1){
  ...
  $_SESSION['afterMembership']="/services/dashboard/active.php".$msg1;
...
<td class="text-center">
 <a href="<?php echo $BaseUrl.'/post-ad/services/?active=1&postid='.$row['idspPostings']; ?>" class="" data-postid="<?php echo $row['idspPostings'];?>"><i style="color: #428bca" title="Edit" class="fa fa-pencil"></i></a> 
<a href="javascript:void(0);" class="disable-btn" data-work="deactive" data-Id="<?php echo $row['idspPostings'];  ?>"><i style="color: red;" title="Deactivate" class="fa fa-ban disable-btn" data-disableId=""></i></a> 
<!--<a href="javascript:void(0)" data-postid="<?php echo $row['idspPostings']; ?>" class="delpost" ><i class="fa fa-trash"></i></a>-->

<a href="javascript:void(0);" class="disable-btn" data-work="delete" data-Id="<?php echo $row['idspPostings'];  ?>"><i style="color: red;" title="Delete" class="fa fa-trash disable-btn" data-disableId=""></i></a> 
</td>
</tr>
