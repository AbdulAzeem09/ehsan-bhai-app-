						...
						<link rel='stylesheet' href='https://cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css'>
                            ...
                            <div class="col-sm-12">
								...
								<form action="formupdate.php" method="post">
								 idsprealEnquiry:-<input type="text" name="idsprealEnquiry" value="<?php  echo $row4["idsprealEnquiry"];?>"><br/><br/>
								  sprealName:    -<input type="text" name="sprealName" value="<?php  echo $row4["sprealName"];?>"><br/><br/>
								   sprealEmail:   -<input type="text" name="sprealEmail" value="<?php  echo $row4["sprealEmail"];?>"><br/><br/>
								    sprealPhone:   -<input type="text" name="sprealPhone" value="<?php  echo $row4["sprealPhone"];?>"><br/><br/>
									 <input type="hidden" name="id" value="<?php echo  $_GET['idform'];?>">
