...
/*if($_SESSION['ptid'] != 2 && $_SESSION['ptid'] != 5){ 
	...
	if (isset($_GET["id"] )) {
			       ...
			       $p1 = new _addServiceEnq;
			 
							 $res2 = $p1->readEnq($_GET["id"]);
							 //var_dump
							...
							//echo $cp;die;
								if($cp == false){
									 //die('===56872345==');
																						            ...
																						            header("Location: $BaseUrl/services/dashboard/index.php?msg=notacess");
							}
							
						   if ($res2 != false) {
							  // 
                          while ($row = mysqli_fetch_assoc($res2)) {
							 // die('_________0000000_______');
							 //print_r($row);die('====');
						  $sndrID=$row['sender_id'];
                    $recieverID=$row['spProfile_idspProfile'];
																
	           if(($_SESSION['pid']!=$recieverID)&&($_SESSION['pid']!=$sndrID)){ 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
										...
										$poID=$row['spPosting_idspPosting'];
											...
											?>
											<span>Sender Name: <?= $sndrName; ?></span>
											<br>
											<span>Product Name: </span><a href="<?php echo $BaseUrl.'/services/detail.php?postid='.$row['spPosting_idspPosting'];?>"><?php echo ucfirst($sppostitle); ?></a>
											<br>
											<span>Enquiry Message: <?= $enq_msg; ?></span>
											<br>
