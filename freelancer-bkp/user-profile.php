            ...
            <div class="container nopadding projectdetails userprofile">
              ...
              $row = mysqli_fetch_assoc($result);
               ...
               if($result_fi){
				...
				<a onclick="return confirm('Are you sure you want to delete from favorite?');" href="delfav1.php?postid=<?php echo $_GET['profile']; ?> " class="icon-favorites fa fa-heart sp-favorites pull-right color: red" style="font-size:24px"></a>
				<?php	header("location:user-profile.php");  ?>
				<?php
				}
						else{?>
					<a onclick="return confirm('Are you sure you want to add to favorite?');" href="addfav1.php?postid=<?php echo $_GET['profile']; ?>" class="icon-favorites fa fa-heart-o sp-favorites pull-right  color: red" style="font-size:24px"></a>
					<?php	header("location:user-profile.php");  ?>
						<?php }
...
*/
                    ...
                    <span class="red">$<?php echo $hourlyrate;?>/hr</span></div>
...
*/
     ...
     <a href="<?php echo $BaseUrl.'/freelancer/showfreelancerating.php?postid='.$profileId;?>"><span>&nbsp;&nbsp; Reviews : <?php echo $totalmyreviews1; ?>
			...
			<b style="font-size: 30px; color:red;">		Hourly Rate:	</b>
			<?php echo '<span style="font-size:25px">'.$free1['hourlyrate'].'</span>';
			 echo '<br><br>';
			?>
						 
				<b style="font-size: 30px ; color:red;">		Skills:		</b>
	...
	<b style="font-size: 30px; color:red;">		Certification:	<?php	 ?></b>
	...
	<b style="font-size: 30px; color:red;"> Project Worked:		   </b>
  ...
  <b style="font-size: 30px; color:red;"> Working Interest:		</b>
					...
					<b style="font-size: 30px; color:red;">	Lanugage Fluency :</b>
