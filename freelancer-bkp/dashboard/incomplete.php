                      ...
                      <div class="col-md-12 nopadding dashboard-section" style="margin-top: 24px;">
                        <div class="col-xs-12 dashboardbreadcrum">
                            <ul class="breadcrumb">
                              ...
                              <li><a href="<?php echo $BaseUrl;?>/freelancer/active.php">Completed Project</a></li>
                                ...
                                <table class="table text-center tbl_activebid">
                                    <thead style="background-color: #3e3e3e;color: #fff;">
                                        <tr>
                                            ...
                                            <th class="action" style="color:#fff;">Review</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                                ...
                                                <div class="col-md-12">
                                                 ...
                                                 /*   $res2 = $p->singletimelines($_GET['postid']);
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control no-radius" maxlength="150" name="desc_recomndation"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                ...
                                <form method="post" action="../addrecomndation.php">
                                    <div class="modal-content no-radius">
                                        ...
                                        <div class="modal-footer">
                                          ...
                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#reviewgivenhire<?php echo $row['idspPostings']; ?>" class="btn btn-warning"> View Review</a>
...
<!-- 
                       ...
                       <!--  <a href="<?php echo $BaseUrl.'/freelancer/dashboard/freelance_project_detail.php?postid='.$row['id'];?>"  class="" ><i class="fa fa-eye"></i></a> -->
                                ...
                                <form method="post" action="../addrecomndation.php">
                                    <div class="modal-content no-radius">
                                        ...
                                        <div class="modal-footer">
                                          ...
                                          <a href="javascript:void(0);" data-toggle="modal" data-target="#reviewgiven<?php echo $row['id']; ?>" class="btn btn-warning"> View Review</a>
