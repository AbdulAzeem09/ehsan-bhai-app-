...
<?php if($_SESSION["ptname"] == "Freelancer"){ ?> 
        ...
        <div class="left_freelance_menu">
           ...
           <li class="Back_to_freelancer"><button style="background-color: #f78d47;border-color: #f78d47;" class="btn btn-primary"><a href="<?php echo $BaseUrl.'/freelancer'; ?> " style="color: black!important;">

            <i class="fa fa-arrow-left"></i> Freelancer Home </a></li></button>
        </div>
...
<?php if($_SESSION["ptname"] == "Bussiness"){ ?> 
    <div class="left_freelance_menu">
           ...
           <li class="Back_to_freelancer"><button style="background-color: #f78d47;border-color: #f78d47;" class="btn btn-primary"><a href="<?php echo $BaseUrl.'/freelancer'; ?> " style="color: white;">
   ...
   <?php
    ...
    <div class="row no-margin">
                ...
                <div class="col-md-8">
                    <div class="dropdown">
                        <button style="background-color:#808080;" class="btn btn-primary dropdown-toggle freelancer_capitalize" type="button" data-toggle="dropdown"><?php
...
<ul class="sidebar-menu" style="padding-top: 20px;">
     ...
     <?php if($_SESSION["ptname"] == "Freelancer"){ ?> 
		...
		<li class="<?php echo ($activePage == 1)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/';?>">Dashboard </a></li>
                        ...
                        <li class="<?php echo ($activePage == ww)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/projects.php?cat=ALL';?>" >Browse all projects</a></li>
                       ...
                       <!--  <li class="<?php echo ($activePage == 4)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/active-project.php';?>" >Active Projects</a></li> -->
                        ...
                        <!-- <li class="<?php echo ($activePage == 5)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/favourite.php';?>" >Saved Projects</a></li> -->
                         <li class="<?php echo ($activePage == 21 )?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/freelancer_requested_project.php'; ?>" >Direct Hired</a></li>
                          <li class="<?php echo ($activePage == 33 )?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/milestone_payment_list.php'; ?>" >Recieved Milestone</a></li>
          ...
          <?php }?>
           ...
           <?php if($_SESSION["ptname"] == "Bussiness"){ ?> 
                ...
                <li class="treeview <?php echo ($activePage == 11 || $activePage == 12 || $activePage == 13 || $activePage == 14 || $activePage == 15 || $activePage == 16 || $activePage == 17 || $activePage == 18 || $activePage == 22)?'active activeMain' : '';?> ">
                    <!-- <a href="#">
...
<li><a href="<?php echo $BaseUrl ?>/post-ad/freelancer/?post" >Post a Project</a></li>
                        ...
                        <li class="<?php echo ($activePage == 11)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/poster_dashboard.php';?>" >My Dashboard</a></li>
                        ...
                        <li class="<?php echo ($activePage == 19)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/freelancer_hire_project.php'; ?>" >Favourite Freelancers</a></li>
                        ...
                        <!--<li class="<?php echo ($activePage == 22)?'activeInsub' : '';?>"><a href="<?php echo $BaseUrl.'/freelancer/dashboard/cancelled_milestone.php'; ?>" >Cancel Milstone</a></li>-->
