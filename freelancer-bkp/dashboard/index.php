						...
						<div class="col-md-5 " >
							...
							<div class="box box-info">
								...
								<div class="box-body">
                                    ...
                                    $fps = new _freelance_project_status;
                                        $result = $fps->myAssignProject($_SESSION['pid']);
                                    /* print_r($result3);*/
                                    if ($result) {
                                    ...
                                    $totalExpire = 0;
                                     /*   $result4 = $p->myExpireProduct1(5, $_SESSION['pid']);
                                        ...
                                        $sf  = new _freelance_chat_project;
                                        //$res = $p->myExpireProduct(5, $_SESSION['pid']);
                                          $result4 = $sf->getfreelancerConversation($_SESSION['pid']);
                                    /* print_r($result3);*/
                                    if($result4){
									...
									$sfp = new _freelancerposting;
                                       $res33 = $sfp->myBidProject1212(5, $_SESSION['pid']);
									  $submProp = mysqli_num_rows($res33);
										...
										<table class="table table-striped no-margin">
											<tbody>
											    ...
											    <tr>
                                                    <td><a href="<?php echo $BaseUrl.'/freelancer/dashboard/mybid-project.php'; ?>">Submitted Proposals</a></td>
                                                    <td><span class="label label-info"><?php echo $submProp; ?></span></td>
                                                </tr>
                                                
                                                <tr>
                                                    <td><a href="<?php echo $BaseUrl.'/freelancer/dashboard/active.php'; ?>">Project Awarded</a></td>
                                             ...
                                             <!--     <tr>
                                               ...
                                               <tr>
                                                    <td><a href="<?php echo $BaseUrl.'/freelancer/dashboard/expire.php'; ?>">Direct Hired</a></td>
