            ...
            <div class="container nopadding projectslist dashboardpage">               
                ...
                <div class="col-xs-12 col-sm-9 nopadding">
                    ...
                    <div class="col-xs-12 nopadding">
                        ...
                        <?php
                        $res = $p->mylike_freelance($_SESSION['pid']);
                        ...
                        if($res){
                                    ...
                                    <div class="col-xs-12 nopadding">
                                        ...
                                        if(count($skill) >0){
                                            foreach($skill as $key => $value){
                                                if($value != ''){
                                                    echo "<span class='skills-tags freelancer_capitalize'>".$value."</span>";
                                                }
                            ...
                            echo " <div class='col-xs-12 nopadding freelancer-post'><center>No Record Found</center></div>";
                             }
                        ?>
