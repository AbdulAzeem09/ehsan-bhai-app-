            ...
            <div class="col-xs-12 search-freelancer">
                <div class="container">
                   ...
                   <!-- <div class="col-xs-12">
                        ...
                        <p class="offer-note">We offer exclusive access to thousands of freelancers who are ready to your short term projects. You can now source all your contract workers from this platform! Easily find talent by browsing through the professional profiles of freelancers or post a project and receive direct bids from the skilled talented professionals from our global network. Then hire direct with no restrictions! </p>
                                        ...
                                        <div class="freelancer-content">
                                            <div class="avatar bradius-10">
                                                ...
                                                if(isset($picture) && !empty($picture)){
                                                    echo "<img  alt='Posting Pic' class='img-responsive bradius-10' src=' ".($picture)."' >" ;
                                                }else{
