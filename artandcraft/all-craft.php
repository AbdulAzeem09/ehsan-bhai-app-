...
$result3 = $pv->publicpostartandcraft($start,$_GET["categoryID"],$artcraft,$limit );   
$numrowsw = mysqli_num_rows($result3); 
//echo $pv->ta->sql; die;
...
$result = $p->chkExist($row3['idspPostings'], $_SESSION['pid']);
if($result != false){  ?>
...
<li><a href="<?php echo $BaseUrl.'/artandcraft/detail.php?postid='.$row3['idspPostings'];?>" data-toggle="tooltip" title="View Product">
...
$resallcount = $pv->publicpostartandcraftcount($_GET["categoryID"],$artcraft);
...
<a href="all-craft.php?page=<?php echo $_GET['page']-1 ;?>">Previous</a>
...
<a href="all-craft.php?page=<?php echo $_GET['page']+1 ;?>">Next</a>
