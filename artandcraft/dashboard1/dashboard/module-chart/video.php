                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Total Videos</a></td>
                                                                <td><span class="label label-success"><?php echo $totalProducts; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">My Uploaded Videos</a></td>
                                                                <td><span class="label label-info"><?php echo $totalActive; ?></span></td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Favourite Videos</a></td>
                                                                <td><span class="label label-warning"><?php echo $totFav; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Playlist</a></td>
                                                                <td><span class="label label-warning"><?php echo $playList; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Album</a></td>
                                                                <td><span class="label label-warning"><?php echo $album; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">My Private Videos</a></td>
                                                                <td><span class="label label-warning"><?php echo $private; ?></span></td>
                                                            </tr>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/videos/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/videos/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
