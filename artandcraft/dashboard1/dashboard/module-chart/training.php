                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    // =========TOTAL COURSES
                                                    $totcourse = 0;
                                                    $result6 = $p->readMyAllProfileProduct($_GET["categoryid"], $_SESSION['pid']);
                                                    if ($result6) {
                                                        $totcourse = $result6->num_rows;
                                                    }
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Total Trainings</a></td>
                                                                <td><span class="label label-success"><?php echo $totalProducts; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">My Trainings</a></td>
                                                                <td><span class="label label-info"><?php echo $totalActive; ?></span></td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Favourite Trainings</a></td>
                                                                <td><span class="label label-warning"><?php echo $totFav; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Total Courses</a></td>
                                                                <td><span class="label label-warning"><?php echo $totcourse; ?></span></td>
                                                            </tr>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/trainings/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/trainings/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="nav-tabs-custom">
                                            ...
                                            <div class="tab-content no-padding">
                                                <!-- Morris chart - Sales -->
                                                <div class="chart tab-pane active" id="bar-chart" style="position: relative; height: 218px;">
                                                    <div id="jobBoardChart" style="width: 100%; height: 100%; margin: 0 auto"></div>
                                                </div>
                                                <!-- this is xxtra chart for dummy -->
                                                <div class="chart tab-pane " id="revenue-chart" style="position: relative; height: 218px;">
                                                    
                                                    
                                                </div>
                                                <div class="chart tab-pane" id="chart-two" style="position: relative; height: 218px;">
                                                    
                                                    
                                                </div>
                                                <div class="chart tab-pane" id="pie-chart" style="position: relative; height: 218px;">
            ...
            $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        ...
                        {label: "My Trainings", value: <?php echo $totalActive;?>},
                        {label: "Total Courses", value: <?php echo $totcourse; ?>},
