                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Active Jobs</a></td>
                                                                <td><span class="label label-info"><?php echo $totalActive; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Past Jobs</a></td>
                                                                <td><span class="label label-info"><?php echo $totInActive; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Draft Jobs</a></td>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/job-board/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/job-board/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
