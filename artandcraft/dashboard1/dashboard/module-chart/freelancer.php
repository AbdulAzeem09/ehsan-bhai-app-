                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/freelancer/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/freelancer/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
