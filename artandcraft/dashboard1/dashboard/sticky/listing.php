                                    ...
                                    <div class="col-md-12">
                                        <div class="box">
                                            <div class="box-header text-right">
                                                <a href="<?php echo $BaseUrl.'/dashboard/sticky/index.php';?>" class="btn butn"><i class="fa fa-file"></i> View Notes</a>
                                                <a href="<?php echo $BaseUrl.'/dashboard/sticky/add.php';?>" class="btn butn"><i class="fa fa-plus"></i> Add New Vault</a>
                                            </div><!-- /.box-header -->
                                            <div class="box-body">
                                                    ...
                                                    while ($row = mysqli_Fetch_assoc($result)) {
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="menu-action text-center">
                                                          ...
                                                          <a href="<?php echo $BaseUrl.'/dashboard/sticky/modify.php?id='.$row['idspSticky'];?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"> <i style="color: #428bca" class="fa fa-pencil"></i> </a> 
