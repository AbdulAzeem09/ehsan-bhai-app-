                                    ...
                                    <div class="col-md-12">
                                        <div class="box">
                                            <div class="box-header text-right">
                                                <a href="<?php echo $BaseUrl.'/dashboard/vault/add.php';?>" class="btn butn"><i class="fa fa-plus"></i> Add My Vault</a>
                                            </div><!-- /.box-header -->
                                            <div class="box-body">
                                                ...
                                                <tbody>
                                                  ...
                                                  if ($result) {
                                                    while ($row = mysqli_Fetch_assoc($result)) {
                                                      ...
                                                      <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td style="text-align: left;"><?php echo $row['spStickyTitle']?></td>
