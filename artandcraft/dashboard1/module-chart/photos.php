                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="box box-info">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-striped no-margin">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Active Art</a></td>
                                                            ...
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Flaged Art</a></td>
                                                                <td><span class="label label-warning"><?php echo $totFav; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Your Board</a></td>
                                                                <td><span class="label label-warning"><?php echo $board; ?></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td><a href="javascript:void(0)">Total Enquiry</a></td>
                                            ...
                                            <div class="box-footer clearfix">
                                                <a href="<?php echo $BaseUrl.'/photos/dashboard.php';?>" class="btn btn-sm btn-info btn-flat pull-left">View Module Dashboard</a>
                                                <a href="<?php echo $BaseUrl.'/photos/';?>" class="btn btn-sm btn-default btn-flat pull-right">View Module</a>
                                            </div><!-- /.box-footer -->
                                        </div><!-- /.box -->
                                    </div>
