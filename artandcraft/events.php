...
$pf  = new _postfield;
$eventVisibility = -3;
$res = $p->showEventsArt($eventVisibility, $_GET["categoryID"]);
//echo $p->ta->sql;
if($res != false){
...
?>
<a href="<?php echo $BaseUrl.'/photos/shop-top-category.php?catName='.$rows['idmasterDetails'];?>" class=""><?php echo ucwords(strtolower($rows["masterDetails"]));?> <span class="pull-right">(<?php echo $count;?>)</span></a> <?php
