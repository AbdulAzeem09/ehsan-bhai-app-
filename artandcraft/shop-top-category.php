            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 no-padding">
                        ...
                        <?php include('shop-top-product.php');?>

<?php if($catId && isset($_GET['page'])){ ?>
	<div class="row">	
<div class="col-md-6" style=" text-align: left; ">
<?php
          //die('===========');
		  
			$resallcount = $p->publicpostallcountcat($catId, 13, $_GET['for']);
			//echo 1;
...
<?php if($_GET['page']!=1){ ?>
		...
		<a href="shop-top-category.php?catId=<?php echo $catId; ?>&for=<?=$_GET['for'];?>&page=<?php echo $_GET['page']-1 ;?>">Previous</a>
...
<?php if($numrowsw==15){ ?>	
		...
		<a href="shop-top-category.php?catId=<?php echo $catId; ?>&for=<?=$_GET['for'];?>&page=<?php echo $_GET['page']+1 ;?>">Next</a>
