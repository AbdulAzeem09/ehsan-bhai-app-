        ...
        <section class="">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
					<div class="panel panel-default"><div class="panel-heading"> Dashboard / Cancel Orders / ORDER_<?php echo base64_decode($_GET['order']); ?></div></div>
  	...
  	<div class="col-2 col-md-2">
		...
		<div class="col-6 col-md-6 hh-grayBox pt45 pb20">
			...
			<?php if($rowststus['Delivered'] == 1 && $rowststus['Cancel'] == 0){ ?>
				...
				<a class="btn btn-primary" href="<?php echo $BaseUrl.'/artandcraft/dashboard/invoice.php?order='.$id.'&action=3r='.$_GET['order'];?>">Return Request</a>	 
