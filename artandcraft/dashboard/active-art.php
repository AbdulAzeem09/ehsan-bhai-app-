...
$p->remove($postid);
$pic->removePostPic($postid);
$re = new _redirect;
$re->redirect($BaseUrl . "/artandcraft/dashboard/active-art.php");
}
}
?>
<!DOCTYPE html>
...
?></td>
<td>
<a href="<?php echo $BaseUrl . '/post-ad/photos/?postid=' . $row['idspPostings']; ?>"><i title="Edit" style="color:#428bca" class="fa fa-pencil"></i></a>
<a href="<?php echo $BaseUrl . '/artandcraft/detail.php?postid=' . $row['idspPostings']; ?>">
...
<i id="button99<?php echo $id; ?>" title="Delete" class="fa fa-trash" aria-hidden="true"></i>
...
<script>
$("#button99<?php echo $id; ?>").click(function(e) {
e.preventDefault();
...
//alert("<?php echo $BaseUrl . '/artandcraft/dashboard/active-art.php?action=delete&postid=' . $id; ?>");
window.location.href = "<?php echo $BaseUrl . '/artandcraft/dashboard/active-art.php?action=delete&postid=' . $id; ?>";
