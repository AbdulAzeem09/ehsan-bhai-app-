                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="table-responsive">
                                            ...
                                            // =========ACTIVE POST
                                            $totalActive = 0;
                                            $result4 = $p->singleFriendProduct($_SESSION['pid'], $_GET["categoryid"]);
                                            if ($result4) {
                                                $totalActive = $result4->num_rows;
                                            }
                                            // =========PAST POST
                                            $totExp = 0;
                                            $result5 = $p->myExpireProduct($_GET['categoryid'], $_SESSION['pid']);
                                            //echo $p->ta->sql;
                                            if ($result5) {
                                                $totExp = $result5->num_rows;
                                            }

                                            // ============YOUR BOARD
                                            $myflag = 0;
                                            $result6 = $p->myflagPost($_GET['categoryid'], $_SESSION['pid']);
                                            if ($result6) {
                                                $myflag = $result6->num_rows;
                                            }
                                            ...
                                            <table class="table table-striped no-margin">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.$pageLink.'active-art.php'; ?>">Active Photos</a></td>
                                                        <td><span class="label label-info"><?php echo $totalActive; ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.$pageLink.'past-art.php';?>">Past Photos</a></td>
                                                        <td><span class="label label-info"><?php echo $totExp; ?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.$pageLink.'my-enquiry.php'; ?>">Total Enquiry</a></td>
                                                        <td><span class="label label-warning"><?php echo $totenquiry; ?></span></td>
                                                    </tr> 
                                                    <tr>
                                                        <td><a href="<?php echo $BaseUrl.$pageLink.'myflag.php';?>">Flagged Art</a></td>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        {label: "Active Photos", value: <?php echo $totalActive;?>},
                        {label: "Past Photos", value: <?php echo $totExp;?>},
                        {label: "Total Enquiry", value: <?php echo $totenquiry; ?>},
                        {label: "Flagged Photos", value: <?php echo $myflag; ?>}
