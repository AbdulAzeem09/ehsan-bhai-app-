        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="panel panel-default" style="margin-top:10px;" >
              <div class="panel-heading"> Dashboard / My Orders </div>
            </div>
...
<input type="text" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="Search.." class="form-control">
                ...
                <table class="table table-striped table-class" id= "example">
                  ...
                  <tbody>
                    ...
                    $status = $st->readstatus_art($_SESSION['pid'], $_SESSION['uid']);
                    ...
                    ?>
                        ...
                        <td></td>
                          ...
                          <td class="text-center">
                            ...
                            <a href="<?php echo $BaseUrl . '/artandcraft/dashboard/statusnew.php?postid=' . $r1['idspOrder']; ?>" data-original-title="View Detail" data-toggle="tooltip" data-placement="top"> <i style="color:#428bca" class="fa fa-eye"></i> </a>
