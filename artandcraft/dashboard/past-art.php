            ...
            <div class="container-fluid ">
                <div class="row">
					...
					<div class="panel panel-default">
							<div class="panel-heading"> Dashboard / Expired Listing </div>
							</div>
...
<!--  
  ...
  /*  $pid = $_SESSION['pid'];
    ...
    $sql = "SELECT * FROM `sppostingsartcraft` where spProfiles_idspProfiles= $pid AND saveasdraft=0 ORDER BY spPostingDate DESC";
...
;
											...
											$curr=$res1['currency'];
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td>
 <a href="<?php echo $BaseUrl.'/post-ad/photos/?postid='.$row['idspPostings'].'&exp=1';?>"><i style="color:#428bca"  title="Edit" class="fa fa-pencil"></i></a>
                                                            <a href="<?php echo $BaseUrl.'/artandcraft/detail.php?postid='.$row['idspPostings']; ?>">
                                                                <i style="color:#428bca" title="View" class="fa fa-eye"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                   <?php
