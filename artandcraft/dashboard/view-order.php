...
<div class="panel-heading"> Dashboard / New Orders </div>
</div>
...
$results = $o->readseller_artcraft($_SESSION['pid']);
//var_dump($results);
if ($results!=false) {
...
<td><a href="<?= $BaseUrl; ?>/artandcraft/dashboard/sellerstatusnew.php?postid=<?= $row['idspOrder']; ?>"><i style="color: #428bca" title="View" class="fa fa-eye" style="font-size:16px"></i></a></td>
