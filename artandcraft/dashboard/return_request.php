        ...
        <section class="">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
<div class="panel panel-default" style="margin-top:10px;"><div class="panel-heading"> Dashboard / Refund Request </div></div>
...
#example1_filter label{margin-bottom: 3px;}
#example1_length label{margin-top: 4px;}
</style>              
...
<!-- partial:index.partial.html -->
  ...
  <table class="table table-striped table-class" id= "example">
             ...
             $status= $st->readstatus_art_refund($_SESSION['pid'],$_SESSION['uid']);
										...
										//	print_r($r1);
												...
												$rdf = $pv->read_artproduct($r1['idspPostings']);
																						
												//print_r($name); 
											
												$r2 =  mysqli_fetch_assoc($rdf);
													$title = $r2['spPostingTitle'];
													
													
													$curr = $r2['defaltcurrency'];
                        ...
                        <td></td>
								...
								<td class="text-center">		<a href="<?= $BaseUrl; ?>/artandcraft/detail.php?postid=<?= $r1['idspPostings']; ?>"><?php echo $title; ?></a>
</td>
...
<td class="text-center"><a href="<?php echo $BaseUrl.'/artandcraft/dashboard/statusnew.php?postid='.$r1['idspOrder'];?>" data-original-title="View Detail" data-toggle="tooltip" data-placement="top" > <i style="color: #428bca" class="fa fa-eye"></i> </a></td>
