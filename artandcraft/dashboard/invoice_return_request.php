        ...
        <section class="">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
					<div class="panel panel-default"><div class="panel-heading"> Dashboard / Refund Request / ORDER_<?php echo base64_decode($_GET['order']); ?></div></div>
...
Order Id : ORDER_<?php echo base64_decode($_GET['order']); ?>
  ...
  <?php
			  $result = $o->readBuyerOrdertotalpro(base64_decode($_GET['order']));
				if ($result) {
					$i = 1;
					$totalprice=0;
  ...
  <div class="row mb-5" style="margin-bottom: 34px;margin: 10px;">
  	...
  	<div class="col-2 col-md-2">
		...
		<div class="col-5 col-md-5 hh-grayBox pt45 pb20">
...
<?php 				 
           ...
           foreach($res as $row){
           		...
           		$status_refund = $row['refund_complete'];
 ...
 ?>
			...
			<?php  
				...
				<a class="btn btn-danger" href="<?php echo $BaseUrl.'/artandcraft/dashboard/invoice.php?orderPid='.$id.'&action=Cancel&r='.$_GET['order'].'&done_by=0';?>">Cancel</a>
				
			<?php	} ?>
			<?php if($rowststus['Delivered'] == 1){
				 if($rowststus['return_request'] == 0){  	 ?>
				<a class="btn btn-primary" href="<?php echo $BaseUrl.'/artandcraft/dashboard/invoice.php?orderPid='.$id.'&action=return_request&r='.$_GET['order'];?>">Refund Request</a>	 
				
				 <?php }else{

 						 	if (!empty($Carrier) && !empty($Tracking_Id)) { ?>
			 <p style="color:green;">
				 Refund Proccessed
				 </p>	
	 <b>Carrier : </b><?php echo $Carrier; ?><br>
				 <b>Tracking Id : </b><?php echo $Tracking_Id; ?><br>
 						 <?php	}
