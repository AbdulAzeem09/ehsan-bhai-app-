...
<div class="row">
  ...
  <li class="breadcrumb-item"><a href="#">Home</a></li>
    ...
    <li class="breadcrumb-item"><a href="#">Flagged Posting</a></li>
...
<div class="card-header">
                  ...
                  <thead class="bg-200 text-900" style="text-align: center;">
                    <tr>
                      ...
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">Title</th>
                         ...
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Date Of Flag</th>
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;"> Reason Of Flagging</th>
    ...
    width: 10rem;">
                     ...
                     <td class="phone align-middle white-space-nowrap py-2" style="text-align: center;"><a href="tel:2012001851">ajdhsjhdas jhadjsah</a></td>
                      </td>
