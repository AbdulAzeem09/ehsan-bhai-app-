                  ...
                  <div class="row g-3">
                        ...
                        <div class="card-body d-flex flex-column justify-content-end">
                          <div class="row">
                            ...
                            <div class="col-auto ps-0">
                              <div class="echart-bar-weekly-sales h-100 echart-bar-weekly-sales-smaller-width" style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;" _echarts_instance_="ec_1638288895167"><div style="position: relative; width: 104px; height: 46px; padding: 0px; margin: 0px; border-width: 0px;"><canvas data-zr-dom-id="zr_0" width="104" height="46" style="position: absolute; left: 0px; top: 0px; width: 104px; height: 46px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); padding: 0px; margin: 0px; border-width: 0px;"></canvas></div><div class=""></div></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="card h-100">
                        <div class="card-header pb-0">
                          <h6 class="mb-0 mt-2 d-flex align-items-center">Total Purchased Product</h6>
                        </div>
                        <div class="card-body">
                          <div class="row align-items-end">
                            <div class="col">
