...
<div class="row">
  ...
  <li class="breadcrumb-item"><a href="#">Home</a></li>
    <li class="breadcrumb-item"><a href="#">Art And Craft</a></li>
                  ...
                  <div class="col-auto" style="margin-left: 12px;">
                      <form class="row gx-2">
                        ...
                        <div class="col-auto"><select class="form-select form-select-sm" aria-label="Bulk actions">
                            ...
                            <option value="Refund">20</option>
                            <option value="Delete">50</option>
                          </select></div> <div class="col-auto"><small>Entries </small></div>
                      </form>
                    </div>
                </div>
                ...
                <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                  <thead class="bg-200 text-900" style="text-align: center;">
                    <tr>
                      ...
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">ID</th>
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="name">Title</th>
                    
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Price</th>
                     
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Status</th>
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Posting Date</th>
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Expiry Date</th>
                  ...
                  <tr class="btn-reveal-trigger">
                    <td class="address align-middle white-space-nowrap  py-2" style="text-align: center;" style="text-align: center;">1</td>
                    <td class="name align-middle white-space-nowrap py-2" style="text-align: center;"><a href="http://dev.thesharepage/artandcraft/detail.php">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2" style="height: 7rem;
    width: 10rem;">
                            <img class="" src="https://images.unsplash.com/photo-1453728013993-6d66e9c9123a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dmlld3xlbnwwfHwwfHw%3D&w=1000&q=80" alt="">
                            </div>
                            <div class="flex-1">
                              <h5 class="mb-0 fs--1">wwwwwwwwwwwwww</h5>
                            </div>
                          </div>
                        </a>
                      </td>
                        
                        <td class="phone align-middle white-space-nowrap py-2" style="text-align: center;"><a href="tel:2012001851">$10</a></td>
                      <td class="phone align-middle white-space-nowrap py-2" style="text-align: center;"><a href="tel:2012001851">Private</a></td>
                      
               
                      <td class="joined align-middle py-2" style="text-align: center;">30/03/2018</td>
                      <td class="joined align-middle py-2" style="text-align: center;">30/03/2018</td>
                      <td class="align-middle white-space-nowrap py-2 text-end" >
                        <div class="dropdown font-sans-serif position-static" style="text-align: center;">
                    ...
                    <tr class="btn-reveal-trigger">
                    <td class="address align-middle white-space-nowrap  py-2" style="text-align: center;" style="text-align: center;">1</td>
                      <td class="name align-middle white-space-nowrap py-2" style="text-align: center;"><a href="as_single_album.php">
                          <div class="d-flex d-flex align-items-center">
                            <div class="avatar avatar-xl me-2" style="height: 7rem;
    width: 10rem;">
                            <img class="" src="includes/../../dashboard/assets/img/products/1.jpg" alt="">
                            </div>
                            <div class="flex-1">
                              <h5 class="mb-0 fs--1">Bollywood Unplugged - 1</h5>
                            </div>
                          </div>
                        </a>
                      </td>
                      ...
                      <td class="joined align-middle py-2" style="text-align: center;">30/03/2018</td>
                      <td class="align-middle white-space-nowrap py-2 text-end" >
                        <div class="dropdown font-sans-serif position-static" style="text-align: center;"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button" id="customer-dropdown-0" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false"><svg class="svg-inline--fa fa-ellipsis-h fa-w-16 fs--1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-h" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z"></path></svg><!-- <span class="fas fa-ellipsis-h fs--1"></span> Font Awesome fontawesome.com --></button>
                          <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                            <div class="bg-white py-2"><a class="dropdown-item" href="#!">Edit</a><a class="dropdown-item text-danger" href="#!">Delete</a></div>
                          </div>
