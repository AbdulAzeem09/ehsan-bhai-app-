...
#example_length label{margin-top: 6px;}
</style>
		...
		<?php
                                            ...
                                            if($result != false){
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $result2 = $ag->readdetails($row['spPosting_idspPosting']);
                                                    //echo $p->ta->sql;
                                                    if($result2 != false){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo $BaseUrl.'/artandcraft/dashboard/enquiry-details.php?idartenquiry='.$row['idartenquiry'];?>" ><i style="color: #428bca" title="View" class="fa fa-eye" ></i></a></td>
                                                    </tr>
                                                    <?php
                                             $i++;   }
                                            }
