...
<div class="row">
  ...
  <li class="breadcrumb-item"><a href="#">Home</a></li>
    ...
    <li class="breadcrumb-item"><a href="#">My Enquiry</a></li>
...
<div class="card-header">
                  ...
                  <thead class="bg-200 text-900" style="text-align: center;">
                    <tr>
                      ...
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Price</th>
                         ...
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Message</th>
                        
                         
                      <th class="align-middle no-sort">Read More / Reply</th>
                    </tr>
                  </thead>
    ...
    width: 10rem;">
                      ...
                      <td class="phone align-middle white-space-nowrap py-2" style="text-align: center;"><a href="tel:2012001851">hsdjfhjsdhfjkasdf djshfjsdhf</a></td>
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end" >
                        <div class="dropdown font-sans-serif position-static" style="text-align: center;">
                          ...
                          <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                            <div class="bg-white py-2"><a class="dropdown-item" href="#!">Read More</a><a class="dropdown-item text-danger" href="#!">Reply</a></div>
                          </div>
