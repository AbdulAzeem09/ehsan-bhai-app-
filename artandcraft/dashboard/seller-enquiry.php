...
$pf  = new _postfield;
//print_r($_SESSION);
$result1 = $p->singletimelinesspProfiles_idspProfiles($_SESSION['pid']);
;
//print_r($row2); die('===============');
...
$result = $ag->readMyEnqueryspspPosting_idspPosting($row1['idspPostings']);
...
<td><?php echo $i; ?></td>
<td><?php echo $i; ?></td>
<td><a href="#"><?php echo $ProName;?></a></td>
...
<td><a href="<?php echo $BaseUrl.'/artandcraft/dashboard/enquiry-details-seller.php?idartenquiry='.$row['idartenquiry'];?>" class="btn btn-success btn-border-radius"><i  style="color:#428bca" title="View" class="fa fa-eye" ></i>
</a></td>
</tr>
<?php
$i++;   }
