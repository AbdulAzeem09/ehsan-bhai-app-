...
<div class="panel-heading"> Dashboard / Delivered Orders </div>
</div>
...
$results = $o->readseller_artcraft_delivered($_SESSION['pid']);
//var_dump($results);
if ($results!=false) {
$i = 1;
...
<td style="text-align: center;"><a href="<?= $BaseUrl; ?>/artandcraft/dashboard/sellerstatusnew.php?postid=<?= $row['idspOrder']; ?>"><i style="color: #428bca" class="fa fa-eye" ></i> </a></td>
