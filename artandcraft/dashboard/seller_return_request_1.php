...
<div class="row">
  ...
  <li class="breadcrumb-item"><a href="#">Home</a></li>
    ...
    <li class="breadcrumb-item"><a href="#">Return Reuest</a></li>
                ...
                <div class="col-8 col-sm-auto text-end ps-2">
                  <div class="d-none" id="table-customers-actions">
                    <div class="d-flex"><select class="form-select form-select-sm" aria-label="Bulk actions">
                      ...
                      </select><button class="btn btn-falcon-default btn-sm ms-2 btn-border-radius" type="button">Apply</button></div>
                  </div>
                  ...
                  <thead class="bg-200 text-900" style="text-align: center;">
                    <tr>
                      ...
                      <th class="sort pe-1 align-middle white-space-nowrap" data-sort="phone">Price</th>
                         ...
                         <th class="sort pe-1 align-middle white-space-nowrap " data-sort="address" style="min-width: 50px;">Request Date</th>
                      ...
                      <td class="align-middle white-space-nowrap py-2 text-end" >
                        <div class="dropdown font-sans-serif position-static" style="text-align: center;">
                          ...
                          <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-0">
                            <div class="bg-white py-2"><a class="dropdown-item" href="#!">Pending</a>
