        ...
        <section class="">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
<div class="panel panel-default" style="margin-top:10px;"><div class="panel-heading"> Dashboard / Cancelled Orders</div></div>
...
<td class="text-center"><a href="<?php echo $BaseUrl.'/artandcraft/dashboard/statusnew.php?postid='.$r1['idspOrder'];?>" data-original-title="View Detail" data-toggle="tooltip" data-placement="top" > <i class="fa fa-eye"></i> </a></td>
